...
class EQBugFixModule : public MQModule
{
public:
	EQBugFixModule() : MQModule("EQBugFix", static_cast<int>(ModulePriority::Default), ModuleFlags::CanUnload)
	{
	}
...
DECLARE_MODULE_FACTORY(EQBugFixModule)
