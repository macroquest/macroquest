...
static bool SetDragDropPayload(const char* type, sol::object data, const std::optional<int>& cond)
{
...
static std::unique_ptr<LuaImGuiPayload> AcceptDragDropPayload(const char* type, const std::optional<int>& flags)
{
...
void RegisterBindings_ImGui(sol::state_view state)
{
	...
	ImGui.set_function("Begin", sol::overload(
		...
		[](const char* name, const std::optional<bool>& open, const std::optional<int>& flags) {
	...
	ImGui.set_function("BeginChild", sol::overload(
		...
		[](const char* str_id, const std::optional<float>& size_x, const std::optional<float>& size_y, const std::optional<bool>& border, const std::optional<int>& flags)
		{
		...
		[](const char* str_id, const ImVec2& size, const std::optional<bool>& border, const std::optional<int>& flags)
		{
		...
		[](const char* str_id, const std::optional<float>& size_x, const std::optional<float>& size_y, const std::optional<int>& child_flags, const std::optional<int>& flags)
		{
			return ImGui::BeginChild(str_id, ImVec2(size_x.value_or(0.f), size_y.value_or(0.f)), child_flags.value_or(0), flags.value_or(0));
		},
		[](const char* str_id, const ImVec2& size, const std::optional<int>& child_flags, const std::optional<int>& flags)
		{
	...
	ImGui.set_function("IsWindowFocused", [](const std::optional<int>& flags) { return ImGui::IsWindowFocused(flags.value_or(0)); });
	ImGui.set_function("IsWindowHovered", [](const std::optional<int>& flags) { return ImGui::IsWindowHovered(flags.value_or(0)); });
	...
	ImGui.set_function("SetNextWindowPos", sol::overload(
		[](float posX, float posY, const std::optional<int>& cond, const std::optional<float>& pivotX, const std::optional<float>& pivotY) { ImGui::SetNextWindowPos({ posX, posY }, cond.value_or(0), { pivotX.value_or(0.f), pivotY.value_or(0.f) }); },
		[](const ImVec2& pos, const std::optional<int>& cond, const std::optional<ImVec2>& pivot) { ImGui::SetNextWindowPos(pos, cond.value_or(0), pivot.value_or(ImVec2(0, 0))); }
	));
	ImGui.set_function("SetNextWindowSize", sol::overload(
		[](float sizeX, float sizeY, const std::optional<int>& cond) { ImGui::SetNextWindowSize({ sizeX, sizeY }, cond.value_or(0)); },
		[](const ImVec2& size, const std::optional<int>& cond) { ImGui::SetNextWindowSize(size, cond.value_or(0)); }
	));
	ImGui.set_function("SetNextWindowSizeConstraints", sol::overload(
		[](sol::this_state s, const ImVec2& min, const ImVec2& max, const std::optional<sol::function>& callback)
		{
			if (callback.has_value()) {
				ImGui::SetNextWindowSizeConstraints(min, max, [callback, L = s.lua_state()](ImGuiSizeCallbackData* data) {
					...
					const std::optional<ImVec2>& value = result.get<std::optional<ImVec2>>();
					if (value.has_value())
	...
	ImGui.set_function("SetNextWindowCollapsed", [](bool collapsed, const std::optional<int>& cond) { ImGui::SetNextWindowCollapsed(collapsed, cond.value_or(0)); });
	...
	ImGui.set_function("SetWindowPos", sol::overload(
		[](float posX, float posY, const std::optional<int>& cond) { ImGui::SetWindowPos({ posX, posY }, cond.value_or(0)); },
		[](const ImVec2& pos, const std::optional<int>& cond) { ImGui::SetWindowPos(pos, cond.value_or(0)); },
		[](const char* name, float posX, float posY, const std::optional<int>& cond) { ImGui::SetWindowPos(name, { posX, posY }, cond.value_or(0)); },
		[](const char* name, const ImVec2& pos, const std::optional<int>& cond) { ImGui::SetWindowPos(name, pos, cond.value_or(0)); }
	));
	ImGui.set_function("SetWindowSize", sol::overload(
		[](float sizeX, float sizeY, const std::optional<int>& cond) { ImGui::SetWindowSize({ sizeX, sizeY }, cond.value_or(0)); },
		[](const char* name, float sizeX, float sizeY, const std::optional<int>& cond) { ImGui::SetWindowSize(name, { sizeX, sizeY }, cond.value_or(0)); },
		[](const ImVec2& size, const std::optional<int>& cond) { ImGui::SetWindowSize(size, cond.value_or(0)); },
		[](const char* name, const ImVec2& size, const std::optional<int>& cond) { ImGui::SetWindowSize(name, size, cond.value_or(0)); }
	));
	ImGui.set_function("SetWindowCollapsed", sol::overload(
		[](bool collapsed, const std::optional<int>& cond) { ImGui::SetWindowCollapsed(collapsed, cond.value_or(0)); },
		[](const char* name, bool collapsed, const std::optional<int>& cond) { ImGui::SetWindowCollapsed(name, collapsed, cond.value_or(0)); }
	));
	ImGui.set_function("SetWindowFocus", sol::overload(
		[]() { ImGui::SetWindowFocus(); },
		[](const std::optional<const char*>& name) { ImGui::SetWindowFocus(name.value_or(nullptr)); }
	));
	...
	ImGui.set_function("SetScrollHereX", [](const std::optional<float>& center_x_ratio) { ImGui::SetScrollHereX(center_x_ratio.value_or(0.5f)); });
	ImGui.set_function("SetScrollHereY", [](const std::optional<float>& center_y_ratio) { ImGui::SetScrollHereY(center_y_ratio.value_or(0.5f)); });
	ImGui.set_function("SetScrolFromPosX", [](float local_x, const std::optional<float>& center_x_ratio) { ImGui::SetScrollFromPosX(local_x, center_x_ratio.value_or(0.5f)); });
	ImGui.set_function("SetScrolFromPosY", [](float local_y, const std::optional<float>& center_y_ratio) { ImGui::SetScrollFromPosY(local_y, center_y_ratio.value_or(0.5f)); });
	#pragma endregion

	#pragma region Parameters Stacks (Shared)
	// Parameters stacks (shared)
	ImGui.set_function("PushFont", [](const std::optional<ImFont*>& font) { ImGui::PushFont(font.value_or(nullptr)); });
	...
	ImGui.set_function("PopStyleColor", [](const std::optional<int>& count) { ImGui::PopStyleColor(count.value_or(1)); });
	...
	ImGui.set_function("PopStyleVar", [](const std::optional<int>& count) { ImGui::PopStyleVar(count.value_or(1)); });
	...
	ImGui.set_function("PushTextWrapPos", [](const std::optional<float>& wrap_local_pos_x) { ImGui::PushTextWrapPos(wrap_local_pos_x.value_or(0.0f)); });
	...
	ImGui.set_function("SameLine", [](const std::optional<float>& offset_from_start_x, const std::optional<float>& spacing) { ImGui::SameLine(offset_from_start_x.value_or(0.0f), spacing.value_or(-1.0f)); });
	...
	ImGui.set_function("Indent", [](const std::optional<float>& indent_w) { ImGui::Indent(indent_w.value_or(0.0f)); });
	ImGui.set_function("Unindent", [](const std::optional<float>& indent_w) { ImGui::Unindent(indent_w.value_or(0.0f)); });
	...
	ImGui.set_function("BeginPopup", [](const char* str_id, const std::optional<int>& flags) { return ImGui::BeginPopup(str_id, flags.value_or(0)); });
	ImGui.set_function("BeginPopupModal", sol::overload(
		[](const char* name, const std::optional<bool>& open, const std::optional<bool>& flags)
		{
	...
	ImGui.set_function("OpenPopup", sol::overload(
		[](const char* str_id, const std::optional<int>& popup_flags) { ImGui::OpenPopup(str_id, popup_flags.value_or(0)); },
		[](ImGuiID id, const std::optional<int>& popup_flags) { ImGui::OpenPopup(id, popup_flags.value_or(0)); }
	));
...
#pragma endregion
	...
	ImGui.set_function("BeginTable", [](const char* str_id, int column, const std::optional<int>& flags, const std::optional<ImVec2>& outer_size, const std::optional<float>& inner_width) {
	...
	ImGui.set_function("TableNextRow", [](const std::optional<int>& flags, const std::optional<float>& min_row_height) { ImGui::TableNextRow(flags.value_or(0), min_row_height.value_or(0.0f)); });
	ImGui.set_function("TableNextColumn", &ImGui::TableNextColumn);
	ImGui.set_function("TableSetColumnIndex", &ImGui::TableSetColumnIndex);

	ImGui.set_function("TableSetupColumn", [](const char* label, const std::optional<int>& flags, const std::optional<float>& init_width_or_weight, const std::optional<int>& user_id) { ImGui::TableSetupColumn(label, flags.value_or(0), init_width_or_weight.value_or(0.0f), (ImGuiID)user_id.value_or(0)); });
	...
	ImGui.set_function("TableGetColumnName", [](const std::optional<int>& column_n) { return ImGui::TableGetColumnName(column_n.value_or(-1)); });
	ImGui.set_function("TableGetColumnFlags", [](const std::optional<int>& column_n) { return ImGui::TableGetColumnFlags(column_n.value_or(-1)); });
	...
	ImGui.set_function("TableSetBgColor", sol::overload(
		[](int target, ImU32 color, const std::optional<int>& column_n) { ImGui::TableSetBgColor(target, color, column_n.value_or(-1)); },
		[](int target, const ImVec4& color, const std::optional<int>& column_n) { ImGui::TableSetBgColor(target, ImGui::ColorConvertFloat4ToU32(color), column_n.value_or(-1)); },
		[](int target, float colorR, float colorG, float colorB, float colorA, const std::optional<int>& column_n) { ImGui::TableSetBgColor(target, ImGui::ColorConvertFloat4ToU32({colorR, colorG, colorB, colorA}), column_n.value_or(-1)); }
	));

	ImGui.set_function("TableGetColumnIsVisible", [](const std::optional<int>& column_n) { return (ImGui::TableGetColumnFlags(column_n.value_or(-1)) & ImGuiTableColumnFlags_IsVisible) != 0; });
	ImGui.set_function("TableGetColumnIsSorted", [](const std::optional<int>& column_n) { return (ImGui::TableGetColumnFlags(column_n.value_or(-1)) & ImGuiTableColumnFlags_IsSorted) != 0; });
	ImGui.set_function("TableGetHoveredColumn", &ImGui::TableGetHoveredColumn);
	ImGui.set_function("TableGetColumnHasFlag", [](int flag, const std::optional<int>& column_n) { return (ImGui::TableGetColumnFlags(column_n.value_or(-1)) & flag) != 0; });
	#pragma endregion

	#pragma region Columns
	ImGui.set_function("Columns", [](const std::optional<int>& count, const std::optional<const char*>& id, const std::optional<bool>& border) { ImGui::Columns(count.value_or(1), id.value_or(nullptr), border.value_or(true)); });
	ImGui.set_function("NextColumn", &ImGui::NextColumn);
	ImGui.set_function("GetColumnIndex", &ImGui::GetColumnIndex);
	ImGui.set_function("GetColumnWidth", [](const std::optional<int>& column_index) { return ImGui::GetColumnWidth(column_index.value_or(-1)); });
	ImGui.set_function("SetColumnWidth", &ImGui::SetColumnWidth);
	ImGui.set_function("GetColumnOffset", [](const std::optional<int>& column_index) { return ImGui::GetColumnOffset(column_index.value_or(-1)); });
	...
	ImGui.set_function("DockSpace", sol::overload(
		[](ImGuiID id, const std::optional<ImVec2>& size, const std::optional<int> flags, const std::optional<ImGuiWindowClass*>& window_class) { return ImGui::DockSpace(id, size.value_or(ImVec2(0, 0)), flags.value_or(0), window_class.value_or(nullptr)); },
		[](ImGuiID id, float sizeX, float sizeY, const std::optional<int> flags, const std::optional<ImGuiWindowClass*>& window_class) { return ImGui::DockSpace(id, { sizeX, sizeY }, flags.value_or(0), window_class.value_or(nullptr)); }
	));
	ImGui.set_function("DockSpaceOverViewport", [](const std::optional<ImGuiViewport*>& viewport, const std::optional<int> flags, const std::optional<ImGuiWindowClass*>& window_class) { return ImGui::DockSpaceOverViewport(viewport.value_or(nullptr), flags.value_or(0), window_class.value_or(nullptr)); });
	ImGui.set_function("SetNextWindowDockID", [](ImGuiID dock_id, const std::optional<int>& cond) { ImGui::SetNextWindowDockID(dock_id, cond.value_or(0)); });
	...
	// Logging / Capture
	ImGui.set_function("LogToTTY", [](const std::optional<int>& auto_open_depth) { ImGui::LogToTTY(auto_open_depth.value_or(-1)); });
	ImGui.set_function("LogToFile", [](const std::optional<int>& auto_open_depth, const std::optional<const char*>& filename) { ImGui::LogToFile(auto_open_depth.value_or(-1), filename.value_or(nullptr)); });
	ImGui.set_function("LogToClipboard", [](const std::optional<int>& auto_open_depth) { ImGui::LogToClipboard(auto_open_depth.value_or(-1)); });
	...
	ImGui.set_function("BeginDragDropSource", [](const std::optional<int>& flags) { return ImGui::BeginDragDropSource(flags.value_or(0)); });
	...
	// Disabling
	ImGui.set_function("BeginDisabled", [](const std::optional<bool>& disabled) { ImGui::BeginDisabled(disabled.value_or(true)); });
	...
	ImGui.set_function("SetKeyboardFocusHere", [](const std::optional<int>& offset) { ImGui::SetKeyboardFocusHere(offset.value_or(0)); });
	...
	ImGui.set_function("IsItemHovered", [](const std::optional<int>& flags) { return ImGui::IsItemHovered(flags.value_or(0)); });
	ImGui.set_function("IsItemActive", &ImGui::IsItemActive);
	ImGui.set_function("IsItemFocused", &ImGui::IsItemFocused);
	ImGui.set_function("IsItemClicked", [](const std::optional<int>& mouse_button) { return ImGui::IsItemClicked(mouse_button.value_or(0)); });
	...
	// Text Utilities
	ImGui.set_function("CalcTextSizeVec", [](const char* text, const std::optional<bool>& hide_text_after_double_hash, const std::optional<float>& wrap_width) { return ImGui::CalcTextSize(text, nullptr, hide_text_after_double_hash.value_or(false), wrap_width.value_or(-1.0f)); });
	ImGui.set_function("CalcTextSize", [](const char* text, const std::optional<bool>& hide_text_after_double_hash, const std::optional<float>& wrap_width) { ImVec2 size = ImGui::CalcTextSize(text, nullptr, hide_text_after_double_hash.value_or(false), wrap_width.value_or(-1.0f)); return std::make_tuple(size.x, size.y); });
	...
	state.set_function("IM_COL32", [](int colR, int colG, int colB, const std::optional<int>& colA) -> int { return IM_COL32(colR, colG, colB, colA.value_or(255)); });
	#pragma endregion

	#pragma region Inputs Utilities: Keyboard
	// Inputs Utilities: Keyboard
	ImGui.set_function("IsKeyDown", [](ImGuiKey key) { return ImGui::IsKeyDown(key); });
	ImGui.set_function("IsKeyPressed", [](ImGuiKey key, const std::optional<bool>& repeat) { return ImGui::IsKeyPressed(key, repeat.value_or(true)); });
	...
	ImGui.set_function("IsMouseClicked", [](int button, const std::optional<bool>& repeat) { return ImGui::IsMouseClicked(button, repeat.value_or(true)); });
	...
	ImGui.set_function("IsMouseHoveringRect", sol::overload(
		[](const ImVec2& r_min, const ImVec2& r_max, const std::optional<bool>& clip) { return ImGui::IsMouseHoveringRect(r_min, r_max, clip.value_or(true)); },
		[](float min_x, float min_y, float max_x, float max_y, const std::optional<bool>& clip) { return ImGui::IsMouseHoveringRect({ min_x, min_y }, { max_x, max_y }, clip.value_or(true)); }
	));
	ImGui.set_function("IsMousePosValid", [](const std::optional<ImVec2>& mouse_pos) { return ImGui::IsMousePosValid(mouse_pos.has_value() ? &mouse_pos.value() : nullptr); });
	...
	ImGui.set_function("IsMouseDragging", [](int button, const std::optional<float>& lock_threshold) { return ImGui::IsMouseDragging(button, lock_threshold.value_or(-1.0f)); });
	ImGui.set_function("GetMouseDragDelta", [](const std::optional<int>& button, const std::optional<float>& lock_threshold) { ImVec2 vec2 = ImGui::GetMouseDragDelta(button.value_or(0), lock_threshold.value_or(-1.0f)); return std::make_tuple(vec2.x, vec2.y); });
	ImGui.set_function("GetMouseDragDelta", [](const std::optional<int>& button, const std::optional<float>& lock_threshold) { return ImGui::GetMouseDragDelta(button.value_or(0), lock_threshold.value_or(-1.0f)); });
	ImGui.set_function("ResetMouseDragDelta", [](const std::optional<int>& button) { ImGui::ResetMouseDragDelta(button.value_or(0)); });
...
#pragma region Obsolete Functions
	...
	ImGui.set_function("CaptureKeyboardFromApp", [](const std::optional<bool>& want_capture_keyboard) { ImGui::SetNextFrameWantCaptureKeyboard(want_capture_keyboard.value_or(true)); });
	ImGui.set_function("CaptureMouseFromApp", [](const std::optional<bool>& want_capture_mouse) { ImGui::SetNextFrameWantCaptureMouse(want_capture_mouse.value_or(true)); });

	ImGui.set_function("BeginChildFrame", sol::overload(
		[](ImGuiID id, float sizeX, float sizeY, const std::optional<int>& flags) { return ImGui::BeginChild(id, { sizeX, sizeY }, ImGuiChildFlags_FrameStyle, flags.value_or(0)); },
		[](ImGuiID id, const ImVec2& size, const std::optional<int>& flags) { return ImGui::BeginChild(id, size, ImGuiChildFlags_FrameStyle, flags.value_or(0)); }
	));
