...
make_override 0x2a8, ?Top@?$CXWndTrampoline@VMapViewMap@eqlib@@@detail@eqlib@@UEAAX_N@Z
make_override 0x2b0, ?Bottom@?$CXWndTrampoline@VMapViewMap@eqlib@@@detail@eqlib@@UEAAX_N@Z
make_override 0x2b8, ?Right@?$CXWndTrampoline@VMapViewMap@eqlib@@@detail@eqlib@@UEAAX_N@Z
make_override 0x2c0, ?Left@?$CXWndTrampoline@VMapViewMap@eqlib@@@detail@eqlib@@UEAAX_N@Z
make_override 0x2c8, ?MoveToCursor@?$CXWndTrampoline@VMapViewMap@eqlib@@@detail@eqlib@@UEAAHXZ
make_override 0x2d0, ?GetChildWndAt@?$CXWndTrampoline@VMapViewMap@eqlib@@@detail@eqlib@@UEBAPEAVCXWnd@3@AEBVCXPoint@3@_N1@Z
make_override 0x2d8, ?GetSidlPiece@?$CXWndTrampoline@VMapViewMap@eqlib@@@detail@eqlib@@UEBAPEAVCScreenPieceTemplate@3@AEBVCXStr@3@_N@Z
make_override 0x2e0, ?GetWindowName@?$CXWndTrampoline@VMapViewMap@eqlib@@@detail@eqlib@@UEBAPEBVCXStr@3@XZ
make_override 0x2e8, ?SetVScrollPos@?$CXWndTrampoline@VMapViewMap@eqlib@@@detail@eqlib@@UEAAHH@Z
make_override 0x2f0, ?SetHScrollPos@?$CXWndTrampoline@VMapViewMap@eqlib@@@detail@eqlib@@UEAAHH@Z
make_override 0x2f8, ?AutoSetVScrollPos@?$CXWndTrampoline@VMapViewMap@eqlib@@@detail@eqlib@@UEAAHVCXRect@3@@Z
make_override 0x200, ?AutoSetHScrollPos@?$CXWndTrampoline@VMapViewMap@eqlib@@@detail@eqlib@@UEAAHVCXRect@3@@Z
make_override 0x208, ?SetAttributesFromSidl@?$CXWndTrampoline@VMapViewMap@eqlib@@@detail@eqlib@@UEAAXPEAVCParamScreenPiece@3@@Z
make_override 0x310, ?OnReloadSidl@?$CXWndTrampoline@VMapViewMap@eqlib@@@detail@eqlib@@UEAAXXZ
make_override 0x318, ?HasActivatedFirstTimeAlert@?$CXWndTrampoline@VMapViewMap@eqlib@@@detail@eqlib@@UEBA_NXZ
make_override 0x320, ?SetHasActivatedFirstTimeAlert@?$CXWndTrampoline@VMapViewMap@eqlib@@@detail@eqlib@@UEAAX_N@Z
make_override 0x328, ?GetMinClientSize@?$CXWndTrampoline@VMapViewMap@eqlib@@@detail@eqlib@@UEBAAEBVCXSize@3@XZ
make_override 0x330, ?GetMaxClientSize@?$CXWndTrampoline@VMapViewMap@eqlib@@@detail@eqlib@@UEBAAEBVCXSize@3@XZ
make_override 0x338, ?GetActiveEditWnd@?$CXWndTrampoline@VMapViewMap@eqlib@@@detail@eqlib@@UEBAPEAVCEditWnd@3@XZ
make_override 0x340, ?UpdateLayout@?$CXWndTrampoline@VMapViewMap@eqlib@@@detail@eqlib@@UEAAX_N@Z


; CSidlScreenWnd virtual functions
make_override 0x348, ?Unknown0x330@?$CSidlScreenWndTrampoline@VMapViewMap@eqlib@@@detail@eqlib@@UEAAXPEBD_N@Z
make_override 0x350, ?OnZone@?$CSidlScreenWndTrampoline@VMapViewMap@eqlib@@@detail@eqlib@@UEAAHXZ
make_override 0x358, ?OnPreZone@?$CSidlScreenWndTrampoline@VMapViewMap@eqlib@@@detail@eqlib@@UEAAHXZ
make_override 0x360, ?LoadIniInfo@?$CSidlScreenWndTrampoline@VMapViewMap@eqlib@@@detail@eqlib@@UEAAXXZ
make_override 0x368, ?StoreIniInfo@?$CSidlScreenWndTrampoline@VMapViewMap@eqlib@@@detail@eqlib@@UEAAXXZ
make_override 0x370, ?AsSidlScreenWnd@?$CSidlScreenWndTrampoline@VMapViewMap@eqlib@@@detail@eqlib@@UEAAPEAVCSidlScreenWnd@3@XZ
make_override 0x378, ?GetScreenWndType@?$CSidlScreenWndTrampoline@VMapViewMap@eqlib@@@detail@eqlib@@UEAA_NXZ