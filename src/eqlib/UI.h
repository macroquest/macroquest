...
/*0x238*/ CButtonDrawTemplate DrawTemplate;
/*0x26c*/ bool         bAllowButtonClickThrough;
/*0x26d*/ bool         bCoolDownDoDelayedStart;
/*0x26e*/ bool         bIsCheckbox;
/*0x26f*/ bool         bIsDrawLasso;
/*0x270*/ uint32_t     ButtonStyle;              // tbd
/*0x274*/ CLabel*      pButtonLabel;
/*0x278*/
...
/*0x20c*/ int32_t                      TextTotalHeight;
/*0x210*/ int32_t                      TextTotalWidth;
/*0x214*/ int32_t                      Unknown0x224;
/*0x218*/ ArrayClass2<SLinkInfo>       Links;                        // size 0x1c at 0x228 for sure see 8F4487 in Sep 11 2017 test
/*0x230*/ ArrayClass<STable>           Tables;
/*0x240*/ bool                         bReparseNow;
/*0x241*/ bool                         bResized;
/*0x242*/ bool                         bAlignCenter;
/*0x244*/ int                          LineSpacingAdjust;
/*0x248*/ int32_t                      CapturedLinkID;
/*0x24c*/ int32_t                      MousedOverLinkID;
/*0x250*/ COLORREF                     BackGroundColor;
/*0x254*/ COLORREF                     TextColor;
/*0x258*/ COLORREF                     LinkColor;
/*0x25c*/ COLORREF                     VLinkColor;
/*0x260*/ COLORREF                     ALinkColor;
/*0x264*/ COLORREF                     MLinkColor;
/*0x268*/ ESTMLParseState              CurrentParseState;
/*0x26c*/ ArrayClass2<SHistoryElement> HistoryArray;
...
/*0x9228*/ CButtonWnd* pQueryButton;
/*0x922c*/ CButtonWnd* pWelcomeButton;
/*0x9230*/ CButtonWnd* pUpdatePlayerButton;
/*0x9234*/ CButtonWnd* pRequestItemButton;
/*0x9238*/ CButtonWnd* pRequestPreviewButton;
/*0x923c*/ CButtonWnd* pFindTraderButton;
/*0x9240*/ CButtonWnd* pHideTradersButton;
/*0x9244*/ CButtonWnd* pDefaultButton;
/*0x9248*/ CButtonWnd* pBuyButton;
/*0x924c*/ CLabelWnd*  pItemNameLabel;
/*0x9250*/ CLabelWnd*  pPlayersLabel;
/*0x9254*/ CLabelWnd*  pItemSlotLabel;
/*0x9258*/ CLabelWnd*  pStatSlotLabel;
/*0x925c*/ CLabelWnd*  pRaceSlotLabel;
/*0x9260*/ CLabelWnd*  pClassSlotLabel;
/*0x9264*/ CLabelWnd*  pItemTypeLabel;
/*0x9268*/ CLabelWnd*  pSearchResultLabel;
/*0x926c*/ CLabelWnd*  pMaxPriceLabel;
/*0x9270*/ CLabelWnd*  pMinPriceLabel;
/*0x9274*/ CLabelWnd*  pItemPrestigeLabel;
/*0x9278*/ CLabelWnd*  pItemAugmentLabel;
/*0x927c*/ CComboWnd*  pItemSlotCombobox;
/*0x9280*/ CComboWnd*  pStatSlotCombobox;
/*0x9284*/ CComboWnd*  pRaceSlotCombobox;
/*0x9288*/ CComboWnd*  pClassSlotCombobox;
/*0x928c*/ CComboWnd*  pItemTypeCombobox;
/*0x9290*/ CComboWnd*  pPlayersCombobox;
/*0x9294*/ CComboWnd*  pItemPrestigeCombobox;
/*0x9298*/ CComboWnd*  pItemAugmentCombobox;
/*0x929c*/ CEditWnd*   pItemNameInput;
/*0x92a0*/ CEditWnd*   pMaxPriceInput;
/*0x92a4*/ CEditWnd*   pMinPriceInput;
/*0x92a8*/ CEditWnd*   pMaxLevelInput;
/*0x92ac*/ CEditWnd*   pMinLevelInput;
/*0x92b0*/ CEditWnd*   pMaxResultsPerTraderInput;
/*0x92b4*/ BYTE        Unknown0x92C8[0x8];
/*0x92bc*/
};
...
/*0x6d4*/ uint8_t     Unknown0x06ec[0x28];
...
/*0x23c*/ SoeUtil::IString Unknown0x23c;
/*0x24c*/ SoeUtil::IString Unknown0x24c;
...
/*0x234*/ CHtmlComponentWnd*       pHtmlComponentMain;
/*0x238*/ CButtonWnd*              pBackBtn;
/*0x23c*/ CButtonWnd*              pForwardBtn;
/*0x240*/ CGaugeWnd*               pProgressGauge;
/*0x244*/ CLabelWnd*               pStatusLabel;
/*0x248*/ CXStr                    WindowID;
/*0x24c*/
};
...
/*0x288*/ VePointer<CONTENTS> LinkedItem;              // ItemBasePtr
...
/*0x230*/ BYTE              Unknown0x240[0x94];
/*0x2c4*/ DWORD             NumOfSlots;
/*0x2c8*/ BYTE              Unknown0x02e0[0x4];
/*0x2cc*/ INVENTORYARRAY*   pInventoryArray;
/*0x2d0*/ DWORD             Size;
/*0x2d4*/ DWORD             NumOfSlots3;
/*0x2d8*/ BYTE              Unknown0x2e8[0x8];
/*0x2e0*/ BYTE              Unknown0x2f0;
/*0x2e1*/ BYTE              Unknown0x2f1;
/*0x2e2*/ BYTE              Unknown0x2f2;
/*0x2e3*/ BYTE              Unknown0x2f3;
/*0x2e4*/ CXWnd*            LootInvWnd;
/*0x2e8*/ CInvSlotWnd*      LootSlotWnd[0x22];
/*0x370*/ CLabel*           LW_CorpseName;
/*0x374*/ CButtonWnd*       DoneButton;
/*0x378*/ CButtonWnd*       BroadcastButton;
/*0x37c*/ CButtonWnd*       LootAllButton;
/*0x380*/ BYTE              Unknown0x390[0x10];
/*0x390*/
};
...
/*0x458*/
#else
/*0x230*/ bool         bInventoryWasActive;
/*0x234*/ VeArray<VePointer<MerchantPageHandler>> PageHandlers;
/*0x240*/ float        MerchantGreed;
/*0x244*/ ItemGlobalIndex ItemLocation;
/*0x250*/ BYTE         Unknown0x254[0x8];
/*0x258*/ VePointer<CONTENTS> pSelectedItem;
/*0x25c*/ time_t       MailExpireTime;
/*0x260*/ bool         bAutoRetrieveingMail;
/*0x261*/ BYTE         Unknown0x268[0x10];
/*0x274*/ char*        Labels[0xc];
/*0x2a4*/ CEditWnd*    SearchEdit;
...
/*0x314*/ CTabWnd*     TabWindow;
/*0x318*/ CButtonWnd*  UsableButton;
/*0x31c*/ CLabel*      CurrentCurrencyLabel;
/*0x320*/ int          Unknown0x32c;
/*0x324*/ int          Unknown0x330;
/*0x328*/ int          Unknown0x334;
/*0x32c*/ int          Unknown0x338;
/*0x330*/ int          Unknown0x33C;
/*0x334*/ int          Guk_Currency;
/*0x338*/ uint8_t      Unknown0x340[0x108];
/*0x440*/
#endif
...
/*0x704*/ uint8_t            Unknown0x714[0x20];
...
/*0x22c*/ uint8_t            Unknown0x0240[0xb0];
/*0x2dc*/ ECombatState       CombatState;                       // right above "A_PWCSInCombat"
/*0x2e0*/
};
...
/*0x2a8*/ PSPAWNINFO         ActiveMerchant; // PlayerClient*
...
/*0x2cc*/ CONTENTS* pSelectedItem; // ItemBasePtr
...
/*0x23c*/ SoeUtil::IString   DescriptionText;
/*0x24c*/ SoeUtil::IString   TitleText;
...
/*0x284*/ D3DCOLOR           SpellGemTintArray[11];    // I dont understand why there are only 11 of these when we have 13 gems noaways, probably a bug or unused?
...
/*0x2c4*/ ItemBaseContainer  TradeItems;
