...
/*0x238*/ int64_t            LastFlashTime;
/*0x240*/ COLORREF           CRHighlightFlashColor;
/*0x244*/ bool               bHighlightOnNewMessages;
/*0x245*/ bool               bFlashing;
/*0x248*/
};
...
public:
	...
	// todo: check
/*0x0224*/ BYTE        Unknown0x023c[0x8ff4];
/*0x9218*/ void**      ppTraderData;
/*0x921c*/ DWORD       hashVal;                  // find in CBazaarSearchWnd__HandleBazaarMsg_x
/*0x9220*/ CListWnd*   pItemList;
/*0x9224*/ CButtonWnd* pQueryButton;
/*0x9228*/ CButtonWnd* pWelcomeButton;
/*0x922c*/ CButtonWnd* pUpdatePlayerButton;
/*0x9230*/ CButtonWnd* pRequestItemButton;
/*0x9234*/ CButtonWnd* pRequestPreviewButton;
/*0x9238*/ CButtonWnd* pFindTraderButton;
/*0x923c*/ CButtonWnd* pHideTradersButton;
/*0x9240*/ CButtonWnd* pDefaultButton;
/*0x9244*/ CButtonWnd* pBuyButton;
/*0x9248*/ CLabelWnd*  pItemNameLabel;
/*0x924c*/ CLabelWnd*  pPlayersLabel;
/*0x9250*/ CLabelWnd*  pItemSlotLabel;
/*0x9254*/ CLabelWnd*  pStatSlotLabel;
/*0x9258*/ CLabelWnd*  pRaceSlotLabel;
/*0x925c*/ CLabelWnd*  pClassSlotLabel;
/*0x9260*/ CLabelWnd*  pItemTypeLabel;
/*0x9264*/ CLabelWnd*  pSearchResultLabel;
/*0x9268*/ CLabelWnd*  pMaxPriceLabel;
/*0x926c*/ CLabelWnd*  pMinPriceLabel;
/*0x9270*/ CLabelWnd*  pItemPrestigeLabel;
/*0x9274*/ CLabelWnd*  pItemAugmentLabel;
/*0x9278*/ CComboWnd*  pItemSlotCombobox;
/*0x927c*/ CComboWnd*  pStatSlotCombobox;
/*0x9280*/ CComboWnd*  pRaceSlotCombobox;
/*0x9284*/ CComboWnd*  pClassSlotCombobox;
/*0x9288*/ CComboWnd*  pItemTypeCombobox;
/*0x928c*/ CComboWnd*  pPlayersCombobox;
/*0x9290*/ CComboWnd*  pItemPrestigeCombobox;
/*0x9294*/ CComboWnd*  pItemAugmentCombobox;
/*0x9298*/ CEditWnd*   pItemNameInput;
/*0x929c*/ CEditWnd*   pMaxPriceInput;
/*0x92a0*/ CEditWnd*   pMinPriceInput;
/*0x92a4*/ CEditWnd*   pMaxLevelInput;
/*0x92a8*/ CEditWnd*   pMinLevelInput;
/*0x92ac*/ CEditWnd*   pMaxResultsPerTraderInput;
/*0x92b0*/ BYTE        Unknown0x92C8[0x8];
/*0x92b8*/
};
...
/*0x280*/ VePointer<CONTENTS> LinkedItem;              // ItemBasePtr
...
/*0x2b0*/ VePointer<CONTENTS> pItem; // ItemBasePtr
...
/*0x306*/ BYTE              Unknown0x30e[0x2f2];
/*0x5f8*/ DWORD             Unknown0x600;
/*0x5fc*/ DWORD             Unknown0x604;
/*0x600*/ DWORD             Unknown0x608;
...
/*0x228*/ BYTE              Unknown0x240[0x94];
/*0x2bc*/ DWORD             NumOfSlots;
/*0x2c0*/ BYTE              Unknown0x02e0[0x4];
/*0x2c4*/ INVENTORYARRAY*   pInventoryArray;
/*0x2c8*/ DWORD             Size;
/*0x2cc*/ DWORD             NumOfSlots3;
/*0x2d0*/ BYTE              Unknown0x2e8[0x8];
/*0x2d8*/ BYTE              Unknown0x2f0;
/*0x2d9*/ BYTE              Unknown0x2f1;
/*0x2da*/ BYTE              Unknown0x2f2;
/*0x2db*/ BYTE              Unknown0x2f3;
...
/*0x334*/ uint8_t      Unknown0x340[0x108];
/*0x43c*/
#endif
...
/*0x6fc*/ uint8_t            Unknown0x714[0x20];
...
/*0x27c*/ D3DCOLOR           SpellGemTintArray[11];    // I dont understand why there are only 11 of these when we have 13 gems noaways, probably a bug or unused?
