...
// The mandatory pre-setup function.  Our name is "ISXEQAutoLogin", and the class is ISXEQAutoLogin.
...
void ISXEQAutoLogin::RegisterAliases()
{
    // add any aliases
}

void ISXEQAutoLogin::RegisterDataTypes()
{
    // add any datatypes
    // pMyType = new MyType;
...
void ISXEQAutoLogin::UnRegisterAliases()
{
    // remove aliases
}
void ISXEQAutoLogin::UnRegisterDataTypes()
{
    // remove data types
    //if (pMyType)
    //{
...
void ISXEQAutoLogin::UnRegisterTopLevelObjects()
{
    // remove Top-Level Objects
    //    pISInterface->RemoveTopLevelObject("MapSpawn");
}
void ISXEQAutoLogin::UnRegisterServices()
{
    // shutdown our own services
    //    if (hISXEQAutoLoginService)
    //        pISInterface->ShutdownService(this,hISXEQAutoLoginService);
}
...
void ISXEQAutoLogin::LoadSettings()
{
    ...
    // open the settings file, and store the ID number in ISXEQAutoLoginXML
    ...
    Any set can be referred to by its ID.  The base set is stored in ISXEQAutoLoginXML.  Note that the settings
