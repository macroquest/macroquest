...
EQLIB_OBJECT int64_t GetClassMember(void* This, int ID);
EQLIB_OBJECT void SetClassMember(void* This, int ID, int64_t Value);
...
#if 0
#define CXW_NO_VTABLE_DATA \
private: \
/*0x004*/ BYTE FTYMF[0x1E4];
#else
#define CXW_NO_VTABLE_DATA \
	CXW_NO_VTABLE_BEGIN \
...
/*0x0028*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x1c */ \
...
/*0x00C8*/ bool bClickThroughMenuItemStatus; /* on/off */ \
...
/*0x00EC*/ DWORD	LastTimeMouseOver; \
...
/*0x010D*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x010E*/ bool		bClipToParent; \
/*0x010F*/ bool		bKeepOnScreen; \
/*0x0110*/ LONG		BlinkStartTimer; \
/*0x0114*/ RECT		ClientRect; \
/*0x0124*/ BYTE     bResizableMask; \
/*0x0125*/ bool		bRightAnchoredToLeft; \
...
/*0x014C*/ bool		bIsParentOrContextMenuWindow; \
...
/*0x0174*/ bool		bTopAnchoredToTop; \
/*0x0175*/ bool		dShow; \
/*0x0176*/ bool		bMarkedForDelete; \
/*0x0178*/ UINT		TransitionDuration; \
/*0x017C*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0180*/ UINT		BlinkFadeStartTime; \
/*0x0184*/ bool		bMaximized; \
...
public: \
			...
			{ \
				SetClassMember(this,15,bValue); /*Minimized*/ \
			} \
			bool IsMouseOver() \
			{ \
...
// CBazaarSearchWnd_size: 0x92d0 (see 54363E) in May 13 2019 Live - eqmule
...
// CPlayerWindow_size: 0x2e8 (see 542F34) in May 13 2019 Live - eqmule
...
// CTargetWindow_size: 0x8c8 (see 542DCF) in May 13 2019 Live - eqmule
...
// CBuffWindow_size: 0x718 (see 542C73) in May 13 2019 Live - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x320 (see 7F51BB) in May 13 2019 Live - eqmule
...
// CCastSpellWnd_size: 0x2d0 (see 54302D) in May 13 2019 Live - eqmule
...
// CInvSlotWnd_size: 0x2d0 (see 7F52BC) in May 13 2019 Live - eqmule
...
// CItemDisplayWindow_size: 0x628 (see 755432) in May 13 2019 Live - eqmule
...
// CLootWnd_size: 0x398 (see 543396) in May 13 2019 Live - eqmule
...
// CMapViewWnd_size: 0x648 (see 542AD4) in May 13 2019 Live - eqmule
...
// CMerchantWnd_size: 0x448 (see 5434F2) in May 13 2019 Live - eqmule
...
// CPetInfoWindow_size: 0x8c8 (see 542511) in May 13 2019 Live - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a8 (see 542802) in May 13 2019 Live - eqmule
...
// CTradeWnd__size: 0x2f0 (see 543598) in May 13 2019 Live - eqmule
...
// CFactionWnd__size: 0x278 (see 5436E4) in May 13 2019 Live - eqmule
