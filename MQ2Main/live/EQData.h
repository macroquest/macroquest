...
//Actual Size: 0x150 (see 0x61047C in eqgame.exe Live dated Apr 18 2019) - eqmule
...
#define EQ_ASSIST_COMPLETE              0x582b   // aMsgTimeStampRe
#define EQ_BEGIN_ZONE                   0x2BC9   // CEverQuest__SavePCForce
#define EQ_END_ZONE                     0x45B0   // CEverQuest__DoMainLoop+B2F
#define EQ_ASSIST                       0x76C3   // do_assist(PlayerClient *,char const *)+399 20160212 live (see 52C319)
