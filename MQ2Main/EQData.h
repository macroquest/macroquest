...
//Actual Size: 0x150 (see 0x600D6C in eqgame.exe Live dated Nov 27 2018) - eqmule
...
/*0x0098*/ int	Open;
/*0x009C*/ CHAR	ActorTag1[0x1e];
/*0x00BC*/ int	StackCount;
/*0x00C0*/ int	EvolvingMaxLevel;
...
/*0x00E4*/ bool	IsEvolvingItem;
/*0x00E5*/ bool	bCollected;
/*0x00E8*/ UINT	LastCastTime;
/*0x00EC*/ int	RealEstateID;
/*0x00F0*/ UINT	NewArmorID;
/*0x00F4*/ ItemGlobalIndex2 GlobalIndex; /* Size is 0xa (0xc)*/
/*0x0100*/ ArrayClass_RO<UINT> RealEstateArray;
/*0x0110*/ bool	EvolvingExpOn;
/*0x0114*/ int	Charges;
/*0x0118*/ int	MerchantQuantity;
/*0x011C*/ UINT	Tint;
/*0x0120*/ bool	bDisableAugTexture;
/*0x0124*/ int	ItemColor;
/*0x0128*/ int	GroupID;
/*0x012C*/ LONG	LastEquipped;
/*0x0130*/ UINT	RespawnTime;
/*0x0134*/ int	Power;
/*0x0138*/ bool	bRankDisabled;
/*0x013C*/ int	OrnamentationIcon;
//start of ItemClient
...
/*0x018C*/ int		AFK; \
/*0x0190*/ FLOAT		GetMeleeRangeVar1; /* used by GetMeleeRange */ \
/*0x0194*/ UINT		RespawnTimer; /* its actually TimeOfDeath...TimeStamp of when RespawnWnd will close - 0 when you're alive */ \
/*0x0198*/ BYTE		Level; \
/*0x0199*/ EqItemGuid 	realEstateItemGuid; \
/*0x01AC*/ UINT		LastPrimaryUseTime; \
/*0x01B0*/ BYTE		IsPassenger; /* if u are on a boat or airship or whatever */ \
/*0x01B4*/ struct _EQC_INFO*	spawneqc_info; \
/*0x01B8*/ __int64		HPMax; \
/*0x01C0*/ UINT		MinuteTimer; \
/*0x01C4*/ UINT		LastRangedUsedTime; \
/*0x01C8*/ BYTE		GMRank; /* i think */ \
/*0x01CC*/ int		DoSpecialMelee; \
/*0x01D0*/ BYTE		LastAttack; \
/*0x01D4*/ FLOAT		BearingToTarget; \
/*0x01D8*/ UINT		CorpseDragCount; \
/*0x01DC*/ UINT		LastTimeStoodStill; \
/*0x01E0*/ int		Deity; \
/*0x01E4*/ int		SomeData[0x2]; \
/*0x01EC*/ struct _SPAWNINFO*	pViewPlayer; \
/*0x01F0*/ int		AltAttack; \
/*0x01F4*/ BYTE		HoldingAnimation; /* todo: create enum for this byte. Holding: Nothing=0 A RightHand Weapon=1 A Shield=2 Dual Wielding Two Weapons=3 A Spear=4 A LeftHand Weapon=5 A Two Handed Weapon=6 A bow=7 */ \
/*0x01F8*/ int		Stuff; \
/*0x01FC*/ bool		Mercenary; \
/*0x01FD*/ BYTE		Blind; \
/*0x01FE*/ bool		bOfflineMode; \
/*0x0200*/ int		CurrIOState; \
/*0x0204*/ CPhysicsInfo	LastCollision; \
/*0x0234*/ DWORD		LastCastTime; \
/*0x0238*/ BYTE		FD; \
/*0x023C*/ int		Trader;	/* found in CEverQuest__RightClickedOnPlayer_x */ \
/*0x0240*/ int		IsAttacking; /* need to investigate */ \
/*0x0244*/ UINT		FishingETA; \
/*0x0248*/ void		*pRaceGenderInfo; /* todo this is not a void* so... map the CRaceGenderInfo class */ \
/*0x024C*/ UINT		CombatSkillTicks[0x2]; \
/*0x0254*/ int		NpcTintIndex; \
/*0x0258*/ int		PrimaryTintIndex; \
/*0x025C*/ int		RealEstateID; \
/*0x0260*/ DWORD		PotionTimer; \
/*0x0264*/ int		Anon; /* found in EQPlayer__SetNameSpriteTint_x */ \
/*0x0268*/ int		LastCastNum; \
/*0x026C*/ FLOAT		MerchantGreed; \
/*0x0270*/ DWORD		Meditating; \
/*0x0274*/ DWORD		LoginSerial; \
/*0x0278*/ UINT		ACounter; /* not sure what this one is for*/ \
/*0x027C*/ int		DontKnowYet; \
/*0x0280*/ int		Buyer; \
/*0x0284*/ int		SomethingElse; \
...
/*0x0294*/ bool		bSwitchMoved; /* true when a door moves near the spawn */ \
/*0x0298*/ int		RealEstateItemId; \
/*0x029C*/ UINT		SitStartTime; \
/*0x02A0*/ FLOAT		CameraOffset; \
/*0x02A4*/ BYTE		TitleVisible; \
/*0x02A8*/ int		SecondaryTintIndex; \
/*0x02AC*/ bool		bTempPet; \
/*0x02B0*/ DWORD		Zone; \
/*0x02B4*/ int		berserker; \
/*0x02B8*/ bool		bBetaBuffed; \
/*0x02B9*/ BYTE		FishingEvent; \
/*0x02BC*/ UINT		SpellCooldownETA; \
/*0x02C0*/ BYTE		FindBits; \
/*0x02C1*/ CHAR		DragNames[0x2][0x40]; \
/*0x0344*/ UINT		LastMealTime; /* last time we eat or drank */ \
/*0x0348*/ UINT		LastSecondaryUseTime; \
/*0x034C*/ UINT		MasterID; \
/*0x0350*/ UINT		TimeStamp; /* updates all the time including when on a mount */ \
/*0x0354*/ BYTE		Light; \
/*0x0358*/ UINT		CombatSkillUsed[0x2]; \
/*0x0360*/ bool		Linkdead; \
/*0x0361*/ BYTE		InPvPArea; /* are we in a PvP area? */ \
/*0x0364*/ int		HideMode; \
/*0x0368*/ bool		bAnimationOnPop; \
/*0x036C*/ UINT		LastRefresh; \
/*0x0370*/ bool		PvPFlag; \
/*0x0371*/ BYTE		CharClass; /* Im pretty sure this isnt working */ \
/*0x0374*/ int		EnduranceCurrent; \
/*0x0378*/ int		ManaCurrent; \
/*0x037C*/ UINT		LastResendAddPlayerPacket; \
/*0x0380*/ int		PetID; \
/*0x0384*/ bool		Sneak; \
/*0x0388*/ FLOAT		MyWalkSpeed; \
/*0x038C*/ UINT		NextIntimidateTime; \
/*0x0390*/ int		ManaMax; \
/*0x0394*/ bool		LFG; \
/*0x0398*/ __int64		HPCurrent; \
/*0x03A0*/ FLOAT		AnimationSpeedRelated; \
/*0x03A4*/ bool		bStationary; \
/*0x03A5*/ BYTE		Type2; /* check */ \
/*0x03A6*/ bool		bBuffTimersOnHold; /* no you can't control this client side so unless you want to get banned leave it alone */ \
/*0x03A8*/ UINT		LastTick; \
/*0x03AC*/ int		WarCry; \
/*0x03B0*/ bool		bShowHelm; \
/*0x03B4*/ UINT		EnduranceMax; \
/*0x03B8*/ bool		bAlwaysShowAura; \
/*0x03BC*/ FLOAT		RunSpeed; /*0.70 on runspeed 5... */ \
/*0x03C0*/ int		AARank;/* this really is the title id */ \
/*0x03C4*/ UINT		SpellGemETA[0xf]; /*InnateETA is now the last member in this array */ \
/*0x0400*/ CHAR		LoginRelated[0x20]; \
/*0x0420*/ struct _LAUNCHSPELLDATA	CastingData; /* size: 0x58 */ \
/*0x0478*/ CHAR		Handle[0x20]; \
/*0x0498*/ __int64	GuildID; \
/*0x04A0*/ UINT		LastTrapDamageTime; \
/*0x04A4*/ FLOAT		MissileRangeToTarget; \
/*0x04A8*/ BYTE		HmmWhat; /* todo: figure out */ \
/*0x04A9*/ CHAR		Title[0x80]; \
/*0x052C*/ DWORD		**ppUDP; /* UdpLibrary::UdpConnection? */ \
/*0x0530*/ FLOAT		ViewHeight; \
/*0x0534*/ BYTE		IntimidateCount; \
/*0x0538*/ FLOAT		FallingStartZ; \
/*0x053C*/ UINT		StunTimer; \
/*0x0540*/ CHAR		Suffix[0x80]; \
/*0x05C0*/ CHAR		DraggingPlayer[0x40]; \
/*0x0600*/ BYTE		StandState; \
/*0x0601*/ bool		bAttackRelated; \
/*0x0602*/ CHAR		GM; \
/*0x0604*/
...
#define EQ_ASSIST_COMPLETE              0x45F9   // aMsgTimeStampRe
#define EQ_BEGIN_ZONE                   0x09FC   // CEverQuest__SavePCForce
#define EQ_END_ZONE                     0x2AD4   // CEverQuest__DoMainLoop+B2F
#define EQ_ASSIST                       0x3026   // do_assist(PlayerClient *,char const *)+399 20160212 live (see 52C319)
