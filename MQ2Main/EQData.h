...
//Actual Size: 168 (see 594c97 in eqgame.exe Live dated Nov 19 2015) - eqmule
typedef struct _CONTENTS {
	...
	/*0x00b8*/ DWORD        Power;
	/*0x00bc*/ BYTE         Unknown0x00bc[0x14];
	/*0x00d0*/ DWORD        Price;
	/*0x00d4*/ BYTE         Unknown0x00d4[0x5];
	/*0x00d9*/ BYTE         IsEvolvingItem;
	/*0x00da*/ BYTE         Unknown0x00da[0x2e];
...
// actual size 0x1FE4 in Nov 19 2015 Live (see 0x5D7CFA) - eqmule
typedef struct _SPAWNINFO {
	...
	/*0x023c*/ DWORD        EnduranceCurrent;
	/*0x0240*/ BYTE         Mercenary;
	/*0x0241*/ BYTE         Unknown0x0241[0xb];
	/*0x024c*/ DWORD        EnduranceMax;
	/*0x0250*/ BYTE         Unknown0x0250[0x18];
	/*0x0268*/ struct _LAUNCHSPELLDATA      CastingData; // size: 0x50
	/*0x02b8*/ BYTE         FishingEvent;
	/*0x02b9*/ BYTE         Unknown0x02b9[0x1f];
	/*0x02d8*/ DWORD        SpellCooldownETA;
	/*0x02dc*/ BYTE         Unknown0x02dc;
	/*0x02dd*/ BYTE         Linkdead;
	/*0x02de*/ BYTE         Unknown0x02de[0x2];
	/*0x02e0*/ DWORD        Buyer;
	...
	/*0x031c*/ BYTE         Unknown0x031c[0x24];
	/*0x0340*/ DWORD        AFK;
	/*0x0344*/ BYTE         LFG;
	/*0x0345*/ BYTE         Unknown0x0345[0x3b];
	/*0x0380*/ DWORD        Anon;//found in EQPlayer__SetNameSpriteTint_x
	/*0x0384*/ BYTE         Unknown0x0384[0xc];
	/*0x0390*/ BYTE         Level;
	/*0x0391*/ BYTE         Unknown0x0391[0xc1];
	/*0x0452*/ CHAR         Suffix[0x80];
	/*0x04d2*/ BYTE         Unknown0x04d2[0xe];
	/*0x04e0*/ CHAR         Title[0x80];
	/*0x0560*/ BYTE         Unknown0x0560[0x4];
	/*0x0564*/ DWORD        PetID;//the unknown above this is petwindow target related I think
	/*0x0568*/ BYTE         Unknown0x0568[0x4];
	/*0x056c*/ DWORD        Trader;//found in CEverQuest__RightClickedOnPlayer_x
	/*0x0570*/ BYTE         Unknown0x0570;
	/*0x0571*/ BYTE         Light;
	/*0x0572*/ BYTE         Unknown0x0572[0xa];
	/*0x057c*/ LONG         HPCurrent;
	/*0x0580*/ DWORD        Deity;
	/*0x0584*/ BYTE         Unknown0x0584[0x4];
	/*0x0588*/ BYTE         PvPFlag;
	/*0x0589*/ BYTE         Unknown0x0589[0x7];
	/*0x0590*/ DWORD        MasterID;
	/*0x0594*/ BYTE         Unknown0x0594[0xc];
	/*0x05a0*/ FLOAT        RunSpeed;//0.70 on runspeed 5...
	/*0x05a4*/ BYTE         HoldingType; // I dont know the types, i put a 2h in Primary and its a 4 , modrod there and its a 1, nothing its a 5 -eqmule
	/*0x05a5*/ BYTE         Unknown0x05a5[0x23];
	/*0x05c8*/ DWORD        TimeStamp;//updates all the time including when on a mount
	/*0x05cc*/ BYTE         HideMode;
	/*0x05cd*/ BYTE         Unknown0x05cd[0xf];
	/*0x05dc*/ DWORD        ManaCurrent;
	/*0x05e0*/ BYTE         Unknown0x05e0[0x4];
	/*0x05e4*/ DWORD        GuildID;
...
#define EQ_BEGIN_ZONE                   0x702B   // CEverQuest__SavePCForce				
#define EQ_END_ZONE                     0x57FA   // CEverQuest__DoMainLoop+B2F			
