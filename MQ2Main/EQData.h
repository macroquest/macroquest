...
#define nEQMappableCommands             0x13e
...
// actual size: 0x498c 3-10-10 - ieatacid
...
/*0x1ad8*/   DWORD      Exp;
/*0x1adc*/   BYTE       Unknown0x1adc[0x64];
/*0x1b40*/   void       *OtherCharData;
/*0x1b44*/   BYTE       Unknown0x1b44[0x62c];
/*0x2170*/   void       *vtable2;
/*0x2174*/   struct     _EQC_INFO* eqc_info;
/*0x2178*/   struct     _SPAWNINFO* pSpawn;
/*0x217c*/   DWORD      Unknown0x217c;
/*0x2180*/   DWORD      Unknown0x2180;
/*0x2184*/   DWORD      CurrWeight;
/*0x2188*/   BYTE       Unknown0x2188[0xc];
/*0x2194*/   DWORD      HPBonus;
/*0x2198*/   DWORD      ManaBonus;
/*0x219c*/   DWORD      EnduranceBonus;
/*0x21a0*/   DWORD      CombatEffectsCap;
/*0x21a4*/   DWORD      ShieldingCap;
/*0x21a8*/   DWORD      SpellShieldCap;
/*0x21ac*/   DWORD      AvoidanceCap;
/*0x21b0*/   DWORD      AccuracyCap;
/*0x21b4*/   DWORD      StunResistCap;
/*0x21b8*/   DWORD      StrikeThroughCap;
/*0x21bc*/   DWORD      Unknown0x21bc[0x9];
/*0x21e0*/   DWORD      SkillMinDamageModBonus[0x9];
/*0x2204*/   BYTE       Unknown0x2204[0x4];
/*0x2208*/   DWORD      DoTShieldCap;
/*0x220c*/   DWORD      DamageShieldMitigationCap;
/*0x2210*/   DWORD      CombatEffectsBonus;
/*0x2214*/   DWORD      SpellShieldBonus;
/*0x2218*/   DWORD      ShieldingBonus;
/*0x221c*/   DWORD      DamageShieldBonus;
/*0x2220*/   DWORD      DoTShieldBonus;
/*0x2224*/   DWORD      DamageShieldMitigationBonus;
/*0x2228*/   DWORD      AvoidanceBonus;
/*0x222c*/   DWORD      AccuracyBonus;
/*0x2230*/   DWORD      StunResistBonus;
/*0x2234*/   DWORD      StrikeThroughBonus;
/*0x2238*/   DWORD      HeroicSTRBonus;
/*0x223c*/   DWORD      HeroicINTBonus;
/*0x2240*/   DWORD      HeroicWISBonus;
/*0x2244*/   DWORD      HeroicAGIBonus;
/*0x2248*/   DWORD      HeroicDEXBonus;
/*0x224c*/   DWORD      HeroicSTABonus;
/*0x2250*/   DWORD      HeroicCHABonus;
/*0x2254*/   DWORD      HeroicSvMagicBonus;
/*0x2258*/   DWORD      HeroicSvFireBonus;
/*0x225c*/   DWORD      HeroicSvColdBonus;
/*0x2260*/   DWORD      HeroicSvDiseaseBonus;
/*0x2264*/   DWORD      HeroicSvPoisonBonus;
/*0x2268*/   DWORD      HeroicSvCorruptionBonus;
/*0x226c*/   DWORD      HealAmountBonus;
/*0x2270*/   DWORD      SpellDamageBonus;
/*0x2274*/   DWORD      Unknown0x2274[0x2];
/*0x227c*/   DWORD      ClairvoyanceBonus;
/*0x2280*/   DWORD      AttackBonus;
/*0x2284*/   DWORD      HPRegenBonus;
/*0x2288*/   DWORD      ManaRegenBonus;
/*0x228c*/   DWORD      EnduranceRegenBonus;
/*0x2290*/   DWORD      DamageShieldCap;
/*0x2294*/   DWORD      AttackSpeed;
/*0x2298*/   BYTE       Unknown0x2298[0xa8];
/*0x2340*/   struct     _XTARGETMGR *pXTargetMgr;
/*0x2344*/   DWORD      InCombat;
/*0x2348*/   DWORD      Downtime;
/*0x234c*/   DWORD      DowntimeStamp;
/*0x2350*/   BYTE       Unknown0x2350[0x4];
/*0x2354*/   struct     _GROUPINFO *pGroupInfo;
/*0x2358*/   BYTE       Unknown0x2358[0x1c];
/*0x2374*/   void       *pUnknown2;
/*0x2378*/   struct     _CI2_INFO* pCI2;
/*0x237c*/   DWORD      Unknown0x237c;
/*0x2380*/   BYTE       languages[0x20];
/*0x23a0*/   BYTE       Unknown0x23a0[0x10];
/*0x23b0*/   CHAR       Name[0x40];
/*0x23f0*/   CHAR       Lastname[0x20];
/*0x2410*/   BYTE       Unknown0x2410[0x60];
/*0x2470*/   BYTE       Stunned;
/*0x2471*/   BYTE       Unknown0x2471[0x3];
/*0x2474*/   WORD       zoneId;
/*0x2476*/   WORD       instance;
/*0x2478*/   DWORD      standstate;
/*0x247c*/   BYTE       Unknown0x247c[0x4];
/*0x2480*/   struct     _LEADERABILITIES ActiveAbilities; //ability levels of the leader of your group (size 0x40)
/*0x24c0*/   BYTE       Unknown0x24c0[0x334];
/*0x27f4*/   DWORD      BankSharedPlat;
/*0x27f8*/   DWORD      BankSharedGold;
/*0x27fc*/   DWORD      BankSharedSilver;
/*0x2800*/   DWORD      BankSharedCopper;
/*0x2804*/   DWORD      BankPlat;
/*0x2808*/   DWORD      BankGold;
/*0x280c*/   DWORD      BankSilver;
/*0x2810*/   DWORD      BankCopper;
/*0x2814*/   DWORD      STR;
/*0x2818*/   DWORD      STA;
/*0x281c*/   DWORD      CHA;
/*0x2820*/   DWORD      DEX;
...
/*0x2828*/   DWORD      AGI;
/*0x282c*/   DWORD      WIS;
/*0x2830*/   DWORD      SavePoison;
/*0x2834*/   DWORD      SaveMagic;
/*0x2838*/   DWORD      SaveDisease;
/*0x283c*/   DWORD      SaveCorruption;
/*0x2840*/   DWORD      SaveFire;
/*0x2844*/   DWORD      SaveCold;
/*0x2848*/   BYTE       Unknown0x2848[0x2144];
/*0x498c*/
} CHARINFO, *PCHARINFO;
