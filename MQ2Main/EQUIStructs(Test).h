...
// actual size 0x1E0 in Mar  2 2020 Test (see 0x95E2AD) - eqmule
// actual size 0x1F0 in Mar  9 2020 Test (see 0x95F18D) - eqmule
#define CXW_NO_VTABLE \
private: \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x001D*/ bool		bRightAnchoredToLeft; \
/*0x001E*/ bool		bUseInLayoutHorizontal; \
/*0x001F*/ bool		bBringToTopWhenClicked; \
/*0x0020*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
/*0x0024*/ bool		bClientRectChanged; \
/*0x0025*/ bool		bUseInLayoutVertical; \
/*0x0028*/ DWORD  BackgroundDrawType; \
/*0x002C*/ int		VScrollMax; \
/*0x0030*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x0034*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x0038*/ int		TopOffset; \
/*0x003C*/ void   *TitlePiece; \
/*0x0040*/ int		BlinkState; \
/*0x0044*/ RECT		ClipRectScreen; \
/*0x0054*/ COLORREF DisabledBackground; \
/*0x0058*/ int		managerArrayIndex; \
/*0x005C*/ RECT		Location; \
/*0x006C*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x006D*/ bool		bTopAnchoredToTop; \
/*0x006E*/ BYTE		Alpha; \
...
/*0x008C*/ struct _CXSTR*	DataStr; \
/*0x0090*/ bool		bIsTransitioning; \
/*0x0091*/ BYTE     bResizableMask; \
/*0x0094*/ RECT		IconRect; \
/*0x00A4*/ BYTE		TargetAlpha; \
/*0x00A5*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
...
/*0x00C8*/ __int64		Data; \
/*0x00D0*/ bool		bBorder; \
/*0x00D1*/ bool		bLeftAnchoredToLeft; \
/*0x00D4*/ void		*pLayoutStrategy; \
/*0x00D8*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
...
/*0x00F4*/ UINT		TransitionStartTick; \
/*0x00F8*/ DWORD	FadeDelay; \
/*0x00FC*/ bool		bScreenClipRectChanged; \
/*0x00FD*/ bool		Minimized; \
/*0x00FE*/ bool		Fades; \
/*0x0100*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0104*/ LONG		BlinkStartTimer; \
/*0x0108*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x010C*/ void   *TitlePiece2; \
/*0x0110*/ void	    *pFont; \
/*0x0114*/ bool		bTiled; \
/*0x0118*/ UINT		LastBlinkFadeRefreshTime; \
/*0x011C*/ bool		bKeepOnScreen; \
/*0x011D*/ bool		bCaptureTitle; \
/*0x011E*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x0120*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x0124*/ bool		bClientClipRectChanged; \
/*0x0128*/ struct _CSIDLWND* pWndFocusOther; \
/*0x012C*/ int		DeleteCount; \
/*0x0130*/ int		HScrollMax; \
/*0x0134*/ RECT		TransitionRect; \
/*0x0144*/ UINT		BlinkFadeStartTime; \
/*0x0148*/ bool		bEscapableLocked; \
/*0x0149*/ bool		Enabled; \
/*0x014C*/ tagSIZE	MaxClientSize; \
/*0x0154*/ bool		bMarkedForDelete; \
/*0x0155*/ bool		bActive; \
/*0x0156*/ bool		bAction; \
/*0x0158*/ int		VScrollPos; \
/*0x015C*/ bool		bHCenterTooltip; \
/*0x0160*/ int	Transition; \
/*0x0164*/ int		LeftOffset; \
/*0x0168*/ int		ParentAndContextMenuArrayIndex; \
/*0x016C*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0170*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0174*/ BYTE		StartAlpha; \
/*0x0178*/ int		RightOffset; \
/*0x017C*/ bool		bMaximizable; \
/*0x017D*/ bool		bIsParentOrContextMenuWindow; \
/*0x0180*/ DWORD	LastTimeMouseOver; \
/*0x0184*/ bool		Faded; \
/*0x0188*/ RECT		OldLocation; \
/*0x0198*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x019C*/ void	*IconTextureAnim; \
/*0x01A0*/ void* pTipTextObject; \
/*0x01A4*/ void *pController; \
/*0x01A8*/ void	*DrawTemplate; \
/*0x01AC*/ int		HScrollPos; \
/*0x01B0*/ bool		dShow; \
/*0x01B4*/ void*	pTextObject; \
/*0x01B8*/ BYTE		FadeAlpha; \
...
/*0x01E1*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x01E2*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x01E4*/ UINT		BlinkFadeDuration; \
/*0x01E8*/ bool		bMaximized; \
...
// CBazaarSearchWnd_size: 0x92d8 (see 556ACE) in Mar  9 2020 Test - eqmule
...
// CPlayerWindow_size: 0x2f0 (see 5563BE) in Mar  9 2020 Test - eqmule
...
// CTargetWindow_size: 0x8d0 (see 556255) in Mar  9 2020 Test - eqmule
...
// CBuffWindow_size: 0x720 (see 5560F9) in Mar  9 2020 Test - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x328 (see 81408B) in Mar  9 2020 Test - eqmule
...
// CCastSpellWnd_size: 0x2d8 (see 5564B7) in Mar  9 2020 Test - eqmule
...
// CInvSlotWnd_size: 0x2d8 (see 81419C) in Mar  9 2020 Test - eqmule
...
// CItemDisplayWindow_size: 0x630 (see 776CA2) in Mar  9 2020 Test - eqmule
...
// CLootWnd_size: 0x3a0 (see 556826) in Mar  9 2020 Test - eqmule
...
// CMapViewWnd_size: 0x658 (see 555F5A) in Mar  9 2020 Test - eqmule
...
// CMerchantWnd_size: 0x450 (see 556982) in Mar  9 2020 Test - eqmule
...
// CPetInfoWindow_size: 0x8d0 (see 5559B1) in Mar  9 2020 Test - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3b0 (see 555CA2) in Mar  9 2020 Test - eqmule
...
// CTradeWnd__size: 0x2f8 (see 556A28) in Mar  9 2020 Test - eqmule
...
// CFactionWnd__size: 0x280 (see 556B74) in Mar  9 2020 Test - eqmule
