...
/*0x0020*/ bool		bBorder; \
/*0x0021*/ bool		bIsParentOrContextMenuWindow; \
/*0x0024*/ int		VScrollMax; \
/*0x0028*/ RECT		IconRect; \
/*0x0038*/ DWORD	XMLIndex; \
/*0x003C*/ BYTE     bResizableMask; \
/*0x0040*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0044*/ void *pController; \
/*0x0048*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x004C*/ struct _CXSTR*	DataStr; \
/*0x0050*/ tagSIZE	MaxClientSize; \
...
/*0x0088*/ bool		bKeepOnScreen; \
/*0x0089*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x008C*/ UINT		TransitionDuration; \
/*0x0090*/ bool		Minimized; \
/*0x0091*/ bool		bTopAnchoredToTop; \
/*0x0092*/ bool		bUseInLayoutVertical; \
/*0x0093*/ bool		bClipToParent; \
/*0x0094*/ bool		bClientRectChanged; \
/*0x0098*/ __int64		Data; \
/*0x00A0*/ bool		Fades; \
...
/*0x00BC*/ bool		bAction; \
/*0x00C0*/ COLORREF DisabledBackground; \
...
/*0x00E8*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x00EC*/ bool		dShow; \
/*0x00ED*/ BYTE		Alpha; \
/*0x00F0*/ int		VScrollPos; \
/*0x00F4*/ bool		bUseInLayoutHorizontal; \
...
/*0x0114*/ bool		bRightAnchoredToLeft; \
/*0x0118*/ void   *TitlePiece; \
/*0x011C*/ void   *TitlePiece2; \
/*0x0120*/ int		BlinkState; \
/*0x0124*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0128*/ int		managerArrayIndex; \
/*0x012C*/ BYTE		TargetAlpha; \
/*0x012D*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x012E*/ bool		bBorder2; \
/*0x012F*/ BYTE		FadeAlpha; \
/*0x0130*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x0134*/ bool		bHCenterTooltip; \
/*0x0135*/ bool		bFullyScreenClipped; \
/*0x0138*/ void*	pTextObject; \
/*0x013C*/ bool		Enabled; \
/*0x013D*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x013E*/ bool bClickThroughMenuItemStatus; /* on/off */ \
...
/*0x014C*/ int		TopOffset; \
/*0x0150*/ UINT		TransitionStartTick; \
/*0x0154*/ int		HScrollMax; \
/*0x0158*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0159*/ bool		bCaptureTitle; \
/*0x015A*/ bool		bIsTransitioning; \
/*0x015B*/ bool		bBottomAnchoredToTop; \
/*0x015C*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x015D*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
...
/*0x016E*/ bool		ValidCXWnd; /* IsValid has this one */ \
...
/*0x0191*/ bool		bLeftAnchoredToLeft; \
...
/*0x01B4*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
...
// CBazaarSearchWnd_size: 0x92c8 (see 55891E) in Nov 10 2020 Test - eqmule
...
// CPlayerWindow_size: 0x2e0 (see 55820E) in Nov 10 2020 Test - eqmule
...
// CTargetWindow_size: 0x8c0 (see 5580A5) in Nov 10 2020 Test - eqmule
...
// CBuffWindow_size: 0x710 (see 557F49) in Nov 10 2020 Test - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x318 (see 7F990B) in Nov 10 2020 Test - eqmule
...
// CCastSpellWnd_size: 0x2c8 (see 558307) in Nov 10 2020 Test - eqmule
...
// CInvSlotWnd_size: 0x2c8 (see 7F9A1C) in Nov 10 2020 Test - eqmule
...
// CItemDisplayWindow_size: 0x620 (see 75C632) in Nov 10 2020 Test - eqmule
...
// CLootWnd_size: 0x390 (see 558676) in Nov 10 2020 Test - eqmule
...
// CMapViewWnd_size: 0x638 (see 557DAA) in Nov 10 2020 Test - eqmule
...
// CMerchantWnd_size: 0x440 (see 5587D2) in Nov 10 2020 Test - eqmule
...
// CPetInfoWindow_size: 0x8c0 (see 557801) in Nov 10 2020 Test - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x398 (see 557AF2) in Nov 10 2020 Test - eqmule
...
// CTradeWnd__size: 0x2e8 (see 558878) in Nov 10 2020 Test - eqmule
...
// CFactionWnd__size: 0x270 (see 5589C4) in Nov 10 2020 Test - eqmule
