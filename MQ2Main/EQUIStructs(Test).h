...
// actual size 0x1D4 in May 11 2016 Test (see 0x692B98) - eqmule
...
/*0x001c*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x "BGType" in ini */ \
/*0x0020*/ BYTE		Unknown0x0020[0x10]; \
/*0x0030*/ ARGBCOLOR	BGColor; \
...
/*0x0048*/ DWORD	HScrollPos; \
/*0x004c*/ BYTE		Unknown0x004c[0x1d]; \
/*0x0069*/ BYTE		ValidCXWnd; /*IsValid has this one*/\
/*0x006a*/ BYTE		Unknown0x006a[0xa]; \
/*0x0074*/ DWORD	FadeDuration; \
/*0x0078*/ BYTE		Unknown0x0078[0x4]; \
/*0x007c*/ DWORD	UnknownCW; /*found in OnProcessFrame*/\
/*0x0080*/ DWORD	TimeMouseOver; \
/*0x0084*/ BYTE		Unknown0x0084[0x4]; \
/*0x0088*/ BYTE		dShow; \
/*0x0089*/ BYTE		Unknown0x0089[0x2]; \
/*0x008b*/ BYTE		Faded; \
/*0x008c*/ BYTE		Unknown0x008c[0x30]; \
/*0x00bc*/ BYTE		MouseOver; /*found in CXWnd__SetMouseOver_x*/ \
/*0x00bd*/ BYTE		Unknown0x00bd[0xb]; \
...
/*0x00e8*/ BYTE		Locked; /*found in CSidlScreenWnd__LoadIniInfo_x*/ \
/*0x00e9*/ BYTE		Unknown0x00e9[0x3]; \
/*0x00ec*/ DWORD	VScrollPos; \
/*0x00f0*/ BYTE		Unknown0x00f0[0x8]; \
/*0x00f8*/ BYTE		Minimized; \
/*0x00f9*/ BYTE		Unknown0x00f9[0x57]; \
/*0x0150*/ RECT		Location; \
/*0x0160*/ BYTE		Unknown0x0160[0x4]; \
/*0x0164*/ DWORD	ZLayer; /*found in CXWndManager__DrawWindows_x*/ \
/*0x0168*/ BYTE		Unknown0x0168[0x9]; \
...
/*0x01cc*/ BYTE		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x01cd*/ BYTE		Unknown0x01cd[0x07];
/*0x01d4*/
