...
// actual size 0x1E8 in Dec  5 2017 Test (see 0x8D4F8D) - eqmule
...
/*0x008D*/ BYTE		Alpha; \
/*0x008E*/ bool		bFullyScreenClipped; \
/*0x008F*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x0090*/ bool		bEscapableLocked; \
/*0x0094*/ UINT		TransitionStartTick; \
/*0x0098*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0099*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x009A*/ bool		bAction; \
/*0x009B*/ bool		bCaptureTitle; \
/*0x009C*/ bool		Enabled; \
/*0x009D*/ bool		bClipToParent; \
/*0x00A0*/ int		HScrollMax; \
/*0x00A4*/ int		VScrollMax; \
/*0x00A8*/ bool		bBottomAnchoredToTop; \
/*0x00A9*/ bool		bMaximizable; \
/*0x00AA*/ bool		bUseInLayoutVertical; \
/*0x00AC*/ int		HScrollPos; \
/*0x00B0*/ UINT		FadeDuration; \
/*0x00B4*/ BYTE		FadeAlpha; \
...
/*0x00DC*/ bool		dShow; \
/*0x00DD*/ bool		bRightAnchoredToLeft; \
...
/*0x00EE*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x00EF*/ bool		bActive; \
/*0x00F0*/ int		ParentAndContextMenuArrayIndex; \
/*0x00F4*/ bool		bLeftAnchoredToLeft; \
/*0x00F8*/ int		TopOffset; \
/*0x00FC*/ int		BlinkDuration; \
...
/*0x0124*/ RECT		ClipRectScreen; \
/*0x0134*/ RECT		OldLocation; \
/*0x0144*/ bool		Minimized; \
/*0x0148*/ void	    *pFont; \
...
/*0x0195*/ bool		bIsParentOrContextMenuWindow; \
/*0x0196*/ BYTE		StartAlpha; \
/*0x0197*/ bool		bClientRectChanged; \
/*0x0198*/ bool		bUseInLayoutHorizontal; \
/*0x019C*/ UINT		BlinkFadeDuration; \
/*0x01A0*/ UINT		BlinkFadeFreq; \
/*0x01A4*/ bool		bClientClipRectChanged; \
/*0x01A8*/ void		*pLayoutStrategy; \
/*0x01AC*/ void	*IconTextureAnim; \
/*0x01B0*/ bool		bMaximized; \
/*0x01B1*/ bool		bBringToTopWhenClicked; \
...
// CBazaarSearchWnd_size: 0x92c8 (see 4CCE5A) in Dec 11 2017 Test - eqmule
...
// CPlayerWindow_size: 0x2e0 (see 4CC69D) in Dec 11 2017 Test - eqmule
...
// CTargetWindow_size: 0x8c0 (see 4CC534) in Dec 11 2017 Test - eqmule
...
// CBuffWindow_size: 0x710 (see 4CC3C8) in Dec 11 2017 Test - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x310 (see 7A3438) in Dec 11 2017 Test - eqmule
...
// CCastSpellWnd_size: 0x2c8 (see 4CC7AE) in Dec 11 2017 Test - eqmule
...
// CInvSlotWnd_size: 0x2c8 (see 7A3549) in Dec 11 2017 Test - eqmule
...
// CItemDisplayWindow_size: 0x608 (see 6ED78F) in Dec 11 2017 Test - eqmule
...
// CLootWnd_size: 0x390 (see 4CCB70) in Dec 11 2017 Test - eqmule
...
// CMapViewWnd_size: 0x638 (see 4CC229) in Dec 11 2017 Test - eqmule
...
// CMerchantWnd_size: 0x440 (see 4CCCEE) in Dec 11 2017 Test - eqmule
...
// CPetInfoWindow_size: 0x8c0 (see 4CBC60) in Dec 11 2017 Test - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a0 (see 4CBF53) in Dec 11 2017 Test - eqmule
...
// CTradeWnd__size: 0x2e8 (see 4CCDA4) in Dec 11 2017 Test - eqmule
