...
/*0x001E*/ bool		bClientClipRectChanged; \
/*0x001F*/ bool		dShow; \
...
/*0x0060*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x0078*/ DWORD	LastTimeMouseOver; \
/*0x007C*/ bool		bTiled; \
/*0x0080*/ int		ParentAndContextMenuArrayIndex; \
/*0x0084*/ tagSIZE	MaxClientSize; \
/*0x008C*/ void *pController; \
/*0x0090*/ int		BlinkDuration; \
/*0x0094*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
...
/*0x00AC*/ UINT		TransitionDuration; \
/*0x00B0*/ __int64		Data; \
...
/*0x00FC*/ BYTE     bResizableMask; \
/*0x00FD*/ bool		bEscapableLocked; \
/*0x0100*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x0104*/ bool		bClipToParent; \
/*0x0108*/ RECT		ClipRectScreen; \
/*0x0118*/ bool		bHCenterTooltip; \
/*0x011C*/ RECT		TransitionRect; \
/*0x012C*/ bool		bTopAnchoredToTop; \
/*0x012D*/ BYTE		TargetAlpha; \
/*0x012E*/ bool		bUseInLayoutVertical; \
/*0x0130*/ RECT		Location; \
/*0x0140*/ BYTE		Alpha; \
/*0x0141*/ bool		bAction; \
/*0x0142*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x0143*/ bool		bIsTransitioning; \
/*0x0144*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
...
/*0x014D*/ bool		bCaptureTitle; \
/*0x014E*/ bool		Minimized; \
/*0x0150*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0154*/ bool		bScreenClipRectChanged; \
/*0x0155*/ bool		bKeepOnScreen; \
/*0x0156*/ bool		bBringToTopWhenClicked; \
...
/*0x0194*/ bool		bActive; \
/*0x0195*/ bool		bBorder; \
/*0x0198*/ int		DeleteCount; \
/*0x019C*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
...
/*0x01B9*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x01BC*/ RECT		OldLocation; \
/*0x01CC*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x01D0*/ bool bClickThroughMenuItemStatus; /* on/off */ \
...
// CBazaarSearchWnd_size: 0x92c8 (see 5565EE) in Mar 16 2020 Test - eqmule
...
// CPlayerWindow_size: 0x2e0 (see 555EDE) in Mar 16 2020 Test - eqmule
...
// CTargetWindow_size: 0x8c0 (see 555D75) in Mar 16 2020 Test - eqmule
...
// CBuffWindow_size: 0x710 (see 555C19) in Mar 16 2020 Test - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x318 (see 81392B) in Mar 16 2020 Test - eqmule
...
// CCastSpellWnd_size: 0x2c8 (see 555FD7) in Mar 16 2020 Test - eqmule
...
// CInvSlotWnd_size: 0x2c8 (see 813A2C) in Mar 16 2020 Test - eqmule
...
// CItemDisplayWindow_size: 0x620 (see 7768A2) in Mar 16 2020 Test - eqmule
...
// CLootWnd_size: 0x390 (see 556346) in Mar 16 2020 Test - eqmule
...
// CMapViewWnd_size: 0x638 (see 555A7A) in Mar 16 2020 Test - eqmule
...
// CMerchantWnd_size: 0x440 (see 5564A2) in Mar 16 2020 Test - eqmule
...
// CPetInfoWindow_size: 0x8c0 (see 5554D1) in Mar 16 2020 Test - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a0 (see 5557C2) in Mar 16 2020 Test - eqmule
...
// CTradeWnd__size: 0x2e8 (see 556548) in Mar 16 2020 Test - eqmule
...
// CFactionWnd__size: 0x270 (see 556694) in Mar 16 2020 Test - eqmule
