...
/*0x0014*/ BYTE         Unknown0x0014[0x34]; \
...
/*0x0064*/ DWORD        UnknownCW; /*found in OnProcessFrame*/\
/*0x0068*/ BYTE         Alpha; \
/*0x0069*/ BYTE         MouseOver; /*found in CXWnd__SetMouseOver_x*/ \
/*0x006a*/ BYTE         Unknown0x006a[0x23]; \
/*0x008d*/ BYTE         FadeToAlpha; /*found in CSidlScreenWnd__StoreIniInfo_x*/\
/*0x008e*/ BYTE         Unknown0x008e; \
/*0x008f*/ BYTE         Fades; \
...
/*0x00e8*/ BYTE         Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x00e9*/ BYTE         Unknown0x00e9[0x19]; \
/*0x0102*/ BYTE         Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x0103*/ BYTE         Unknown0x0103[0x9]; \
/*0x010c*/ struct _CXSTR*       WindowText; /*CXWnd__GetWindowTextA_x has this one*/ \
/*0x0110*/ BYTE         Unknown0x0110[0xd]; \
/*0x011d*/ BYTE         CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x011e*/ BYTE         Unknown0x011e[0x6]; \
/*0x0124*/ BYTE         ValidCXWnd; /*IsValid has this one*/\
/*0x0125*/ BYTE         Unknown0x0125[0x1f]; \
/*0x0144*/ DWORD        VScrollPos; \
/*0x0148*/ BYTE         Unknown0x0148[0x4]; \
/*0x014c*/ DWORD        VScrollMax; \
/*0x0150*/ BYTE         Unknown0x0150[0x28]; \
...
/*0x01cc*/ BYTE         Unknown0x01cc; \
/*0x01cd*/ BYTE         Faded; \
/*0x01ce*/ BYTE         Unknown0x01ce[0xa]; \
/*0x01d8*/ BYTE         dShow; \
/*0x01d9*/ BYTE         Unknown0x01c5[0x3]; \
/*0x01DC*/
