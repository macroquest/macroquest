...
/*0x0059*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x005A*/ bool		Faded; \
/*0x005C*/ int		RightOffset; \
/*0x0060*/ int		HScrollPos; \
/*0x0064*/ int		DeleteCount; \
/*0x0068*/ bool		bLeftAnchoredToLeft; \
/*0x0069*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x006A*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x006C*/ RECT		ClientRect; \
/*0x007C*/ void		*pLayoutStrategy; \
...
/*0x0090*/ DWORD  BackgroundDrawType; \
/*0x0094*/ bool		bUseInLayoutVertical; \
/*0x0098*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x009C*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x00A0*/ UINT		LastBlinkFadeRefreshTime; \
/*0x00A4*/ bool		bEscapableLocked; \
/*0x00A5*/ bool		bHCenterTooltip; \
...
/*0x00E8*/ BYTE		Alpha; \
/*0x00EC*/ int		VScrollPos; \
/*0x00F0*/ BYTE		StartAlpha; \
/*0x00F1*/ bool		bRightAnchoredToLeft; \
/*0x00F2*/ bool		bClipToParent; \
/*0x00F3*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x00F4*/ COLORREF DisabledBackground; \
/*0x00F8*/ bool		bTopAnchoredToTop; \
/*0x00FC*/ void   *TitlePiece2; \
/*0x0100*/ bool		bMaximizable; \
/*0x0104*/ int		BlinkDuration; \
/*0x0108*/ __int64		Data; \
...
/*0x0131*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
...
/*0x013A*/ bool		Minimized; \
/*0x013C*/ LONG		BlinkStartTimer; \
/*0x0140*/ bool		bKeepOnScreen; \
/*0x0141*/ bool		bMaximized; \
/*0x0144*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x0148*/ struct _CXSTR*	DataStr; \
/*0x014C*/ bool		dShow; \
/*0x014D*/ bool		bClientClipRectChanged; \
/*0x014E*/ bool		bScreenClipRectChanged; \
/*0x014F*/ bool		bAction; \
/*0x0150*/ int		LeftOffset; \
...
/*0x016C*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x0170*/ bool		Fades; \
/*0x0171*/ bool		bUseInLayoutHorizontal; \
/*0x0172*/ BYTE		TargetAlpha; \
...
/*0x01A1*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x01A4*/ UINT		BlinkFadeDuration; \
/*0x01A8*/ bool		bMarkedForDelete; \
/*0x01AC*/ RECT		Location; \
/*0x01BC*/ bool		bIsParentOrContextMenuWindow; \
/*0x01C0*/ RECT		OldLocation; \
/*0x01D0*/ bool		bIsTransitioning; \
/*0x01D4*/ int		ParentAndContextMenuArrayIndex; \
/*0x01D8*/ UINT		BlinkFadeStartTime; \
/*0x01DC*/ BYTE     bResizableMask; \
/*0x01E0*/ DWORD	FadeDelay; \
/*0x01E4*/ DWORD	Filler0x01E4;
/*0x01E8*/
