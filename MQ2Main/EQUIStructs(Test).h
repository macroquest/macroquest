...
/*0x0038*/ bool		bUseInLayoutHorizontal; \
/*0x003C*/ UINT		BlinkFadeStartTime; \
/*0x0040*/ int		managerArrayIndex; \
/*0x0044*/ bool		bKeepOnScreen; \
...
/*0x0060*/ void	*DrawTemplate; \
/*0x0064*/ void		*pLayoutStrategy; \
/*0x0068*/ bool		bClipToParent; \
/*0x0069*/ bool		bClientClipRectChanged; \
...
/*0x00A8*/ UINT		FadeDuration; \
/*0x00AC*/ bool		bAction; \
/*0x00B0*/ int		HScrollPos; \
/*0x00B4*/ DWORD	FadeDelay; \
/*0x00B8*/ int		TopOffset; \
/*0x00BC*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x00C0*/ void *pController; \
/*0x00C4*/ COLORREF DisabledBackground; \
/*0x00C8*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x00C9*/ bool		bMaximizable; \
/*0x00CC*/ UINT		BlinkFadeFreq; \
/*0x00D0*/ int		ParentAndContextMenuArrayIndex; \
/*0x00D4*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x00D8*/ bool		bScreenClipRectChanged; \
/*0x00D9*/ bool		bFullyScreenClipped; \
/*0x00DA*/ bool		bUseInLayoutVertical; \
...
/*0x0110*/ bool		bActive; \
/*0x0111*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x0112*/ bool		bMaximized; \
...
/*0x012C*/ bool		bBringToTopWhenClicked; \
/*0x012D*/ BYTE		Alpha; \
...
/*0x0178*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
...
// CBazaarSearchWnd_size: 0x92c8 (see 543F6E) in Oct 22 2019 Test - eqmule
...
// CPlayerWindow_size: 0x2e0 (see 54385E) in Oct 22 2019 Test - eqmule
...
// CTargetWindow_size: 0x8c0 (see 5436F5) in Oct 22 2019 Test - eqmule
...
// CBuffWindow_size: 0x710 (see 543599) in Oct 22 2019 Test - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x318 (see 7F35BB) in Oct 22 2019 Test - eqmule
...
// CCastSpellWnd_size: 0x2c8 (see 543957) in Oct 22 2019 Test - eqmule
...
// CInvSlotWnd_size: 0x2c8 (see 7F36CC) in Oct 22 2019 Test - eqmule
...
// CItemDisplayWindow_size: 0x620 (see 756992) in Oct 22 2019 Test - eqmule
...
// CLootWnd_size: 0x390 (see 543CC6) in Oct 22 2019 Test - eqmule
...
// CMapViewWnd_size: 0x638 (see 5433FA) in Oct 22 2019 Test - eqmule
...
// CMerchantWnd_size: 0x440 (see 543E22) in Oct 22 2019 Test - eqmule
...
// CPetInfoWindow_size: 0x8c0 (see 542E51) in Oct 22 2019 Test - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a0 (see 543142) in Oct 22 2019 Test - eqmule
...
// CTradeWnd__size: 0x2e8 (see 543EC8) in Oct 22 2019 Test - eqmule
...
// CFactionWnd__size: 0x270 (see 544014) in Oct 22 2019 Test - eqmule
