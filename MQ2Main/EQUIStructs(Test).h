...
// actual size 0x1F8 in Jun 10 2019 Test (see 0x9351BD) - eqmule
// actual size 0x1E0 in Oct 22 2019 Test (see 0x93CC4D) - eqmule
// actual size 0x1E8 in Nov 21 2019 Test (see 0x93C0DD) - eqmule
// actual size 0x1F0 in Dec 18 2019 Test (see 0x95213D) - eqmule
// actual size 0x1D0 in Jan  6 2020 Test (see 0x952D1D) - eqmule
#define CXW_NO_VTABLE \
private: \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ void   *TitlePiece; \
/*0x0020*/ bool		bMaximizable; \
/*0x0021*/ bool		bLeftAnchoredToLeft; \
/*0x0024*/ int		BlinkState; \
/*0x0028*/ tagSIZE	MinClientSize; \
/*0x0030*/ int		TopOffset; \
/*0x0034*/ UINT		LastBlinkFadeRefreshTime; \
/*0x0038*/ bool		Faded; \
/*0x0039*/ bool		bBorder; \
/*0x003A*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x003B*/ bool		bKeepOnScreen; \
/*0x003C*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x003D*/ bool		bCaptureTitle; \
/*0x0040*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x0058*/ bool		dShow; \
/*0x005C*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0060*/ BYTE		TargetAlpha; \
/*0x0064*/ DWORD	XMLIndex; \
/*0x0068*/ RECT		IconRect; \
/*0x0078*/ struct _CSIDLWND* pWndFocusOther; \
/*0x007C*/ bool		bTiled; \
/*0x007D*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x007E*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x0080*/ void* pTipTextObject; \
/*0x0084*/ RECT		ClientRect; \
/*0x0094*/ int		VScrollMax; \
/*0x0098*/ __int64		Data; \
/*0x00A0*/ RECT		OldLocation; \
/*0x00B0*/ int	Transition; \
/*0x00B4*/ DWORD	FadeDelay; \
/*0x00B8*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x00BC*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x00C0*/ int		HScrollPos; \
/*0x00C4*/ BYTE     bResizableMask; \
/*0x00C5*/ bool		bIsTransitioning; \
/*0x00C6*/ bool		bBringToTopWhenClicked; \
/*0x00C8*/ void *pController; \
/*0x00CC*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
/*0x00D0*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x00D1*/ bool		Fades; \
/*0x00D2*/ bool		Minimized; \
/*0x00D4*/ tagSIZE	MaxClientSize; \
/*0x00DC*/ int		DeleteCount; \
/*0x00E0*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x00E4*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x00E8*/ DWORD  BackgroundDrawType; \
/*0x00EC*/ bool		bRightAnchoredToLeft; \
/*0x00ED*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x00F0*/ COLORREF DisabledBackground; \
/*0x00F4*/ BYTE		Alpha; \
/*0x00F5*/ BYTE		FadeAlpha; \
/*0x00F8*/ UINT		FadeDuration; \
/*0x00FC*/ void	*DrawTemplate; \
/*0x0100*/ bool		bMaximized; \
/*0x0104*/ int		BottomOffset; \
/*0x0108*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x010C*/ void	    *pFont; \
/*0x0110*/ UINT		TransitionStartTick; \
/*0x0114*/ int		HScrollMax; \
/*0x0118*/ UINT		TransitionDuration; \
...
/*0x0124*/ bool		bAction; \
/*0x0128*/ int		LeftOffset; \
/*0x012C*/ bool		Enabled; \
/*0x012D*/ bool		bIsParentOrContextMenuWindow; \
/*0x012E*/ bool		bClipToParent; \
/*0x0130*/ UINT		BlinkFadeDuration; \
/*0x0134*/ bool		bClientRectChanged; \
/*0x0138*/ int		managerArrayIndex; \
/*0x013C*/ DWORD	LastTimeMouseOver; \
/*0x0140*/ bool		bUseInLayoutVertical; \
/*0x0141*/ bool		bBorder2; \
/*0x0142*/ bool		bTopAnchoredToTop; \
/*0x0143*/ bool		bUseInLayoutHorizontal; \
/*0x0144*/ RECT		TransitionRect; \
/*0x0154*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x0158*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x015C*/ struct _CXSTR*	DataStr; \
/*0x0160*/ UINT		BlinkFadeFreq; \
/*0x0164*/ RECT		Location; \
/*0x0174*/ void		*pLayoutStrategy; \
/*0x0178*/ bool		bScreenClipRectChanged; \
/*0x0179*/ bool		bClientClipRectChanged; \
/*0x017C*/ int		BlinkDuration; \
/*0x0180*/ void	*IconTextureAnim; \
/*0x0184*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x0185*/ bool		bHCenterTooltip; \
/*0x0186*/ bool		bMarkedForDelete; \
/*0x0187*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0188*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x018C*/ UINT		BlinkFadeStartTime; \
/*0x0190*/ void*	pTextObject; \
/*0x0194*/ RECT		ClipRectScreen; \
/*0x01A4*/ bool		bEscapableLocked; \
/*0x01A8*/ LONG		BlinkStartTimer; \
/*0x01AC*/ int		VScrollPos; \
/*0x01B0*/ int		RightOffset; \
/*0x01B4*/ BYTE		StartAlpha; \
/*0x01B5*/ bool		bActive; \
/*0x01B6*/ bool		bFullyScreenClipped; \
/*0x01B7*/ bool		bBottomAnchoredToTop; \
/*0x01B8*/ RECT		ClipRectClient; \
/*0x01C8*/ int		ParentAndContextMenuArrayIndex; \
...
//Size 0x218 in Oct 17 2017 Live exe see 60586D - eqmule
#define SIDL \
/*0x1d0*/ bool bControlsCreated; /*yes this REALLY is here, see 8D255E in aug 10 2017 live - eqmule*/ \
/*0x1d4*/ PCXSTR SidlText; /*found in CChatWindow__WndNotification_x*/\
/*0x1d8*/ LPVOID SidlPiece; /* CScreenPieceTemplate (important) */ \
/*0x1dc*/ ArrayClass_RO<void*>RadioGroup; /*CRadioGroup*/ \
/*0x1ec*/ bool bInitVisibility; \
/*0x1ed*/ bool bVisibleBeforeResize; \
/*0x1f0*/ int IniFlags; \
/*0x1f4*/ PCXSTR INIStorageName; /*found in CSidlScreenWnd__LoadSidlScreen_x*/\
/*0x1f8*/ int	IniVersion; \
/*0x1fc*/ int	LastResX; \
/*0x200*/ int	LastResY; \
/*0x204*/ bool bLastResFullscreen; \
/*0x208*/ int  ContextMenuID; \
/*0x20c*/ PCXWND pFirstVScrollChild; \
/*0x210*/ int ContextMenuTipID; \
/*0x214*/ bool bHasActivatedFirstTimeAlert; \
/*0x218*/
...
//Size 0x360 see 69A7DD in Oct 17 2017 Live exe -eqmule
typedef struct _EQCHATWINDOW {
/*0x000*/ struct _CSIDLWND Wnd;
/*0x218*/ struct _EQCHATMGR *ChatManager; 
/*0x21c*/ struct _CSIDLWND* InputWnd;
/*0x220*/ struct _CSIDLWND* OutputWnd;
/*0x224*/ int ChatChannel;
/*0x228*/ int ChatChannelIndex;
/*0x22c*/ CHAR TellTarget[0x40];//for sure
/*0x26c*/ int Language;
/*0x270*/ bool bIsMainChat;
/*0x271*/ bool bIsTellWnd;
/*0x274*/ int TimestampFormat;
/*0x278*/ COLORREF TimestampColor;
/*0x27c*/ bool bTimestampMatchChatColor;
/*0x280*/ struct _CXSTR *CommandHistory[0x28]; // see 690DAA in apr 11 2017 test
/*0x320*/ int HistoryIndex;
/*0x324*/ int HistoryLastShown;
/*0x328*/ int FontSize;//style but yeah...
/*0x32c*/ int AlwaysChathereIndex;//menu
/*0x330*/ int NamesContextMenu;//guess
/*0x334*/ int ContextMenuID;//also a guess
/*0x338*/ int ContextMenuSubID[0xa];//this is not correct but ill fix it later.
/*0x360*/
...
//aSpelldisplaywi
// Actual size 0x268 Nov 02 2017 Beta see 7AE2DF -eqmule
typedef struct _EQSPELLINFOWINDOW 
{ 
/*0x000*/ struct _CSIDLWND Wnd;
/*0x218*/ PVOID WindowID;
/*0x21c*/ PVOID pDuration;
/*0x220*/ struct _CSIDLWND *DisplayWnd;//pDescription
/*0x224*/ PVOID pName; 
/*0x228*/ PVOID pIcon; 
/*0x22c*/ IString2 ItemInfo;
/*0x23c*/ IString2 MoreText;
/*0x24c*/ DWORD Unknown0x24c;
/*0x250*/ DWORD pTABuffIcons;
/*0x254*/ DWORD pTADragIcons;
/*0x258*/ bool bFailed;
/*0x25c*/ PVOID TextureAnim;
/*0x260*/ DWORD SpellID;
/*0x264*/ DWORD TimeStamp;
/*0x268*/ 
...
/*0x1d0*/ bool bNoWrap;
/*0x1d1*/ bool bAlignRight;
/*0x1d2*/ bool bAlignCenter;
/*0x1d4*/ int  xOffset;
/*0x1d8*/ bool bResizeHeightToText;
/*0x1dc*/ int Unknown0x1dc;
/*0x1e0*/ PCXSTR Text;
/*0x1e4*/ int Unknown0x1e4;
/*0x1e8*/ bool Unknown0x1e8;
/*0x1ec*/ int Unknown0x1ec;
/*0x1f0*/ //begin CLABEL
/*0x1f0*/ int EQType;//renamed from SidlPiece
/*0x1f4*/ int Unknown0x1f4;
/*0x1f8*/
} CLABEL, *PCLABEL;

//CButtonWnd__CButtonWnd_x
//size is 0x268 see 91829A in eqgame.exe dated 18 Sep 2018 Live - eqmule
typedef struct _CBUTTONWND {
/*0x000*/ struct _CXWND Wnd;
/*0x01d0*/ int		MouseButtonState;
/*0x01d4*/ bool		bPicture;
/*0x01d8*/ void*	pGroup;//CRadioGroup*
/*0x01dc*/ bool		bChecked;
/*0x01dd*/ bool		bMouseOverLastFrame;
/*0x01e0*/ tagPOINT	DecalOffset;
/*0x01e8*/ tagSIZE	DecalSize;
/*0x01f0*/ COLORREF	DecalTint;//Color
/*0x01f4*/ RECT		TextOffsets;
/*0x0204*/ int		TextModeBits;
/*0x0208*/ COLORREF	Mouseover;
/*0x020c*/ COLORREF	Pressed;
/*0x0210*/ COLORREF	Disabled;
/*0x0214*/ UINT		CoolDownBeginTime;
/*0x0218*/ UINT		CoolDownDuration;
/*0x021c*/ PCXSTR	Indicator;
/*0x0220*/ UINT		IndicatorVal;
/*0x0224*/ void*	pIndicatorTextObject;
/*0x0228*/ void*	Unknown0x228;//most likely a CTextureAnimation*
/* CButtonDrawTemplate Start */
/*0x022c*/ PCXSTR	Name;
/*0x0230*/ void*	Normal;//CTextureAnimation
/*0x0234*/ void*	taPressed;
/*0x0238*/ void*	Flyby;
/*0x023c*/ void*	taDisabled;
/*0x0240*/ void*	PressedFlyby;
/*0x0244*/ void*	PressedDisabled;
/*0x0248*/ void*	NormalDecal;
/*0x024c*/ void*	PressedDecal;
/*0x0250*/ void*	FlybyDecal;
/*0x0254*/ void*	DisabledDecal;
/*0x0258*/ void*	PressedFlybyDecal;
/*0x025c*/ void*	PressedDisabledDecal;
/*0x0260*/ bool		bAllowButtonClickThrough;
/*0x0261*/ bool		bCoolDownDoDelayedStart;
/*0x0262*/ bool		bIsCheckbox;
/*0x0263*/ bool		bIsDrawLasso;
/*0x0264*/ UINT		ButtonStyle;
/*0x0268*/
...
//size 0x2e8 see 4CEDDD in Nov 02 2017 Beta -eqmule
...
/*0x2c0*/ DWORD		TotalLootCount;
/*0x2c4*/ DWORD		Unknown0x2c4;
/*0x2c8*/ DWORD		ContextMenuId;
/*0x2cc*/ DWORD		CLastStackSize;
/*0x2d0*/ BYTE		Unknown0x2d0[0x18];
/*0x2e8*/
...
/*0x0218*/ BYTE         Unknown0x0218[0x90];
...
// CBazaarSearchWnd_size: 0x92b8 (see 550F7E) in Jan  6 2020 Test - eqmule
typedef struct _BAZAARSEARCHWND {
	...
	/*0x9218*/ BYTE         Unknown0x9218[0xa0];
	/*0x92b8*/
...
// CPlayerWindow_size: 0x2d0 (see 55086E) in Jan  6 2020 Test - eqmule
...
// CTargetWindow_size: 0x8b0 (see 550705) in Jan  6 2020 Test - eqmule
...
/*0x083c*/ int			LastBuffRecievedTime;
/*0x0840*/ UINT			Timer;
/*0x0844*/ HashTable<PCXSTR> Casters;
/*0x0854*/ int			ContextMenuID;
/*0x0858*/ PCXWND		RequestingWnd;
/*0x085c*/ bool			bRemovedBuffBlockMenuItem;
/*0x0860*/ DWORD        Type;              // 1 = self, 4 = group member, 5 = PC, 7 = NPC
/*0x0864*/ BYTE         Unknown0x0864[0x4c];
/*0x08b0*/
} CTARGETWND, *PCTARGETWND;

// CBuffWindow__CBuffWindow aBuffwindow
// this is used for both long and shortbuffs...
// CBuffWindow_size: 0x700 (see 5505A9) in Jan  6 2020 Test - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x308 (see 80827B) in Jan  6 2020 Test - eqmule
typedef struct _EQCASTSPELLGEM {
/*0x0000*/ struct _CBUTTONWND        Wnd;
/*0x0268*/ int			MouseButtonState;//correct
/*0x026c*/ bool			bChecked;
/*0x0270*/ UINT			LastRefresh;
/*0x0274*/ DWORD		SpellGemTintArray[0xb];//I dont understand why there are only 11 of these when we have 13 gems noaways, probably a bug or unused?
/*0x02a0*/ int			SpellGemAlphaArray[0xb];
/*0x02ac*/ int			Unknown0x02ac;
/*0x02d0*/ int			Unknown0x02d0;
/*0x02d4*/ int			SpellIconOffsetX;
/*0x02d8*/ int			SpellIconOffsetY;
/*0x02dc*/ DWORD        spellicon;		//if this is equal to FFFFFFFF there is no spell memmed in this slot...
/*0x02e0*/ DWORD        spellstate;		//1 = cast in progress or refreshtime not met 2 means we ducked or aborted cast, 0 means its ok to cast, should really rename this to tintstage
/*0x02e4*/ int			TintIndex;
/*0x02e8*/ void			*SpellIconTexture;//CTextureAnimation
/*0x02ec*/ void			*CustomIconTexture;//CTextureAnimation
/*0x02f0*/ int			SpellSlot;
/*0x02f4*/ int			Percent;
/*0x02f8*/ PCXWND		TemplateName;
/*0x02fc*/ void			*TemplateBG;//CTextureAnimation
/*0x0300*/ void			*TemplateHolder;//CTextureAnimation
/*0x0304*/ void			*TemplateHighlight;//CTextureAnimation
/*0x0308*/
} EQCASTSPELLGEM, *PEQCASTSPELLGEM;

//pinstCCastSpellWnd_x
// CCastSpellWnd__CCastSpellWnd aCastspellwnd
// CCastSpellWnd_size: 0x2b8 (see 550967) in Jan  6 2020 Test - eqmule
...
/*0x0264*/ BYTE         Unknown0x0674[0x54];
/*0x02b8*/
} EQCASTSPELLWINDOW, *PEQCASTSPELLWINDOW;

//note that Invslot needs to be a short or pickupitem wont work
// CInvSlotWnd_size: 0x2b8 (see 80838C) in Jan  6 2020 Test - eqmule
typedef struct _EQINVSLOTWND {
/*0x0000*/ struct _CBUTTONWND	ButtonWnd;
/*0x0268*/ void*				pTABackground;//CTextureAnimation
/*0x026C*/ LONG					Location; // Really this is a ItemGlobalIndex
/*0x0270*/ short				Slot1;
/*0x0272*/ short				Slot2;
/*0x0274*/ short				Slot3;
/*0x0278*/ VePointer<CONTENTS>  pItem;
/*0x027c*/ int					ItemOffsetX;
/*0x0280*/ int					ItemOffsetY;
/*0x0284*/ void*				pTAItem;//CTextureAnimation
/*0x0288*/ int					Quantity;
/*0x028c*/ bool					bSelected;
/*0x028d*/ bool					bFindSelected;
/*0x0290*/ int					RecastLeft;
/*0x0294*/ bool					bHotButton;
/*0x0295*/ bool					bInventorySlotLinked;
/*0x0298*/ struct _EQINVSLOT*	pInvSlot;
/*0x029c*/ void*				pTextObject;//CTextObjectInterface
/*0x02a0*/ int					TextFontStyle;//EFontStyles
/*0x02a4*/ BOOL					ProcessClick;
/*0x02a8*/ D3DCOLOR				BGTintRollover;
/*0x02ac*/ D3DCOLOR				BGTintNormal;
/*0x02b0*/ long					LastTime;
/*0x02b4*/ long					Unknown0x02b4;
/*0x02b8*/
...
// CItemDisplayWindow_size: 0x610 (see 76B462) in Jan  6 2020 Test - eqmule
typedef struct _EQITEMWINDOW {
/*0x0000*/ struct _CSIDLWND     Wnd;
/*0x0218*/ struct _CSIDLWND *Description;
/*0x021c*/ struct _CSIDLWND *Name;
/*0x0220*/ struct _CSIDLWND *IconButton;
/*0x0224*/ struct _CSIDLWND *ItemLore;
/*0x0228*/ struct _CSIDLWND *ItemDescriptionTabBox;
/*0x022c*/ struct _CSIDLWND *ItemDescriptionTab;
/*0x0230*/ struct _CSIDLWND *ItemLoreTab;
/*0x0234*/ struct _CSIDLWND *pAppearanceSocketScreen;
/*0x0238*/ CBUTTONWND *pAppearanceSocketItem;
/*0x023c*/ CBUTTONWND *pAppearanceSocketBuyButton;
/*0x0240*/ struct _CSIDLWND *pAppearanceSocketDescription;
/*0x0244*/ struct _CSIDLWND *pItemSocketScreen[6];
/*0x025c*/ CBUTTONWND *pItemSocketItemButton[6];
/*0x0274*/ struct _CSIDLWND *pItemSocketDescription[6];
/*0x028c*/ PCXSTR       ItemInfo;//this item is placable in yards, guild yards blah blah , This item can be used in tradeskills
/*0x0290*/ PCXSTR       WindowTitle;
/*0x0294*/ PCXSTR       ItemAdvancedLoreText;
/*0x0298*/ PCXSTR       ItemMadeByText;
/*0x029c*/ PCXSTR       UnknownCXStr; // if this is NULL don't populate item data in MQ2ItemDisplay
/*0x02a0*/ BYTE         Unknown0x02a0[0x4];
/*0x02a4*/ PCXSTR       ItemInformationText;//Item Information: Placing this augment into blah blah, this armor can only be used in blah blah
/*0x02a8*/ PCONTENTS    pItem;
/*0x02ac*/ bool			bActiveItem;
/*0x02ad*/ bool			bItemTextSet;
/*0x02b0*/ void*		BuffIcons;//CTextureAnimation
/*0x02b4*/ void*		DragIcons;//CTextureAnimation
/*0x02b8*/ bool			bTaggable;
/*0x02b9*/ bool			bFailed;
/*0x02bc*/ UINT			TabCount;
/*0x02c0*/ CLABEL		*ModButtonLabel;
/*0x02c4*/ CLABEL*		RewardButtonLabel;
/*0x02c8*/ CSIDLWND*	ConvertStml;
/*0x02cc*/ CLABEL*		MadeByLabel;
/*0x02d0*/ CLABEL*		CollectedLabel;
/*0x02d4*/ CLABEL*		ScribedLabel;
/*0x02d8*/ int			Row;
/*0x02dc*/ bool			bAntiTwink;
/*0x02e0*/ CBUTTONWND*	ModButton;
/*0x02e4*/ CBUTTONWND*	RewardButton;
/*0x02e8*/ CBUTTONWND*	PrintRealEstateItems;
/*0x02ec*/ CBUTTONWND*	ConvertButton;
/*0x02f0*/ bool			bCollected;
/*0x02f1*/ bool			bCollectedReceived;
/*0x02f4*/ int			Unknown0x031c;
/*0x02f8*/ int			Unknown0x0320;
/*0x02fc*/ bool			bScribed;
/*0x02fd*/ bool			bScribedReceived;
/*0x02fe*/ BYTE         Unknown0x02fe[0x2f2];
/*0x05f0*/ DWORD        Unknown0x05f0;
/*0x05f4*/ DWORD        Unknown0x05f4;
...
// CLootWnd_size: 0x380 (see 550CD6) in Jan  6 2020 Test - eqmule
typedef struct _EQLOOTWINDOW {
	/*0x0000*/ struct _CSIDLWND     Wnd;
	/*0x0218*/ void*        vftable; // for CLootWnd::DialogResponse handler
	/*0x021c*/ BYTE         Unknown0x021c[0x98];
	/*0x02b4*/ DWORD        NumOfSlots;
	/*0x02b8*/ BYTE         Unknown0x02b8[0x4];
	/*0x02bc*/ struct _INVENTORYARRAY*      pInventoryArray;
	/*0x02c0*/ DWORD        Size;
	/*0x02c4*/ DWORD        NumOfSlots3;
	/*0x02c8*/ BYTE         Unknown0x02c8[0x8];
	/*0x02d0*/ BYTE         Unknown0x02d0;
	/*0x02d1*/ BYTE         Unknown0x02d1;
	/*0x02d2*/ BYTE         Unknown0x02d2;
	/*0x02d3*/ BYTE         Unknown0x02d3;
	/*0x02d4*/ struct _CSIDLWND*   LootInvWnd;
	/*0x02d8*/ struct _CSILDWND*   LootSlotWnd[0x22];
	/*0x0360*/ struct _CSIDLWND*   LW_CorpseName;
	/*0x0364*/ struct _CSIDLWND*   DoneButton;
	/*0x0368*/ struct _CSIDLWND*   BroadcastButton;
	/*0x036c*/ struct _CSIDLWND*   LootAllButton;
	/*0x0370*/ BYTE         Unknown0x0370[0x10];
	/*0x0380*/
} EQLOOTWINDOW, *PEQLOOTWINDOW;

// pLines address = 0x254 + 0x035c = 0x05b0 (address of pMapViewMapVfTable)
// CMapViewWnd__CMapViewWnd_x
// CMapViewWnd_size: 0x618 (see 55040A) in Jan  6 2020 Test - eqmule
typedef struct _EQMAPWINDOW {
	/*0x0000*/ struct _CSIDLWND     Wnd;
	/*0x0218*/ BYTE         Unknown0x0218[0x40];
	/*0x0258*/ CHAR         shortzonename[0x80];
	/*0x0278*/ BYTE         Unknown0x0278[0x3c];
	...
	/*0x05a0*/ BYTE         Unknown0x05a0[0x78];
	/*0x0618*/
...
// CMerchantWnd_size: 0x430 (see 550E32) in Jan  6 2020 Test - eqmule
...
/*0x0248*/ BYTE         Unknown0x0248[0x1e8];
/*0x0430*/
} EQMERCHWINDOW, *PEQMERCHWINDOW;

//CPetInfoWindow__CPetInfoWindow aPetinfowindow
// CPetInfoWindow_size: 0x8b0 (see 54FE61) in Jan  6 2020 Test - eqmule
typedef struct _EQPETINFOWINDOW {
/*0x0000*/ struct _CSIDLWND     Wnd;
/*0x0218*/ DWORD PetSpawnID;//The pets SpawnID
...
/*0x0278*/ BYTE Unknown0x0278[0x174];
/*0x03ec*/ struct _CSIDLWND *   pWnd[NUM_BUFF_SLOTS]; // buff icons?
/*0x0570*/ int Buff[NUM_BUFF_SLOTS];        // Spell ID# of each buff -- 97 total
/*0x06f4*/ BYTE Unknown0x06f4[0x20];
/*0x0714*/ DWORD PetBuffTimer[NUM_BUFF_SLOTS]; // duration until buff fades, in thousands of a second
/*0x0898*/ BYTE Unknown0x0898[0xd];
/*0x08a5*/ BYTE Sit;//0/1 is off/on
/*0x08a6*/ BYTE Stop;//0/1 is off/on
/*0x08a7*/ BYTE ReGroup;//0/1 is off/on
/*0x08a8*/ BYTE Follow;//0/1 is off/on
/*0x08a9*/ BYTE Guard;//0/1 is off/on
/*0x08aa*/ BYTE Taunt;//0/1 is off/on
/*0x08ab*/ BYTE Hold;//0/1 is off/on
/*0x08ac*/ BYTE GHold;//0/1 is off/on
/*0x08ad*/ BYTE Focus;//0/1 is off/on
/*0x08ae*/ BYTE Unknown0x08ae[0x2];
/*0x08b0*/
} EQPETINFOWINDOW, *PEQPETINFOWINDOW;

//CRaidWindow__CRaidWindow
//aClasscolorD
// CRaidWindow_size: 0x390 (see 550152) in Jan  6 2020 Test - eqmule
...
// CTradeWnd__size: 0x2d8 (see 550ED8) in Jan  6 2020 Test - eqmule
typedef struct _EQTRADEWINDOW {
	/*0x0000*/ struct _CSIDLWND     Wnd;
	/*0x0218*/ BYTE         Unknown0x0218[0xb8];
	/*0x02d0*/ BYTE         HisTradeReady;
	/*0x02d1*/ BYTE         MyTradeReady;
	/*0x02d2*/ BYTE         TradeWndOpen;
	/*0x02d3*/ BYTE         Unknown0x02d3[0x5];
	/*0x02d8*/
} EQTRADEWINDOW, *PEQTRADEWINDOW;

//CFactionWnd__CFactionWnd_x aFactionwnd
// CFactionWnd__size: 0x260 (see 551024) in Jan  6 2020 Test - eqmule
typedef struct _EQFACTIONWINDOW {
/*0x0000*/ struct _CSIDLWND Wnd;
/*0x0218*/ int			Unknown0x0218;
/*0x021c*/ bool			bUnknown0x021c;
/*0x0220*/ int			Unknown0x0220;
/*0x0224*/ int			Unknown0x0224;
/*0x0228*/ int			Unknown0x0228;
/*0x022c*/ IString<char> Unknown0x022c;
/*0x023c*/ IString<char> Unknown0x023c;
/*0x024c*/ void*		StandingGaugeTemplate;//CGaugeWnd*
/*0x0250*/ void*		Categories;//CTreeView*
/*0x0254*/ void*		SearchNameInput;//CEditWnd*
/*0x0258*/ PCBUTTONWND	SearchButton;//CButtonWnd*
/*0x025c*/ void*		FactionList;//CListWnd*
/*0x0260*/
