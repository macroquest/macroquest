...
/*0x008c*/ BYTE         MouseOver; /*found in CXWnd__SetMouseOver_x*/ \
...
/*0x0098*/ DWORD        ZLayer; /*found in CXWndManager__DrawWindows_x*/ \
...
/*0x00dd*/ BYTE         Unknown0x00dd[0x1b]; \
...
/*0x0128*/ BYTE         dShow; \
/*0x0129*/ BYTE         Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x012a*/ BYTE         ValidCXWnd; /*IsValid has this one*/\
...
/*0x013c*/ BYTE         Unknown0x013c[0x1c]; \
/*0x0158*/ LPVOID       DrawTemplate; \
/*0x015c*/ BYTE         Unknown0x015c[0x28]; \
/*0x0184*/ DWORD        BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x "BGType" in ini */ \
