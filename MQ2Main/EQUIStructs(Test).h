...
/*0x00E0*/ UINT		LastBlinkFadeRefreshTime; \
...
/*0x00F8*/ bool		bClipToParent; \
/*0x00F9*/ bool		bBottomAnchoredToTop; \
...
/*0x0141*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x0144*/ int		managerArrayIndex; \
/*0x0148*/ bool		bBorder2; \
/*0x014C*/ int		ParentAndContextMenuArrayIndex; \
/*0x0150*/ bool		bMarkedForDelete; \
/*0x0151*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0152*/ bool		bClientClipRectChanged; \
/*0x0153*/ bool		bMaximizable; \
/*0x0154*/ UINT		FadeDuration; \
/*0x0158*/ int		BlinkDuration; \
/*0x015C*/ UINT		BlinkFadeFreq; \
/*0x0160*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0164*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x0168*/ bool		bUseInLayoutHorizontal; \
...
/*0x01B2*/ bool		bCaptureTitle; \
/*0x01B4*/ UINT		TransitionStartTick; \
/*0x01B8*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x01B9*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
...
/*0x01D9*/ bool		bIsParentOrContextMenuWindow; \
/*0x01DA*/ bool		bMaximized; \
/*0x01DB*/ BYTE		FadeAlpha; \
/*0x01DC*/ LONG		BlinkStartTimer; \
/*0x01E0*/ tagSIZE	MinClientSize; \
/*0x01E8*/ BYTE		StartAlpha; \
/*0x01E9*/ bool		bFullyScreenClipped; \
...
// CBazaarSearchWnd_size: 0x92d8 (see 55715E) in Feb  4 2020 Test - eqmule
...
// CPlayerWindow_size: 0x2f0 (see 556A4E) in Feb  4 2020 Test - eqmule
...
// CTargetWindow_size: 0x8d0 (see 5568E5) in Feb  4 2020 Test - eqmule
...
// CBuffWindow_size: 0x720 (see 556789) in Feb  4 2020 Test - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x328 (see 8124CB) in Feb  4 2020 Test - eqmule
...
// CCastSpellWnd_size: 0x2d8 (see 556B47) in Feb  4 2020 Test - eqmule
...
// CInvSlotWnd_size: 0x2d8 (see 8125DC) in Feb  4 2020 Test - eqmule
...
// CItemDisplayWindow_size: 0x630 (see 775552) in Feb  4 2020 Test - eqmule
...
// CLootWnd_size: 0x3a0 (see 556EB6) in Feb  4 2020 Test - eqmule
...
// CMapViewWnd_size: 0x658 (see 5565EA) in Feb  4 2020 Test - eqmule
...
// CMerchantWnd_size: 0x450 (see 557012) in Feb  4 2020 Test - eqmule
...
// CPetInfoWindow_size: 0x8d0 (see 556041) in Feb  4 2020 Test - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3b0 (see 556332) in Feb  4 2020 Test - eqmule
...
// CTradeWnd__size: 0x2f8 (see 5570B8) in Feb  4 2020 Test - eqmule
...
// CFactionWnd__size: 0x280 (see 557204) in Feb  4 2020 Test - eqmule
