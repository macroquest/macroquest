...
// actual size 0x1E8 in May 31 2017 Test (see 0x69799F) - eqmule
...
/*0x002C*/ bool		bTiled; \
/*0x002D*/ bool		bActive; \
/*0x002E*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0030*/ void	    *pFont; \
...
/*0x0080*/ void		*pLayoutStrategy; \
/*0x0084*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x0085*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x0086*/ BYTE		Alpha; \
/*0x0088*/ struct _CSIDLWND* pWndFocusOther; \
/*0x008C*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0090*/ BYTE		StartAlpha; \
...
/*0x00A4*/ COLORREF DisabledBackground; \
...
/*0x00B6*/ BYTE     bResizableMask; \
/*0x00B7*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x00B8*/ bool		bHCenterTooltip; \
/*0x00B9*/ bool		bUseInLayoutHorizontal; \
/*0x00BC*/ DWORD	XMLIndex; \
/*0x00C0*/ bool		bRightAnchoredToLeft; \
/*0x00C1*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x00C2*/ bool		bFullyScreenClipped; \
/*0x00C3*/ bool		Fades; \
/*0x00C4*/ bool		bMaximized; \
/*0x00C5*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x00C8*/ int		TopOffset; \
/*0x00CC*/ int		RightOffset; \
/*0x00D0*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x00D1*/ bool		bAction; \
...
/*0x00EC*/ void*	pTextObject; \
/*0x00F0*/ bool		bEscapableLocked; \
/*0x00F1*/ BYTE		FadeAlpha; \
/*0x00F4*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x00F8*/ bool		bBottomAnchoredToTop; \
/*0x00F9*/ bool		bIsTransitioning; \
/*0x00FA*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x00FB*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x00FC*/ RECT		IconRect; \
/*0x010C*/ bool		bScreenClipRectChanged; \
/*0x0110*/ RECT		ClientRect; \
/*0x0120*/ BYTE		TargetAlpha; \
/*0x0124*/ UINT		TransitionStartTick; \
/*0x0128*/ LONG		BlinkStartTimer; \
/*0x012C*/ void *pController; \
/*0x0130*/ RECT		ClipRectScreen; \
/*0x0140*/ bool		Faded; \
/*0x0144*/ void   *TitlePiece; \
/*0x0148*/ int		managerArrayIndex; \
/*0x014C*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
...
/*0x0160*/ bool		bKeepOnScreen; \
/*0x0164*/ int		BlinkDuration; \
/*0x0168*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x0169*/ bool		bMaximizable; \
/*0x016A*/ bool		bIsParentOrContextMenuWindow; \
/*0x016C*/ int		HScrollPos; \
/*0x0170*/ RECT		TransitionRect; \
/*0x0180*/ DWORD  BackgroundDrawType; \
/*0x0184*/ int		ParentAndContextMenuArrayIndex; \
/*0x0188*/ int		BlinkState; \
/*0x018C*/ void	*IconTextureAnim; \
/*0x0190*/ bool		bMarkedForDelete; \
/*0x0191*/ bool		bClipToParent; \
/*0x0192*/ bool		Minimized; \
/*0x0194*/ void	*DrawTemplate; \
/*0x0198*/ UINT		LastBlinkFadeRefreshTime; \
/*0x019C*/ bool		bTopAnchoredToTop; \
/*0x01A0*/ int	Transition; \
/*0x01A4*/ RECT		OldLocation; \
/*0x01B4*/ bool		bClientRectChanged; \
/*0x01B5*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
...
//Size 0x380 see 69607B in 12 Jun 2017 Test exe -eqmule
...
/*0x288*/ struct _CXSTR *CommandHistory[0x28];
...
/*0x340*/ int ContextMenuSubID[0xa];//this is not correct but ill fx it later.
/*0x368*/
