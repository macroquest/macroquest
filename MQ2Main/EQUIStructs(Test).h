...
/*0x0054*/ DWORD        BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x "BGType" in ini */ \
...
/*0x0094*/ BYTE         CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0095*/ BYTE         FadeToAlpha; /*found in CSidlScreenWnd__StoreIniInfo_x*/\
/*0x0096*/ BYTE         Unknown0x0096[0x2]; \
/*0x0098*/ RECT         OldLocation; \
/*0x00a8*/ BYTE         Alpha; \
/*0x00a9*/ BYTE         Unknown0x00a9[0x17]; \
/*0x00c0*/ DWORD        VScrollMax; \
...
/*0x00e9*/ BYTE         Unknown0x00e9[0x2f]; \
/*0x0118*/ DWORD        VScrollPos; \
/*0x011c*/ DWORD        ZLayer; /*found in CXWndManager__DrawWindows_x*/ \
/*0x0120*/ BYTE         Locked; /*found in CSidlScreenWnd__LoadIniInfo_x*/ \
...
/*0x0178*/ BYTE         Unknown0x0178[0x6]; \
/*0x017e*/ BYTE         ValidCXWnd; /*IsValid has this one*/\
/*0x017f*/ BYTE         Unknown0x017f; \
/*0x0180*/ ARGBCOLOR    BGColor; \
/*0x0184*/ BYTE         Unknown0x0184; \
/*0x0185*/ BYTE         MouseOver; /*found in CXWnd__SetMouseOver_x*/ \
/*0x0186*/ BYTE         Unknown0x0186[0x2]; \
/*0x0188*/ DWORD        HScrollPos; \
...
/*0x01c8*/ BYTE         Unknown0x01c8[0x18]; \
/*0x01e0*/
