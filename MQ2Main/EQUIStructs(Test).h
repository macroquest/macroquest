...
/*0x0045*/ BYTE		StartAlpha; \
/*0x0046*/ bool		bRightAnchoredToLeft; \
...
/*0x006E*/ BYTE     bResizableMask; \
/*0x006F*/ bool		bIsTransitioning; \
/*0x0070*/ bool		bBringToTopWhenClicked; \
/*0x0071*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x0074*/ int		LeftOffset; \
/*0x0078*/ void	*IconTextureAnim; \
/*0x007C*/ bool		bMarkedForDelete; \
/*0x0080*/ UINT		LastBlinkFadeRefreshTime; \
/*0x0084*/ DWORD	FadeDelay; \
/*0x0088*/ bool		Fades; \
/*0x008C*/ int		TopOffset; \
/*0x0090*/ LONG		BlinkStartTimer; \
/*0x0094*/ int		VScrollMax; \
/*0x0098*/ struct _CSIDLWND* pWndFocusOther; \
/*0x009C*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x009D*/ bool		bFullyScreenClipped; \
/*0x00A0*/ struct _CXSTR*	DataStr; \
/*0x00A4*/ bool		bBorder; \
/*0x00A5*/ bool		dShow; \
/*0x00A8*/ tagSIZE	MinClientSize; \
/*0x00B0*/ void* pTipTextObject; \
/*0x00B4*/ bool		bCaptureTitle; \
...
/*0x00E8*/ bool		bBorder2; \
/*0x00E9*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x00EC*/ RECT		TransitionRect; \
/*0x00FC*/ int		managerArrayIndex; \
/*0x0100*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x0104*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x0108*/ int		RightOffset; \
/*0x010C*/ void*	pTextObject; \
/*0x0110*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0114*/ tagSIZE	MaxClientSize; \
/*0x011C*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x0134*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x0138*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x013C*/ void	*DrawTemplate; \
/*0x0140*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0141*/ bool		bClientRectChanged; \
/*0x0142*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0143*/ bool		bMaximized; \
/*0x0144*/ BYTE		FadeAlpha; \
/*0x0148*/ RECT		IconRect; \
/*0x0158*/ bool		bIsParentOrContextMenuWindow; \
/*0x015C*/ UINT		BlinkFadeStartTime; \
/*0x0160*/ __int64		Data; \
/*0x0168*/ UINT		FadeDuration; \
/*0x016C*/ bool		bTopAnchoredToTop; \
/*0x0170*/ int		BlinkState; \
/*0x0174*/ int		VScrollPos; \
/*0x0178*/ bool		bScreenClipRectChanged; \
/*0x017C*/ DWORD	LastTimeMouseOver; \
/*0x0180*/ bool		bUseInLayoutVertical; \
/*0x0181*/ bool		bClipToParent; \
/*0x0184*/ RECT		ClipRectScreen; \
/*0x0194*/ BYTE		Alpha; \
/*0x0195*/ bool		bLeftAnchoredToLeft; \
...
/*0x01A8*/ void   *TitlePiece2; \
/*0x01AC*/ int		DeleteCount; \
/*0x01B0*/ RECT		ClientRect; \
/*0x01C0*/ void	    *pFont; \
/*0x01C4*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x01C5*/ bool		bHCenterTooltip; \
...
/*0x01E0*/ UINT		TransitionDuration; \
...
// CBazaarSearchWnd_size: 0x92d0 (see 5431CD) in Jul 12 2019 Live - eqmule
...
// CPlayerWindow_size: 0x2e8 (see 542ABE) in Jul 12 2019 Live - eqmule
...
// CTargetWindow_size: 0x8c8 (see 542955) in Jul 12 2019 Live - eqmule
...
// CBuffWindow_size: 0x718 (see 5427F9) in Jul 12 2019 Live - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x320 (see 7F6B3B) in Jul 12 2019 Live - eqmule
...
// CCastSpellWnd_size: 0x2d0 (see 542BB7) in Jul 12 2019 Live - eqmule
...
// CInvSlotWnd_size: 0x2d0 (see 7F6C4C) in Jul 12 2019 Live - eqmule
...
// CItemDisplayWindow_size: 0x628 (see 756862) in Jul 12 2019 Live - eqmule
...
// CLootWnd_size: 0x398 (see 542F25) in Jul 12 2019 Live - eqmule
...
// CMapViewWnd_size: 0x648 (see 54265A) in Jul 12 2019 Live - eqmule
...
// CMerchantWnd_size: 0x448 (see 543081) in Jul 12 2019 Live - eqmule
...
// CPetInfoWindow_size: 0x8c8 (see 5420B1) in Jul 12 2019 Live - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a8 (see 5423A2) in Jul 12 2019 Live - eqmule
...
// CTradeWnd__size: 0x2f0 (see 543127) in Jul 12 2019 Live - eqmule
...
// CFactionWnd__size: 0x278 (see 543273) in Jul 12 2019 Live - eqmule
