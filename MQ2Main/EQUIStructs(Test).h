...
/*0x002E*/ bool		bUseInLayoutHorizontal; \
...
/*0x0066*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x0067*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
...
/*0x0092*/ bool		Minimized; \
/*0x0094*/ UINT		BlinkFadeStartTime; \
/*0x0098*/ bool		bTopAnchoredToTop; \
/*0x0099*/ bool		bBringToTopWhenClicked; \
/*0x009C*/ RECT		ClientRect; \
...
/*0x00D8*/ RECT		Location; \
/*0x00E8*/ DWORD  BackgroundDrawType; \
/*0x00EC*/ bool		bUseInLayoutVertical; \
/*0x00F0*/ int		BlinkState; \
/*0x00F4*/ int		BottomOffset; \
/*0x00F8*/ bool		Enabled; \
/*0x00FC*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x1c */ \
...
/*0x018C*/ bool		dShow; \
/*0x018D*/ bool		bBottomAnchoredToTop; \
/*0x018E*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x018F*/ BYTE		TargetAlpha; \
/*0x0190*/ bool		Fades; \
/*0x0194*/ void	*DrawTemplate; \
/*0x0198*/ UINT		TransitionDuration; \
/*0x019C*/ int		DeleteCount; \
/*0x01A0*/ UINT		BlinkFadeDuration; \
/*0x01A4*/ BYTE     bResizableMask; \
...
/*0x01DD*/ bool		bLeftAnchoredToLeft; \
/*0x01DE*/ bool		bActive; \
/*0x01DF*/ bool		bHCenterTooltip; \
...
/*0x2a0*/ struct _CXSTR *CommandHistory[0x28]; // see 696CCA in jun 12 2017 test
...
/*0x358*/ int ContextMenuSubID[0xa];//this is not correct but ill fx it later.
/*0x380*/
