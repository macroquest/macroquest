...
/*0x001c*/ DWORD        TickCount2; \
/*0x0020*/ BYTE         Unknown0x0020[0x4]; \
/*0x0024*/ BYTE         Minimized; \
/*0x0025*/ BYTE         Unknown0x0025[0xb]; \
/*0x0030*/ BYTE         dShow; \
...
/*0x0040*/ DWORD        BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x "BGType" in ini */ \
...
/*0x0059*/ BYTE         Unknown0x0059[0xb]; \
/*0x0064*/ DWORD        VScrollPos; \
/*0x0068*/ BYTE         Unknown0x0068[0x4]; \
/*0x006c*/ DWORD        UnknownCW; /*found in OnProcessFrame*/\
/*0x0070*/ BYTE         Unknown0x0070[0xc]; \
/*0x007c*/ DWORD        HScrollMax; \
...
/*0x0098*/ BYTE         Fades; \
/*0x0099*/ BYTE         Unknown0x0099[0x1b]; \
/*0x00b4*/ DWORD        FadeDuration; \
/*0x00b8*/ BYTE         Unknown0x00b8[0x36]; \
/*0x00ee*/ BYTE         Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x00ef*/ BYTE         Unknown0x00ef; \
/*0x00f0*/ BYTE         CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x00f1*/ BYTE         Unknown0x00f1[0x13]; \
/*0x0104*/ DWORD        VScrollMax; \
/*0x0108*/ BYTE         Unknown0x0108[0x10]; \
/*0x0118*/ DWORD        HScrollPos; \
...
/*0x013c*/ BYTE         Unknown0x013c[0x14]; \
/*0x0150*/ BYTE         Faded; \
/*0x0151*/ BYTE         Alpha; \
/*0x0152*/ BYTE         Unknown0x0152[0x2]; \
/*0x0154*/ struct _CXSTR*       Tooltip; /*found in CSidlManager__CreateLabel_x*/ \
/*0x0158*/ BYTE         Unknown0x0158; \
/*0x0159*/ BYTE         ValidCXWnd; /*IsValid has this one*/\
/*0x015a*/ BYTE         Unknown0x015a[0x12]; \
/*0x016c*/ BYTE         MouseOver; /*found in CXWnd__SetMouseOver_x*/ \
/*0x016d*/ BYTE         Unknown0x016d[0x17]; \
/*0x0184*/ BYTE         Enabled; \
...
/*0x01a0*/ BYTE         Unknown0x01a0[0x18]; \
/*0x01b8*/ LPVOID       DrawTemplate; \
