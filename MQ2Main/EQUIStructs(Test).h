...
/*0x002D*/ bool		bTopAnchoredToTop; \
/*0x002E*/ bool		bBringToTopWhenClicked; \
/*0x0030*/ int		managerArrayIndex; \
/*0x0034*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0035*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x0038*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x003C*/ bool		bCaptureTitle; \
/*0x003D*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x003E*/ BYTE		TargetAlpha; \
/*0x0040*/ int		VScrollMax; \
/*0x0048*/ __int64		Data; \
/*0x0050*/ bool		bClientClipRectChanged; \
/*0x0054*/ int		TopOffset; \
/*0x0058*/ bool		bFullyScreenClipped; \
/*0x0059*/ bool		bIsTransitioning; \
/*0x005C*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0060*/ bool		bTiled; \
/*0x0064*/ RECT		ClipRectScreen; \
...
/*0x0080*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x0084*/ RECT		OldLocation; \
/*0x0094*/ DWORD	FadeDelay; \
/*0x0098*/ BYTE		StartAlpha; \
/*0x009C*/ LONG		BlinkStartTimer; \
/*0x00A0*/ UINT		TransitionStartTick; \
/*0x00A4*/ bool		bClipToParent; \
/*0x00A5*/ bool		dShow; \
/*0x00A6*/ bool		bKeepOnScreen; \
/*0x00A7*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x00A8*/ bool		bUseInLayoutVertical; \
/*0x00AC*/ int		RightOffset; \
/*0x00B0*/ bool		Faded; \
/*0x00B4*/ int		BottomOffset; \
/*0x00B8*/ int		BlinkState; \
/*0x00BC*/ DWORD	LastTimeMouseOver; \
/*0x00C0*/ bool		bAction; \
/*0x00C1*/ bool		bClientRectChanged; \
/*0x00C4*/ UINT		FadeDuration; \
/*0x00C8*/ int	Transition; \
/*0x00CC*/ bool		bBorder; \
/*0x00D0*/ int		HScrollPos; \
/*0x00D4*/ int		DeleteCount; \
/*0x00D8*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x00DC*/ void   *TitlePiece; \
/*0x00E0*/ UINT		TransitionDuration; \
/*0x00E4*/ bool		bBorder2; \
/*0x00E5*/ bool		bActive; \
/*0x00E6*/ bool		bLeftAnchoredToLeft; \
/*0x00E8*/ void* pTipTextObject; \
/*0x00EC*/ tagSIZE	MinClientSize; \
/*0x00F4*/ UINT		BlinkFadeFreq; \
/*0x00F8*/ bool		Fades; \
/*0x00FC*/ int		ParentAndContextMenuArrayIndex; \
/*0x0100*/ bool		bMaximized; \
/*0x0104*/ void   *TitlePiece2; \
/*0x0108*/ UINT		LastBlinkFadeRefreshTime; \
/*0x010C*/ RECT		Location; \
/*0x011C*/ void	*IconTextureAnim; \
/*0x0120*/ struct _CSIDLWND* pWndFocusOther; \
/*0x0124*/ DWORD	XMLIndex; \
/*0x0128*/ void		*pLayoutStrategy; \
/*0x012C*/ bool		bHCenterTooltip; \
/*0x012D*/ bool		bMaximizable; \
/*0x0130*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x0134*/ struct _CXSTR*	DataStr; \
/*0x0138*/ int		BlinkDuration; \
/*0x013C*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x0140*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x0158*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x015C*/ void *pController; \
/*0x0160*/ bool		bScreenClipRectChanged; \
/*0x0161*/ bool		Enabled; \
/*0x0162*/ BYTE     bResizableMask; \
/*0x0164*/ RECT		ClipRectClient; \
/*0x0174*/ int		LeftOffset; \
...
/*0x018C*/ DWORD  BackgroundDrawType; \
/*0x0190*/ bool		bMarkedForDelete; \
/*0x0194*/ RECT		IconRect; \
/*0x01A4*/ UINT		BlinkFadeDuration; \
/*0x01A8*/ bool		bRightAnchoredToLeft; \
/*0x01A9*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x01AA*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x01AC*/ UINT		BlinkFadeStartTime; \
/*0x01B0*/ RECT		ClientRect; \
/*0x01C0*/ bool		bUseInLayoutHorizontal; \
/*0x01C1*/ BYTE		Alpha; \
/*0x01C2*/ BYTE		FadeAlpha; \
/*0x01C4*/ void	*DrawTemplate; \
/*0x01C8*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
/*0x01CC*/ void*	pTextObject; \
/*0x01D0*/ bool		bEscapableLocked; \
...
// CBazaarSearchWnd_size: 0x92d8 (see 5512CE) in Dec 18 2019 Test - eqmule
...
// CPlayerWindow_size: 0x2f0 (see 550BBE) in Dec 18 2019 Test - eqmule
...
// CTargetWindow_size: 0x8d0 (see 550A55) in Dec 18 2019 Test - eqmule
...
// CBuffWindow_size: 0x720 (see 5508F9) in Dec 18 2019 Test - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x328 (see 8085CB) in Dec 18 2019 Test - eqmule
...
// CCastSpellWnd_size: 0x2d8 (see 550CB7) in Dec 18 2019 Test - eqmule
...
// CInvSlotWnd_size: 0x2d8 (see 8086DC) in Dec 18 2019 Test - eqmule
...
// CItemDisplayWindow_size: 0x630 (see 76B562) in Dec 18 2019 Test - eqmule
...
// CLootWnd_size: 0x3a0 (see 551026) in Dec 18 2019 Test - eqmule
...
// CMapViewWnd_size: 0x658 (see 55075A) in Dec 18 2019 Test - eqmule
...
// CMerchantWnd_size: 0x450 (see 551182) in Dec 18 2019 Test - eqmule
...
// CPetInfoWindow_size: 0x8d0 (see 5501B1) in Dec 18 2019 Test - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3b0 (see 5504A2) in Dec 18 2019 Test - eqmule
...
// CTradeWnd__size: 0x2f8 (see 551228) in Dec 18 2019 Test - eqmule
...
// CFactionWnd__size: 0x280 (see 551374) in Dec 18 2019 Test - eqmule
