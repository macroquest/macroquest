...
/*0x002c*/ DWORD        TickCount2; \
/*0x0030*/ BYTE         Unknown0x0030[0x24]; \
/*0x0054*/ RECT         Location; \
/*0x0064*/ BYTE         Enabled; \
/*0x0065*/ BYTE         Unknown0x0065; \
/*0x0066*/ BYTE         Faded; \
/*0x0067*/ BYTE         Unknown0x0067[0x11]; \
/*0x0078*/ DWORD        HScrollMax; \
/*0x007c*/ DWORD        TimeMouseOver; \
/*0x0080*/ BYTE         Unknown0x0080[0x8]; \
/*0x0088*/ DWORD        VScrollMax; \
/*0x008c*/ BYTE         Unknown0x008c[0x20]; \
/*0x00ac*/ BYTE         CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x00ad*/ BYTE         Unknown0x00ad[0xf]; \
/*0x00bc*/ BYTE         dShow; \
/*0x00bd*/ BYTE         Unknown0x00bd[0x7]; \
/*0x00c4*/ BYTE         ValidCXWnd; /*IsValid has this one*/\
/*0x00c5*/ BYTE         Unknown0x00c5[0x13]; \
/*0x00d8*/ RECT         OldLocation; \
/*0x00e8*/ BYTE         Unknown0x00e8[0x2c]; \
/*0x0114*/ LPVOID       DrawTemplate; \
/*0x0118*/ BYTE         Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
...
/*0x012c*/ DWORD        ZLayer; /*found in CXWndManager__DrawWindows_x*/ \
/*0x0130*/ BYTE         Locked; /*found in CSidlScreenWnd__LoadIniInfo_x*/ \
/*0x0131*/ BYTE         Unknown0x0131[0x7]; \
/*0x0138*/ ARGBCOLOR    BGColor; \
...
/*0x0160*/ BYTE         Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
...
/*0x0178*/ DWORD        HScrollPos; \
/*0x017c*/ BYTE         Unknown0x017c[0x20]; \
/*0x019c*/ BYTE         Minimized; \
/*0x019d*/ BYTE         Unknown0x019d; \
/*0x019e*/ BYTE         FadeToAlpha; /*found in CSidlScreenWnd__StoreIniInfo_x*/\
/*0x019f*/ BYTE         Unknown0x019f[0x5]; \
...
/*0x01d0*/ BYTE         MouseOver; /*found in CXWnd__SetMouseOver_x*/ \
