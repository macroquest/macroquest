...
/*0x0084*/ UINT		LastBlinkFadeRefreshTime; \
/*0x0088*/ int		HScrollMax; \
/*0x008C*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x0090*/ void		*pLayoutStrategy; \
/*0x0094*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x0095*/ bool		bTiled; \
/*0x0096*/ bool		bBorder; \
...
/*0x013C*/ UINT		BlinkFadeStartTime; \
/*0x0140*/ int		LeftOffset; \
/*0x0144*/ RECT		ClipRectScreen; \
/*0x0154*/ void	*DrawTemplate; \
/*0x0158*/ int		BlinkState; \
/*0x015C*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x0160*/ void	    *pFont; \
/*0x0164*/ bool		bUseInLayoutHorizontal; \
/*0x0165*/ bool		bClientClipRectChanged; \
...
/*0x0185*/ bool		bIsParentOrContextMenuWindow; \
/*0x0186*/ BYTE     bResizableMask; \
/*0x0187*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x0188*/ struct _CXSTR*	DataStr; \
/*0x018C*/ int		BottomOffset; \
...
/*0x01B9*/ bool		bEscapableLocked; \
/*0x01BA*/ bool		Enabled; \
/*0x01BB*/ bool		bRightAnchoredToLeft; \
/*0x01BC*/ int		BlinkDuration; \
/*0x01C0*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x01C4*/ DWORD	LastTimeMouseOver; \
/*0x01C8*/ DWORD	XMLIndex; \
/*0x01CC*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
...
// CBazaarSearchWnd_size: 0x92c8 (see 55143E) in Jan 10 2020 Test - eqmule
...
// CPlayerWindow_size: 0x2e0 (see 550D2E) in Jan 10 2020 Test - eqmule
...
// CTargetWindow_size: 0x8c0 (see 550BC5) in Jan 10 2020 Test - eqmule
...
// CBuffWindow_size: 0x710 (see 550A69) in Jan 10 2020 Test - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x318 (see 80799B) in Jan 10 2020 Test - eqmule
...
// CCastSpellWnd_size: 0x2c8 (see 550E27) in Jan 10 2020 Test - eqmule
...
// CInvSlotWnd_size: 0x2c8 (see 807AAC) in Jan 10 2020 Test - eqmule
...
// CItemDisplayWindow_size: 0x620 (see 76AB12) in Jan 10 2020 Test - eqmule
...
// CLootWnd_size: 0x390 (see 551196) in Jan 10 2020 Test - eqmule
...
// CMapViewWnd_size: 0x638 (see 5508CA) in Jan 10 2020 Test - eqmule
...
// CMerchantWnd_size: 0x440 (see 5512F2) in Jan 10 2020 Test - eqmule
...
// CPetInfoWindow_size: 0x8c0 (see 550321) in Jan 10 2020 Test - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a0 (see 550612) in Jan 10 2020 Test - eqmule
...
// CTradeWnd__size: 0x2e8 (see 551398) in Jan 10 2020 Test - eqmule
...
// CFactionWnd__size: 0x270 (see 5514E4) in Jan 10 2020 Test - eqmule
