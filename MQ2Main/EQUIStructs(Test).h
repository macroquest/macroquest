...
/*0x0074*/ DWORD        BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x "BGType" in ini */ \
/*0x0078*/ BYTE         Unknown0x0078[0x8]; \
/*0x0080*/ BYTE         Minimized; \
/*0x0081*/ BYTE         Unknown0x0081[0x3]; \
/*0x0084*/ DWORD        VScrollPos; \
/*0x0088*/ BYTE         Unknown0x0088[0x8]; \
/*0x0090*/ RECT         Location; \
/*0x00a0*/ BYTE         Unknown0x00a0[0x38]; \
/*0x00d8*/ DWORD        TickCount2; \
/*0x00dc*/ BYTE         dShow; \
/*0x00dd*/ BYTE         Unknown0x00dd[0xb]; \
/*0x00e8*/ struct _CXSTR*       XMLToolTip; /*found in CSidlManager__CreateLabel_x*/ \
/*0x00ec*/ BYTE         Unknown0x00ec; \
/*0x00ed*/ BYTE         FadeToAlpha; /*found in CSidlScreenWnd__StoreIniInfo_x*/\
/*0x00ee*/ BYTE         Faded; \
/*0x00ef*/ BYTE         Unknown0x00ef[0xd]; \
/*0x00fc*/ LPVOID       DrawTemplate; \
/*0x0100*/ BYTE         Unknown0x0100[0x14]; \
/*0x0114*/ BYTE         CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0115*/ BYTE         Unknown0x0115[0x7]; \
/*0x011c*/ BYTE         Locked; /*found in CSidlScreenWnd__LoadIniInfo_x*/ \
/*0x011d*/ BYTE         MouseOver; /*found in CXWnd__SetMouseOver_x*/ \
...
/*0x019c*/ BYTE         Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x019d*/ BYTE         Unknown0x019d[0x1b]; \
/*0x01b8*/ DWORD        WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x01bc*/ BYTE         Unknown0x01bc[0x8]; \
/*0x01c4*/ DWORD        VScrollMax; \
/*0x01c8*/ BYTE         Unknown0x01c8[0x4]; \
/*0x01cc*/ DWORD        ZLayer; /*found in CXWndManager__DrawWindows_x*/ \
/*0x01d0*/ BYTE         Unknown0x01d0[0x7]; \
/*0x01d7*/ BYTE         Enabled; \
/*0x01d8*/
...
// Individual Gems 
// Actual Size: 0x2f8 (see 76E588) in Jan 14 2015 test - eqmule
...
// Actual Size: 0x2ac (see 76E699) in Jan 14 2015 test - eqmule
...
//aClasscolorD
// Actual Size: 0x390 (see 49A9A5) in Jan 14 2015 test - eqmule
