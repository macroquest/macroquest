...
//2014-11-13 test size is 1e4 see (8CA6ED) - eqmule
//2014-11-21 test size is 1d0 see (8C9B0D) - eqmule
//2014-12-02 test size is 1dc see (8CA43D) - eqmule
//2015-01-14 test size is 1d8 see (8C994D) - eqmule
...
/*0x0029*/ BYTE         Unknown0x0029[0xb]; \
/*0x0034*/ DWORD        VScrollPos; \
/*0x0038*/ DWORD        HScrollPos; \
/*0x003c*/ BYTE         FadeToAlpha; /*found in CSidlScreenWnd__StoreIniInfo_x*/\
/*0x003d*/ BYTE         Alpha; \
/*0x003e*/ BYTE         Unknown0x003e[0xf]; \
/*0x004d*/ BYTE         Faded; \
/*0x004e*/ BYTE         Unknown0x004e[0x2]; \
/*0x0050*/ struct _CXSTR*       WindowText; /*CXWnd__GetWindowTextA_x has this one*/ \
/*0x0054*/ BYTE         Unknown0x0054[0x8]; \
/*0x005c*/ DWORD        BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x "BGType" in ini */ \
/*0x0060*/ BYTE         Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0061*/ BYTE         Unknown0x0061[0x2]; \
/*0x0063*/ BYTE         Minimized; \
/*0x0064*/ BYTE         Unknown0x0064[0x3c]; \
/*0x00a0*/ BYTE         ValidCXWnd; /*IsValid has this one*/\
/*0x00a1*/ BYTE         Unknown0x00a1[0xb]; \
/*0x00ac*/ DWORD        ZLayer; /*found in CXWndManager__DrawWindows_x*/ \
/*0x00b0*/ struct _CSIDLWND*    pParentWindow; /*CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x00b4*/ LPVOID       DrawTemplate; \
/*0x00b8*/ BYTE         Fades; \
/*0x00b9*/ BYTE         Enabled; \
/*0x00ba*/ BYTE         Unknown0x00ba[0x16]; \
/*0x00d0*/ BYTE         MouseOver; /*found in CXWnd__SetMouseOver_x*/ \
/*0x00d1*/ BYTE         Unknown0x00d1[0x1b]; \
/*0x00ec*/ RECT         OldLocation; \
/*0x00fc*/ BYTE         Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x00fd*/ BYTE         Unknown0x00fd[0x3]; \
/*0x0100*/ DWORD        XMLIndex; \
/*0x0104*/ BYTE         Unknown0x0104[0x3c]; \
/*0x0140*/ DWORD        WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x0144*/ BYTE         Unknown0x0144[0x4]; \
/*0x0148*/ struct _CXSTR*       XMLToolTip; /*found in CSidlManager__CreateLabel_x*/ \
/*0x014c*/ DWORD        FadeDuration; \
/*0x0150*/ BYTE         Unknown0x0150[0x14]; \
/*0x0164*/ BYTE         dShow; \
/*0x0165*/ BYTE         Unknown0x0165[0x3]; \
/*0x0168*/ RECT         Location; \
/*0x0178*/ DWORD        VScrollMax; \
/*0x017c*/ ARGBCOLOR    BGColor; \
/*0x0180*/ BYTE         Unknown0x0180[0xc]; \
/*0x018c*/ BYTE         Locked; /*found in CSidlScreenWnd__LoadIniInfo_x*/ \
/*0x018d*/ BYTE         Unknown0x018d[0x7]; \
/*0x0194*/ DWORD        TimeMouseOver; \
/*0x0198*/ BYTE         Unknown0x0198[0x4]; \
/*0x019c*/ DWORD        UnknownCW; /*found in OnProcessFrame*/\
/*0x01a0*/ BYTE         Unknown0x01a0[0x40]; \
/*0x01e0*/ DWORD        TickCount2; \
/*0x01e4*/
...
// size 0x27c Jan 22 2014 test (see 6554CB) -eqmule
#define CONTEXTTAIL \
/*0x21c*/ DWORD ZeroMe; \
...
/*0x270*/ DWORD Unknown0x270; /*constructor sets this to 0x10000*/ \
/*0x274*/ DWORD ZeroMeAsWell; \
/*0x278*/ DWORD Unknown0x278; /*constructor sets this to 0*/ \
/*0x27c*/
