...
/*0x0020*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x0021*/ bool		Minimized; \
/*0x0022*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0023*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x0024*/ bool		bTiled; \
/*0x0025*/ BYTE		StartAlpha; \
/*0x0028*/ void   *TitlePiece; \
/*0x002C*/ bool		dShow; \
/*0x002D*/ bool		bClientRectChanged; \
/*0x0030*/ int		VScrollPos; \
/*0x0034*/ bool		bScreenClipRectChanged; \
/*0x0038*/ COLORREF DisabledBackground; \
/*0x003C*/ void	*DrawTemplate; \
...
/*0x005C*/ bool		bLeftAnchoredToLeft; \
/*0x005D*/ bool		Faded; \
/*0x005E*/ bool		bIsParentOrContextMenuWindow; \
/*0x005F*/ bool		bClientClipRectChanged; \
...
/*0x00D0*/ RECT		IconRect; \
/*0x00E0*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x00E4*/ int		LeftOffset; \
/*0x00E8*/ RECT		ClipRectScreen; \
/*0x00F8*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
...
/*0x012D*/ bool		bIsTransitioning; \
/*0x012E*/ bool		bCaptureTitle; \
/*0x012F*/ bool		bKeepOnScreen; \
/*0x0130*/ RECT		ClientRect; \
/*0x0140*/ bool		bEscapableLocked; \
/*0x0141*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0144*/ void		*pLayoutStrategy; \
/*0x0148*/ BYTE		Alpha; \
/*0x0149*/ bool		bClipToParent; \
/*0x014A*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x014C*/ UINT		LastBlinkFadeRefreshTime; \
/*0x0150*/ DWORD	LastTimeMouseOver; \
/*0x0154*/ bool		bMaximizable; \
/*0x0155*/ bool		Fades; \
/*0x0158*/ int		managerArrayIndex; \
...
/*0x01D4*/ BYTE     bResizableMask; \
/*0x01D5*/ bool		bHCenterTooltip; \
...
// CBazaarSearchWnd_size: 0x92c8 (see 544C3D) in Aug 12 2019 Test - eqmule
...
// CPlayerWindow_size: 0x2e0 (see 54452E) in Aug 12 2019 Test - eqmule
...
// CTargetWindow_size: 0x8c0 (see 5443C5) in Aug 12 2019 Test - eqmule
...
// CBuffWindow_size: 0x710 (see 544269) in Aug 12 2019 Test - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x318 (see 7F8FAB) in Aug 12 2019 Test - eqmule
...
// CCastSpellWnd_size: 0x2c8 (see 544627) in Aug 12 2019 Test - eqmule
...
// CInvSlotWnd_size: 0x2c8 (see 7F90BC) in Aug 12 2019 Test - eqmule
...
// CItemDisplayWindow_size: 0x620 (see 759142) in Aug 12 2019 Test - eqmule
...
// CLootWnd_size: 0x390 (see 544995) in Aug 12 2019 Test - eqmule
...
// CMapViewWnd_size: 0x638 (see 5440CA) in Aug 12 2019 Test - eqmule
...
// CMerchantWnd_size: 0x440 (see 544AF1) in Aug 12 2019 Test - eqmule
...
// CPetInfoWindow_size: 0x8c0 (see 543B21) in Aug 12 2019 Test - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a0 (see 543E12) in Aug 12 2019 Test - eqmule
...
// CTradeWnd__size: 0x2e8 (see 544B97) in Aug 12 2019 Test - eqmule
...
// CFactionWnd__size: 0x270 (see 544CE3) in Aug 12 2019 Test - eqmule
