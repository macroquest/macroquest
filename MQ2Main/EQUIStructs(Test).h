...
/*0x0024*/ int		VScrollPos; \
/*0x0028*/ void* pTipTextObject; \
/*0x002C*/ bool		bCaptureTitle; \
/*0x0030*/ void		*pLayoutStrategy; \
/*0x0034*/ bool bClickThroughMenuItemStatus; /* on/off */ \
...
/*0x003D*/ bool		Faded; \
/*0x0040*/ int		HScrollPos; \
/*0x0044*/ bool		bUseInLayoutVertical; \
/*0x0045*/ bool		bRightAnchoredToLeft; \
/*0x0046*/ bool		bUseInLayoutHorizontal; \
...
/*0x0068*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x006C*/ UINT		TransitionDuration; \
/*0x0070*/ bool		bMarkedForDelete; \
/*0x0071*/ bool		bScreenClipRectChanged; \
/*0x0072*/ bool		bActive; \
/*0x0073*/ bool		bIsTransitioning; \
...
/*0x0080*/ bool		bEscapableLocked; \
/*0x0081*/ bool		bClientClipRectChanged; \
/*0x0082*/ bool		dShow; \
/*0x0084*/ COLORREF DisabledBackground; \
/*0x0088*/ void *pController; \
/*0x008C*/ bool		bTiled; \
/*0x0090*/ int		VScrollMax; \
/*0x0094*/ bool		Fades; \
/*0x0095*/ bool		bIsParentOrContextMenuWindow; \
...
/*0x0102*/ bool		bKeepOnScreen; \
/*0x0103*/ bool		bLeftAnchoredToLeft; \
/*0x0104*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x0108*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0109*/ bool		bMaximizable; \
/*0x010A*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
...
/*0x0140*/ bool		bBottomAnchoredToTop; \
/*0x0144*/ UINT		TransitionStartTick; \
/*0x0148*/ int		BlinkState; \
...
// CBazaarSearchWnd_size: 0x92c8 (see 5571EE) in May 12 2020 Test - eqmule
...
// CPlayerWindow_size: 0x2e0 (see 556ADE) in May 12 2020 Test - eqmule
...
// CTargetWindow_size: 0x8c0 (see 556975) in May 12 2020 Test - eqmule
...
// CBuffWindow_size: 0x710 (see 556819) in May 12 2020 Test - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x318 (see 8164DB) in May 12 2020 Test - eqmule
...
// CCastSpellWnd_size: 0x2c8 (see 556BD7) in May 12 2020 Test - eqmule
...
// CInvSlotWnd_size: 0x2c8 (see 8165EC) in May 12 2020 Test - eqmule
...
// CItemDisplayWindow_size: 0x620 (see 778BB2) in May 12 2020 Test - eqmule
...
// CLootWnd_size: 0x390 (see 556F46) in May 12 2020 Test - eqmule
...
// CMapViewWnd_size: 0x638 (see 55667A) in May 12 2020 Test - eqmule
...
// CMerchantWnd_size: 0x440 (see 5570A2) in May 12 2020 Test - eqmule
...
// CPetInfoWindow_size: 0x8c0 (see 5560D1) in May 12 2020 Test - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a0 (see 5563C2) in May 12 2020 Test - eqmule
...
// CTradeWnd__size: 0x2e8 (see 557148) in May 12 2020 Test - eqmule
...
// CFactionWnd__size: 0x270 (see 557294) in May 12 2020 Test - eqmule
