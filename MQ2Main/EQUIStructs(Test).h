...
/*0x0014*/ BYTE         Unknown0x0014[0x25]; \
/*0x0039*/ BYTE         Faded; \
/*0x003a*/ BYTE         Unknown0x003a[0x2]; \
/*0x003c*/ LPVOID       DrawTemplate; \
/*0x0040*/ BYTE         ValidCXWnd; /*IsValid has this one*/\
/*0x0041*/ BYTE         dShow; \
/*0x0042*/ BYTE         Unknown0x0042[0x2]; \
/*0x0044*/ DWORD        FadeDuration; \
/*0x0048*/ BYTE         Unknown0x0048; \
/*0x0049*/ BYTE         Locked; /*found in CSidlScreenWnd__LoadIniInfo_x*/ \
...
/*0x00a4*/ BYTE         MouseOver; /*found in CXWnd__SetMouseOver_x*/ \
...
/*0x00c0*/ DWORD        VScrollPos; \
/*0x00c4*/ BYTE         Unknown0x00c4[0x1c]; \
...
/*0x0121*/ BYTE         Unknown0x0121[0x8]; \
/*0x0129*/ BYTE         Fades; \
/*0x012a*/ BYTE         Unknown0x012a; \
/*0x012b*/ BYTE         Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x012c*/ BYTE         Unknown0x012c[0x14]; \
/*0x0140*/ DWORD        TimeMouseOver; \
/*0x0144*/ BYTE         Unknown0x0144; \
/*0x0145*/ BYTE         CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0146*/ BYTE         Unknown0x0146[0x32]; \
/*0x0178*/ DWORD        HScrollPos; \
/*0x017c*/ DWORD        ZLayer; /*found in CXWndManager__DrawWindows_x*/ \
/*0x0180*/ BYTE         Unknown0x0180[0x18]; \
/*0x0198*/ DWORD        HScrollMax; \
/*0x019c*/ BYTE         Unknown0x019c; \
/*0x019d*/ BYTE         Alpha; \
/*0x019e*/ BYTE         Unknown0x019e[0x16]; \
/*0x01b4*/ BYTE         Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
