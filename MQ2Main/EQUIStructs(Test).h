...
//2014-10-20 test size is 1dc see (8CAD2D) - eqmule
...
/*0x0019*/ BYTE         Faded; \
/*0x001a*/ BYTE         Unknown0x001a[0x2a]; \
...
/*0x0050*/ BYTE         dShow; \
/*0x0051*/ BYTE         Unknown0x0051[0xb]; \
/*0x005c*/ DWORD        HScrollMax; \
/*0x0060*/ DWORD        UnknownCW; /*found in OnProcessFrame*/\
/*0x0064*/ BYTE         Unknown0x0064[0x1c]; \
/*0x0080*/ DWORD        HScrollPos; \
...
/*0x00a0*/ DWORD        ZLayer; /*found in CXWndManager__DrawWindows_x*/ \
/*0x00a4*/ DWORD        FadeDuration; \
...
/*0x00e8*/ BYTE         MouseOver; /*found in CXWnd__SetMouseOver_x*/ \
/*0x00e9*/ BYTE         Unknown0x00e9[0xf]; \
...
/*0x0114*/ DWORD        TickCount2; \
/*0x0118*/ BYTE         Unknown0x0118[0x1d]; \
/*0x0135*/ BYTE         Enabled; \
/*0x0136*/ BYTE         Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0137*/ BYTE         Locked; /*found in CSidlScreenWnd__LoadIniInfo_x*/ \
/*0x0138*/ BYTE         Unknown0x0138[0x4]; \
/*0x013c*/ RECT         OldLocation; /*found in CXWnd__Resize_x*/ \
/*0x014c*/ DWORD        VScrollPos; \
/*0x0150*/ BYTE         Unknown0x0150[0x1d]; \
/*0x016d*/ BYTE         Alpha; \
/*0x016e*/ BYTE         Unknown0x016e[0x3a]; \
/*0x01a8*/ BYTE         Fades; \
...
/*0x01bc*/ LPVOID       DrawTemplate; \
/*0x01c0*/ BYTE         Unknown0x01c0[0x8]; \
/*0x01c8*/ ARGBCOLOR    BGColor; \
/*0x01cc*/ BYTE         Unknown0x01cc[0x5]; \
/*0x01d1*/ BYTE         ValidCXWnd; /*IsValid has this one*/\
/*0x01d2*/ BYTE         Unknown0x01d2[0x2]; \
/*0x01d4*/ BYTE         Minimized; \
...
// Actual Size: 0x92c0 (see 49B463) in Sep 18 2014 test - eqmule
...
// Actual Size: 0x2dc (see 49AD9E) in Sep 18 2014 test - eqmule
...
// Actual Size: 0x8b8 (see 49AC32) in Sep 18 2014 test - eqmule
...
// Actual Size: 0x70c (see 49AAC6) in Sep 18 2014 test - eqmule
...
/*0x0580*/ DWORD BuffId[NUM_LONG_BUFFS];//0x2a
...
// Individual Gems 
// Actual Size: 0x2fc (see 76A418) in Sep 18 2014 test - eqmule
...
// Actual Size: 0x2b4 (see 49AEB2) in Sep 18 2014 test - eqmule
...
// Actual Size: 0x2b0 (see 76A529) in Sep 18 2014 test - eqmule
...
// Actual Size: 0x604 (see 6B97AF) in Oct 20 2014 test - eqmule
...
// Actual Size: 0x3a8 (see 49B235) in Sep 18 2014 test - eqmule
...
/*0x02d4*/ BYTE Unknown0x02d4[0x28];
...
// Actual Size: 0x62c (see 49A927) in Sep 18 2014 test - eqmule
...
// Actual Size: 0x2c0 (see 49B34F) in Sep 18 2014 test - eqmule
...
// Actual Size: 0x924 (see 49A362) in Sep 18 2014 test - eqmule
...
//aClasscolorD
// Actual Size: 0x394 (see 49A655) in Sep 18 2014 test - eqmule
...
// Actual Size: 0x300 (see 49B3AB) in Sep 18 2014 test - eqmule
