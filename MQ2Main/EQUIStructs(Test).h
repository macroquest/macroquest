...
/*0x0020*/ int		HScrollPos; \
/*0x0024*/ BYTE		Alpha; \
/*0x0028*/ RECT		ClipRectScreen; \
/*0x0038*/ bool		bMaximized; \
/*0x003C*/ int		HScrollMax; \
/*0x0040*/ bool		bCaptureTitle; \
/*0x0041*/ bool		bActive; \
/*0x0044*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x1c */ \
/*0x0060*/ bool		bScreenClipRectChanged; \
/*0x0064*/ void	    *pFont; \
/*0x0068*/ UINT		BlinkFadeDuration; \
/*0x006C*/ void* pTipTextObject; \
/*0x0070*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x0074*/ UINT		LastBlinkFadeRefreshTime; \
/*0x0078*/ bool		bMarkedForDelete; \
/*0x0079*/ bool		Faded; \
/*0x007C*/ struct _CXSTR*	DataStr; \
/*0x0080*/ bool		bTiled; \
/*0x0081*/ bool		bUseInLayoutHorizontal; \
/*0x0084*/ tagSIZE	MinClientSize; \
/*0x008C*/ RECT		TransitionRect; \
/*0x009C*/ UINT		BlinkFadeFreq; \
/*0x00A0*/ COLORREF DisabledBackground; \
/*0x00A4*/ LONG		BlinkStartTimer; \
/*0x00A8*/ bool		bLeftAnchoredToLeft; \
/*0x00AC*/ int		RightOffset; \
/*0x00B0*/ void   *TitlePiece2; \
...
/*0x00CD*/ bool		bBorder; \
/*0x00CE*/ bool		bBottomAnchoredToTop; \
/*0x00CF*/ bool		bAction; \
/*0x00D0*/ void	*IconTextureAnim; \
/*0x00D4*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x00D8*/ bool		bTopAnchoredToTop; \
/*0x00D9*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x00DA*/ bool		bEscapableLocked; \
/*0x00E0*/ __int64		Data; \
/*0x00E8*/ int	Transition; \
/*0x00EC*/ void   *TitlePiece; \
/*0x00F0*/ bool		bIsParentOrContextMenuWindow; \
/*0x00F1*/ bool		bFullyScreenClipped; \
/*0x00F2*/ BYTE		TargetAlpha; \
/*0x00F3*/ bool		bHCenterTooltip; \
/*0x00F4*/ bool		bMaximizable; \
/*0x00F5*/ bool		bUseInLayoutVertical; \
/*0x00F8*/ int		BottomOffset; \
/*0x00FC*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0100*/ int		BlinkState; \
/*0x0104*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x0108*/ DWORD	FadeDelay; \
/*0x010C*/ UINT		TransitionDuration; \
/*0x0110*/ BYTE		FadeAlpha; \
/*0x0114*/ void	*DrawTemplate; \
/*0x0118*/ void		*pLayoutStrategy; \
/*0x011C*/ int		managerArrayIndex; \
/*0x0120*/ int		BlinkDuration; \
/*0x0124*/ int		DeleteCount; \
/*0x0128*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x012C*/ bool		Fades; \
/*0x0130*/ RECT		ClientRect; \
...
/*0x015C*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0160*/ void*	pTextObject; \
/*0x0164*/ bool		Enabled; \
/*0x0165*/ BYTE		StartAlpha; \
/*0x0166*/ bool		bIsTransitioning; \
/*0x0168*/ void *pController; \
/*0x016C*/ int		VScrollPos; \
/*0x0170*/ bool		bBringToTopWhenClicked; \
/*0x0174*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0178*/ bool		dShow; \
/*0x017C*/ tagSIZE	MaxClientSize; \
/*0x0184*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0188*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x018C*/ DWORD	LastTimeMouseOver; \
/*0x0190*/ bool		Minimized; \
/*0x0194*/ int		ParentAndContextMenuArrayIndex; \
/*0x0198*/ DWORD	XMLIndex; \
/*0x019C*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x01A0*/ UINT		FadeDuration; \
/*0x01A4*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x01A8*/ UINT		TransitionStartTick; \
/*0x01AC*/ int		LeftOffset; \
/*0x01B0*/ bool		bBorder2; \
/*0x01B4*/ int		TopOffset; \
/*0x01B8*/ RECT		IconRect; \
/*0x01C8*/ bool		bClientRectChanged; \
/*0x01CC*/ struct _CSIDLWND* pWndFocusOther; \
/*0x01D0*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x01D4*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x01D5*/ bool		bRightAnchoredToLeft; \
/*0x01D6*/ bool		bKeepOnScreen; \
/*0x01D7*/ BYTE     bResizableMask; \
/*0x01D8*/ DWORD  BackgroundDrawType; \
/*0x01DC*/ RECT		Location; \
/*0x01EC*/ UINT		BlinkFadeStartTime; \
/*0x01F0*/ bool		bClientClipRectChanged; \
...
// CBazaarSearchWnd_size: 0x92e0 (see 53640D) in Oct  8 2018 Test - eqmule
...
// CPlayerWindow_size: 0x2f8 (see 535D00) in Oct  8 2018 Test - eqmule
...
// CTargetWindow_size: 0x8d8 (see 535B9B) in Oct  8 2018 Test - eqmule
...
// CBuffWindow_size: 0x728 (see 535A3F) in Oct  8 2018 Test - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x330 (see 7E295B) in Oct  8 2018 Test - eqmule
...
// CCastSpellWnd_size: 0x2e0 (see 535DF9) in Oct  8 2018 Test - eqmule
...
// CInvSlotWnd_size: 0x2e0 (see 7E2A6C) in Oct  8 2018 Test - eqmule
...
// CItemDisplayWindow_size: 0x630 (see 743282) in Oct  8 2018 Test - eqmule
...
// CLootWnd_size: 0x3a8 (see 536165) in Oct  8 2018 Test - eqmule
...
// CMapViewWnd_size: 0x668 (see 5358A0) in Oct  8 2018 Test - eqmule
...
// CMerchantWnd_size: 0x458 (see 5362C1) in Oct  8 2018 Test - eqmule
...
// CPetInfoWindow_size: 0x8d8 (see 5352DA) in Oct  8 2018 Test - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3b8 (see 5355CB) in Oct  8 2018 Test - eqmule
...
// CTradeWnd__size: 0x300 (see 536367) in Oct  8 2018 Test - eqmule
