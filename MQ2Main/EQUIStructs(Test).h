...
/*0x0020*/ BYTE         Unknown0x0020[0x2]; \
/*0x0022*/ BYTE         Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x0023*/ BYTE         Unknown0x0023[0x41]; \
/*0x0064*/ BYTE         Minimized; \
/*0x0065*/ BYTE         Unknown0x0065[0xf]; \
/*0x0074*/ struct _CSIDLWND*    pParentWindow; /*CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x0078*/ BYTE         Locked; /*found in CSidlScreenWnd__LoadIniInfo_x*/ \
/*0x0079*/ BYTE         dShow; \
/*0x007a*/ BYTE         Unknown0x007a[0x1a]; \
/*0x0094*/ DWORD        BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x "BGType" in ini */ \
/*0x0098*/ DWORD        HScrollPos; \
/*0x009c*/ BYTE         Unknown0x009c[0x28]; \
/*0x00c4*/ BYTE         MouseOver; /*found in CXWnd__SetMouseOver_x*/ \
/*0x00c5*/ BYTE         Unknown0x00c5[0x3]; \
/*0x00c8*/ DWORD        UnknownCW; /*found in OnProcessFrame*/\
...
/*0x00e8*/ BYTE         Unknown0x00e8[0x2]; \
/*0x00ea*/ BYTE         Faded; \
/*0x00eb*/ BYTE         Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x00ec*/ BYTE         Unknown0x00ec[0x14]; \
/*0x0100*/ DWORD        FadeDuration; \
/*0x0104*/ BYTE         Unknown0x0104[0x14]; \
/*0x0118*/ DWORD        VScrollPos; \
/*0x011c*/ BYTE         Alpha; \
/*0x011d*/ BYTE         Unknown0x011d[0x7]; \
/*0x0124*/ DWORD        VScrollMax; \
/*0x0128*/ BYTE         Unknown0x0128[0x8]; \
/*0x0130*/ RECT         OldLocation; \
/*0x0140*/ struct _CXSTR*       WindowText; /*CXWnd__GetWindowTextA_x has this one*/ \
/*0x0144*/ BYTE         Unknown0x0144[0x1d]; \
/*0x0161*/ BYTE         CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0162*/ BYTE         Unknown0x0162[0x2]; \
...
// Individual Gems 
// Actual Size: 0x2fc (see 76F388) in Dec  2 2014 test - eqmule
...
// Actual Size: 0x2b0 (see 76F499) in Dec  2 2014 test - eqmule
...
//aClasscolorD
// Actual Size: 0x394 (see 49A9E5) in Dec  2 2014 test - eqmule
