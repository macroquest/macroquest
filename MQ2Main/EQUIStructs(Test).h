...
/*0x0050*/ BYTE         Unknown0x0050[0x10]; \
/*0x0060*/ BYTE         CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0061*/ BYTE         Unknown0x0061[0xf]; \
/*0x0070*/ DWORD        TimeMouseOver; \
/*0x0074*/ BYTE         Unknown0x0074[0x4]; \
/*0x0078*/ RECT         OldLocation; \
/*0x0088*/ BYTE         Unknown0x0088[0x18]; \
/*0x00a0*/ DWORD        BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x "BGType" in ini */ \
/*0x00a4*/ BYTE         Unknown0x00a4[0x11]; \
/*0x00b5*/ BYTE         dShow; \
/*0x00b6*/ BYTE         Minimized; \
/*0x00b7*/ BYTE         Unknown0x00b7; \
/*0x00b8*/ DWORD        TickCount2; \
/*0x00bc*/ BYTE         Faded; \
/*0x00bd*/ BYTE         Unknown0x00bd[0x3]; \
/*0x00c0*/ ARGBCOLOR    BGColor; \
/*0x00c4*/ BYTE         ValidCXWnd; /*IsValid has this one*/\
/*0x00c5*/ BYTE         Unknown0x00c5[0x8]; \
/*0x00cd*/ BYTE         Locked; /*found in CSidlScreenWnd__LoadIniInfo_x*/ \
/*0x00ce*/ BYTE         Fades; \
/*0x00cf*/ BYTE         Unknown0x00cf[0xf]; \
/*0x00de*/ BYTE         MouseOver; /*found in CXWnd__SetMouseOver_x*/ \
...
/*0x0180*/ BYTE         Unknown0x0180[0x1c]; \
/*0x019c*/ DWORD        HScrollPos; \
/*0x01a0*/ BYTE         Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x01a1*/ BYTE         Alpha; \
/*0x01a2*/ BYTE         Unknown0x01a2[0x16]; \
/*0x01b8*/ struct _CXSTR*       XMLToolTip; /*found in CSidlManager__CreateLabel_x*/ \
/*0x01bc*/ BYTE         Unknown0x01bc[0xa]; \
/*0x01c6*/ BYTE         Enabled; \
/*0x01c7*/ BYTE         Unknown0x01c7[0x9]; \
