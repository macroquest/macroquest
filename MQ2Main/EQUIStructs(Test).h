...
#define EQ_CHAT_HISTORY_OFFSET 0x278
...
// actual size 0x1DC in Nov 19 2015 Test (see 0x697A12) - eqmule
// actual size 0x1E0 in Nov 25 2015 Test (see 0x697762) - eqmule
...
/*0x0024*/ DWORD        VScrollPos; \
/*0x0028*/ BYTE         Unknown0x0028; \
/*0x0029*/ BYTE         MouseOver; /*found in CXWnd__SetMouseOver_x*/ \
/*0x002a*/ BYTE         Unknown0x002a[0x2]; \
/*0x002c*/ BYTE         ValidCXWnd; /*IsValid has this one*/\
/*0x002d*/ BYTE         Unknown0x002d[0xb]; \
/*0x0038*/ BYTE         dShow; \
/*0x0039*/ BYTE         Unknown0x0039[0x7]; \
/*0x0040*/ DWORD        UnknownCW; /*found in OnProcessFrame*/\
/*0x0044*/ BYTE         Unknown0x0044[0x4]; \
/*0x0048*/ DWORD        VScrollMax; \
/*0x004c*/ BYTE         Unknown0x004c[0x4]; \
/*0x0050*/ DWORD        BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x "BGType" in ini */ \
/*0x0054*/ RECT         OldLocation; \
/*0x0064*/ struct _CXSTR*       Tooltip; /*found in CSidlManager__CreateLabel_x*/ \
/*0x0068*/ struct _CXSTR*       XMLToolTip; /*found in CSidlManager__CreateLabel_x*/ \
/*0x006c*/ BYTE         Unknown0x006c[0x18]; \
/*0x0084*/ DWORD        HScrollPos; \
/*0x0088*/ BYTE         Unknown0x0088[0x10]; \
/*0x0098*/ BYTE         Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0099*/ BYTE         Fades; \
/*0x009a*/ BYTE         Unknown0x009a[0x26]; \
/*0x00c0*/ LPVOID       DrawTemplate; \
/*0x00c4*/ struct _CXSTR*       WindowText; /*CXWnd__GetWindowTextA_x has this one*/ \
/*0x00c8*/ BYTE         Unknown0x00c8[0x8]; \
/*0x00d0*/ DWORD        ZLayer; /*found in CXWndManager__DrawWindows_x*/ \
/*0x00d4*/ BYTE         Unknown0x00d4[0x18]; \
/*0x00ec*/ DWORD        WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x00f0*/ BYTE         Unknown0x00f0[0xc]; \
/*0x00fc*/ ARGBCOLOR    BGColor; \
/*0x0100*/ BYTE         Unknown0x0100[0x14]; \
/*0x0114*/ DWORD        FadeDuration; \
/*0x0118*/ DWORD        TimeMouseOver; \
/*0x011c*/ BYTE         CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x011d*/ BYTE         Unknown0x011d[0x7]; \
/*0x0124*/ BYTE         Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x0125*/ BYTE         Enabled; \
/*0x0126*/ BYTE         Unknown0x0126[0x2a]; \
/*0x0150*/ BYTE         Locked; /*found in CSidlScreenWnd__LoadIniInfo_x*/ \
/*0x0151*/ BYTE         Unknown0x0151[0x3]; \
/*0x0154*/ RECT         Location; \
/*0x0164*/ BYTE         Unknown0x0164[0x4]; \
/*0x0168*/ BYTE         FadeToAlpha; /*found in CSidlScreenWnd__StoreIniInfo_x*/\
/*0x0169*/ BYTE         Unknown0x0169[0x37]; \
/*0x01a0*/ struct _CSIDLWND*    pParentWindow; /*CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x01a4*/ DWORD        TickCount2; \
/*0x01a8*/ BYTE         Unknown0x01a8[0xc]; \
/*0x01b4*/ BYTE         Faded; \
/*0x01b5*/ BYTE         Unknown0x01b5; \
/*0x01b6*/ BYTE         Minimized; \
/*0x01b7*/ BYTE         Unknown0x01b7[0xd]; \
/*0x01c4*/ BYTE         Alpha; \
...
//updated from Dec 02 2015 test exe - eqmule
#define SIDL \
/*0x1c8*/ union { \
...
/*0x1d0*/ LPVOID SidlPiece; /* CScreenPieceTemplate (important) */ \
/*0x1d4*/ union { /*find in CSidlScreenWnd__dCSidlScreenWnd_x*/ \
                struct { \
                        BYTE Checked; \
                        BYTE Highlighted; \
                        BYTE Unused0x1d6[0x2]; \
                }; \
                DWORD MaxChars; \
        }; \
/*0x1d8*/ DWORD TextureAnim; \
/*0x1dc*/ struct  _CXSTR* InputText; /*found in CChatWindow__CChatWindow_x*/\
/*0x1e0*/ DWORD Selector; /*found in CSidlScreenWnd__CSidlScreenWnd1_x*/\
/*0x1e4*/ DWORD PushToSelector; /*found in CSidlScreenWnd__LoadIniInfo_x*/\
/*0x1e8*/ DWORD EnableINIStorage; /*found in CSidlScreenWnd__LoadSidlScreen_x*/\
/*0x1ec*/ union { \
                struct _CXSTR* INIStorageName; /*found in CSidlScreenWnd__LoadSidlScreen_x*/\
                struct _EQINVSLOT* pEQInvSlot; \
        }; \
/*0x1f0*/ BYTE  Unknown0x1f0[0x10];  \
/*0x200*/ LPVOID ContextMenu; /* CTextureAnimation */ \
/*0x204*/ DWORD Unknown0x204; /* CTextureAnimation */ \
/*0x208*/ DWORD Unknown0x208; /* CTextureAnimation */ \
...
// size 0x270 Dec 02 2015 (see 684B5B) -eqmule
#define CONTEXTTAIL \
/*0x210*/ DWORD ZeroMe; \
/*0x214*/ DWORD SetToMinus1; /*must be set to -1 in constructor or menu wndnotification wont be called*/ \
/*0x218*/ DWORD WillBeZero1; /*set by contructor to 0*/ \
/*0x21c*/ ARGBCOLOR HightLightTextColor; /*set by contructor*/ \
/*0x220*/ ARGBCOLOR HighLightTextBkColor; /*set by contructor*/ \
/*0x224*/ BYTE ZeroMeOut1[0x24]; \
/*0x248*/ DWORD WillBeZero2; /*constructor sets this to 0*/ \
/*0x24c*/ BYTE ZeroMeOut2[0x18]; \
/*0x264*/ DWORD Unknown0x264; /*constructor sets this to 0x10000*/ \
/*0x268*/ DWORD ZeroMeAsWell; \
/*0x26c*/ DWORD Unknown0x26c; /*constructor sets this to 0*/ \
/*0x270*/
...
//size is 0x25c see 8DEEFE in eqgame.exe dated 02 Dec 2015 - eqmule
typedef struct _CBUTTONWND {
	/*0x000*/ struct    _CXWND Wnd;
	/*0x1c8*/ BYTE      Unknown[0x4];
	/*0x1cc*/ BYTE      State;        //1=down 0=up
	/*0x1cd*/ BYTE      Unknown0x1cd; //something to do with State
	/*0x1ce*/ BYTE      Unknown0x1ce[0x12];
	/*0x1e0*/ ARGBCOLOR Color;
	/*0x1e4*/ BYTE      Unknown0x1e4[0x58];
	/*0x23c*/ DWORD     TextureAnim;//im guessing now but I think this is the icon displayed use iconcache->geticon to fill it in...
	/*0x240*/ BYTE      Unknown0x240[0x1c];
	/*0x25c*/
...
//size 0x2CC see 4BCDF7 in Dec 02 2015 -eqmule
typedef struct _EQADVLOOTWND {
	/*0x000*/ struct _CSIDLWND     Wnd;
	/*0x210*/ BYTE	Unknown0x0220[0x94];
	/*0x2a4*/ struct _LOOTLIST *pCLootList;//below ref to aAdlw_applyfilt
	/*0x2a8*/ struct _LOOTLIST *pPLootList;//below ref to aAdlw_cllwnd
	/*0x2ac*/ BYTE		Unknown0x2bc[0xc];
	/*0x2b8*/ DWORD		PListCount;
	/*0x2bc*/ BYTE		Unknown0x2cc[0x4];
	/*0x2c0*/ DWORD		ContextMenuId;
	/*0x2c4*/ BYTE		Unknown0x2d4[0x8];
	/*0x2cc*/
...
// Actual Size: 0x92ac (see 4BAE55) in Dec  2 2015 Test - eqmule
typedef struct _BAZAARSEARCHWND {
	/*0x0000*/ struct _CSIDLWND     Wnd;
	/*0x0210*/ BYTE         Unknown0x0210[0x8ff8];
	/*0x9208*/ void **      ppTraderData;
	/*0x920c*/ DWORD        hashVal;//find in CBazaarSearchWnd__HandleBazaarMsg_x
	/*0x9210*/ BYTE         Unknown0x9210[0x9c];
	/*0x92ac*/
...
// Actual Size: 0x2c8 (see 4BA73E) in Dec  2 2015 Test - eqmule
typedef struct _CPLAYERWND {
	/*0x0000*/ struct _CSIDLWND     Wnd;
	/*0x0210*/ BYTE         Unknown0x0210[0xb4];
	/*0x02c4*/ DWORD        CombatState;   // 1=debuffed, 2=combat cooldown, 3=stand, 4=sit
	/*0x02c8*/
} CPLAYERWND, *PCPLAYERWND;

// CTargetWindow__CTargetWindow aTargetwindow
// Actual Size: 0x8a4 (see 4BA5D2) in Dec  2 2015 Test - eqmule
typedef struct _CTARGETWND {
	/*0x0000*/ struct _CSIDLWND     Wnd;
	/*0x0210*/ BYTE         Unknown0x0210[0x198];
	/*0x03a8*/ struct _CBUTTONWND * pTargetBuff[NUM_BUFF_SLOTS]; // buff icons
	/*0x052c*/ int          BuffSpellID[NUM_BUFF_SLOTS]; // 0xffffffff if no buff
	/*0x06b0*/ DWORD        BuffTimer[NUM_BUFF_SLOTS];
	/*0x0834*/ BYTE         Unknown0x0834[0x24];
	/*0x0858*/ DWORD        Type;              // 1 = self, 4 = group member, 5 = PC, 7 = NPC
	/*0x085c*/ BYTE         Unknown0x085c[0x48];
	/*0x08a4*/
} CTARGETWND, *PCTARGETWND;

// CBuffWindow__CBuffWindow aBuffwindow
// this is used for both long and shortbuffs...
// Actual Size: 0x6f8 (see 4BA466) in Dec  2 2015 Test - eqmule
typedef struct _EQBUFFWINDOW {
	/*0x0000*/ struct _CSIDLWND     Wnd;
	/*0x0210*/ BYTE         Unknown0x0210[0xbc];
	/*0x02cc*/ struct _CBUTTONWND * pBuff[0x24];    // CButton*
	/*0x035c*/ BYTE         Unknown0x035c[0x210];
	/*0x056c*/ DWORD        BuffId[NUM_LONG_BUFFS];
	/*0x0614*/ DWORD        BuffTimer[NUM_LONG_BUFFS];
	/*0x06bc*/ BYTE         Unknown0x06bc[0x28];
	/*0x06e4*/ DWORD        MaxLongBuffs;           //0x2a (NUM_LONG_BUFFS)
	/*0x06e8*/ DWORD        MaxShortBuffs;          //0x37 (NUM_SHORT_BUFFS)
	/*0x06ec*/ BYTE         Unknown0x06ec[0xc];
	/*0x06f8*/
} EQBUFFWINDOW, *PEQBUFFWINDOW;

// CSpellGemWnd__CSpellGemWnd
// Individual Gems 
// Actual Size: 0x2f4 (see 79D398) in Dec  2 2015 aSpelldisplaywi - eqmule
typedef struct _EQCASTSPELLGEM {
	/*0x0000*/ struct _CXWND        Wnd;
	/*0x01c8*/ BYTE         Unknown0x01c8[0x44];
	/*0x020c*/ DWORD        TimeStamp;
	/*0x0210*/ DWORD        RecastTime;
	/*0x0214*/ BYTE         Unknown0x0214[0xb4];
	/*0x02c8*/ DWORD        spellicon;       //if this is equal to FFFFFFFF there is no spell memmed in this slot...
	/*0x02cc*/ DWORD        spellstate;      // 1 = cast in progress or refreshtime not met 2 means we ducked or aborted cast, 0 means its ok to cast
	/*0x02d0*/ BYTE         Unknown0x02d0[0x24];
	/*0x02f4*/
} EQCASTSPELLGEM, *PEQCASTSPELLGEM;

//pinstCCastSpellWnd_x
// CCastSpellWnd__CCastSpellWnd aCastspellwnd
// Actual Size: 0x2a0 (see 4BA852) in Dec  2 2015 Test - eqmule
typedef struct _EQCASTSPELLWINDOW {
	/*0x0000*/ struct _CSIDLWND     Wnd;
	/*0x0210*/ BYTE         Unknown0x0210[0x14];
	/*0x0224*/ struct _EQCASTSPELLGEM *     SpellSlots[NUM_SPELL_GEMS];//CSPW_Spell%d
	/*0x0254*/ BYTE         Unknown0x0254[0x4c];
	/*0x02a0*/
} EQCASTSPELLWINDOW, *PEQCASTSPELLWINDOW;

// Actual Size: 0x2a8 (see 79D4A9) in Dec  2 2015 Test - eqmule
typedef struct _EQINVSLOTWND {
	/*0x0000*/ struct _CXWND        Wnd;      //----/ actually CButtonWnd
	/*0x01c8*/ BYTE         Unknown0x01c8[0x88];
	/*0x0250*/ BYTE         Unknown0x0250[0x10];
	/*0x0260*/ LONG         WindowType;        // ieatacid has this as InventoryType
											   // 00 for inventory
											   // 01 for bank
											   // 02 for shared bank
	...
	/*0x0264*/ WORD         InvSlot;
	/*0x0266*/ WORD         BagSlot;
	/*0x0268*/ WORD         GlobalSlot;
	/*0x026a*/ WORD         RandomNum;              //no idea what this is, it changes upon login but we need it for moveitem... -eqmule
	/*0x026c*/ BYTE         Unknown0x026c[0x20];
	/*0x028c*/ struct _EQINVSLOT *  pInvSlot;
	/*0x0290*/ BYTE         Unknown0x0290[0x8];
	/*0x0298*/ BOOL         ProcessClick;
	/*0x029c*/ BYTE         Unknown0x029c[0xc];
	/*0x02a8*/
} EQINVSLOTWND, *PEQINVSLOTWND;

// CItemDisplayWindow__CItemDisplayWindow aItemdisplaywin
// Actual Size: 0x5f0 (see 6E699F) in Dec  2 2015 aItemdisplaywin - eqmule
typedef struct _EQITEMWINDOW {
	/*0x0000*/ struct _CSIDLWND     Wnd;
	/*0x0210*/ struct _CSIDLWND *   DisplayWnd;//ItemDescription
	/*0x0214*/ BYTE         Unknown0x0214[0x4];
	/*0x0218*/ struct _CSIDLWND *   IconButton;
	/*0x021c*/ struct _CSIDLWND *   ItemLore;
	/*0x0220*/ struct _CSIDLWND *   ItemDescriptionTabBox;
	/*0x0224*/ struct _CSIDLWND *   ItemDescriptionTab;
	/*0x0228*/ struct _CSIDLWND *   ItemLoreTab;
	/*0x022c*/ BYTE         Unknown0x022c[0x58];
	/*0x0284*/ PCXSTR       ItemInfo;//this item is placable in yards, guild yards blah blah , This item can be used in tradeskills
	/*0x0288*/ PCXSTR       WindowTitle;
	/*0x028c*/ PCXSTR       ItemAdvancedLoreText;
	/*0x0290*/ PCXSTR       ItemMadeByText;
	/*0x0294*/ PCXSTR       UnknownCXStr; // if this is NULL don't populate item data in MQ2ItemDisplay
	/*0x0298*/ BYTE         Unknown0x0298[0x4];
	/*0x029c*/ PCXSTR       ItemInformationText;//Item Information: Placing this augment into blah blah, this armor can only be used in blah blah
	/*0x02a0*/ PCONTENTS    pItem;
	/*0x02a4*/ BYTE         Unknown0x02a4[0x348];
	/*0x05ec*/ DWORD        ItemWndIndex;//0-5? you can have max 6 windows up I think before it starts overwriting the sixth.
	/*0x05f0*/
} EQITEMWINDOW, *PEQITEMWINDOW;

//CLootWnd__CLootWnd aLootwnd
// Actual Size: 0x398 (see 4BAC27) in Dec  2 2015 Test - eqmule
typedef struct _EQLOOTWINDOW {
	/*0x0000*/ struct _CSIDLWND     Wnd;
	/*0x0210*/ void *       vftable; // for CLootWnd::DialogResponse handler
	/*0x0214*/ BYTE         Unknown0x0214[0x9c];
	/*0x02b0*/ DWORD        NumOfSlots;
	/*0x02b4*/ BYTE         Unknown0x02b4[0x4];
	/*0x02b8*/ struct _INVENTORYARRAY *     pInventoryArray;
	/*0x02bc*/ DWORD        NumOfSlots2;
	/*0x02c0*/ DWORD        NumOfSlots3;
	/*0x02c4*/ BYTE         Unknown0x02c4[0x24];
...
// Actual Size: 0x604 (see 4BA2C7) in Dec  2 2015 Test - eqmule
typedef struct _EQMAPWINDOW {
	/*0x0000*/ struct _CSIDLWND     Wnd;
	/*0x0210*/ BYTE         Unknown0x0210[0x40];
	/*0x0250*/ CHAR         shortzonename[0x20];
	/*0x0270*/ BYTE         Unknown0x0270[0x9c];
	/*0x030c*/ struct _CXWND *      wnd;           // its the MVW_MapRenderArea window... found at aMvw_maprendera
	/*0x0310*/ BYTE         Unknown0x0310[0x38];
	/*0x0348*/ struct _CSIDLWNDVFTABLE *    pMapViewMapVfTable; // found at aMapviewmap
	/*0x034c*/ BYTE         Unknown0x034c[0x23c];
	/*0x0588*/ PMAPLINE     pLines;     //0x240
	/*0x058c*/ PMAPLABEL    pLabels;    //0x254
	/*0x0590*/ BYTE         Unknown0x0590[0x74];
	/*0x0604*/
...
// Actual Size: 0x2ac (see 4BAD41) in Dec  2 2015 aSDeliveryRecei - eqmule
typedef struct _EQMERCHWINDOW {
	/*0x0000*/ struct _CSIDLWND     Wnd;
	/*0x0210*/ BYTE         Unknown0x0210[0x10];
	/*0x0220*/ merch_other *        pMerchOther;//found in CMerchantWnd__CMerchantWnd
	/*0x0224*/ BYTE         Unknown0x0224[0x8];
	/*0x022c*/ FLOAT        Markup;//found in CMerchantWnd__DisplayBuyOrSellPrice_x
	/*0x0230*/ BYTE         Unknown0x0230[0xc];
	/*0x023c*/ DWORD        SelectedSlotID;//found in CMerchantWnd__RequestBuyItem_x
	/*0x0240*/ BYTE         Unknown0x0240[0x6c];
	/*0x02ac*/
} EQMERCHWINDOW, *PEQMERCHWINDOW;

//CPetInfoWindow__CPetInfoWindow aPetinfowindow
// Actual Size: 0x910 (see 4B9D02) in Dec  2 2015 Test - eqmule
typedef struct _EQPETINFOWINDOW {
	/*0x0000*/ struct _CSIDLWND     Wnd;
	/*0x0210*/ BYTE         Unknown0x0210[0x8];
	/*0x0218*/ DWORD        PetSpawnID;//The pets SpawnID
	/*0x021c*/ BYTE         Unknown0x021c[0x8];
	/*0x0224*/ struct _CBUTTONWND * pButton[0xe];//there are 14 buttons on the petinfowin with text that can be set to attack,none,back and so on, these are those...
	/*0x025c*/ BYTE         Unknown0x025c[0x8];
	/*0x0264*/ struct _CBUTTONWND * pAttackButton;//if 0 its not assigned.
	/*0x0268*/ struct _CBUTTONWND * pQAttackButton;//if 0 its not assigned.
	/*0x026c*/ struct _CBUTTONWND * pFollowButton;//if 0 its not assigned.
	/*0x0270*/ struct _CBUTTONWND * pGuardButton;//if 0 its not assigned.
	/*0x0274*/ struct _CBUTTONWND * pSitButton;//if 0 its not assigned.
	/*0x0278*/ struct _CBUTTONWND * pStopButton;//if 0 its not assigned.
	/*0x027c*/ BYTE         Unknown0x027c[0x1bc];
	/*0x0438*/ struct _CSIDLWND *   pWnd[NUM_BUFF_SLOTS]; // buff icons?
	/*0x05bc*/ int          Buff[NUM_BUFF_SLOTS];        // Spell ID# of each buff -- 97 total
	/*0x0740*/ BYTE         Unknown0x0740[0x20];
	/*0x0760*/ DWORD        PetBuffTimer[NUM_BUFF_SLOTS]; // duration until buff fades, in thousands of a second
	/*0x08e4*/ BYTE         Unknown0x08e4[0x1f];
	/*0x0903*/ BYTE         Sit;//0/1 is off/on
	/*0x0904*/ BYTE         Stop;//0/1 is off/on
	/*0x0905*/ BYTE         ReGroup;//0/1 is off/on
	/*0x0906*/ BYTE         Follow;//0/1 is off/on
	/*0x0907*/ BYTE         Guard;//0/1 is off/on
	/*0x0908*/ BYTE         Taunt;//0/1 is off/on
	/*0x0909*/ BYTE         Hold;//0/1 is off/on
	/*0x090a*/ BYTE         GHold;//0/1 is off/on
	/*0x090b*/ BYTE         Focus;//0/1 is off/on
	/*0x090c*/ BYTE         Unknown0x090c[0x4];
	/*0x0910*/
} EQPETINFOWINDOW, *PEQPETINFOWINDOW;

//CRaidWindow__CRaidWindow
//aClasscolorD
// Actual Size: 0x384 (see 4B9FF5) in Dec  2 2015 Test - eqmule
typedef struct _EQRAIDWINDOW {
	/*0x0000*/ struct _CSIDLWND     Wnd;
	/*0x0210*/ BYTE         Unknown0x0210[0xb8];
	/*0x02c8*/ DWORD        ClassColors[0x10];
	/*0x0308*/ BYTE         Unknown0x0308[0x7c];
	/*0x0384*/
} EQRAIDWINDOW, *PEQRAIDWINDOW;

//CTradeWnd__CTradeWnd aTradewnd
// Actual Size: 0x2f0 (see 4BAD9D) in Dec  2 2015 Test - eqmule
typedef struct _EQTRADEWINDOW {
	/*0x0000*/ struct _CSIDLWND     Wnd;
	/*0x0210*/ BYTE         Unknown0x0210[0xd8];
