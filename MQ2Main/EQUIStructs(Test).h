...
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ UINT		LastBlinkFadeRefreshTime; \
/*0x0020*/ __int64		Data; \
/*0x0028*/ int	Transition; \
/*0x002C*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x002D*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x002E*/ bool		dShow; \
...
/*0x007C*/ bool		Faded; \
/*0x007D*/ bool		Fades; \
/*0x007E*/ bool		bCaptureTitle; \
/*0x007F*/ BYTE     bResizableMask; \
/*0x0080*/ BYTE		Alpha; \
/*0x0081*/ BYTE		TargetAlpha; \
...
/*0x00A4*/ bool		bScreenClipRectChanged; \
/*0x00A5*/ bool		bActive; \
/*0x00A6*/ bool		bLeftAnchoredToLeft; \
...
/*0x00D5*/ bool		bIsTransitioning; \
/*0x00D6*/ bool		bRightAnchoredToLeft; \
/*0x00D7*/ bool		bTiled; \
/*0x00D8*/ int		BlinkState; \
/*0x00DC*/ bool		bTopAnchoredToTop; \
/*0x00DD*/ bool		bAction; \
/*0x00E0*/ void   *TitlePiece; \
/*0x00E4*/ DWORD	XMLIndex; \
/*0x00E8*/ tagSIZE	MaxClientSize; \
/*0x00F0*/ struct _CSIDLWND* pWndFocusOther; \
/*0x00F4*/ bool		bHCenterTooltip; \
/*0x00F5*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
...
/*0x010C*/ bool		bIsParentOrContextMenuWindow; \
...
/*0x01D0*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x01D4*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x01D8*/ RECT		TransitionRect; \
/*0x01E8*/ bool		bClientClipRectChanged; \
...
// CBazaarSearchWnd_size: 0x92d8 (see 54334D) in Mar  5 2019 Test - eqmule
...
// CPlayerWindow_size: 0x2f0 (see 542C3E) in Mar  5 2019 Test - eqmule
...
// CTargetWindow_size: 0x8d0 (see 542AD2) in Mar  5 2019 Test - eqmule
...
// CBuffWindow_size: 0x720 (see 542976) in Mar  5 2019 Test - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x328 (see 7F437B) in Mar  5 2019 Test - eqmule
...
// CCastSpellWnd_size: 0x2d8 (see 542D37) in Mar  5 2019 Test - eqmule
...
// CInvSlotWnd_size: 0x2d8 (see 7F448C) in Mar  5 2019 Test - eqmule
...
// CItemDisplayWindow_size: 0x630 (see 7546D2) in Mar  5 2019 Test - eqmule
...
// CLootWnd_size: 0x3a0 (see 5430A5) in Mar  5 2019 Test - eqmule
...
// CMapViewWnd_size: 0x658 (see 5427D7) in Mar  5 2019 Test - eqmule
...
// CMerchantWnd_size: 0x450 (see 543201) in Mar  5 2019 Test - eqmule
...
// CPetInfoWindow_size: 0x8d0 (see 542211) in Mar  5 2019 Test - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3b0 (see 542502) in Mar  5 2019 Test - eqmule
...
// CTradeWnd__size: 0x2f8 (see 5432A7) in Mar  5 2019 Test - eqmule
...
// CFactionWnd__size: 0x280 (see 5433F3) in Mar  5 2019 Test - eqmule
