...
// actual size 0x1E8 in Aug 16 2018 Test (see 0x91EC1D) - eqmule
// actual size 0x1F0 in Sep  4 2018 Test (see 0x91F55D) - eqmule
// actual size 0x1E0 in Sep 25 2018 Test (see 0x920A9D) - eqmule
...
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ void   *TitlePiece2; \
/*0x0020*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0024*/ RECT		OldLocation; \
/*0x0034*/ BYTE		Alpha; \
/*0x0035*/ BYTE		TargetAlpha; \
/*0x0038*/ UINT		TransitionDuration; \
/*0x003C*/ bool		dShow; \
/*0x0040*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0044*/ struct _CSIDLWND* pWndFocusOther; \
/*0x0048*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x004C*/ void	*DrawTemplate; \
/*0x0050*/ bool		bScreenClipRectChanged; \
/*0x0051*/ bool		bClientRectChanged; \
/*0x0052*/ bool		bCaptureTitle; \
/*0x0054*/ tagSIZE	MinClientSize; \
/*0x005C*/ int		BottomOffset; \
/*0x0060*/ bool		bMarkedForDelete; \
/*0x0061*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x0062*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x0064*/ int		BlinkDuration; \
/*0x0068*/ int		HScrollMax; \
/*0x006C*/ struct _CXSTR*	DataStr; \
/*0x0070*/ bool		bKeepOnScreen; \
/*0x0071*/ bool		bBottomAnchoredToTop; \
/*0x0074*/ int		VScrollPos; \
/*0x0078*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x007C*/ DWORD	LastTimeMouseOver; \
/*0x0080*/ tagSIZE	MaxClientSize; \
/*0x0088*/ UINT		TransitionStartTick; \
/*0x008C*/ bool		bRightAnchoredToLeft; \
/*0x0090*/ RECT		ClipRectScreen; \
/*0x00A0*/ UINT		BlinkFadeFreq; \
/*0x00A4*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
/*0x00A8*/ bool		bBringToTopWhenClicked; \
/*0x00A9*/ bool		bAction; \
/*0x00AA*/ bool		bTopAnchoredToTop; \
/*0x00AB*/ bool		bIsParentOrContextMenuWindow; \
/*0x00AC*/ bool		bTiled; \
/*0x00AD*/ bool		Fades; \
/*0x00AE*/ bool		bUseInLayoutVertical; \
/*0x00B0*/ DWORD  BackgroundDrawType; \
/*0x00B4*/ int		managerArrayIndex; \
/*0x00B8*/ int		ParentAndContextMenuArrayIndex; \
/*0x00BC*/ bool		bClientClipRectChanged; \
/*0x00BD*/ bool		bClipToParent; \
/*0x00BE*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x00C0*/ __int64		Data; \
/*0x00C8*/ bool		Faded; \
/*0x00C9*/ bool		bFullyScreenClipped; \
/*0x00CA*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x00CB*/ bool		bBorder2; \
/*0x00CC*/ void	*IconTextureAnim; \
/*0x00D0*/ UINT		FadeDuration; \
/*0x00D4*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x00D8*/ RECT		TransitionRect; \
/*0x00E8*/ UINT		BlinkFadeDuration; \
/*0x00EC*/ int		HScrollPos; \
/*0x00F0*/ bool		bEscapableLocked; \
/*0x00F4*/ int	Transition; \
/*0x00F8*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x00FC*/ UINT		LastBlinkFadeRefreshTime; \
/*0x0100*/ bool		bBorder; \
/*0x0104*/ void		*pLayoutStrategy; \
/*0x0108*/ DWORD	FadeDelay; \
/*0x010C*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x1c */ \
/*0x0128*/ int		DeleteCount; \
/*0x012C*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x0130*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0134*/ int		VScrollMax; \
...
/*0x0149*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x014A*/ bool		bActive; \
/*0x014C*/ DWORD	XMLIndex; \
/*0x0150*/ RECT		ClipRectClient; \
/*0x0160*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x0164*/ void* pTipTextObject; \
/*0x0168*/ void   *TitlePiece; \
/*0x016C*/ BYTE		StartAlpha; \
/*0x0170*/ int		TopOffset; \
/*0x0174*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x0178*/ void	    *pFont; \
/*0x017C*/ RECT		Location; \
/*0x018C*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x018D*/ bool		bMaximized; \
/*0x018E*/ bool		bMaximizable; \
/*0x0190*/ void*	pTextObject; \
/*0x0194*/ bool		Enabled; \
/*0x0195*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0196*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x0197*/ bool		bLeftAnchoredToLeft; \
/*0x0198*/ int		BlinkState; \
/*0x019C*/ LONG		BlinkStartTimer; \
/*0x01A0*/ RECT		IconRect; \
/*0x01B0*/ int		LeftOffset; \
/*0x01B4*/ RECT		ClientRect; \
/*0x01C4*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x01C8*/ UINT		BlinkFadeStartTime; \
/*0x01CC*/ BYTE     bResizableMask; \
/*0x01CD*/ BYTE		FadeAlpha; \
/*0x01CE*/ bool		Minimized; \
/*0x01CF*/ bool		bIsTransitioning; \
/*0x01D0*/
...
/*0x1dc*/ int Unknown0x1ec;
/*0x1e0*/ PCXSTR Text;
/*0x1e4*/ int Unknown0x1f4;
/*0x1e8*/ bool Unknown0x1f8;
/*0x1ec*/ int Unknown0x1fc;
/*0x1f0*/ //begin CLABEL
...
/*0x0228*/ PCXSTR Name;
/*0x022c*/ void   *Normal;//CTextureAnimation
/*0x0230*/ void   *taPressed;
/*0x0234*/ void   *Flyby;
/*0x0238*/ void   *taDisabled;
/*0x023c*/ void   *PressedFlyby;
/*0x0240*/ void   *PressedDisabled;
/*0x0244*/ void   *NormalDecal;
/*0x0248*/ void   *PressedDecal;
/*0x024c*/ void   *FlybyDecal;
/*0x0250*/ void   *DisabledDecal;
/*0x0254*/ void   *PressedFlybyDecal;
/*0x0258*/ void   *PressedDisabledDecal;
/*0x025c*/ bool		bAllowButtonClickThrough;
/*0x025d*/ bool		bCoolDownDoDelayedStart;
/*0x025e*/ bool		bIsCheckbox;
/*0x025f*/ bool		bIsDrawLasso;
/*0x0260*/ UINT		ButtonStyle;
/*0x0264*/ PCLABEL	pButtonLabel;
/*0x0268*/
...
// CBazaarSearchWnd_size: 0x92b8 (see 535F3D) in Oct 26 2018 Test - eqmule
...
// CPlayerWindow_size: 0x2d0 (see 535830) in Oct 26 2018 Test - eqmule
...
// CTargetWindow_size: 0x8b0 (see 5356CB) in Oct 26 2018 Test - eqmule
...
// CBuffWindow_size: 0x700 (see 53556F) in Oct 26 2018 Test - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x308 (see 7E19FB) in Oct 26 2018 Test - eqmule
...
// CCastSpellWnd_size: 0x2b8 (see 535929) in Oct 26 2018 Test - eqmule
...
// CInvSlotWnd_size: 0x2b8 (see 7E1B0C) in Oct 26 2018 Test - eqmule
typedef struct _EQINVSLOTWND {
/*0x0000*/ struct _CXWND        Wnd;      //----/ actually CButtonWnd
/*0x01d0*/ BYTE         Unknown0x01d0[0x8c];
/*0x025c*/ BYTE         Unknown0x025c[0x10];
/*0x026c*/ LONG         WindowType;
											// 00 for inventory
											// 01 for bank
											// 02 for shared bank
											...
											// 11 for loot window
/*0x0270*/ short         InvSlot;
/*0x0272*/ short         BagSlot;
/*0x0274*/ short         GlobalSlot;
/*0x0276*/ short         RandomNum;              //no idea what this is, it changes upon login but we need it for moveitem... -eqmule
/*0x0278*/ BYTE         Unknown0x0278[0x20];
/*0x0298*/ struct _EQINVSLOT *  pInvSlot;
/*0x029c*/ BYTE         Unknown0x029c[0x8];
/*0x02a4*/ BOOL         ProcessClick;
/*0x02a8*/ BYTE         Unknown0x02a8[0x10];
/*0x02b8*/
} EQINVSLOTWND, *PEQINVSLOTWND;

// CItemDisplayWindow__CItemDisplayWindow aItemdisplaywin
// CItemDisplayWindow_size: 0x608 (see 742332) in Oct 26 2018 Test - eqmule
...
// CLootWnd_size: 0x380 (see 535C95) in Oct 26 2018 Test - eqmule
...
// CMapViewWnd_size: 0x618 (see 5353D0) in Oct 26 2018 Test - eqmule
...
// CMerchantWnd_size: 0x430 (see 535DF1) in Oct 26 2018 Test - eqmule
...
// CPetInfoWindow_size: 0x8b0 (see 534E0A) in Oct 26 2018 Test - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x390 (see 5350FB) in Oct 26 2018 Test - eqmule
...
// CTradeWnd__size: 0x2d8 (see 535E97) in Oct 26 2018 Test - eqmule
