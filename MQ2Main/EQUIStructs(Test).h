...
// actual size 0x1E8 in Jun 21 2019 Test (see 0x933BFD) - eqmule
// actual size 0x1D0 in Jul  8 2019 Test (see 0x940ACD) - eqmule
// actual size 0x1F0 in Jul 10 2019 Test (see 0x93F0FD) - eqmule
// actual size 0x1E0 in Jul 12 2019 Test (see 0x940C3D) - eqmule
#define CXW_NO_VTABLE \
private: \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ UINT		BlinkFadeDuration; \
/*0x0020*/ COLORREF DisabledBackground; \
/*0x0024*/ bool		bBottomAnchoredToTop; \
/*0x0025*/ BYTE		TargetAlpha; \
/*0x0028*/ RECT		ClientRect; \
/*0x0038*/ RECT		OldLocation; \
/*0x0048*/ BYTE		Alpha; \
/*0x004C*/ UINT		LastBlinkFadeRefreshTime; \
/*0x0050*/ UINT		BlinkFadeFreq; \
/*0x0054*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x0055*/ bool		bBringToTopWhenClicked; \
/*0x0058*/ DWORD	XMLIndex; \
/*0x005C*/ void	    *pFont; \
/*0x0060*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x0061*/ BYTE		FadeAlpha; \
/*0x0064*/ DWORD	FadeDelay; \
/*0x0068*/ int		BlinkState; \
/*0x0070*/ __int64		Data; \
/*0x0078*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x007C*/ LONG		BlinkStartTimer; \
/*0x0080*/ bool		bAction; \
/*0x0084*/ tagSIZE	MinClientSize; \
/*0x008C*/ RECT		IconRect; \
/*0x009C*/ bool		bLeftAnchoredToLeft; \
/*0x00A0*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x00B8*/ void* pTipTextObject; \
/*0x00BC*/ bool		bRightAnchoredToLeft; \
/*0x00C0*/ DWORD	LastTimeMouseOver; \
/*0x00C4*/ bool		bIsParentOrContextMenuWindow; \
/*0x00C5*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x00C8*/ UINT		BlinkFadeStartTime; \
/*0x00CC*/ bool		bUseInLayoutHorizontal; \
/*0x00CD*/ bool		bMaximized; \
/*0x00CE*/ bool		bCaptureTitle; \
/*0x00CF*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x00D0*/ bool		bBorder; \
/*0x00D4*/ UINT		TransitionDuration; \
/*0x00D8*/ void   *TitlePiece2; \
/*0x00DC*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
...
/*0x0135*/ bool		bScreenClipRectChanged; \
/*0x0136*/ BYTE     bResizableMask; \
/*0x0137*/ bool		bEscapableLocked; \
/*0x0138*/ int		TopOffset; \
/*0x013C*/ struct _CSIDLWND* pWndFocusOther; \
/*0x0140*/ void		*pLayoutStrategy; \
/*0x0144*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x0145*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0146*/ bool		Enabled; \
/*0x0147*/ bool		Minimized; \
/*0x0148*/ int		VScrollPos; \
/*0x014C*/ RECT		TransitionRect; \
...
/*0x0168*/ tagSIZE	MaxClientSize; \
/*0x0170*/ void	*DrawTemplate; \
/*0x0174*/ int	Transition; \
/*0x0178*/ bool		bFullyScreenClipped; \
/*0x0179*/ bool		bBorder2; \
/*0x017C*/ int		HScrollMax; \
/*0x0180*/ bool		bClientClipRectChanged; \
/*0x0181*/ bool		bHCenterTooltip; \
...
/*0x0194*/ bool		bTopAnchoredToTop; \
/*0x0198*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x019C*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x019D*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x019E*/ bool		bMaximizable; \
/*0x01A0*/ void*	pTextObject; \
/*0x01A4*/ int		managerArrayIndex; \
/*0x01A8*/ bool		bKeepOnScreen; \
...
// CBazaarSearchWnd_size: 0x92c8 (see 54328D) in Jul 12 2019 Test - eqmule
...
// CPlayerWindow_size: 0x2e0 (see 542B7E) in Jul 12 2019 Test - eqmule
...
// CTargetWindow_size: 0x8c0 (see 542A15) in Jul 12 2019 Test - eqmule
...
// CBuffWindow_size: 0x710 (see 5428B9) in Jul 12 2019 Test - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x318 (see 7F79DB) in Jul 12 2019 Test - eqmule
...
// CCastSpellWnd_size: 0x2c8 (see 542C77) in Jul 12 2019 Test - eqmule
...
// CInvSlotWnd_size: 0x2c8 (see 7F7AEC) in Jul 12 2019 Test - eqmule
...
// CItemDisplayWindow_size: 0x620 (see 757772) in Jul 12 2019 Test - eqmule
...
// CLootWnd_size: 0x390 (see 542FE5) in Jul 12 2019 Test - eqmule
...
// CMapViewWnd_size: 0x638 (see 54271A) in Jul 12 2019 Test - eqmule
...
// CMerchantWnd_size: 0x440 (see 543141) in Jul 12 2019 Test - eqmule
...
// CPetInfoWindow_size: 0x8c0 (see 542171) in Jul 12 2019 Test - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a0 (see 542462) in Jul 12 2019 Test - eqmule
...
// CTradeWnd__size: 0x2e8 (see 5431E7) in Jul 12 2019 Test - eqmule
...
// CFactionWnd__size: 0x270 (see 543333) in Jul 12 2019 Test - eqmule
