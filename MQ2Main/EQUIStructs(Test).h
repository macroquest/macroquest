...
/*0x0024*/ BYTE         Locked; /*found in CSidlScreenWnd__LoadIniInfo_x*/ \
/*0x0025*/ BYTE         Unknown0x0025; \
/*0x0026*/ BYTE         CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0027*/ BYTE         Unknown0x0027[0x11]; \
/*0x0038*/ DWORD        HScrollMax; \
/*0x003c*/ BYTE         Enabled; \
...
/*0x006d*/ BYTE         Unknown0x006d[0x13]; \
/*0x0080*/ BYTE         Faded; \
...
/*0x01ac*/ BYTE         Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x01ad*/ BYTE         ValidCXWnd; /*IsValid has this one*/\
/*0x01ae*/ BYTE         Unknown0x01ae[0x7]; \
/*0x01b5*/ BYTE         MouseOver; /*found in CXWnd__SetMouseOver_x*/ \
/*0x01b6*/ BYTE         Unknown0x01b6[0x1e]; \
