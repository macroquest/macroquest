...
/*0x0068*/ BYTE		TargetAlpha; \
/*0x0069*/ bool		Enabled; \
/*0x006A*/ BYTE		StartAlpha; \
/*0x006B*/ BYTE     bResizableMask; \
/*0x006C*/ bool		bLeftAnchoredToLeft; \
/*0x006D*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x0070*/ RECT		TransitionRect; \
/*0x0080*/ bool		Fades; \
/*0x0084*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x009C*/ bool		bBottomAnchoredToTop; \
...
/*0x00A5*/ bool		bMarkedForDelete; \
/*0x00A8*/ struct _CXSTR*	DataStr; \
/*0x00AC*/ LONG		BlinkStartTimer; \
...
/*0x00E5*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
...
/*0x0110*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
...
/*0x0148*/ void* pTipTextObject; \
/*0x014C*/ RECT		ClipRectScreen; \
/*0x015C*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0160*/ bool		bTopAnchoredToTop; \
/*0x0164*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x0168*/ bool		bBringToTopWhenClicked; \
...
/*0x01D2*/ bool		bClientClipRectChanged; \
/*0x01D4*/ void	*DrawTemplate; \
...
// CBazaarSearchWnd_size: 0x92d0 (see 55740E) in Feb  6 2020 Test - eqmule
...
// CPlayerWindow_size: 0x2e8 (see 556CFE) in Feb  6 2020 Test - eqmule
...
// CTargetWindow_size: 0x8c8 (see 556B95) in Feb  6 2020 Test - eqmule
...
// CBuffWindow_size: 0x718 (see 556A39) in Feb  6 2020 Test - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x320 (see 812BAB) in Feb  6 2020 Test - eqmule
...
// CCastSpellWnd_size: 0x2d0 (see 556DF7) in Feb  6 2020 Test - eqmule
...
// CInvSlotWnd_size: 0x2d0 (see 812CBC) in Feb  6 2020 Test - eqmule
...
// CItemDisplayWindow_size: 0x628 (see 775A02) in Feb  6 2020 Test - eqmule
...
// CLootWnd_size: 0x398 (see 557166) in Feb  6 2020 Test - eqmule
...
// CMapViewWnd_size: 0x648 (see 55689A) in Feb  6 2020 Test - eqmule
...
// CMerchantWnd_size: 0x448 (see 5572C2) in Feb  6 2020 Test - eqmule
...
// CPetInfoWindow_size: 0x8c8 (see 5562F1) in Feb  6 2020 Test - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a8 (see 5565E2) in Feb  6 2020 Test - eqmule
...
// CTradeWnd__size: 0x2f0 (see 557368) in Feb  6 2020 Test - eqmule
...
// CFactionWnd__size: 0x278 (see 5574B4) in Feb  6 2020 Test - eqmule
