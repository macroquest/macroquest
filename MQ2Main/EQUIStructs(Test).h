...
// actual size 0x1F0 in Dec  9 2019 Test (see 0x9525BD) - eqmule
...
/*0x0037*/ bool		bTiled; \
/*0x0038*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0039*/ bool		bHCenterTooltip; \
...
/*0x0050*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
...
/*0x005C*/ DWORD	LastTimeMouseOver; \
...
/*0x008A*/ bool		bScreenClipRectChanged; \
/*0x008C*/ UINT		LastBlinkFadeRefreshTime; \
/*0x0090*/ UINT		TransitionStartTick; \
...
/*0x00EC*/ void	    *pFont; \
/*0x00F0*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x0108*/ bool		bLeftAnchoredToLeft; \
/*0x010C*/ tagSIZE	MaxClientSize; \
/*0x0114*/ int		VScrollMax; \
/*0x0118*/ struct _CXSTR*	DataStr; \
/*0x011C*/ bool		bBorder; \
/*0x011D*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x011E*/ bool		bUseInLayoutVertical; \
/*0x011F*/ bool		Faded; \
...
// CBazaarSearchWnd_size: 0x92d8 (see 550DEE) in Dec  9 2019 Test - eqmule
...
// CPlayerWindow_size: 0x2f0 (see 5506DE) in Dec  9 2019 Test - eqmule
...
// CTargetWindow_size: 0x8d0 (see 550575) in Dec  9 2019 Test - eqmule
...
// CBuffWindow_size: 0x720 (see 550419) in Dec  9 2019 Test - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x328 (see 80865B) in Dec  9 2019 Test - eqmule
...
// CCastSpellWnd_size: 0x2d8 (see 5507D7) in Dec  9 2019 Test - eqmule
...
// CInvSlotWnd_size: 0x2d8 (see 80876C) in Dec  9 2019 Test - eqmule
...
// CItemDisplayWindow_size: 0x630 (see 76B5B2) in Dec  9 2019 Test - eqmule
...
// CLootWnd_size: 0x3a0 (see 550B46) in Dec  9 2019 Test - eqmule
...
// CMapViewWnd_size: 0x658 (see 55027A) in Dec  9 2019 Test - eqmule
...
// CMerchantWnd_size: 0x450 (see 550CA2) in Dec  9 2019 Test - eqmule
...
// CPetInfoWindow_size: 0x8d0 (see 54FCD1) in Dec  9 2019 Test - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3b0 (see 54FFC2) in Dec  9 2019 Test - eqmule
...
// CTradeWnd__size: 0x2f8 (see 550D48) in Dec  9 2019 Test - eqmule
...
// CFactionWnd__size: 0x280 (see 550E94) in Dec  9 2019 Test - eqmule
