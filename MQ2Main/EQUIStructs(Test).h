...
/*0x0034*/ BYTE         Unknown0x0034; \
/*0x0035*/ BYTE         Minimized; \
...
/*0x003c*/ BYTE         MouseOver; /*found in CXWnd__SetMouseOver_x*/ \
...
/*0x0078*/ BYTE         CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0079*/ BYTE         Unknown0x0079[0x10]; \
/*0x0089*/ BYTE         Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x008a*/ BYTE         Unknown0x008a[0x2]; \
/*0x008c*/ DWORD        VScrollMax; \
/*0x0090*/ BYTE         Unknown0x0090[0x10]; \
/*0x00a0*/ struct _CXSTR*       WindowText; /*CXWnd__GetWindowTextA_x has this one*/ \
/*0x00a4*/ BYTE         Unknown0x00a4; \
/*0x00a5*/ BYTE         FadeToAlpha; /*found in CSidlScreenWnd__StoreIniInfo_x*/\
/*0x00a6*/ BYTE         Unknown0x00a6[0x16]; \
/*0x00bc*/ DWORD        HScrollPos; \
/*0x00c0*/ BYTE         Unknown0x00c0[0x4]; \
...
/*0x00ec*/ BYTE         Unknown0x00ec[0x20]; \
/*0x010c*/ DWORD        TickCount2; \
/*0x0110*/ BYTE         Unknown0x0110[0x19]; \
/*0x0129*/ BYTE         Locked; /*found in CSidlScreenWnd__LoadIniInfo_x*/ \
/*0x012a*/ BYTE         Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x012b*/ BYTE         Unknown0x012b[0x16]; \
/*0x0141*/ BYTE         ValidCXWnd; /*IsValid has this one*/\
...
/*0x0154*/ BYTE         Unknown0x0154[0x11]; \
/*0x0165*/ BYTE         Alpha; \
/*0x0166*/ BYTE         Unknown0x0166[0x1a]; \
/*0x0180*/ struct _CXSTR*       Tooltip; /*found in CSidlManager__CreateLabel_x*/ \
/*0x0184*/ BYTE         Faded; \
/*0x0185*/ BYTE         Unknown0x0185[0x8]; \
/*0x018d*/ BYTE         Enabled; \
/*0x018e*/ BYTE         Unknown0x018e[0x2]; \
/*0x0190*/ RECT         OldLocation; \
/*0x01a0*/ DWORD        TimeMouseOver; \
/*0x01a4*/ BYTE         Unknown0x01a4[0x28]; \
/*0x01cc*/ LPVOID       DrawTemplate; \
/*0x01d0*/ ARGBCOLOR    BGColor; \
...
// size 0x284 Mar 10 2015 test (see 67189B) -eqmule
#define CONTEXTTAIL \
/*0x224*/ DWORD ZeroMe; \
...
/*0x260*/ DWORD ZeroMeOut2[0x18]; \
/*0x278*/ DWORD Unknown0x278; /*constructor sets this to 0x10000*/ \
/*0x27c*/ DWORD ZeroMeAsWell; \
/*0x280*/ DWORD Unknown0x280; /*constructor sets this to 0*/ \
/*0x284*/
