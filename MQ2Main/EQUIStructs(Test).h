...
/*0x0038*/ DWORD        TimeMouseOver; \
/*0x003c*/ BYTE         Unknown0x003c[0x10]; \
/*0x004c*/ DWORD        ZLayer; /*found in CXWndManager__DrawWindows_x*/ \
...
/*0x0070*/ DWORD        UnknownCW; /*found in OnProcessFrame*/\
...
/*0x00bc*/ BYTE         Minimized; \
/*0x00bd*/ BYTE         Unknown0x00bd[0x7]; \
/*0x00c4*/ RECT         OldLocation; \
/*0x00d4*/ BYTE         Unknown0x00d4[0x8]; \
/*0x00dc*/ BYTE         Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
...
/*0x00f4*/ BYTE         Unknown0x00f4[0x21]; \
/*0x0115*/ BYTE         FadeToAlpha; /*found in CSidlScreenWnd__StoreIniInfo_x*/\
/*0x0116*/ BYTE         Unknown0x0116[0xa]; \
/*0x0120*/ struct _CXSTR*       XMLToolTip; /*found in CSidlManager__CreateLabel_x*/ \
/*0x0124*/ BYTE         Unknown0x0124[0x2c]; \
...
/*0x0165*/ BYTE         Unknown0x0165; \
/*0x0166*/ BYTE         Enabled; \
/*0x0167*/ BYTE         Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x0168*/ DWORD        VScrollMax; \
/*0x016c*/ BYTE         Unknown0x016c[0x5]; \
/*0x0171*/ BYTE         Faded; \
...
/*0x0188*/ DWORD        FadeDuration; \
/*0x018c*/ BYTE         Unknown0x018c[0x8]; \
/*0x0194*/ BYTE         Fades; \
/*0x0195*/ BYTE         Unknown0x0195[0xf]; \
/*0x01a4*/ BYTE         CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x01a5*/ BYTE         Unknown0x01a5[0x1f]; \
/*0x01c4*/ BYTE         Alpha; \
/*0x01c5*/ BYTE         dShow; \
/*0x01c6*/ BYTE         Unknown0x01c6[0x1a]; \
/*0x01e0*/ ARGBCOLOR    BGColor; \
