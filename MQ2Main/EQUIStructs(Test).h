...
/*0x001c*/ BYTE         Unknown0x001c; \
/*0x001d*/ BYTE         ValidCXWnd; /*IsValid has this one*/\
/*0x001e*/ BYTE         Minimized; \
/*0x001f*/ BYTE         Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
...
/*0x0051*/ BYTE         CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0052*/ BYTE         Unknown0x0052[0x8]; \
/*0x005a*/ BYTE         FadeToAlpha; /*found in CSidlScreenWnd__StoreIniInfo_x*/\
...
/*0x0094*/ BYTE         Unknown0x0094[0x44]; \
/*0x00d8*/ DWORD        BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x "BGType" in ini */ \
/*0x00dc*/ BYTE         Faded; \
/*0x00dd*/ BYTE         Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x00de*/ BYTE         Unknown0x00de[0x2]; \
/*0x00e0*/ DWORD        TimeMouseOver; \
/*0x00e4*/ BYTE         Alpha; \
/*0x00e5*/ BYTE         Unknown0x00e5[0x1f]; \
...
/*0x0154*/ BYTE         Unknown0x0154[0x30]; \
/*0x0184*/ BYTE         dShow; \
...
/*0x0194*/ DWORD        ZLayer; /*found in CXWndManager__DrawWindows_x*/ \
/*0x0198*/ BYTE         Unknown0x0198[0x28]; \
