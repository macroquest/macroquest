...
// actual size 0x1E0 in Mar 16 2020 Test (see 0x95E3CD) - eqmule
// actual size 0x1F0 in Apr  7 2020 Test (see 0x9608BD) - eqmule
// actual size 0x1E8 in Apr 13 2020 Test (see 0x96042D) - eqmule
// actual size 0x1F8 in Apr 21 2020 Test (see 0x95F81D) - eqmule
#define CXW_NO_VTABLE \
private: \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ int		DeleteCount; \
/*0x0020*/ RECT		Location; \
/*0x0030*/ RECT		OldLocation; \
/*0x0040*/ bool		bBorder; \
/*0x0044*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0048*/ int		VScrollMax; \
/*0x004C*/ void   *TitlePiece; \
/*0x0050*/ UINT		TransitionDuration; \
/*0x0054*/ tagSIZE	MinClientSize; \
/*0x005C*/ bool		bClientRectChanged; \
/*0x005D*/ bool		bIsTransitioning; \
/*0x005E*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x005F*/ bool		bTiled; \
/*0x0060*/ int		LeftOffset; \
/*0x0064*/ BYTE		StartAlpha; \
/*0x0065*/ bool		bBottomAnchoredToTop; \
/*0x0068*/ DWORD	XMLIndex; \
/*0x006C*/ RECT		TransitionRect; \
/*0x007C*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x0080*/ tagSIZE	MaxClientSize; \
/*0x0088*/ int		BlinkState; \
...
/*0x009C*/ UINT		BlinkFadeDuration; \
/*0x00A0*/ bool		bMarkedForDelete; \
...
/*0x00B0*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x00B4*/ void   *TitlePiece2; \
/*0x00B8*/ bool		bClipToParent; \
/*0x00BC*/ void*	pTextObject; \
/*0x00C0*/ bool		bEscapableLocked; \
/*0x00C1*/ bool		bTopAnchoredToTop; \
/*0x00C4*/ LONG		BlinkStartTimer; \
/*0x00C8*/ bool		Fades; \
/*0x00CC*/ UINT		BlinkFadeStartTime; \
/*0x00D0*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x00D4*/ bool		bClientClipRectChanged; \
/*0x00D8*/ int		ParentAndContextMenuArrayIndex; \
/*0x00DC*/ bool		bAction; \
/*0x00E0*/ void* pTipTextObject; \
/*0x00E4*/ bool		bUseInLayoutHorizontal; \
/*0x00E8*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
...
/*0x010C*/ bool		Enabled; \
/*0x0110*/ void	*IconTextureAnim; \
/*0x0114*/ RECT		ClientRect; \
/*0x0124*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x0128*/ UINT		TransitionStartTick; \
/*0x012C*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x012D*/ bool		bFullyScreenClipped; \
/*0x012E*/ bool		bUseInLayoutVertical; \
/*0x012F*/ bool		bCaptureTitle; \
/*0x0130*/ int		RightOffset; \
/*0x0134*/ COLORREF DisabledBackground; \
/*0x0138*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x013C*/ UINT		FadeDuration; \
/*0x0140*/ bool		bActive; \
/*0x0144*/ RECT		IconRect; \
/*0x0154*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x0158*/ struct _CXSTR*	DataStr; \
/*0x015C*/ int		BottomOffset; \
/*0x0160*/ RECT		ClipRectScreen; \
/*0x0170*/ bool		bLeftAnchoredToLeft; \
/*0x0174*/ int		managerArrayIndex; \
/*0x0178*/ bool		Minimized; \
/*0x0179*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x017A*/ bool		bIsParentOrContextMenuWindow; \
/*0x017B*/ bool		bHCenterTooltip; \
/*0x017C*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x017D*/ BYTE		Alpha; \
/*0x0180*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x0184*/ RECT		ClipRectClient; \
/*0x0194*/ int		VScrollPos; \
/*0x0198*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x019C*/ void		*pLayoutStrategy; \
/*0x01A0*/ __int64		Data; \
/*0x01A8*/ void	*DrawTemplate; \
...
/*0x01B8*/ bool		bBringToTopWhenClicked; \
/*0x01B9*/ BYTE		FadeAlpha; \
/*0x01BA*/ bool		bKeepOnScreen; \
...
/*0x01C8*/ DWORD	FadeDelay; \
/*0x01CC*/ DWORD  BackgroundDrawType; \
/*0x01D0*/ int		HScrollMax; \
/*0x01D4*/ BYTE		TargetAlpha; \
/*0x01D8*/ void	    *pFont; \
/*0x01DC*/ bool		bMaximizable; \
/*0x01E0*/ int		TopOffset; \
/*0x01E4*/ BYTE     bResizableMask; \
/*0x01E5*/ bool		bRightAnchoredToLeft; \
/*0x01E8*/ void *pController; \
/*0x01EC*/ bool		dShow; \
/*0x01F0*/ DWORD	LastTimeMouseOver; \
...
// CBazaarSearchWnd_size: 0x92e0 (see 5562EE) in Apr 21 2020 Test - eqmule
...
// CPlayerWindow_size: 0x2f8 (see 555BDE) in Apr 21 2020 Test - eqmule
...
// CTargetWindow_size: 0x8d8 (see 555A75) in Apr 21 2020 Test - eqmule
...
// CBuffWindow_size: 0x728 (see 555919) in Apr 21 2020 Test - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x330 (see 814BEB) in Apr 21 2020 Test - eqmule
...
// CCastSpellWnd_size: 0x2e0 (see 555CD7) in Apr 21 2020 Test - eqmule
...
// CInvSlotWnd_size: 0x2e0 (see 814CFC) in Apr 21 2020 Test - eqmule
...
// CItemDisplayWindow_size: 0x638 (see 7773F2) in Apr 21 2020 Test - eqmule
...
// CLootWnd_size: 0x3a8 (see 556046) in Apr 21 2020 Test - eqmule
...
// CMapViewWnd_size: 0x668 (see 55577A) in Apr 21 2020 Test - eqmule
...
// CMerchantWnd_size: 0x458 (see 5561A2) in Apr 21 2020 Test - eqmule
...
// CPetInfoWindow_size: 0x8d8 (see 5551D1) in Apr 21 2020 Test - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3b8 (see 5554C2) in Apr 21 2020 Test - eqmule
...
// CTradeWnd__size: 0x300 (see 556248) in Apr 21 2020 Test - eqmule
...
// CFactionWnd__size: 0x288 (see 556394) in Apr 21 2020 Test - eqmule
