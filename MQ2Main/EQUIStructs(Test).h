...
// actual size 0x1E8 in May  6 2016 Test (see 0x691A98) - eqmule
...
/*0x0020*/ DWORD	VScrollMax; \
/*0x0024*/ BYTE		Unknown0x0024[0xc]; \
/*0x0030*/ DWORD	ZLayer; /*found in CXWndManager__DrawWindows_x*/ \
/*0x0034*/ BYTE		Locked; /*found in CSidlScreenWnd__LoadIniInfo_x*/ \
/*0x0035*/ BYTE		dShow; \
/*0x0036*/ BYTE		Unknown0x0036[0x2]; \
...
/*0x0044*/ BYTE		Unknown0x0044[0x15]; \
/*0x0059*/ BYTE		Alpha; \
/*0x005a*/ BYTE		Unknown0x005a[0x6]; \
/*0x0060*/ RECT		Location; \
/*0x0070*/ BYTE		Unknown0x0070[0x1c]; \
/*0x008c*/ DWORD	TickCount2; \
...
/*0x00a4*/ BYTE		Unknown0x00a4[0x18]; \
/*0x00bc*/ RECT		OldLocation; \
/*0x00cc*/ BYTE		Unknown0x00cc; \
/*0x00cd*/ BYTE		Minimized; \
/*0x00ce*/ BYTE		ValidCXWnd; /*IsValid has this one*/\
/*0x00cf*/ BYTE		Unknown0x00cf[0x5]; \
/*0x00d4*/ BYTE		FadeToAlpha; /*found in CSidlScreenWnd__StoreIniInfo_x*/\
/*0x00d5*/ BYTE		Unknown0x00d5[0x13]; \
/*0x00e8*/ BYTE		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
...
/*0x00f4*/ BYTE		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x00f5*/ BYTE		Unknown0x00f5[0x7]; \
/*0x00fc*/ DWORD	UnknownCW; /*found in OnProcessFrame*/\
/*0x0100*/ ARGBCOLOR	BGColor; \
/*0x0104*/ BYTE		Unknown0x0104[0x16]; \
/*0x011a*/ BYTE		Enabled; \
/*0x011b*/ BYTE		Unknown0x011b; \
/*0x011c*/ DWORD	FadeDuration; \
/*0x0120*/ BYTE		Unknown0x0120[0x20]; \
/*0x0140*/ LPVOID	DrawTemplate; \
/*0x0144*/ BYTE		Unknown0x0144[0x14]; \
/*0x0158*/ DWORD	HScrollPos; \
/*0x015c*/ struct _CXSTR*	XMLToolTip; /*found in CSidlManager__CreateLabel_x*/ \
/*0x0160*/ BYTE		Unknown0x0160[0x8]; \
/*0x0168*/ DWORD	HScrollMax; \
/*0x016c*/ BYTE		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x016d*/ BYTE		Unknown0x016d[0x3]; \
/*0x0170*/ struct _CSIDLWND*	pParentWindow; /*CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x0174*/ BYTE		Faded; \
/*0x0175*/ BYTE		Unknown0x0175[0x13]; \
/*0x0188*/ DWORD	XMLIndex; \
/*0x018c*/ BYTE		Fades; \
/*0x018d*/ BYTE		Unknown0x018d[0x3]; \
/*0x0190*/ DWORD	TimeMouseOver; \
/*0x0194*/ BYTE		Unknown0x0194[0x8]; \
/*0x019c*/ BYTE		MouseOver; /*found in CXWnd__SetMouseOver_x*/ \
/*0x019d*/ BYTE		Unknown0x019d[0x37];
/*0x01d4*/
