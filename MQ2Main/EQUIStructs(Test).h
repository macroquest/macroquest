...
// actual size 0x1E8 in Oct 11 2017 Test (see 0x8D5EED) - eqmule
// actual size 0x1E8 in Oct 12 2017 Test (see 0x8D597D) - eqmule
...
/*0x0028*/ UINT		BlinkFadeStartTime; \
/*0x002C*/ bool		bMaximizable; \
/*0x0030*/ void   *TitlePiece; \
/*0x0034*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x0038*/ bool		bBottomAnchoredToTop; \
/*0x0039*/ BYTE		StartAlpha; \
/*0x003C*/ int		TopOffset; \
/*0x0040*/ bool		bClientRectChanged; \
/*0x0044*/ void	    *pFont; \
/*0x0048*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x0049*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x004C*/ void		*pLayoutStrategy; \
/*0x0050*/ bool		bCaptureTitle; \
/*0x0051*/ bool		bActive; \
/*0x0052*/ bool		dShow; \
/*0x0054*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x1c */ \
...
/*0x0078*/ RECT		IconRect; \
/*0x0088*/ bool		bAction; \
/*0x0089*/ bool		bEscapableLocked; \
/*0x008C*/ struct _CSIDLWND* pWndFocusOther; \
/*0x0090*/ int		BlinkDuration; \
/*0x0094*/ void	*IconTextureAnim; \
/*0x0098*/ LONG		BlinkStartTimer; \
/*0x009C*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x009D*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x00A0*/ RECT		ClientRect; \
/*0x00B0*/ int		BlinkState; \
/*0x00B4*/ DWORD  BackgroundDrawType; \
/*0x00B8*/ DWORD	XMLIndex; \
/*0x00BC*/ void	*DrawTemplate; \
/*0x00C0*/ bool		bUseInLayoutHorizontal; \
/*0x00C4*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x00C8*/ UINT		BlinkFadeDuration; \
/*0x00CC*/ bool		bFullyScreenClipped; \
/*0x00D0*/ DWORD	FadeDelay; \
/*0x00D4*/ bool		Faded; \
/*0x00D8*/ int		BottomOffset; \
/*0x00DC*/ void* pTipTextObject; \
...
/*0x0120*/ int		HScrollPos; \
/*0x0124*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x0128*/ COLORREF DisabledBackground; \
/*0x012C*/ UINT		TransitionDuration; \
/*0x0130*/ bool		bLeftAnchoredToLeft; \
/*0x0131*/ bool		bRightAnchoredToLeft; \
/*0x0134*/ DWORD	LastTimeMouseOver; \
/*0x0138*/ int		RightOffset; \
/*0x013C*/ bool		bHCenterTooltip; \
/*0x013D*/ bool		bClientClipRectChanged; \
/*0x013E*/ bool		bUseInLayoutVertical; \
/*0x013F*/ bool		bMarkedForDelete; \
/*0x0140*/ int		LeftOffset; \
/*0x0144*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x0148*/ bool		bTiled; \
/*0x014C*/ int		VScrollPos; \
/*0x0150*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x0151*/ bool		bIsTransitioning; \
/*0x0152*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x0153*/ bool		bClipToParent; \
/*0x0154*/ bool		Minimized; \
/*0x0155*/ BYTE		TargetAlpha; \
/*0x0156*/ bool		bKeepOnScreen; \
/*0x0157*/ bool		bBringToTopWhenClicked; \
/*0x0158*/ RECT		TransitionRect; \
/*0x0168*/ BYTE     bResizableMask; \
/*0x0169*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x016C*/ int		DeleteCount; \
/*0x0170*/ RECT		ClipRectClient; \
/*0x0180*/ void*	pTextObject; \
/*0x0184*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
...
/*0x01A4*/ bool		bIsParentOrContextMenuWindow; \
/*0x01A8*/ UINT		FadeDuration; \
...
//Size is 0x40 see 69DB24 in Sep 11 2017 Test exe -eqmule
enum ChatFilterEnum {
	CHAT_FILTER_SAY,
	CHAT_FILTER_TELL,
	CHAT_FILTER_GROUP,
...
//size is 0x210 see 7A41F9 in Sep 22 2017 Test -eqmule
...
// Actual Size: 0x92d0 (see 4C603A) in Aug  7 2017 Test - eqmule
...
// Actual Size: 0x2e8 (see 4C587D) in Aug  7 2017 Test - eqmule
...
// Actual Size: 0x8c8 (see 4C5714) in Aug  7 2017 Test - eqmule
...
// Actual Size: 0x718 (see 4C55A8) in Aug  7 2017 Test - eqmule
...
// Individual Gems 
// Actual Size: 0x318 (see 79D138) in Aug  7 2017 Test - eqmule
...
// Actual Size: 0x2c8 (see 4C598E) in Aug  7 2017 Test - eqmule
...
// Actual Size: 0x2d0 (see 79D249) in Aug  7 2017 Test - eqmule
...
// Actual Size: 0x610 (see 6E75EF) in Aug  7 2017 Test - eqmule
...
// Actual Size: 0x398 (see 4C5D50) in Aug  7 2017 Test - eqmule
...
// Actual Size: 0x648 (see 4C5409) in Aug  7 2017 Test - eqmule
...
// Actual Size: 0x2d0 (see 4C5ECE) in Aug  7 2017 Test - eqmule
...
// Actual Size: 0x8c8 (see 4C4E40) in Aug  7 2017 Test - eqmule
...
//aClasscolorD
// Actual Size: 0x3a8 (see 4C5133) in Aug  7 2017 Test - eqmule
...
// Actual Size: 0x2f0 (see 4C5F84) in Aug  7 2017 Test - eqmule
