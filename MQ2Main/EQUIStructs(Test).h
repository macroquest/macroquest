...
/*0x00AC*/ bool		bCaptureTitle; \
/*0x00AD*/ bool		bBorder; \
/*0x00B0*/ int		RightOffset; \
/*0x00B4*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x00B5*/ bool		bClipToParent; \
/*0x00B6*/ bool		bBottomAnchoredToTop; \
/*0x00B8*/ DWORD	XMLIndex; \
/*0x00BC*/ void* pTipTextObject; \
/*0x00C0*/ bool		ValidCXWnd; /* IsValid has this one */ \
...
/*0x0111*/ bool		bClientClipRectChanged; \
/*0x0114*/ void	    *pFont; \
...
/*0x0126*/ bool		bRightAnchoredToLeft; \
/*0x0127*/ bool		bBorder2; \
/*0x0128*/ RECT		TransitionRect; \
/*0x0138*/ bool		bBringToTopWhenClicked; \
/*0x0139*/ bool		bMarkedForDelete; \
...
/*0x0169*/ bool		dShow; \
/*0x016A*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
...
/*0x0190*/ __int64		Data; \
/*0x0198*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x019C*/ bool		bIsTransitioning; \
/*0x019D*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
...
// CBazaarSearchWnd_size: 0x92d8 (see 543DFE) in Sep  9 2019 Test - eqmule
...
// CPlayerWindow_size: 0x2f0 (see 5436EE) in Sep  9 2019 Test - eqmule
...
// CTargetWindow_size: 0x8d0 (see 543585) in Sep  9 2019 Test - eqmule
...
// CBuffWindow_size: 0x720 (see 543429) in Sep  9 2019 Test - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x328 (see 7F6ADB) in Sep  9 2019 Test - eqmule
...
// CCastSpellWnd_size: 0x2d8 (see 5437E7) in Sep  9 2019 Test - eqmule
...
// CInvSlotWnd_size: 0x2d8 (see 7F6BEC) in Sep  9 2019 Test - eqmule
...
// CItemDisplayWindow_size: 0x630 (see 7570F2) in Sep  9 2019 Test - eqmule
...
// CLootWnd_size: 0x3a0 (see 543B56) in Sep  9 2019 Test - eqmule
...
// CMapViewWnd_size: 0x658 (see 54328A) in Sep  9 2019 Test - eqmule
...
// CMerchantWnd_size: 0x450 (see 543CB2) in Sep  9 2019 Test - eqmule
...
// CPetInfoWindow_size: 0x8d0 (see 542CE1) in Sep  9 2019 Test - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3b0 (see 542FD2) in Sep  9 2019 Test - eqmule
...
// CTradeWnd__size: 0x2f8 (see 543D58) in Sep  9 2019 Test - eqmule
...
// CFactionWnd__size: 0x280 (see 543EA4) in Sep  9 2019 Test - eqmule
