...
// actual size 0x1E8 in Aug 27 2019 Test (see 0x94227D) - eqmule
// actual size 0x1E0 in Oct 22 2019 Test (see 0x93CC4D) - eqmule
// actual size 0x1F0 in Nov  8 2019 Test (see 0x93BD2D) - eqmule
...
/*0x002C*/ UINT		LastBlinkFadeRefreshTime; \
/*0x0030*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x0031*/ bool		bScreenClipRectChanged; \
/*0x0034*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x0038*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
...
/*0x0050*/ BYTE		TargetAlpha; \
/*0x0054*/ int		VScrollMax; \
/*0x0058*/ DWORD  BackgroundDrawType; \
/*0x005C*/ bool		bTiled; \
/*0x005D*/ bool		bEscapableLocked; \
/*0x005E*/ bool		Enabled; \
/*0x0060*/ UINT		BlinkFadeFreq; \
/*0x0064*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0065*/ bool		bTopAnchoredToTop; \
/*0x0068*/ DWORD	LastTimeMouseOver; \
/*0x006C*/ bool		bBringToTopWhenClicked; \
/*0x0070*/ int	Transition; \
/*0x0074*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x008C*/ void* pTipTextObject; \
/*0x0090*/ bool		Minimized; \
/*0x0094*/ UINT		FadeDuration; \
/*0x0098*/ int		BottomOffset; \
/*0x009C*/ bool		bMarkedForDelete; \
/*0x00A0*/ UINT		BlinkFadeStartTime; \
/*0x00A4*/ int		DeleteCount; \
/*0x00A8*/ void   *TitlePiece; \
/*0x00AC*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x00B0*/ tagSIZE	MinClientSize; \
/*0x00B8*/ bool		bActive; \
/*0x00B9*/ bool		bAction; \
/*0x00BA*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x00BC*/ void*	pTextObject; \
/*0x00C0*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x00C1*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x00C2*/ BYTE		Alpha; \
/*0x00C4*/ RECT		Location; \
/*0x00D4*/ RECT		IconRect; \
/*0x00E4*/ RECT		TransitionRect; \
/*0x00F4*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x00F8*/ int		RightOffset; \
...
/*0x0108*/ BYTE		StartAlpha; \
/*0x010C*/ struct _CSIDLWND* pWndFocusOther; \
/*0x0110*/ void	    *pFont; \
/*0x0114*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x0118*/ bool		bClientClipRectChanged; \
/*0x011C*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
...
/*0x0125*/ bool		bClipToParent; \
/*0x0128*/ UINT		TransitionStartTick; \
/*0x012C*/ bool		bRightAnchoredToLeft; \
/*0x012D*/ bool		bCaptureTitle; \
/*0x0130*/ RECT		ClipRectClient; \
/*0x0140*/ bool		bIsParentOrContextMenuWindow; \
/*0x0141*/ bool		bHCenterTooltip; \
...
/*0x0158*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x0159*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x015A*/ bool		dShow; \
/*0x015B*/ bool		bIsTransitioning; \
/*0x015C*/ RECT		ClientRect; \
/*0x016C*/ LONG		BlinkStartTimer; \
/*0x0170*/ int		HScrollPos; \
/*0x0178*/ __int64		Data; \
/*0x0180*/ int		TopOffset; \
/*0x0184*/ RECT		OldLocation; \
/*0x0194*/ RECT		ClipRectScreen; \
/*0x01A4*/ int		LeftOffset; \
/*0x01A8*/ bool		Faded; \
/*0x01AC*/ void *pController; \
/*0x01B0*/ BYTE     bResizableMask; \
/*0x01B1*/ bool		bUseInLayoutHorizontal; \
/*0x01B4*/ int		BlinkState; \
/*0x01B8*/ void		*pLayoutStrategy; \
/*0x01BC*/ BYTE		FadeAlpha; \
/*0x01BD*/ bool		bUseInLayoutVertical; \
/*0x01BE*/ bool		bLeftAnchoredToLeft; \
/*0x01C0*/ int		managerArrayIndex; \
/*0x01C4*/ DWORD	FadeDelay; \
/*0x01C8*/ bool		bMaximizable; \
/*0x01CC*/ void	*DrawTemplate; \
/*0x01D0*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x01D4*/ UINT		TransitionDuration; \
/*0x01D8*/ bool		bFullyScreenClipped; \
/*0x01DC*/ int		BlinkDuration; \
/*0x01E0*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x01E4*/ DWORD	XMLIndex; \
/*0x01E8*/ bool		bClientRectChanged; \
...
//Size is 84 see 4E310C in Oct 22 2019 Test -eqmule
enum ChatFilterEnum {
	CHAT_FILTER_SAY,
	CHAT_FILTER_TELL,
	CHAT_FILTER_GROUP,
...
#define MAX_CHAT_FILTERS CHAT_FILTER_SOMETHING2
...
// CBazaarSearchWnd_size: 0x92d8 (see 5455CE) in Nov  8 2019 Test - eqmule
...
// CPlayerWindow_size: 0x2f0 (see 544EBE) in Nov  8 2019 Test - eqmule
...
// CTargetWindow_size: 0x8d0 (see 544D55) in Nov  8 2019 Test - eqmule
...
// CBuffWindow_size: 0x720 (see 544BF9) in Nov  8 2019 Test - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x328 (see 7F530B) in Nov  8 2019 Test - eqmule
...
// CCastSpellWnd_size: 0x2d8 (see 544FB7) in Nov  8 2019 Test - eqmule
...
// CItemDisplayWindow_size: 0x630 (see 758292) in Nov  8 2019 Test - eqmule
...
// CLootWnd_size: 0x3a0 (see 545326) in Nov  8 2019 Test - eqmule
...
// CMapViewWnd_size: 0x658 (see 544A5A) in Nov  8 2019 Test - eqmule
...
// CMerchantWnd_size: 0x450 (see 545482) in Nov  8 2019 Test - eqmule
...
// CPetInfoWindow_size: 0x8d0 (see 5444B1) in Nov  8 2019 Test - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3b0 (see 5447A2) in Nov  8 2019 Test - eqmule
...
// CTradeWnd__size: 0x2f8 (see 545528) in Nov  8 2019 Test - eqmule
...
// CFactionWnd__size: 0x280 (see 545674) in Nov  8 2019 Test - eqmule
