...
// actual size 0x1F8 in Mar 25 2020 Test (see 0x95ED4D) - eqmule
...
/*0x0024*/ DWORD	LastTimeMouseOver; \
...
/*0x0030*/ UINT		TransitionDuration; \
/*0x0034*/ int		VScrollMax; \
/*0x0038*/ bool		Faded; \
/*0x003C*/ int	Transition; \
/*0x0040*/ bool		bLeftAnchoredToLeft; \
/*0x0044*/ int		BottomOffset; \
/*0x0048*/ UINT		LastBlinkFadeRefreshTime; \
/*0x004C*/ bool		bScreenClipRectChanged; \
/*0x004D*/ bool		bIsParentOrContextMenuWindow; \
/*0x0050*/ DWORD	FadeDelay; \
/*0x0054*/ bool		bIsTransitioning; \
/*0x0055*/ bool		bUseInLayoutVertical; \
/*0x0056*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x0058*/ COLORREF DisabledBackground; \
/*0x005C*/ DWORD  BackgroundDrawType; \
/*0x0060*/ RECT		OldLocation; \
/*0x0070*/ bool		bEscapableLocked; \
/*0x0071*/ bool		bFullyScreenClipped; \
...
/*0x0090*/ bool		bBottomAnchoredToTop; \
/*0x0094*/ RECT		IconRect; \
/*0x00A4*/ int		managerArrayIndex; \
/*0x00A8*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x00A9*/ bool		bClientRectChanged; \
/*0x00AC*/ int		BlinkState; \
/*0x00B0*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
...
/*0x00FC*/ bool		bBorder; \
/*0x00FD*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0100*/ UINT		BlinkFadeFreq; \
/*0x0104*/ tagSIZE	MaxClientSize; \
/*0x010C*/ bool		bHCenterTooltip; \
/*0x0110*/ void	    *pFont; \
/*0x0114*/ void   *TitlePiece2; \
/*0x0118*/ bool		bUseInLayoutHorizontal; \
/*0x0119*/ bool		Enabled; \
/*0x011A*/ bool		dShow; \
/*0x011B*/ bool		bActive; \
...
/*0x0184*/ int		TopOffset; \
/*0x0188*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0189*/ bool		bClientClipRectChanged; \
/*0x018A*/ bool		bTiled; \
/*0x018B*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x018C*/ BYTE		FadeAlpha; \
/*0x018D*/ bool		bBringToTopWhenClicked; \
/*0x0190*/ RECT		ClipRectScreen; \
/*0x01A0*/ bool		bBorder2; \
/*0x01A4*/ void *pController; \
/*0x01A8*/ int		HScrollPos; \
/*0x01AC*/ bool		bTopAnchoredToTop; \
/*0x01B0*/ struct _CSIDLWND* pWndFocusOther; \
/*0x01B4*/ UINT		TransitionStartTick; \
/*0x01B8*/ bool		Fades; \
/*0x01BC*/ UINT		BlinkFadeStartTime; \
/*0x01C0*/ int		HScrollMax; \
/*0x01C4*/ bool		bMarkedForDelete; \
/*0x01C5*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x01C6*/ BYTE		TargetAlpha; \
/*0x01C7*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x01C8*/ bool		bRightAnchoredToLeft; \
/*0x01C9*/ bool		Minimized; \
/*0x01CA*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x01CB*/ bool		bClipToParent; \
/*0x01CC*/ bool		bMaximized; \
/*0x01CD*/ BYTE     bResizableMask; \
/*0x01D0*/ void* pTipTextObject; \
/*0x01D4*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x01D8*/ bool		bCaptureTitle; \
...
// CBazaarSearchWnd_size: 0x92d0 (see 556B8E) in Apr 13 2020 Test - eqmule
...
// CPlayerWindow_size: 0x2e8 (see 55647E) in Apr 13 2020 Test - eqmule
...
// CTargetWindow_size: 0x8c8 (see 556315) in Apr 13 2020 Test - eqmule
...
// CBuffWindow_size: 0x718 (see 5561B9) in Apr 13 2020 Test - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x320 (see 8163FB) in Apr 13 2020 Test - eqmule
...
// CCastSpellWnd_size: 0x2d0 (see 556577) in Apr 13 2020 Test - eqmule
...
// CInvSlotWnd_size: 0x2d0 (see 81650C) in Apr 13 2020 Test - eqmule
...
// CItemDisplayWindow_size: 0x628 (see 778E52) in Apr 13 2020 Test - eqmule
...
// CLootWnd_size: 0x398 (see 5568E6) in Apr 13 2020 Test - eqmule
...
// CMapViewWnd_size: 0x648 (see 55601A) in Apr 13 2020 Test - eqmule
...
// CMerchantWnd_size: 0x448 (see 556A42) in Apr 13 2020 Test - eqmule
...
// CPetInfoWindow_size: 0x8c8 (see 555A71) in Apr 13 2020 Test - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a8 (see 555D62) in Apr 13 2020 Test - eqmule
...
// CTradeWnd__size: 0x2f0 (see 556AE8) in Apr 13 2020 Test - eqmule
...
// CFactionWnd__size: 0x278 (see 556C34) in Apr 13 2020 Test - eqmule
