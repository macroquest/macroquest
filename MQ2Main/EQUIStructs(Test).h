...
/*0x0040*/ BYTE		TargetAlpha; \
/*0x0041*/ bool		bBorder2; \
...
/*0x0051*/ bool		bTopAnchoredToTop; \
/*0x0052*/ bool		Minimized; \
...
/*0x00BC*/ DWORD	FadeDelay; \
/*0x00C0*/ bool		Fades; \
/*0x00C1*/ bool		bClipToParent; \
/*0x00C4*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x00C8*/ bool		bMarkedForDelete; \
...
/*0x0111*/ bool		bIsTransitioning; \
/*0x0114*/ int		BlinkState; \
/*0x0118*/ void	*DrawTemplate; \
/*0x011C*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
...
/*0x0198*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x019C*/ void	*IconTextureAnim; \
/*0x01A0*/ UINT		BlinkFadeDuration; \
/*0x01A4*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x01A5*/ bool		Faded; \
/*0x01A8*/ RECT		Location; \
/*0x01B8*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x01B9*/ bool		bUseInLayoutHorizontal; \
/*0x01BC*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x01C0*/ BYTE		StartAlpha; \
/*0x01C1*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
...
/*0x01CE*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x01CF*/ bool		bClientClipRectChanged; \
/*0x01D0*/ RECT		OldLocation; \
/*0x01E0*/ bool		bTiled; \
/*0x01E1*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x01E2*/ bool		bMaximized; \
/*0x01E3*/ bool		bUseInLayoutVertical; \
...
// CBazaarSearchWnd_size: 0x92d0 (see 54318D) in Jun 21 2019 Test - eqmule
...
// CPlayerWindow_size: 0x2e8 (see 542A7E) in Jun 21 2019 Test - eqmule
...
// CTargetWindow_size: 0x8c8 (see 542915) in Jun 21 2019 Test - eqmule
...
// CBuffWindow_size: 0x718 (see 5427B9) in Jun 21 2019 Test - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x320 (see 7F5EDB) in Jun 21 2019 Test - eqmule
...
// CCastSpellWnd_size: 0x2d0 (see 542B77) in Jun 21 2019 Test - eqmule
...
// CInvSlotWnd_size: 0x2d0 (see 7F5FEC) in Jun 21 2019 Test - eqmule
...
// CItemDisplayWindow_size: 0x628 (see 756262) in Jun 21 2019 Test - eqmule
...
// CLootWnd_size: 0x398 (see 542EE5) in Jun 21 2019 Test - eqmule
...
// CMapViewWnd_size: 0x648 (see 54261A) in Jun 21 2019 Test - eqmule
...
// CMerchantWnd_size: 0x448 (see 543041) in Jun 21 2019 Test - eqmule
...
// CPetInfoWindow_size: 0x8c8 (see 542071) in Jun 21 2019 Test - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a8 (see 542362) in Jun 21 2019 Test - eqmule
...
// CTradeWnd__size: 0x2f0 (see 5430E7) in Jun 21 2019 Test - eqmule
...
// CFactionWnd__size: 0x278 (see 543233) in Jun 21 2019 Test - eqmule
