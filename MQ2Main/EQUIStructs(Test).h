...
/*0x001c*/ BYTE         Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x001d*/ BYTE         Unknown0x001d[0x3]; \
/*0x0020*/ DWORD        TimeMouseOver; \
/*0x0024*/ BYTE         Unknown0x0024[0x8]; \
/*0x002c*/ DWORD        FadeDuration; \
/*0x0030*/ DWORD        VScrollMax; \
/*0x0034*/ BYTE         Unknown0x0034[0x8]; \
/*0x003c*/ DWORD        HScrollPos; \
/*0x0040*/ BYTE         Unknown0x0040; \
/*0x0041*/ BYTE         CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0042*/ BYTE         Minimized; \
/*0x0043*/ BYTE         Unknown0x0043[0x9]; \
/*0x004c*/ RECT         Location; \
/*0x005c*/ BYTE         FadeToAlpha; /*found in CSidlScreenWnd__StoreIniInfo_x*/\
/*0x005d*/ BYTE         Unknown0x005d[0x2b]; \
/*0x0088*/ DWORD        HScrollMax; \
/*0x008c*/ LPVOID       DrawTemplate; \
/*0x0090*/ BYTE         Unknown0x0090[0x2]; \
/*0x0092*/ BYTE         Alpha; \
/*0x0093*/ BYTE         dShow; \
/*0x0094*/ BYTE         Unknown0x0094[0x8]; \
/*0x009c*/ DWORD        UnknownCW; /*found in OnProcessFrame*/\
/*0x00a0*/ BYTE         Unknown0x00a0[0x10]; \
/*0x00b0*/ RECT         OldLocation; \
/*0x00c0*/ BYTE         Unknown0x00c0[0xc]; \
/*0x00cc*/ DWORD        TickCount2; \
/*0x00d0*/ BYTE         Unknown0x00d0[0x10]; \
/*0x00e0*/ BYTE         Faded; \
/*0x00e1*/ BYTE         Unknown0x00e1[0x3]; \
...
/*0x00f0*/ BYTE         Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x00f1*/ BYTE         Locked; /*found in CSidlScreenWnd__LoadIniInfo_x*/ \
/*0x00f2*/ BYTE         Unknown0x00f2[0x3a]; \
/*0x012c*/ BYTE         Enabled; \
/*0x012d*/ BYTE         Unknown0x012d[0x3]; \
/*0x0130*/ struct _CXSTR*       XMLToolTip; /*found in CSidlManager__CreateLabel_x*/ \
/*0x0134*/ DWORD        XMLIndex; \
/*0x0138*/ DWORD        VScrollPos; \
/*0x013c*/ BYTE         MouseOver; /*found in CXWnd__SetMouseOver_x*/ \
/*0x013d*/ BYTE         Unknown0x013d[0x2]; \
/*0x013f*/ BYTE         Fades; \
/*0x0140*/ struct _CXSTR*       WindowText; /*CXWnd__GetWindowTextA_x has this one*/ \
/*0x0144*/ DWORD        BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x "BGType" in ini */ \
/*0x0148*/ BYTE         Unknown0x0148[0x20]; \
/*0x0168*/ BYTE         ValidCXWnd; /*IsValid has this one*/\
/*0x0169*/ BYTE         Unknown0x0169[0x33]; \
/*0x019c*/ struct _CSIDLWND*    pParentWindow; /*CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x01a0*/ DWORD        ZLayer; /*found in CXWndManager__DrawWindows_x*/ \
/*0x01a4*/ BYTE         Unknown0x01a4[0x20]; \
...
// Actual Size: 0x92b8 (see 49B423) in Jan 22 2015 test - eqmule
...
// Actual Size: 0x2d4 (see 49AD5E) in Jan 22 2015 test - eqmule
...
// Actual Size: 0x8b0 (see 49ABF2) in Jan 22 2015 test - eqmule
...
// Actual Size: 0x704 (see 49AA86) in Jan 22 2015 test - eqmule
...
// Individual Gems 
// Actual Size: 0x2f4 (see 76E4F8) in Jan 22 2015 test - eqmule
...
// Actual Size: 0x2ac (see 49AE72) in Jan 22 2015 test - eqmule
...
// Actual Size: 0x2a8 (see 76E609) in Jan 22 2015 test - eqmule
...
// Actual Size: 0x5fc (see 6B846F) in Jan 22 2015 test - eqmule
...
/*0x02b0*/ BYTE         Unknown0x02b0[0x34c];
/*0x05fc*/
} EQITEMWINDOW, *PEQITEMWINDOW;

//CLootWnd__CLootWnd aLootwnd
// Actual Size: 0x3a0 (see 49B1F5) in Jan 22 2015 test - eqmule
...
// Actual Size: 0x61c (see 49A8E7) in Jan 22 2015 test - eqmule
...
// Actual Size: 0x2b8 (see 49B30F) in Jan 22 2015 test - eqmule
...
// Actual Size: 0x91c (see 49A322) in Jan 22 2015 test - eqmule
...
//aClasscolorD
// Actual Size: 0x38c (see 49A615) in Jan 22 2015 test - eqmule
...
// Actual Size: 0x2f8 (see 49B36B) in Jan 22 2015 test - eqmule
