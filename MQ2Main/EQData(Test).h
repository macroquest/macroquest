...
#define EQ_ASSIST_COMPLETE              0x2224   // aMsgTimeStampRe
#define EQ_ASSIST                       0x2008   // do_assist(PlayerClient *,char const *)+399 20160212 live (see 52C319)
