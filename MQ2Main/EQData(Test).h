...
//Actual Size: 168 (see 58e8b7 in eqgame.exe Test dated Sep 24 2015) - eqmule
...
/*0x0018*/ BYTE         Unknown0x0018[0x28];
/*0x0040*/ DWORD        Open;
/*0x0044*/ BYTE         EvolvingExpOn;
/*0x0045*/ BYTE         Unknown0x0045[0x7];
/*0x004c*/ DWORD        LinkDBValue;
/*0x0050*/ BYTE         Unknown0x0050[0x28];
/*0x0078*/ DWORD        EvolvingMaxLevel;
/*0x007c*/ BYTE         Unknown0x007c[0x10];
...
/*0x00ca*/ BYTE         Unknown0x00ca[0x1e];
...
/*0x00f8*/ BYTE         IsEvolvingItem;
/*0x00f9*/ BYTE         Unknown0x00f9[0x23];
/*0x011c*/ DWORD        Power;
/*0x0120*/ BYTE         Unknown0x0120[0x14];
/*0x0134*/ DWORD        EvolvingCurrentLevel;
/*0x0138*/ BYTE         Unknown0x0138[0x10];
/*0x0148*/ DOUBLE       EvolvingExpPct;
...
// actual size 0x1FE4 in Sep 24 2015 Test (see 0x5D16EA) - eqmule
...
/*0x0198*/ DWORD        EnduranceMax;
/*0x019c*/ BYTE         Unknown0x019c[0x44];
/*0x01e0*/ DWORD        MasterID;
/*0x01e4*/ BYTE         StandState;
/*0x01e5*/ BYTE         Unknown0x01e5[0x3];
/*0x01e8*/ DWORD        PetID;//the unknown above this is petwindow target related I think
/*0x01ec*/ BYTE         Unknown0x01ec;
/*0x01ed*/ CHAR         Suffix[0x80];
/*0x026d*/ BYTE         Unknown0x026d[0x3];
/*0x0270*/ DWORD        AFK;
/*0x0274*/ BYTE         Unknown0x0274[0xc];
/*0x0280*/ CHAR         Title[0x80];
/*0x0300*/ BYTE         Unknown0x0300[0x8];
/*0x0308*/ struct _EQC_INFO*    spawneqc_info;
/*0x030c*/ DWORD        ManaCurrent;
/*0x0310*/ BYTE         Unknown0x0310[0x4];
/*0x0314*/ LONG         HPMax;
/*0x0318*/ BYTE         Unknown0x0318[0x10];
/*0x0328*/ BYTE         Sneak;
/*0x0329*/ BYTE         PvPFlag;
/*0x032a*/ BYTE         Unknown0x032a[0x2];
/*0x032c*/ DWORD        Anon;//found in EQPlayer__SetNameSpriteTint_x
/*0x0330*/ BYTE         GM;
/*0x0331*/ BYTE         Unknown0x0331[0x3];
/*0x0334*/ DWORD        SpellCooldownETA;
/*0x0338*/ BYTE         Unknown0x0338[0x8];
/*0x0340*/ DWORD        Trader;//found in CEverQuest__RightClickedOnPlayer_x
/*0x0344*/ BYTE         Unknown0x0344[0x8];
/*0x034c*/ DWORD        ManaMax;
/*0x0350*/ BYTE         Unknown0x0350[0x4];
/*0x0354*/ DWORD        LastTick;
/*0x0358*/ DWORD        Deity;
/*0x035c*/ BYTE         Unknown0x035c[0x8];
/*0x0364*/ FLOAT        ViewHeight;
/*0x0368*/ BYTE         Unknown0x0368[0x4];
/*0x036c*/ BYTE         Linkdead;
/*0x036d*/ BYTE         Unknown0x036d[0xb];
/*0x0378*/ FLOAT        RunSpeed;//0.70 on runspeed 5...
/*0x037c*/ WORD         Zone;
/*0x037e*/ WORD         Instance;
/*0x0380*/ DWORD        FishingETA;
/*0x0384*/ BYTE         Unknown0x0384[0x4];
/*0x0388*/ DWORD        RespawnTimer;           // TimeStamp of when RespawnWnd will close - 0 when you're alive
/*0x038c*/ struct _LAUNCHSPELLDATA      CastingData; // size: 0x50
/*0x03dc*/ BYTE         FishingEvent;
/*0x03dd*/ BYTE         Unknown0x03dd[0x33];
/*0x0410*/ DWORD        GuildID;
/*0x0414*/ BYTE         Light;
/*0x0415*/ BYTE         Unknown0x0415[0x23];
/*0x0438*/ BYTE         LFG;
/*0x0439*/ BYTE         Unknown0x0439[0xf];
/*0x0448*/ BYTE         Level;
/*0x0449*/ BYTE         Unknown0x0449[0x3f];
/*0x0488*/ DWORD        Buyer;
/*0x048c*/ BYTE         Unknown0x048c[0x4];
/*0x0490*/ LONG         HPCurrent;
/*0x0494*/ BYTE         Unknown0x0494[0x34];
...
/*0x0571*/ BYTE         Unknown0x0571[0x47];
/*0x05b8*/ DWORD        EnduranceCurrent;
/*0x05bc*/ BYTE         Unknown0x05bc[0x4];
/*0x05c0*/ BYTE         HoldingType; // I dont know the types, i put a 2h in Primary and its a 4 , modrod there and its a 1, nothing its a 5 -eqmule
/*0x05c1*/ BYTE         Unknown0x05c1[0xb];
/*0x05cc*/ FLOAT        GetMeleeRangeVar1;      // used by GetMeleeRange
/*0x05d0*/ BYTE         Unknown0x05d0[0x930];
...
#define EQ_BEGIN_ZONE                   0x70B4   // CEverQuest__SavePCForce
#define EQ_END_ZONE                     0x2470   // CEverQuest__DoMainLoop+B2F
