...
//Actual Size: 0x160 (see 0x6135BC in eqgame.exe Test dated Nov  8 2019) - eqmule
...
#define EQ_ASSIST_COMPLETE              0x2618   // aMsgTimeStampRe
#define EQ_ASSIST                       0x7FF6   // do_assist(PlayerClient *,char const *)+399 20160212 live (see 52C319)
