...
// actual size 0x160 in Mar  6 2015 Test (see 0x584907) - eqmule
...
//Actual Size: 0x1fe4 Mar 06 2015 test (see 5C75FA) - eqmule
...
/*0x018c*/ BYTE         GM;
/*0x018d*/ BYTE         Unknown0x018d[0x87];
/*0x0214*/ BYTE         LFG;
/*0x0215*/ BYTE         Unknown0x0215[0x3];
/*0x0218*/ DWORD        ManaCurrent;
/*0x021c*/ BYTE         Unknown0x021c[0x4];
/*0x0220*/ DWORD        FishingETA;
/*0x0224*/ BYTE         Unknown0x0224[0x4c];
/*0x0270*/ FLOAT        RunSpeed;//0.70 on runspeed 5...
/*0x0274*/ BYTE         Unknown0x0274[0x4];
/*0x0278*/ DWORD        LastTick;
/*0x027c*/ BYTE         StandState;
/*0x027d*/ BYTE         Unknown0x027d[0x13];
/*0x0290*/ DWORD        Buyer;
/*0x0294*/ BYTE         Level;
/*0x0295*/ BYTE         Unknown0x0295[0x23];
/*0x02b8*/ DWORD        EnduranceCurrent;
/*0x02bc*/ DWORD        EnduranceMax;
/*0x02c0*/ BYTE         Unknown0x02c0[0x18];
/*0x02d8*/ DWORD        Trader;//found in CEverQuest__RightClickedOnPlayer_x
/*0x02dc*/ BYTE         Unknown0x02dc[0x28];
/*0x0304*/ DWORD        AFK;
/*0x0308*/ BYTE         Unknown0x0308[0x20];
/*0x0328*/ BYTE         HideMode;
/*0x0329*/ BYTE         Unknown0x0329[0x3];
/*0x032c*/ WORD         Zone;
/*0x032e*/ WORD         Instance;
/*0x0330*/ BYTE         Unknown0x0330[0x30];
...
/*0x036d*/ BYTE         Unknown0x036d[0x33];
/*0x03a0*/ DWORD        ManaMax;
/*0x03a4*/ BYTE         Unknown0x03a4[0xc];
/*0x03b0*/ BYTE         FishingEvent;
/*0x03b1*/ BYTE         Unknown0x03b1[0xf];
/*0x03c0*/ BYTE         PvPFlag;
/*0x03c1*/ BYTE         Unknown0x03c1[0x14];
/*0x03d5*/ BYTE         Sneak;
/*0x03d6*/ BYTE         Unknown0x03d6[0x2];
/*0x03d8*/ LONG         HPMax;
/*0x03dc*/ BYTE         Unknown0x03dc[0x8];
/*0x03e4*/ DWORD        GuildStatus;
/*0x03e8*/ BYTE         Unknown0x03e8[0x10];
/*0x03f8*/ DWORD        PetID;//the unknown above this is petwindow target related I think
/*0x03fc*/ DWORD        RespawnTimer;           // TimeStamp of when RespawnWnd will close - 0 when you're alive
/*0x0400*/ BYTE         Unknown0x0400[0x4];
/*0x0404*/ CHAR         Title[0x80];
/*0x0484*/ BYTE         Unknown0x0484[0x14];
...
/*0x04c8*/ BYTE         Linkdead;
/*0x04c9*/ BYTE         Unknown0x04c9[0x7];
/*0x04d0*/ DWORD        MasterID;
/*0x04d4*/ DWORD        GuildID;
/*0x04d8*/ BYTE         Unknown0x04d8[0x14];
/*0x04ec*/ DWORD        Deity;
/*0x04f0*/ DWORD        Anon;//found in EQPlayer__SetNameSpriteTint_x
/*0x04f4*/ BYTE         Unknown0x04f4[0x5];
/*0x04f9*/ BYTE         Mercenary;
/*0x04fa*/ BYTE         Light;
/*0x04fb*/ BYTE         Unknown0x04fb;
/*0x04fc*/ struct _LAUNCHSPELLDATA      CastingData; // size: 0x50
...
#define EQ_BEGIN_ZONE                   0x6CDA   // CEverQuest__SavePCForce
#define EQ_END_ZONE                     0x7777   // CEverQuest__DoMainLoop+B2F
