...
//Actual Size: 140 (see 592067 in eqgame.exe Test dated May 24 2016) - eqmule
...
/*0x0068*/ BYTE		Unknown0x0068[0x1c];
/*0x0084*/ DWORD	GroupID;
/*0x0088*/ BYTE		Unknown0x0088[0x10];
/*0x0098*/ DWORD	MerchantSlot;       // slot id on a merchant
/*0x009c*/ BYTE		Unknown0x009c[0x33];
/*0x00cf*/ BYTE		EvolvingExpOn;
/*0x00d0*/ BYTE		Unknown0x00d0[0x4];
/*0x00d4*/ DWORD	Open;
/*0x00d8*/ BYTE		Unknown0x00d8[0x34];
/*0x010c*/ struct _ITEMINFO*	Item1;
/*0x0110*/ BYTE		Unknown0x0110[0x18];
/*0x0128*/ BYTE		IsEvolvingItem;
/*0x0129*/ BYTE		Unknown0x0129[0xb];
...
// actual size 0x1FF8 in May 24 2016 Test (see 0x5D555A) - eqmule
...
/*0x0194*/ DWORD	AARank;
/*0x0198*/ BYTE		Unknown0x0198[0x2c];
/*0x01c4*/ BYTE		GM;
/*0x01c5*/ BYTE		Unknown0x01c5[0x27];
/*0x01ec*/ BYTE		Mercenary;
/*0x01ed*/ BYTE		Unknown0x01ed[0x7];
/*0x01f4*/ BYTE		Light;
/*0x01f5*/ BYTE		Unknown0x01f5[0x1b];
/*0x0210*/ DWORD	ManaMax;
/*0x0214*/ BYTE		Unknown0x0214[0x9c];
/*0x02b0*/ BYTE		Sneak;
/*0x02b1*/ BYTE		Unknown0x02b1[0x7];
/*0x02b8*/ BYTE		Linkdead;
/*0x02b9*/ BYTE		Unknown0x02b9[0x23];
/*0x02dc*/ DWORD	Deity;
...
/*0x02f5*/ BYTE		Unknown0x02f5[0x13];
/*0x0308*/ DWORD	MasterID;
...
/*0x03cc*/ BYTE		Unknown0x03cc[0x1c];
/*0x03e8*/ DWORD	GuildStatus;
/*0x03ec*/ BYTE		Unknown0x03ec[0x14];
/*0x0400*/ struct _EQC_INFO*	spawneqc_info;
/*0x0404*/ BYTE		Level;
/*0x0405*/ BYTE		Unknown0x0405[0x4b];
/*0x0450*/ DWORD	SpellGemETA[0xc];
/*0x0480*/ DWORD	InnateETA;              //Calculated TimeStamp when innate skill will be ready (LoH, HT, Bash)
/*0x0484*/ BYTE		LFG;
/*0x0485*/ CHAR		Suffix[0x80];
/*0x0505*/ BYTE		Unknown0x0505[0x23];
/*0x0528*/ BYTE		StandState;
/*0x0529*/ BYTE		Unknown0x0529[0x3];
/*0x052c*/ WORD		Zone;
/*0x052e*/ WORD		Instance;
/*0x0530*/ BYTE		Unknown0x0530[0x4];
/*0x0534*/ DWORD	LastTick;
/*0x0538*/ BYTE		Unknown0x0538[0x4];
/*0x053c*/ DWORD	TimeStamp;//updates all the time including when on a mount
/*0x0540*/ DWORD	Anon;//found in EQPlayer__SetNameSpriteTint_x
/*0x0544*/ struct _LAUNCHSPELLDATA	CastingData; // size: 0x50
/*0x0594*/ BYTE		FishingEvent;
/*0x0595*/ BYTE		Unknown0x0595[0x7];
/*0x059c*/ DWORD	EnduranceMax;
/*0x05a0*/ BYTE		Unknown0x05a0[0x10];
/*0x05b0*/ DWORD	SpellCooldownETA;
/*0x05b4*/ BYTE		Unknown0x05b4[0x34];
/*0x05e8*/ DWORD	GuildID;
/*0x05ec*/ BYTE		Unknown0x05ec[0x4];
/*0x05f0*/ DWORD	EnduranceCurrent;
/*0x05f4*/ LONG		HPMax;
/*0x05f8*/ BYTE		Unknown0x05f8[0x918];
...
#define EQ_ASSIST_COMPLETE              0x7A64	 // aMsg_time_stamp
#define EQ_ASSIST                       0x578F   // do_assist(PlayerClient *,char const *)+399 20160222 test (see 52C769)
#define EQ_BEGIN_ZONE                   0x2433   // CEverQuest__SavePCForce
#define EQ_END_ZONE                     0x3E59   // CEverQuest__DoMainLoop+B2F
