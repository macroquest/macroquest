...
EQLIB_OBJECT int CXWnd::HandleLButtonDown(class CXPoint *);
EQLIB_OBJECT int CXWnd::HandleLButtonHeld(class CXPoint *);
EQLIB_OBJECT int CXWnd::HandleLButtonUp(class CXPoint *);
EQLIB_OBJECT int CXWnd::HandleLButtonUpAfterHeld(class CXPoint *);
EQLIB_OBJECT int CXWnd::HandleMouseMove(class CXPoint,unsigned __int32);
EQLIB_OBJECT int CXWnd::HandleRButtonDown(class CXPoint *);
EQLIB_OBJECT int CXWnd::HandleRButtonHeld(class CXPoint *);
EQLIB_OBJECT int CXWnd::HandleRButtonUp(class CXPoint *);
EQLIB_OBJECT int CXWnd::HandleRButtonUpAfterHeld(class CXPoint *);
