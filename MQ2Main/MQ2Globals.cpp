...
INITIALIZE_EQGAME_OFFSET(pinstCGuildTributeMasterWnd);
...
INITIALIZE_EQGAME_OFFSET(pinstCLeadershipWnd);
INITIALIZE_EQGAME_OFFSET(pinstCLFGuildWnd);
INITIALIZE_EQGAME_OFFSET(pinstCMIZoneSelectWnd);
INITIALIZE_EQGAME_OFFSET(pinstCAdventureMerchantWnd);
...
INITIALIZE_EQGAME_OFFSET(pinstCPvPLeaderboardWnd);
INITIALIZE_EQGAME_OFFSET(pinstCPvPStatsWnd);
INITIALIZE_EQGAME_OFFSET(pinstCSystemInfoDialogBox);
INITIALIZE_EQGAME_OFFSET(pinstCTargetOfTargetWnd);
INITIALIZE_EQGAME_OFFSET(pinstCTaskSelectWnd);
...
INITIALIZE_EQGAME_OFFSET(pinstCTradeskillWnd);
INITIALIZE_EQGAME_OFFSET(pinstCTributeBenefitWnd);
INITIALIZE_EQGAME_OFFSET(pinstCTributeMasterWnd);
