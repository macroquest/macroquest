...
//Actual Size: 0x118 (see 0x63920C in eqgame.exe Beta dated Nov  5 2020) - eqmule
...
/*0x00B4*/ struct _CXSTR *ConvertItemName;
/*0x00B8*/ bool	bItemNeedsUpdate;
/*0x00BC*/ int	Power;
/*0x00C0*/ struct _CXSTR *	ActorTag2;
/*0x00C4*/ int	NoteStatus;
/*0x00C8*/ struct _CXSTR *	ActorTag1;
/*0x00CC*/ SharedPtr<ItemEvolutionData> pEvolutionData;
...
#define EQ_ASSIST_COMPLETE              0x5611   // aMsgTimeStampRe
#define EQ_ASSIST                       0x7DAB   // do_assist(PlayerClient *,char const *)+399 20160212 live (see 52C319)
