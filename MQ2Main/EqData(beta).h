...
//Actual Size: 0x158 (see 0x59FAF7 in eqgame.exe Beta dated Nov  4 2017) - eqmule
...
/*0x0029*/ bool	IsEvolvingItem;
/*0x002C*/ int	Open;
/*0x0030*/ int	Price;
/*0x0034*/ int	MerchantQuantity;
/*0x0038*/ bool	EvolvingExpOn;
/*0x003C*/ UINT	Tint;
...
/*0x0058*/ int	AugFlag;
/*0x005C*/ EqItemGuid ItemGUID;
/*0x0070*/ int	GroupID;
/*0x0074*/ CHAR	ActorTag2[0x1e];
/*0x0094*/ UINT	ItemHash;
/*0x0098*/ ItemBaseContainer2 Contents; /* Size is 0x1c */
/*0x00B8*/ __int64 MerchantSlot;
/*0x00C0*/ int	ScriptIndex;
/*0x00C4*/ bool	bRealEstateItemPlaceable;
/*0x00C8*/ struct _CXSTR *SaveString;
/*0x00CC*/ bool	bCollected;
/*0x00CD*/ bool	bDisableAugTexture;
/*0x00D0*/ int	ItemColor;
/*0x00D4*/ UINT	NewArmorID;
/*0x00D8*/ CHAR	ActorTag1[0x1e];
/*0x00F8*/ int	Power;
...
/*0x0110*/ bool	bRankDisabled;
/*0x0114*/ ItemGlobalIndex2 GlobalIndex; /* Size is 0xa (0xc)*/
/*0x0120*/ int	EvolvingCurrentLevel;
/*0x0124*/ int	Charges;
/*0x0128*/ int	ArmorType;
/*0x012C*/ int	EvolvingMaxLevel;
/*0x0130*/ ArrayClass_RO<UINT> RealEstateArray;
/*0x0140*/ int	NoteStatus;
//start of ItemClient
...
/*0x018C*/ int		Trader;	/* found in CEverQuest__RightClickedOnPlayer_x */ \
/*0x0190*/ UINT		SitStartTime; \
/*0x0194*/ int		HPMax; \
/*0x0198*/ void		*pRaceGenderInfo; /* todo this is not a void* so... map the CRaceGenderInfo class */ \
/*0x019C*/ bool		Mercenary; \
/*0x019D*/ bool		bAlwaysShowAura; \
/*0x019E*/ BYTE		FindBits; \
/*0x01A0*/ UINT		EnduranceMax; \
/*0x01A4*/ bool		bBuffTimersOnHold; /* no you can't control this client side so unless you want to get banned leave it alone */ \
/*0x01A8*/ int		NpcTintIndex; \
/*0x01AC*/ BYTE		Blind; \
/*0x01B0*/ UINT		LastSecondaryUseTime; \
/*0x01B4*/ bool		bSummoned; /* by a PC or by anyone? need to investigate */ \
/*0x01B8*/ UINT		LastTick; \
/*0x01BC*/ struct _EQC_INFO*	spawneqc_info; \
/*0x01C0*/ UINT		LastRefresh; \
/*0x01C4*/ UINT		SpellCooldownETA; \
/*0x01C8*/ UINT		LastTimeStoodStill; \
/*0x01CC*/ CHAR		GM; \
/*0x01D0*/ CPhysicsInfo	LastCollision; \
/*0x0200*/ int		HideMode; \
/*0x0204*/ bool		PvPFlag; \
/*0x0205*/ bool		bTempPet; \
/*0x0208*/ FLOAT		MyWalkSpeed; \
/*0x020C*/ BYTE		InPvPArea; /* are we in a PvP area? */ \
/*0x020D*/ BYTE		HoldingAnimation; /* todo: create enum for this byte. Holding: Nothing=0 A RightHand Weapon=1 A Shield=2 Dual Wielding Two Weapons=3 A Spear=4 A LeftHand Weapon=5 A Two Handed Weapon=6 A bow=7 */ \
/*0x020E*/ bool		bAttackRelated; \
/*0x0210*/ int		LastCastNum; \
/*0x0214*/ DWORD		Zone; \
/*0x0218*/ DWORD		LoginSerial; \
/*0x0220*/ __int64	GuildID; \
/*0x0228*/ bool		bShowHelm; \
/*0x022C*/ int		RealEstateID; \
/*0x0230*/ bool		bBetaBuffed; \
/*0x0231*/ BYTE		TitleVisible; \
/*0x0234*/ int		SecondaryTintIndex; \
/*0x0238*/ UINT		LastResendAddPlayerPacket; \
/*0x023C*/ DWORD		Meditating; \
/*0x0240*/ int		Stuff; \
/*0x0244*/ BYTE		StandState; \
/*0x0245*/ bool		Sneak; \
/*0x0246*/ BYTE		IsPassenger; /* if u are on a boat or airship or whatever */ \
/*0x0248*/ UINT		NextIntimidateTime; \
/*0x024C*/ int		IsAttacking; /* need to investigate */ \
/*0x0250*/ UINT		MasterID; \
/*0x0254*/ UINT		CombatSkillTicks[0x2]; \
/*0x025C*/ int		GuildStatus; \
/*0x0260*/ BYTE		CharClass; /* Im pretty sure this isnt working */ \
/*0x0264*/ int		SomeData[0x2]; \
/*0x026C*/ UINT		CombatSkillUsed[0x2]; \
/*0x0274*/ bool		bStationary; \
/*0x0278*/ FLOAT		GetMeleeRangeVar1; /* used by GetMeleeRange */ \
/*0x027C*/ int		DoSpecialMelee; \
/*0x0280*/ CHAR		DraggingPlayer[0x40]; \
/*0x02C0*/ FLOAT		MissileRangeToTarget; \
/*0x02C4*/ int		ManaMax; \
/*0x02C8*/ BYTE		GMRank; /* i think */ \
/*0x02CC*/ UINT		ACounter; /* not sure what this one is for*/ \
/*0x02D0*/ FLOAT		ViewHeight; \
/*0x02D4*/ bool		Linkdead; \
/*0x02D8*/ int		EnduranceCurrent; \
/*0x02DC*/ int		AARank;/* this really is the title id */ \
/*0x02E0*/ CHAR		LoginRelated[0x20]; \
/*0x0300*/ UINT		LastRangedUsedTime; \
/*0x0304*/ FLOAT		MerchantGreed; \
/*0x0308*/ UINT		StunTimer; \
/*0x030C*/ UINT		MinuteTimer; \
/*0x0310*/ UINT		LastTrapDamageTime; \
/*0x0314*/ CHAR		Handle[0x20]; \
/*0x0334*/ BYTE		FishingEvent; \
/*0x0338*/ int		Deity; \
/*0x033C*/ BYTE		IntimidateCount; \
/*0x033D*/ bool		LFG; \
/*0x033E*/ bool		bSwitchMoved; /* true when a door moves near the spawn */ \
/*0x0340*/ UINT		SpellGemETA[0xf]; /*InnateETA is now the last member in this array */ \
/*0x037C*/ FLOAT		CameraOffset; \
/*0x0380*/ FLOAT		AnimationSpeedRelated; \
/*0x0384*/ FLOAT		BearingToTarget; \
/*0x0388*/ struct _LAUNCHSPELLDATA	CastingData; /* size: 0x58 */ \
/*0x03E0*/ UINT		RespawnTimer; /* its actually TimeOfDeath...TimeStamp of when RespawnWnd will close - 0 when you're alive */ \
/*0x03E4*/ EqItemGuid 	realEstateItemGuid; \
/*0x03F8*/ int		PrimaryTintIndex; \
/*0x03FC*/ FLOAT		FallingStartZ; \
/*0x0400*/ UINT		TimeStamp; /* updates all the time including when on a mount */ \
/*0x0404*/ int		DontKnowYet; \
/*0x0408*/ UINT		LastPrimaryUseTime; \
/*0x040C*/ CHAR		DragNames[0x2][0x40]; \
/*0x048C*/ BYTE		HmmWhat; /* todo: figure out */ \
/*0x048D*/ CHAR		Suffix[0x80]; \
/*0x0510*/ int		ManaCurrent; \
/*0x0514*/ int		AltAttack; \
/*0x0518*/ UINT		FishingETA; \
/*0x051C*/ int		berserker; \
/*0x0520*/ int		HPCurrent; \
/*0x0524*/ int		CurrIOState; \
/*0x0528*/ bool		bOfflineMode; \
/*0x0529*/ bool		bAnimationOnPop; \
/*0x052C*/ int		WarCry; \
/*0x0530*/ CHAR		Title[0x80]; \
/*0x05B0*/ int		PetID; \
/*0x05B4*/ DWORD		LastCastTime; \
/*0x05B8*/ int		Anon; /* found in EQPlayer__SetNameSpriteTint_x */ \
/*0x05BC*/ UINT		NextSwim; \
/*0x05C0*/ int		RealEstateItemId; \
/*0x05C4*/ UINT		CorpseDragCount; \
/*0x05C8*/ BYTE		FD; \
/*0x05CC*/ DWORD		PotionTimer; \
/*0x05D0*/ DWORD		**ppUDP; /* UdpLibrary::UdpConnection? */ \
/*0x05D4*/ int		AFK; \
/*0x05D8*/ UINT		LastMealTime; /* last time we eat or drank */ \
/*0x05DC*/ BYTE		Type2; /* check */ \
/*0x05DD*/ BYTE		LastAttack; \
/*0x05DE*/ BYTE		Light; \
/*0x05E0*/ FLOAT		RunSpeed; /*0.70 on runspeed 5... */ \
/*0x05E4*/ void		*pTouchingSwitch; /* need to get that in here : struct _EQSWITCH */ \
/*0x05E8*/ int		SomethingElse; \
/*0x05EC*/ BYTE		Level; \
/*0x05F0*/ struct _SPAWNINFO*	pViewPlayer; \
/*0x05F4*/ int		Buyer; \
/*0x05F8*/
...
#define EQ_ASSIST_COMPLETE              0x764F   // aMsg_time_stamp
#define EQ_BEGIN_ZONE                   0x507E   // CEverQuest__SavePCForce
#define EQ_END_ZONE                     0x45F6   // CEverQuest__DoMainLoop+B2F
#define EQ_ASSIST                       0x06C8   // do_assist(PlayerClient *,char const *)+399 20160212 live (see 52C319)
