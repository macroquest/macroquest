...
//Actual Size: 0x158 (see 0x59ED27 in eqgame.exe Beta dated Dec  7 2017) - eqmule
...
/*0x00D6*/ bool	bRealEstateItemPlaceable;
...
/*0x011C*/ bool	bCollected;
/*0x0120*/ int	NoteStatus;
/*0x0124*/ int	GroupID;
/*0x0128*/ ItemGlobalIndex2 GlobalIndex; /* Size is 0xa (0xc)*/
/*0x0134*/ UINT	Tint;
/*0x0138*/ int	Open;
/*0x013C*/ int	EvolvingMaxLevel;
...
/*0x0240*/ BYTE		LastAttack; \
/*0x0241*/ bool		bTempPet; \
/*0x0244*/ UINT		SpellCooldownETA; \
/*0x0248*/ BYTE		FishingEvent; \
/*0x024C*/ UINT		RespawnTimer; /* its actually TimeOfDeath...TimeStamp of when RespawnWnd will close - 0 when you're alive */ \
/*0x0250*/ EqItemGuid 	realEstateItemGuid; \
/*0x0264*/ int		RealEstateItemId; \
/*0x0268*/ CHAR		Handle[0x20]; \
/*0x0288*/ UINT		StunTimer; \
/*0x028C*/ int		CurrIOState; \
/*0x0290*/ int		HPCurrent; \
/*0x0294*/ BYTE		InPvPArea; /* are we in a PvP area? */ \
/*0x0298*/ int		LastCastNum; \
/*0x029C*/ int		Deity; \
/*0x02A0*/ struct _EQC_INFO*	spawneqc_info; \
/*0x02A4*/ int		DoSpecialMelee; \
/*0x02A8*/ DWORD		Zone; \
/*0x02AC*/ bool		bStationary; \
/*0x02B0*/ FLOAT		CameraOffset; \
/*0x02B4*/ UINT		MasterID; \
/*0x02B8*/ int		Anon; /* found in EQPlayer__SetNameSpriteTint_x */ \
/*0x02BC*/ FLOAT		MissileRangeToTarget; \
/*0x02C0*/ UINT		NextSwim; \
/*0x02C4*/ CHAR		Suffix[0x80]; \
/*0x0344*/ bool		bShowHelm; \
...
/*0x0358*/ UINT		SpellGemETA[0xf]; /*InnateETA is now the last member in this array */ \
/*0x0394*/ CHAR		GM; \
/*0x0398*/ UINT		EnduranceMax; \
/*0x039C*/ DWORD		**ppUDP; /* UdpLibrary::UdpConnection? */ \
/*0x03A0*/ UINT		LastTrapDamageTime; \
/*0x03A4*/ FLOAT		MerchantGreed; \
/*0x03A8*/ UINT		LastTimeStoodStill; \
/*0x03AC*/ bool		PvPFlag; \
/*0x03B0*/ UINT		LastSecondaryUseTime; \
/*0x03B4*/ bool		bSummoned; /* by a PC or by anyone? need to investigate */ \
/*0x03B8*/ DWORD		PotionTimer; \
/*0x03BC*/ FLOAT		ViewHeight; \
/*0x03C0*/ bool		Sneak; \
/*0x03C4*/ UINT		CombatSkillTicks[0x2]; \
/*0x03CC*/ int		GuildStatus; \
/*0x03D0*/ int		SomeData[0x2]; \
/*0x03D8*/ void		*pRaceGenderInfo; /* todo this is not a void* so... map the CRaceGenderInfo class */ \
/*0x03DC*/ int		SecondaryTintIndex; \
/*0x03E0*/ int		ManaCurrent; \
/*0x03E4*/ int		PetID; \
/*0x03E8*/ int		NpcTintIndex; \
/*0x03EC*/ BYTE		HmmWhat; /* todo: figure out */ \
/*0x03F0*/ int		SomethingElse; \
/*0x03F4*/ BYTE		CharClass; /* Im pretty sure this isnt working */ \
/*0x03F8*/ int		HPMax; \
...
/*0x03FD*/ BYTE		Type2; /* check */ \
/*0x0400*/ int		berserker; \
/*0x0404*/ int		WarCry; \
/*0x0408*/ int		EnduranceCurrent; \
/*0x040C*/ BYTE		TitleVisible; \
/*0x0410*/ DWORD		LoginSerial; \
/*0x0414*/ bool		Linkdead; \
/*0x0415*/ bool		bSwitchMoved; /* true when a door moves near the spawn */ \
/*0x0416*/ BYTE		GMRank; /* i think */ \
/*0x0418*/ DWORD		Meditating; \
/*0x041C*/ UINT		FishingETA; \
/*0x0420*/ FLOAT		AnimationSpeedRelated; \
/*0x0424*/ UINT		LastResendAddPlayerPacket; \
/*0x0428*/ void		*pTouchingSwitch; /* need to get that in here : struct _EQSWITCH */ \
/*0x042C*/ int		Stuff; \
/*0x0430*/ BYTE		IsPassenger; /* if u are on a boat or airship or whatever */ \
/*0x0434*/ int		RealEstateID; \
/*0x0438*/ int		AARank;/* this really is the title id */ \
/*0x043C*/ bool		bOfflineMode; \
/*0x0440*/ DWORD		LastCastTime; \
/*0x0444*/ UINT		SitStartTime; \
/*0x0448*/ int		PrimaryTintIndex; \
/*0x044C*/ BYTE		Light; \
/*0x0450*/ FLOAT		GetMeleeRangeVar1; /* used by GetMeleeRange */ \
/*0x0454*/ CHAR		LoginRelated[0x20]; \
/*0x0474*/ FLOAT		MyWalkSpeed; \
/*0x0478*/ UINT		LastMealTime; /* last time we eat or drank */ \
/*0x047C*/ UINT		LastRangedUsedTime; \
/*0x0480*/ bool		bAttackRelated; \
/*0x0484*/ FLOAT		RunSpeed; /*0.70 on runspeed 5... */ \
/*0x0488*/ __int64	GuildID; \
/*0x0490*/ int		Buyer; \
/*0x0494*/ BYTE		Level; \
/*0x0495*/ BYTE		Blind; \
/*0x0498*/ UINT		NextIntimidateTime; \
/*0x049C*/ UINT		CombatSkillUsed[0x2]; \
/*0x04A4*/ CHAR		DraggingPlayer[0x40]; \
/*0x04E4*/ UINT		MinuteTimer; \
/*0x04E8*/ CHAR		DragNames[0x2][0x40]; \
/*0x0568*/ int		AFK; \
/*0x056C*/ CHAR		Title[0x80]; \
/*0x05EC*/ int		AltAttack; \
/*0x05F0*/ int		IsAttacking; /* need to investigate */ \
/*0x05F4*/ FLOAT		BearingToTarget; \
/*0x05F8*/ int		DontKnowYet; \
/*0x05FC*/ bool		bBetaBuffed; \
/*0x0600*/ UINT		CorpseDragCount; \
/*0x0604*/ UINT		LastTick; \
/*0x0608*/ struct _SPAWNINFO*	pViewPlayer; \
/*0x060C*/
...
#define EQ_ASSIST_COMPLETE              0x7641   // aMsg_time_stamp
#define EQ_BEGIN_ZONE                   0x3DFA   // CEverQuest__SavePCForce
#define EQ_END_ZONE                     0x1875   // CEverQuest__DoMainLoop+B2F
#define EQ_ASSIST                       0x4D7C   // do_assist(PlayerClient *,char const *)+399 20160212 live (see 52C319)
