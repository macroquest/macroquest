...
//Actual Size: 148 (see 596807 in eqgame.exe Beta dated Nov 10 2016) - eqmule
...
/*0x0011*/ BYTE		Unknown0x0011[0xf];
/*0x0020*/ char		ItemGUID[0x12];
/*0x0032*/ BYTE		Unknown0x0032[0x6];
/*0x0038*/ DOUBLE	EvolvingExpPct;
/*0x0040*/ BYTE		Unknown0x0040[0x14];
/*0x0054*/ DWORD	MerchantQuantity;
/*0x0058*/ BYTE		Unknown0x0058[0x28];
/*0x0080*/ DWORD	OrnamentationIcon;
/*0x0084*/ DWORD	Price;
/*0x0088*/ BYTE		Unknown0x0088[0x10];
/*0x0098*/ DWORD	EvolvingCurrentLevel;
/*0x009c*/ DWORD	Open;
...
/*0x00c4*/ DWORD	NumOfSlots1;//ItemSlot is this address + 0x16 in 20130708
/*0x00c8*/ DWORD	ItemLocation;//0x1b mount 0x1d illusion
/*0x00cc*/ struct _CONTENTSARRAY*	pContentsArray;
/*0x00d0*/ DWORD	NumOfSlots2;
/*0x00d4*/ BYTE		Unknown0x00d4[0x6];
/*0x00da*/ WORD		ItemSlot;           // Inventory slot id
/*0x00dc*/ WORD		ItemSlot2;          // Bag slot id, starts at 0 for first slot in bag, or FFFF if item is on cursor
/*0x00de*/ BYTE		Unknown0x00de[0x2a];
/*0x0108*/ LONG		StackCount;
...
// actual size 0x1FF8 in Nov 10 2016 Beta (see 0x5DA0DA) - eqmule
...
/*0x0161*/ BYTE		Unknown0x0161[0x4f];
/*0x01b0*/ DWORD	SpellGemETA[0xc];
/*0x01e0*/ DWORD	InnateETA;              //Calculated TimeStamp when innate skill will be ready (LoH, HT, Bash)
...
/*0x0200*/ BYTE		Unknown0x0200[0x8];
/*0x0208*/ DWORD	Trader;//found in CEverQuest__RightClickedOnPlayer_x
/*0x020c*/ DWORD	ManaMax;
/*0x0210*/ BYTE		Unknown0x0210[0x4];
/*0x0214*/ FLOAT	ViewHeight;
/*0x0218*/ DWORD	FishingETA;
/*0x021c*/ BYTE		HideMode;
/*0x021d*/ BYTE		Unknown0x021d[0x1b];
/*0x0238*/ DWORD	AFK;
/*0x023c*/ BYTE		Unknown0x023c[0xc];
/*0x0248*/ BYTE		LFG;
/*0x0249*/ BYTE		Sneak;
/*0x024a*/ BYTE		PvPFlag;
/*0x024b*/ BYTE		Unknown0x024b[0x29];
/*0x0274*/ DWORD	SpellCooldownETA;
/*0x0278*/ BYTE		Unknown0x0278[0x14];
/*0x028c*/ DWORD	EnduranceCurrent;
/*0x0290*/ BYTE		Unknown0x0290[0x4];
/*0x0294*/ FLOAT	GetMeleeRangeVar1;      // used by GetMeleeRange
/*0x0298*/ BYTE		StandState;
/*0x0299*/ BYTE		Unknown0x0299[0x13];
/*0x02ac*/ BYTE		Light;
/*0x02ad*/ CHAR		Title[0x80];
/*0x032d*/ BYTE		Unknown0x032d[0x7];
/*0x0334*/ DWORD	LastTick;
/*0x0338*/ BYTE		Unknown0x0338[0x8];
/*0x0340*/ DWORD	AARank;
/*0x0344*/ BYTE		Linkdead;
/*0x0345*/ BYTE		Unknown0x0345;
/*0x0346*/ BYTE		Level;
/*0x0347*/ BYTE		Unknown0x0347;
/*0x0348*/ DWORD	Buyer;
/*0x034c*/ BYTE		Unknown0x034c[0x90];
/*0x03dc*/ FLOAT	RunSpeed;//0.70 on runspeed 5...
/*0x03e0*/ LONG		HPMax;
/*0x03e4*/ BYTE		Unknown0x03e4[0x3];
/*0x03e7*/ BYTE		Mercenary;
...
/*0x03fc*/ DWORD	Deity;
/*0x0400*/ BYTE		Unknown0x0400[0x38];
/*0x0438*/ DWORD	GuildStatus;
/*0x043c*/ BYTE		Unknown0x043c[0x18];
/*0x0454*/ DWORD	ManaCurrent;
/*0x0458*/ BYTE		GM;
/*0x0459*/ BYTE		Unknown0x0459[0x7];
/*0x0460*/ struct _LAUNCHSPELLDATA	CastingData; // size: 0x50
/*0x04b0*/ BYTE		FishingEvent;
/*0x04b1*/ BYTE		Unknown0x04b1[0x7];
/*0x04b8*/ DWORD	Anon;//found in EQPlayer__SetNameSpriteTint_x
/*0x04bc*/ struct _EQC_INFO*	spawneqc_info;
/*0x04c0*/ BYTE		Unknown0x04c0[0xa];
/*0x04ca*/ CHAR		Suffix[0x80];
/*0x054a*/ BYTE		Unknown0x054a[0x6];
/*0x0550*/ WORD		Zone;
/*0x0552*/ WORD		Instance;
/*0x0554*/ BYTE		Unknown0x0554;
/*0x0555*/ BYTE		HoldingType; // I dont know the types, i put a 2h in Primary and its a 4 , modrod there and its a 1, nothing its a 5 -eqmule
/*0x0556*/ BYTE		Unknown0x0556[0x2];
/*0x0558*/ DWORD	GuildID;
/*0x055c*/ DWORD	GuildID2;
/*0x0560*/ LONG		HPCurrent;
/*0x0564*/ BYTE		Unknown0x0564[0x998];
...
/*0x111c*/ BYTE		Unknown0x111c[0x68];
...
#define EQ_ASSIST_COMPLETE              0x7967   // aMsg_time_stamp
#define EQ_BEGIN_ZONE                   0x0BC1   // CEverQuest__SavePCForce				
#define EQ_END_ZONE                     0x2238   // CEverQuest__DoMainLoop+B2F			
#define EQ_ASSIST                       0x1343   // do_assist(PlayerClient *,char const *)+399 20160212 live (see 52C319)
