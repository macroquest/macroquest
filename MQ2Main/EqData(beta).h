...
//Actual Size: 0x158 (see 0x625B5C in eqgame.exe Beta dated Dec  2 2019) - eqmule
...
/*0x0100*/ bool	bItemNeedsUpdate;
/*0x0101*/ EqItemGuid ItemGUID;
/*0x0114*/ UINT	NewArmorID;
/*0x0118*/ int	ArmorType;
/*0x011C*/ UINT	Tint;
/*0x0120*/ int	ScriptIndex;
...
#define EQ_ASSIST_COMPLETE              0x0827   // aMsgTimeStampRe
#define EQ_ASSIST                       0x5B2F   // do_assist(PlayerClient *,char const *)+399 20160212 live (see 52C319)
