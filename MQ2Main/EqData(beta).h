...
//Actual Size: 0x110 (see 0x639B1C in eqgame.exe Beta dated Nov 10 2020) - eqmule
...
/*0x004C*/ struct _CXSTR *	ActorTag1;
/*0x0050*/ UINT	NewArmorID;
/*0x0054*/ UINT	Tint;
/*0x0058*/ bool	bDisableAugTexture;
/*0x005C*/ SharedPtr<ItemEvolutionData> pEvolutionData;
...
#define EQ_ASSIST                       0x4715   // do_assist(PlayerClient *,char const *)+399 20160212 live (see 52C319)
