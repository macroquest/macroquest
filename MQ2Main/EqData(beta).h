...
//Actual Size: 0x108 (see 0x638F2C in eqgame.exe Beta dated Nov 15 2020) - eqmule
...
/*0x0015*/ bool	bCopied;
/*0x0016*/ bool	bRankDisabled;
/*0x0018*/ int	ScriptIndex;
/*0x001C*/ int	Luck;
/*0x0020*/ struct _CXSTR *	ActorTag2;
...
/*0x006C*/ struct _CXSTR *	ActorTag1;
/*0x0070*/ int	RealEstateID;
/*0x0074*/ int	Open;
/*0x0078*/ UINT	LastCastTime;
/*0x007C*/ int	MerchantQuantity;
/*0x0080*/ SharedPtr<ItemEvolutionData> pEvolutionData;
...
#define EQ_ASSIST                       0x6ED9   // do_assist(PlayerClient *,char const *)+399 20160212 live (see 52C319)
