...
//Actual Size: 0x158 (see 0x60724C in eqgame.exe Beta dated Nov 20 2018) - eqmule
...
/*0x013C*/ bool	EvolvingExpOn;
/*0x0140*/ UINT	LastCastTime;
/*0x0144*/ bool	IsEvolvingItem;
/*0x0145*/ bool	bDisableAugTexture;
//start of ItemClient
...
/*0x01CC*/ UINT		LastTick; \
/*0x01D0*/ struct _LAUNCHSPELLDATA	CastingData; /* size: 0x58 */ \
/*0x0228*/ FLOAT		BearingToTarget; \
/*0x022C*/ bool		bAttackRelated; \
/*0x0230*/ int		AltAttack; \
/*0x0234*/ BYTE		HmmWhat; /* todo: figure out */ \
/*0x0238*/ UINT		SitStartTime; \
/*0x023C*/ bool		bAlwaysShowAura; \
/*0x0240*/ int		RealEstateItemId; \
/*0x0244*/ UINT		EnduranceMax; \
/*0x0248*/ UINT		LastMealTime; /* last time we eat or drank */ \
/*0x024C*/ int		Anon; /* found in EQPlayer__SetNameSpriteTint_x */ \
/*0x0250*/ __int64		HPMax; \
/*0x0258*/ UINT		FishingETA; \
/*0x025C*/ BYTE		HoldingAnimation; /* todo: create enum for this byte. Holding: Nothing=0 A RightHand Weapon=1 A Shield=2 Dual Wielding Two Weapons=3 A Spear=4 A LeftHand Weapon=5 A Two Handed Weapon=6 A bow=7 */ \
/*0x0260*/ UINT		LastResendAddPlayerPacket; \
/*0x0264*/ void		*pRaceGenderInfo; /* todo this is not a void* so... map the CRaceGenderInfo class */ \
/*0x0268*/ DWORD		LastCastTime; \
/*0x026C*/ CHAR		Title[0x80]; \
/*0x02EC*/ BYTE		Type2; /* check */ \
/*0x02ED*/ BYTE		IsPassenger; /* if u are on a boat or airship or whatever */ \
/*0x02F0*/ struct _EQC_INFO*	spawneqc_info; \
/*0x02F4*/ UINT		RespawnTimer; /* its actually TimeOfDeath...TimeStamp of when RespawnWnd will close - 0 when you're alive */ \
/*0x02F8*/ CHAR		DragNames[0x2][0x40]; \
/*0x0378*/ int		WarCry; \
/*0x037C*/ UINT		StunTimer; \
/*0x0380*/ UINT		NextIntimidateTime; \
/*0x0384*/ bool		LFG; \
/*0x0388*/ int		PrimaryTintIndex; \
/*0x0390*/ __int64	GuildID; \
/*0x0398*/ int		SomeData[0x2]; \
/*0x03A0*/ int		LastCastNum; \
/*0x03A4*/ UINT		SpellCooldownETA; \
/*0x03A8*/ int		ManaMax; \
/*0x03AC*/ BYTE		StandState; \
/*0x03B0*/ int		EnduranceCurrent; \
/*0x03B4*/ int		RealEstateID; \
/*0x03B8*/ FLOAT		MerchantGreed; \
/*0x03BC*/ bool		Mercenary; \
/*0x03BD*/ BYTE		CharClass; /* Im pretty sure this isnt working */ \
/*0x03BE*/ BYTE		Light; \
/*0x03C0*/ int		AFK; \
/*0x03C4*/ BYTE		IntimidateCount; \
/*0x03C5*/ CHAR		Suffix[0x80]; \
/*0x0448*/ UINT		MasterID; \
/*0x044C*/ BYTE		TitleVisible; \
/*0x0450*/ DWORD		Meditating; \
/*0x0454*/ UINT		LastRangedUsedTime; \
/*0x0458*/ bool		bAnimationOnPop; \
/*0x045C*/ int		Buyer; \
/*0x0460*/ int		berserker; \
/*0x0464*/ bool		bTempPet; \
/*0x0468*/ FLOAT		MyWalkSpeed; \
/*0x046C*/ FLOAT		GetMeleeRangeVar1; /* used by GetMeleeRange */ \
/*0x0470*/ UINT		CorpseDragCount; \
/*0x0474*/ FLOAT		CameraOffset; \
/*0x0478*/ bool		bSwitchMoved; /* true when a door moves near the spawn */ \
/*0x0479*/ bool		bStationary; \
/*0x047C*/ struct _SPAWNINFO*	pViewPlayer; \
/*0x0480*/ FLOAT		MissileRangeToTarget; \
/*0x0484*/ bool		Sneak; \
/*0x0488*/ int		AARank;/* this really is the title id */ \
/*0x048C*/ CHAR		LoginRelated[0x20]; \
/*0x04AC*/ void		*pTouchingSwitch; /* need to get that in here : struct _EQSWITCH */ \
/*0x04B0*/ bool		bOfflineMode; \
/*0x04B1*/ BYTE		FindBits; \
/*0x04B8*/ __int64		HPCurrent; \
/*0x04C0*/ BYTE		InPvPArea; /* are we in a PvP area? */ \
/*0x04C4*/ UINT		LastRefresh; \
/*0x04C8*/ bool		bBuffTimersOnHold; /* no you can't control this client side so unless you want to get banned leave it alone */ \
...
/*0x04DC*/ UINT		CombatSkillTicks[0x2]; \
/*0x04E4*/ int		DontKnowYet; \
/*0x04E8*/ UINT		LastTimeStoodStill; \
/*0x04EC*/ UINT		SpellGemETA[0xf]; /*InnateETA is now the last member in this array */ \
...
/*0x053D*/ BYTE		GMRank; /* i think */ \
/*0x0540*/ DWORD		LoginSerial; \
/*0x0544*/ int		PetID; \
/*0x0548*/ bool		PvPFlag; \
/*0x054C*/ int		HideMode; \
/*0x0550*/ FLOAT		RunSpeed; /*0.70 on runspeed 5... */ \
/*0x0554*/ int		DoSpecialMelee; \
...
/*0x05CC*/ DWORD		**ppUDP; /* UdpLibrary::UdpConnection? */ \
...
/*0x05E8*/ UINT		LastPrimaryUseTime; \
/*0x05EC*/ BYTE		Blind; \
/*0x05F0*/ UINT		LastTrapDamageTime; \
/*0x05F4*/ UINT		CombatSkillUsed[0x2]; \
/*0x05FC*/ BYTE		FishingEvent; \
/*0x0600*/ FLOAT		ViewHeight; \
/*0x0604*/ UINT		ACounter; /* not sure what this one is for*/ \
/*0x0608*/ UINT		NextSwim; \
/*0x060C*/ UINT		MinuteTimer; \
/*0x0610*/
...
#define EQ_ASSIST_COMPLETE              0x5523   // aMsgTimeStampRe
#define EQ_BEGIN_ZONE                   0x5A6B   // CEverQuest__SavePCForce
#define EQ_END_ZONE                     0x4719   // CEverQuest__DoMainLoop+B2F
#define EQ_ASSIST                       0x182D   // do_assist(PlayerClient *,char const *)+399 20160212 live (see 52C319)
