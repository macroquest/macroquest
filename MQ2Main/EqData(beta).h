...
//Actual Size: 0x150 (see 0x604E7C in eqgame.exe Beta dated Nov 11 2018) - eqmule
...
/*0x003C*/ ItemBaseContainer2 Contents; /* Size is 0x1c */
/*0x0058*/ bool	bCollected;
/*0x0059*/ bool	EvolvingExpOn;
...
/*0x00A0*/ bool	bCopied;
/*0x00A1*/ bool	bDisableAugTexture;
/*0x00A2*/ bool	bRealEstateItemPlaceable;
/*0x00A4*/ int	Open;
/*0x00A8*/ int	DontKnow2;
...
/*0x018C*/ UINT		LastSecondaryUseTime; \
/*0x0190*/ UINT		LastTimeStoodStill; \
/*0x0194*/ BYTE		IsPassenger; /* if u are on a boat or airship or whatever */ \
/*0x0198*/ int		SecondaryTintIndex; \
/*0x019C*/ BYTE		FD; \
/*0x019D*/ CHAR		GM; \
/*0x01A0*/ int		AARank;/* this really is the title id */ \
/*0x01A4*/ BYTE		StandState; \
/*0x01A8*/ UINT		NextSwim; \
/*0x01AC*/ bool		bBetaBuffed; \
/*0x01B0*/ int		HideMode; \
...
/*0x01C0*/ UINT		ACounter; /* not sure what this one is for*/ \
/*0x01C4*/ UINT		NextIntimidateTime; \
/*0x01C8*/ int		ManaCurrent; \
/*0x01CC*/ BYTE		GMRank; /* i think */ \
/*0x01CD*/ BYTE		InPvPArea; /* are we in a PvP area? */ \
/*0x01D0*/ UINT		MasterID; \
/*0x01D4*/ int		SomethingElse; \
...
/*0x020C*/ UINT		CombatSkillTicks[0x2]; \
/*0x0214*/ int		DontKnowYet; \
/*0x0218*/ BYTE		Type2; /* check */ \
/*0x021C*/ UINT		EnduranceMax; \
/*0x0220*/ FLOAT		MyWalkSpeed; \
/*0x0224*/ UINT		LastRefresh; \
/*0x0228*/ int		Deity; \
/*0x022C*/ int		PrimaryTintIndex; \
/*0x0230*/ int		berserker; \
/*0x0234*/ int		Stuff; \
/*0x0238*/ UINT		LastTrapDamageTime; \
/*0x023C*/ int		AltAttack; \
/*0x0240*/ CHAR		DraggingPlayer[0x40]; \
/*0x0280*/ BYTE		Blind; \
/*0x0281*/ bool		bOfflineMode; \
/*0x0288*/ __int64		HPCurrent; \
/*0x0290*/ int		IsAttacking; /* need to investigate */ \
/*0x0294*/ DWORD		LastCastTime; \
/*0x0298*/ CHAR		DragNames[0x2][0x40]; \
/*0x0318*/ int		DoSpecialMelee; \
/*0x031C*/ int		CurrIOState; \
/*0x0320*/ void		*pTouchingSwitch; /* need to get that in here : struct _EQSWITCH */ \
/*0x0328*/ __int64		HPMax; \
/*0x0330*/ int		Buyer; \
/*0x0334*/ CPhysicsInfo	LastCollision; \
/*0x0364*/ CHAR		Suffix[0x80]; \
/*0x03E4*/ void		*pRaceGenderInfo; /* todo this is not a void* so... map the CRaceGenderInfo class */ \
/*0x03E8*/ __int64	GuildID; \
/*0x03F0*/ struct _LAUNCHSPELLDATA	CastingData; /* size: 0x58 */ \
/*0x0448*/ UINT		LastTick; \
/*0x044C*/ struct _SPAWNINFO*	pViewPlayer; \
/*0x0450*/ BYTE		FishingEvent; \
/*0x0451*/ CHAR		Title[0x80]; \
/*0x04D4*/ DWORD		Meditating; \
/*0x04D8*/ int		Trader;	/* found in CEverQuest__RightClickedOnPlayer_x */ \
/*0x04DC*/ int		AFK; \
/*0x04E0*/ bool		bTempPet; \
/*0x04E4*/ UINT		StunTimer; \
/*0x04E8*/ BYTE		CharClass; /* Im pretty sure this isnt working */ \
/*0x04EC*/ DWORD		LoginSerial; \
/*0x04F0*/ CHAR		LoginRelated[0x20]; \
/*0x0510*/ BYTE		HoldingAnimation; /* todo: create enum for this byte. Holding: Nothing=0 A RightHand Weapon=1 A Shield=2 Dual Wielding Two Weapons=3 A Spear=4 A LeftHand Weapon=5 A Two Handed Weapon=6 A bow=7 */ \
/*0x0511*/ bool		Linkdead; \
/*0x0512*/ bool		bSwitchMoved; /* true when a door moves near the spawn */ \
/*0x0514*/ DWORD		PotionTimer; \
/*0x0518*/ bool		bBuffTimersOnHold; /* no you can't control this client side so unless you want to get banned leave it alone */ \
/*0x051C*/ UINT		MinuteTimer; \
/*0x0520*/ FLOAT		BearingToTarget; \
/*0x0524*/ bool		bShowHelm; \
/*0x0528*/ struct _EQC_INFO*	spawneqc_info; \
/*0x052C*/ bool		bAttackRelated; \
/*0x052D*/ BYTE		IntimidateCount; \
/*0x052E*/ BYTE		HmmWhat; /* todo: figure out */ \
/*0x0530*/ DWORD		Zone; \
/*0x0534*/ bool		Sneak; \
/*0x0538*/ UINT		CombatSkillUsed[0x2]; \
/*0x0540*/ int		RealEstateID; \
/*0x0544*/ UINT		LastResendAddPlayerPacket; \
/*0x0548*/ int		LastCastNum; \
/*0x054C*/ FLOAT		MerchantGreed; \
/*0x0550*/ int		NpcTintIndex; \
/*0x0554*/ FLOAT		CameraOffset; \
/*0x0558*/ int		PetID; \
/*0x055C*/ BYTE		Light; \
...
/*0x0568*/ FLOAT		FallingStartZ; \
/*0x056C*/ BYTE		Level; \
/*0x056D*/ bool		PvPFlag; \
/*0x0570*/ UINT		TimeStamp; /* updates all the time including when on a mount */ \
/*0x0574*/ UINT		LastRangedUsedTime; \
/*0x0578*/ bool		bStationary; \
/*0x0579*/ BYTE		FindBits; \
/*0x057C*/ FLOAT		ViewHeight; \
/*0x0580*/ BYTE		TitleVisible; \
/*0x0584*/ int		WarCry; \
/*0x0588*/ bool		Mercenary; \
/*0x058C*/ UINT		SpellGemETA[0xf]; /*InnateETA is now the last member in this array */ \
/*0x05C8*/ int		SomeData[0x2]; \
/*0x05D0*/ int		ManaMax; \
/*0x05D4*/ EqItemGuid 	realEstateItemGuid; \
/*0x05E6*/ bool		LFG; \
/*0x05E7*/ bool		bAnimationOnPop; \
/*0x05E8*/ FLOAT		MissileRangeToTarget; \
/*0x05EC*/ UINT		FishingETA; \
/*0x05F0*/ UINT		LastMealTime; /* last time we eat or drank */ \
/*0x05F4*/ UINT		CorpseDragCount; \
/*0x05F8*/ DWORD		**ppUDP; /* UdpLibrary::UdpConnection? */ \
/*0x05FC*/ BYTE		LastAttack; \
/*0x0600*/ UINT		SitStartTime; \
/*0x0604*/ FLOAT		AnimationSpeedRelated; \
/*0x0608*/
...
#define EQ_ASSIST_COMPLETE              0x4300   // aMsgTimeStampRe
#define EQ_BEGIN_ZONE                   0x10F8   // CEverQuest__SavePCForce
#define EQ_END_ZONE                     0x0FE9   // CEverQuest__DoMainLoop+B2F
#define EQ_ASSIST                       0x398D   // do_assist(PlayerClient *,char const *)+399 20160212 live (see 52C319)
