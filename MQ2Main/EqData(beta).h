...
//Actual Size: 0x108 (see 0x6391FC in eqgame.exe Beta dated Nov 14 2020) - eqmule
...
/*0x00C4*/ struct _CXSTR *	ActorTag2;
/*0x00C8*/ bool	bRankDisabled;
/*0x00CC*/ UINT	LastCastTime;
/*0x00D0*/ int	Charges;
/*0x00D4*/ bool	bRealEstateItemPlaceable;
/*0x00D5*/ bool	bDisableAugTexture;
/*0x00D8*/ UINT	NewArmorID;
/*0x00DC*/ SharedPtr<ItemEvolutionData> pEvolutionData;
...
#define EQ_ASSIST_COMPLETE              0x0ADB   // aMsgTimeStampRe
#define EQ_ASSIST                       0x3522   // do_assist(PlayerClient *,char const *)+399 20160212 live (see 52C319)
