...
/*0x00BD*/ bool	bDisableAugTexture;
...
#define EQ_ASSIST_COMPLETE              0x258b   // aMsgTimeStampRe
#define EQ_ASSIST                       0x6568   // do_assist(PlayerClient *,char const *)+399 20160212 live (see 52C319)
