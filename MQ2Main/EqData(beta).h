...
//Actual Size: 0x158 (see 0x60C30C in eqgame.exe Beta dated Dec  3 2018) - eqmule
...
/*0x0081*/ bool	bRealEstateItemPlaceable;
/*0x0084*/ int	GroupID;
/*0x0088*/ DOUBLE	EvolvingExpPct;
/*0x0090*/ LONG	LastEquipped;
/*0x0094*/ EqItemGuid ItemGUID;
/*0x00A8*/ ItemBaseContainer2 Contents; /* Size is 0x1c */
/*0x00C4*/ int	AugFlag;
...
/*0x0190*/ __int64	GuildID; \
/*0x0198*/ bool		LFG; \
/*0x0199*/ bool		bSwitchMoved; /* true when a door moves near the spawn */ \
/*0x019C*/ DWORD		Zone; \
/*0x01A0*/ int		WarCry; \
/*0x01A4*/ UINT		LastTrapDamageTime; \
/*0x01A8*/ BYTE		CharClass; /* Im pretty sure this isnt working */ \
/*0x01A9*/ bool		Linkdead; \
/*0x01AC*/ UINT		NextIntimidateTime; \
/*0x01B0*/ UINT		LastTimeStoodStill; \
/*0x01B4*/ DWORD		Meditating; \
...
/*0x01C5*/ BYTE		GMRank; /* i think */ \
/*0x01C8*/ UINT		LastTick; \
/*0x01CC*/ BYTE		FD; \
/*0x01D0*/ UINT		EnduranceMax; \
/*0x01D4*/ BYTE		FishingEvent; \
/*0x01D8*/ UINT		SpellGemETA[0xf]; /*InnateETA is now the last member in this array */ \
/*0x0214*/ struct _EQC_INFO*	spawneqc_info; \
/*0x0218*/ EqItemGuid 	realEstateItemGuid; \
/*0x022A*/ CHAR		GM; \
/*0x022C*/ FLOAT		FallingStartZ; \
/*0x0230*/ BYTE		Level; \
/*0x0234*/ int		SecondaryTintIndex; \
/*0x0238*/ FLOAT		AnimationSpeedRelated; \
/*0x023C*/ int		ManaCurrent; \
/*0x0240*/ UINT		MinuteTimer; \
/*0x0244*/ int		EnduranceCurrent; \
/*0x0248*/ int		Anon; /* found in EQPlayer__SetNameSpriteTint_x */ \
/*0x024C*/ UINT		CombatSkillTicks[0x2]; \
/*0x0254*/ DWORD		LoginSerial; \
/*0x0258*/ bool		bShowHelm; \
/*0x0259*/ bool		bBetaBuffed; \
/*0x025A*/ BYTE		TitleVisible; \
/*0x025C*/ UINT		LastMealTime; /* last time we eat or drank */ \
/*0x0260*/ UINT		FishingETA; \
/*0x0264*/ int		RealEstateID; \
/*0x0268*/ __int64		HPMax; \
/*0x0270*/ bool		bOfflineMode; \
/*0x0274*/ UINT		SpellCooldownETA; \
/*0x0278*/ __int64		HPCurrent; \
/*0x0280*/ DWORD		PotionTimer; \
/*0x0284*/ void		*pRaceGenderInfo; /* todo this is not a void* so... map the CRaceGenderInfo class */ \
/*0x0288*/ int		PetID; \
/*0x028C*/ int		AltAttack; \
/*0x0290*/ int		Stuff; \
/*0x0294*/ BYTE		FindBits; \
/*0x0298*/ DWORD		LastCastTime; \
/*0x029C*/ void		*pTouchingSwitch; /* need to get that in here : struct _EQSWITCH */ \
/*0x02A0*/ bool		bStationary; \
/*0x02A4*/ UINT		CombatSkillUsed[0x2]; \
/*0x02AC*/ UINT		SitStartTime; \
/*0x02B0*/ CHAR		Handle[0x20]; \
/*0x02D0*/ UINT		NextSwim; \
/*0x02D4*/ CHAR		DragNames[0x2][0x40]; \
/*0x0354*/ int		RealEstateItemId; \
/*0x0358*/ BYTE		LastAttack; \
/*0x0359*/ CHAR		Title[0x80]; \
/*0x03DC*/ int		CurrIOState; \
/*0x03E0*/ UINT		StunTimer; \
/*0x03E4*/ CHAR		Suffix[0x80]; \
/*0x0464*/ int		Deity; \
/*0x0468*/ CHAR		DraggingPlayer[0x40]; \
/*0x04A8*/ struct _SPAWNINFO*	pViewPlayer; \
/*0x04AC*/ BYTE		Blind; \
/*0x04B0*/ UINT		LastRangedUsedTime; \
/*0x04B4*/ FLOAT		BearingToTarget; \
/*0x04B8*/ bool		Mercenary; \
/*0x04BC*/ int		AFK; \
/*0x04C0*/ FLOAT		ViewHeight; \
/*0x04C4*/ FLOAT		GetMeleeRangeVar1; /* used by GetMeleeRange */ \
/*0x04C8*/ FLOAT		RunSpeed; /*0.70 on runspeed 5... */ \
/*0x04CC*/ int		Trader;	/* found in CEverQuest__RightClickedOnPlayer_x */ \
/*0x04D0*/ int		ManaMax; \
/*0x04D4*/ int		SomeData[0x2]; \
/*0x04DC*/ int		SomethingElse; \
/*0x04E0*/ UINT		MasterID; \
/*0x04E4*/ bool		bAttackRelated; \
/*0x04E8*/ FLOAT		MerchantGreed; \
/*0x04EC*/ BYTE		HmmWhat; /* todo: figure out */ \
/*0x04F0*/ int		IsAttacking; /* need to investigate */ \
/*0x04F4*/ BYTE		IntimidateCount; \
/*0x04F8*/ UINT		LastSecondaryUseTime; \
/*0x04FC*/ int		AARank;/* this really is the title id */ \
/*0x0500*/ bool		bTempPet; \
/*0x0501*/ bool		bAlwaysShowAura; \
/*0x0504*/ int		Buyer; \
/*0x0508*/ UINT		LastPrimaryUseTime; \
/*0x050C*/ bool		bSummoned; /* by a PC or by anyone? need to investigate */ \
/*0x0510*/ int		DoSpecialMelee; \
/*0x0514*/ FLOAT		MissileRangeToTarget; \
/*0x0518*/ CPhysicsInfo	LastCollision; \
/*0x0548*/ CHAR		LoginRelated[0x20]; \
/*0x0568*/ int		PrimaryTintIndex; \
/*0x056C*/ BYTE		IsPassenger; /* if u are on a boat or airship or whatever */ \
/*0x0570*/ struct _LAUNCHSPELLDATA	CastingData; /* size: 0x58 */ \
/*0x05C8*/ BYTE		InPvPArea; /* are we in a PvP area? */ \
/*0x05CC*/ FLOAT		MyWalkSpeed; \
/*0x05D0*/ BYTE		Type2; /* check */ \
/*0x05D4*/ UINT		LastResendAddPlayerPacket; \
/*0x05D8*/ bool		Sneak; \
/*0x05D9*/ bool		bAnimationOnPop; \
/*0x05DC*/ int		berserker; \
/*0x05E0*/ bool		PvPFlag; \
/*0x05E4*/ int		LastCastNum; \
/*0x05E8*/ int		HideMode; \
/*0x05EC*/ BYTE		HoldingAnimation; /* todo: create enum for this byte. Holding: Nothing=0 A RightHand Weapon=1 A Shield=2 Dual Wielding Two Weapons=3 A Spear=4 A LeftHand Weapon=5 A Two Handed Weapon=6 A bow=7 */ \
...
/*0x0608*/ UINT		ACounter; /* not sure what this one is for*/ \
/*0x060C*/ UINT		RespawnTimer; /* its actually TimeOfDeath...TimeStamp of when RespawnWnd will close - 0 when you're alive */ \
/*0x0610*/
...
#define EQ_ASSIST_COMPLETE              0x1C38   // aMsgTimeStampRe
#define EQ_BEGIN_ZONE                   0x25F7   // CEverQuest__SavePCForce
#define EQ_END_ZONE                     0x5FE3   // CEverQuest__DoMainLoop+B2F
#define EQ_ASSIST                       0x30E6   // do_assist(PlayerClient *,char const *)+399 20160212 live (see 52C319)
