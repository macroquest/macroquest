...
//Actual Size: 0x150 (see 0x59ED87 in eqgame.exe Beta dated Nov 24 2017) - eqmule
...
/*0x0045*/ bool	IsEvolvingItem;
/*0x0048*/ struct _ITEMINFO *Item1;
/*0x004C*/ int	Charges;
/*0x0050*/ int	MerchantQuantity;
...
/*0x00B4*/ int	EvolvingMaxLevel;
/*0x00B8*/ bool	bRankDisabled;
/*0x00BC*/ int	EvolvingCurrentLevel;
/*0x00C0*/ bool	bDisableAugTexture;
...
/*0x018C*/ UINT		LastRangedUsedTime; \
/*0x0190*/ struct _LAUNCHSPELLDATA	CastingData; /* size: 0x58 */ \
/*0x01E8*/ int		LastCastNum; \
/*0x01EC*/ bool		bAttackRelated; \
/*0x01ED*/ bool		bAlwaysShowAura; \
/*0x01F0*/ struct _SPAWNINFO*	pViewPlayer; \
/*0x01F4*/ bool		bOfflineMode; \
/*0x01F8*/ UINT		LastRefresh; \
/*0x01FC*/ UINT		SitStartTime; \
/*0x0200*/ BYTE		HmmWhat; /* todo: figure out */ \
/*0x0204*/ UINT		LastResendAddPlayerPacket; \
/*0x0208*/ int		Trader;	/* found in CEverQuest__RightClickedOnPlayer_x */ \
/*0x020C*/ DWORD		LastCastTime; \
/*0x0210*/ int		NpcTintIndex; \
/*0x0218*/ __int64	GuildID; \
/*0x0220*/ int		EnduranceCurrent; \
/*0x0224*/ int		HPCurrent; \
/*0x0228*/ int		PrimaryTintIndex; \
/*0x022C*/ int		HideMode; \
/*0x0230*/ struct _EQC_INFO*	spawneqc_info; \
/*0x0234*/ FLOAT		BearingToTarget; \
/*0x0238*/ bool		bSummoned; /* by a PC or by anyone? need to investigate */ \
/*0x023C*/ UINT		LastTrapDamageTime; \
/*0x0240*/ BYTE		Level; \
/*0x0241*/ bool		Mercenary; \
/*0x0242*/ CHAR		Handle[0x20]; \
/*0x0264*/ UINT		StunTimer; \
/*0x0268*/ UINT		CombatSkillUsed[0x2]; \
/*0x0270*/ int		AARank;/* this really is the title id */ \
...
/*0x027C*/ BYTE		IntimidateCount; \
/*0x0280*/ int		AFK; \
/*0x0284*/ UINT		ACounter; /* not sure what this one is for*/ \
/*0x0288*/ int		ManaMax; \
/*0x028C*/ BYTE		StandState; \
/*0x028D*/ CHAR		DragNames[0x2][0x40]; \
/*0x0310*/ UINT		LastSecondaryUseTime; \
/*0x0314*/ UINT		FishingETA; \
...
/*0x03A9*/ bool		bAnimationOnPop; \
/*0x03AC*/ DWORD		Meditating; \
/*0x03B0*/ FLOAT		MerchantGreed; \
/*0x03B4*/ void		*pRaceGenderInfo; /* todo this is not a void* so... map the CRaceGenderInfo class */ \
/*0x03B8*/ BYTE		FindBits; \
/*0x03BC*/ int		SecondaryTintIndex; \
/*0x03C0*/ bool		Sneak; \
/*0x03C4*/ UINT		LastTimeStoodStill; \
/*0x03C8*/ int		PetID; \
/*0x03CC*/ BYTE		InPvPArea; /* are we in a PvP area? */ \
/*0x03D0*/ FLOAT		FallingStartZ; \
/*0x03D4*/ int		RealEstateItemId; \
/*0x03D8*/ BYTE		FD; \
/*0x03DC*/ FLOAT		CameraOffset; \
/*0x03E0*/ UINT		LastPrimaryUseTime; \
/*0x03E4*/ int		IsAttacking; /* need to investigate */ \
/*0x03E8*/ UINT		LastTick; \
/*0x03EC*/ FLOAT		AnimationSpeedRelated; \
/*0x03F0*/ CHAR		GM; \
/*0x03F1*/ CHAR		LoginRelated[0x20]; \
/*0x0411*/ BYTE		LastAttack; \
/*0x0414*/ DWORD		**ppUDP; /* UdpLibrary::UdpConnection? */ \
/*0x0418*/ int		SomethingElse; \
/*0x041C*/ int		berserker; \
/*0x0420*/ CPhysicsInfo	LastCollision; \
/*0x0450*/ BYTE		Light; \
/*0x0451*/ BYTE		IsPassenger; /* if u are on a boat or airship or whatever */ \
/*0x0452*/ EqItemGuid 	realEstateItemGuid; \
/*0x0464*/ DWORD		PotionTimer; \
/*0x0468*/ CHAR		DraggingPlayer[0x40]; \
/*0x04A8*/ bool		Linkdead; \
/*0x04AC*/ UINT		MasterID; \
/*0x04B0*/ UINT		NextSwim; \
/*0x04B4*/ bool		LFG; \
/*0x04B8*/ UINT		SpellGemETA[0xf]; /*InnateETA is now the last member in this array */ \
/*0x04F4*/ UINT		SpellCooldownETA; \
/*0x04F8*/ BYTE		CharClass; /* Im pretty sure this isnt working */ \
/*0x04FC*/ int		Deity; \
/*0x0500*/ int		Buyer; \
/*0x0504*/ bool		bTempPet; \
/*0x0505*/ BYTE		TitleVisible; \
/*0x0508*/ UINT		CorpseDragCount; \
/*0x050C*/ int		DontKnowYet; \
/*0x0510*/ BYTE		FishingEvent; \
/*0x0514*/ UINT		MinuteTimer; \
/*0x0518*/ int		RealEstateID; \
/*0x051C*/ UINT		EnduranceMax; \
/*0x0520*/ FLOAT		MyWalkSpeed; \
/*0x0524*/ UINT		CombatSkillTicks[0x2]; \
/*0x052C*/ int		SomeData[0x2]; \
/*0x0534*/ bool		bShowHelm; \
/*0x0535*/ bool		bSwitchMoved; /* true when a door moves near the spawn */ \
/*0x0536*/ BYTE		Blind; \
/*0x0538*/ int		WarCry; \
/*0x053C*/ int		DoSpecialMelee; \
/*0x0540*/ int		CurrIOState; \
/*0x0544*/ int		Stuff; \
/*0x0548*/ CHAR		Title[0x80]; \
/*0x05C8*/ bool		bStationary; \
/*0x05CC*/ UINT		LastMealTime; /* last time we eat or drank */ \
/*0x05D0*/ UINT		RespawnTimer; /* its actually TimeOfDeath...TimeStamp of when RespawnWnd will close - 0 when you're alive */ \
/*0x05D4*/ int		ManaCurrent; \
/*0x05D8*/ DWORD		LoginSerial; \
/*0x05DC*/ FLOAT		ViewHeight; \
/*0x05E0*/ BYTE		Type2; /* check */ \
/*0x05E4*/ DWORD		Zone; \
/*0x05E8*/ FLOAT		RunSpeed; /*0.70 on runspeed 5... */ \
/*0x05EC*/ int		HPMax; \
/*0x05F0*/ void		*pTouchingSwitch; /* need to get that in here : struct _EQSWITCH */ \
/*0x05F4*/ BYTE		GMRank; /* i think */ \
...
#define EQ_ASSIST_COMPLETE              0x5A76   // aMsg_time_stamp
#define EQ_BEGIN_ZONE                   0x4EFD   // CEverQuest__SavePCForce
#define EQ_END_ZONE                     0x5A6D   // CEverQuest__DoMainLoop+B2F
#define EQ_ASSIST                       0x245B   // do_assist(PlayerClient *,char const *)+399 20160212 live (see 52C319)
