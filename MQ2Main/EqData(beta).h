...
//Actual Size: 0x158 (see 0x62674C in eqgame.exe Beta dated Dec  9 2019) - eqmule
...
/*0x001C*/ int	NoteStatus;
/*0x0020*/ int	RealEstateID;
/*0x0024*/ bool	bCollected;
/*0x0025*/ bool	bItemNeedsUpdate;
/*0x0026*/ bool	bRankDisabled;
/*0x0027*/ EqItemGuid ItemGUID;
/*0x003C*/ struct _ITEMINFO *Item1;
/*0x0040*/ bool	bConvertable;
/*0x0041*/ bool	IsEvolvingItem;
...
#define EQ_ASSIST_COMPLETE              0x4f09   // aMsgTimeStampRe
#define EQ_ASSIST                       0x5171   // do_assist(PlayerClient *,char const *)+399 20160212 live (see 52C319)
