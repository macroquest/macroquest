...
//Actual Size: 0x158 (see 0x6275BC in eqgame.exe Beta dated Dec  8 2019) - eqmule
...
/*0x005E*/ bool	bCopied;
/*0x005F*/ bool	bRealEstateItemPlaceable;
/*0x0060*/ DOUBLE	EvolvingExpPct;
/*0x0068*/ int	NoteStatus;
/*0x006C*/ CHAR	ActorTag1[0x1e];
...
/*0x0140*/ int	Power;
/*0x0144*/ bool	bCollected;
//start of ItemClient
/*0x0145*/ BYTE Filler0x0145[0x7];
...
#define EQ_ASSIST_COMPLETE              0x23C5   // aMsgTimeStampRe
#define EQ_ASSIST                       0x1F45   // do_assist(PlayerClient *,char const *)+399 20160212 live (see 52C319)
