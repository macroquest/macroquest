...
//Actual Size: 0x158 (see 0x60CC1C in eqgame.exe Beta dated Dec  2 2018) - eqmule
...
/*0x0100*/ bool	EvolvingExpOn;
/*0x0101*/ bool	bCopied;
/*0x0102*/ EqItemGuid ItemGUID;
/*0x0114*/ ItemGlobalIndex2 GlobalIndex; /* Size is 0xa (0xc)*/
/*0x0120*/ CHAR	ActorTag1[0x1e];
/*0x013E*/ bool	bCollected;
/*0x0140*/ UINT	Tint;
/*0x0144*/ bool	IsEvolvingItem;
/*0x0145*/ bool	bConvertable;
//start of ItemClient
...
/*0x018C*/ CHAR		GM; \
/*0x0190*/ FLOAT		MerchantGreed; \
/*0x0194*/ CHAR		DragNames[0x2][0x40]; \
/*0x0214*/ int		LastCastNum; \
/*0x0218*/ BYTE		InPvPArea; /* are we in a PvP area? */ \
/*0x0219*/ CHAR		LoginRelated[0x20]; \
/*0x0239*/ bool		bAnimationOnPop; \
/*0x023A*/ bool		bOfflineMode; \
/*0x023C*/ UINT		NextSwim; \
/*0x0240*/ BYTE		IsPassenger; /* if u are on a boat or airship or whatever */ \
/*0x0241*/ bool		bSummoned; /* by a PC or by anyone? need to investigate */ \
/*0x0248*/ __int64		HPMax; \
/*0x0250*/ UINT		CombatSkillUsed[0x2]; \
/*0x0258*/ FLOAT		FallingStartZ; \
/*0x025C*/ int		SomethingElse; \
/*0x0260*/ UINT		LastRefresh; \
/*0x0264*/ int		berserker; \
/*0x0268*/ struct _LAUNCHSPELLDATA	CastingData; /* size: 0x58 */ \
/*0x02C0*/ bool		bSwitchMoved; /* true when a door moves near the spawn */ \
/*0x02C1*/ BYTE		FishingEvent; \
...
/*0x02D8*/ int		HideMode; \
/*0x02DC*/ int		Deity; \
/*0x02E0*/ __int64		HPCurrent; \
/*0x02E8*/ CHAR		Suffix[0x80]; \
/*0x0368*/ int		SecondaryTintIndex; \
/*0x036C*/ CHAR		Title[0x80]; \
/*0x03EC*/ UINT		SitStartTime; \
/*0x03F0*/ int		EnduranceCurrent; \
/*0x03F4*/ DWORD		LastCastTime; \
/*0x03F8*/ FLOAT		BearingToTarget; \
/*0x03FC*/ BYTE		HoldingAnimation; /* todo: create enum for this byte. Holding: Nothing=0 A RightHand Weapon=1 A Shield=2 Dual Wielding Two Weapons=3 A Spear=4 A LeftHand Weapon=5 A Two Handed Weapon=6 A bow=7 */ \
/*0x0400*/ void		*pTouchingSwitch; /* need to get that in here : struct _EQSWITCH */ \
/*0x0404*/ struct _EQC_INFO*	spawneqc_info; \
/*0x0408*/ FLOAT		MissileRangeToTarget; \
/*0x040C*/ UINT		LastSecondaryUseTime; \
/*0x0410*/ bool		Linkdead; \
/*0x0414*/ int		PrimaryTintIndex; \
/*0x0418*/ bool		bBuffTimersOnHold; /* no you can't control this client side so unless you want to get banned leave it alone */ \
/*0x0419*/ bool		Mercenary; \
/*0x041A*/ bool		bBetaBuffed; \
/*0x041C*/ int		NpcTintIndex; \
/*0x0420*/ UINT		LastResendAddPlayerPacket; \
/*0x0424*/ BYTE		LastAttack; \
/*0x0425*/ bool		bShowHelm; \
/*0x0426*/ EqItemGuid 	realEstateItemGuid; \
/*0x0438*/ UINT		LastRangedUsedTime; \
/*0x043C*/ int		AltAttack; \
/*0x0440*/ FLOAT		ViewHeight; \
/*0x0444*/ FLOAT		MyWalkSpeed; \
/*0x0448*/ int		ManaMax; \
/*0x044C*/ UINT		MasterID; \
/*0x0450*/ DWORD		PotionTimer; \
...
/*0x04CC*/ int		PetID; \
/*0x04D0*/ BYTE		Level; \
/*0x04D4*/ UINT		LastTimeStoodStill; \
/*0x04D8*/ int		AFK; \
/*0x04DC*/ int		RealEstateItemId; \
/*0x04E0*/ DWORD		Zone; \
/*0x04E4*/ FLOAT		CameraOffset; \
/*0x04E8*/ bool		bTempPet; \
/*0x04E9*/ BYTE		FindBits; \
/*0x04EC*/ int		WarCry; \
/*0x04F0*/ bool		bAttackRelated; \
/*0x04F4*/ void		*pRaceGenderInfo; /* todo this is not a void* so... map the CRaceGenderInfo class */ \
/*0x04F8*/ BYTE		HmmWhat; /* todo: figure out */ \
/*0x04F9*/ BYTE		GMRank; /* i think */ \
/*0x04FC*/ int		DoSpecialMelee; \
/*0x0500*/ UINT		LastTick; \
/*0x0504*/ BYTE		IntimidateCount; \
/*0x0508*/ FLOAT		GetMeleeRangeVar1; /* used by GetMeleeRange */ \
/*0x050C*/ UINT		TimeStamp; /* updates all the time including when on a mount */ \
/*0x0510*/ int		ManaCurrent; \
/*0x0514*/ int		Trader;	/* found in CEverQuest__RightClickedOnPlayer_x */ \
/*0x0518*/ UINT		SpellCooldownETA; \
/*0x051C*/ UINT		RespawnTimer; /* its actually TimeOfDeath...TimeStamp of when RespawnWnd will close - 0 when you're alive */ \
/*0x0520*/ UINT		FishingETA; \
/*0x0524*/ BYTE		CharClass; /* Im pretty sure this isnt working */ \
/*0x0528*/ UINT		LastMealTime; /* last time we eat or drank */ \
/*0x052C*/ UINT		NextIntimidateTime; \
/*0x0530*/ DWORD		Meditating; \
/*0x0534*/ BYTE		Type2; /* check */ \
/*0x0538*/ FLOAT		RunSpeed; /*0.70 on runspeed 5... */ \
/*0x053C*/ BYTE		FD; \
/*0x0540*/ int		RealEstateID; \
/*0x0544*/ bool		bAlwaysShowAura; \
/*0x0548*/ int		Stuff; \
/*0x054C*/ bool		bStationary; \
/*0x0550*/ UINT		ACounter; /* not sure what this one is for*/ \
/*0x0554*/ BYTE		TitleVisible; \
/*0x0558*/ UINT		EnduranceMax; \
/*0x055C*/ BYTE		StandState; \
/*0x0560*/ UINT		CombatSkillTicks[0x2]; \
/*0x0568*/ BYTE		Light; \
/*0x056C*/ UINT		CorpseDragCount; \
/*0x0570*/ int		CurrIOState; \
/*0x0574*/ int		Anon; /* found in EQPlayer__SetNameSpriteTint_x */ \
/*0x0578*/ int		SomeData[0x2]; \
/*0x0580*/ DWORD		LoginSerial; \
/*0x0584*/ UINT		StunTimer; \
/*0x0588*/ BYTE		Blind; \
/*0x058C*/ int		AARank;/* this really is the title id */ \
/*0x0590*/ struct _SPAWNINFO*	pViewPlayer; \
/*0x0594*/ CHAR		DraggingPlayer[0x40]; \
/*0x05D4*/ bool		LFG; \
/*0x05D8*/ __int64	GuildID; \
/*0x05E0*/ UINT		MinuteTimer; \
...
#define EQ_BEGIN_ZONE                   0x6CD8   // CEverQuest__SavePCForce
#define EQ_END_ZONE                     0x2A60   // CEverQuest__DoMainLoop+B2F
#define EQ_ASSIST                       0x378D   // do_assist(PlayerClient *,char const *)+399 20160212 live (see 52C319)
