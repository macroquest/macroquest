...
//Actual Size: 0x158 (see 0x60A62C in eqgame.exe Beta dated Nov 23 2018) - eqmule
...
/*0x0050*/ int	Open;
/*0x0054*/ int	NoteStatus;
/*0x0058*/ int	ArmorType;
...
/*0x009C*/ int	ItemColor;
/*0x00A0*/ EqItemGuid ItemGUID;
/*0x00B2*/ bool	bCopied;
/*0x00B4*/ int	OrnamentationIcon;
/*0x00B8*/ int	Luck;
/*0x00BC*/ bool	EvolvingExpOn;
/*0x00BD*/ bool	IsEvolvingItem;
...
/*0x0110*/ int	RealEstateID;
/*0x0114*/ CHAR	ActorTag1[0x1e];
/*0x0132*/ bool	bDisableAugTexture;
/*0x0134*/ ItemGlobalIndex2 GlobalIndex; /* Size is 0xa (0xc)*/
/*0x0140*/ LONG	LastEquipped;
//start of ItemClient
...
/*0x018C*/ BYTE		Light; \
/*0x018D*/ BYTE		HoldingAnimation; /* todo: create enum for this byte. Holding: Nothing=0 A RightHand Weapon=1 A Shield=2 Dual Wielding Two Weapons=3 A Spear=4 A LeftHand Weapon=5 A Two Handed Weapon=6 A bow=7 */ \
/*0x0190*/ UINT		LastTick; \
/*0x0194*/ UINT		TimeStamp; /* updates all the time including when on a mount */ \
/*0x0198*/ FLOAT		CameraOffset; \
/*0x019C*/ int		Stuff; \
/*0x01A0*/ int		Buyer; \
/*0x01A4*/ int		LastCastNum; \
/*0x01A8*/ int		EnduranceCurrent; \
/*0x01AC*/ bool		bSwitchMoved; /* true when a door moves near the spawn */ \
/*0x01AD*/ BYTE		InPvPArea; /* are we in a PvP area? */ \
/*0x01B0*/ UINT		LastRefresh; \
/*0x01B4*/ void		*pTouchingSwitch; /* need to get that in here : struct _EQSWITCH */ \
/*0x01B8*/ int		Anon; /* found in EQPlayer__SetNameSpriteTint_x */ \
/*0x01BC*/ int		Deity; \
/*0x01C0*/ UINT		LastMealTime; /* last time we eat or drank */ \
/*0x01C4*/ FLOAT		ViewHeight; \
/*0x01C8*/ UINT		MinuteTimer; \
/*0x01CC*/ BYTE		Level; \
/*0x01D0*/ UINT		NextSwim; \
/*0x01D4*/ UINT		CombatSkillUsed[0x2]; \
/*0x01DC*/ int		WarCry; \
/*0x01E0*/ int		SomethingElse; \
/*0x01E8*/ __int64		HPCurrent; \
/*0x01F0*/ UINT		CombatSkillTicks[0x2]; \
/*0x01F8*/ CHAR		GM; \
/*0x01FC*/ int		AFK; \
/*0x0200*/ UINT		SitStartTime; \
/*0x0204*/ int		RealEstateID; \
/*0x0208*/ bool		bAttackRelated; \
/*0x0209*/ bool		bBuffTimersOnHold; /* no you can't control this client side so unless you want to get banned leave it alone */ \
/*0x020C*/ int		SomeData[0x2]; \
/*0x0214*/ BYTE		FD; \
/*0x0218*/ UINT		SpellGemETA[0xf]; /*InnateETA is now the last member in this array */ \
/*0x0254*/ UINT		MasterID; \
/*0x0258*/ void		*pRaceGenderInfo; /* todo this is not a void* so... map the CRaceGenderInfo class */ \
/*0x025C*/ int		berserker; \
/*0x0260*/ UINT		ACounter; /* not sure what this one is for*/ \
/*0x0264*/ CHAR		DraggingPlayer[0x40]; \
/*0x02A4*/ bool		Sneak; \
/*0x02A5*/ bool		bSummoned; /* by a PC or by anyone? need to investigate */ \
/*0x02A8*/ int		IsAttacking; /* need to investigate */ \
/*0x02AC*/ DWORD		Meditating; \
/*0x02B0*/ int		DontKnowYet; \
/*0x02B4*/ CHAR		Title[0x80]; \
/*0x0334*/ bool		LFG; \
/*0x0335*/ BYTE		TitleVisible; \
/*0x0338*/ UINT		StunTimer; \
/*0x033C*/ UINT		EnduranceMax; \
/*0x0340*/ BYTE		LastAttack; \
/*0x0344*/ int		DoSpecialMelee; \
/*0x0348*/ CHAR		Suffix[0x80]; \
/*0x03C8*/ bool		bStationary; \
/*0x03C9*/ BYTE		IntimidateCount; \
/*0x03CC*/ UINT		LastResendAddPlayerPacket; \
/*0x03D0*/ int		PetID; \
/*0x03D4*/ bool		Mercenary; \
/*0x03D5*/ BYTE		Type2; /* check */ \
/*0x03D6*/ bool		PvPFlag; \
/*0x03D8*/ UINT		CorpseDragCount; \
/*0x03DC*/ FLOAT		MerchantGreed; \
/*0x03E0*/ UINT		LastTrapDamageTime; \
/*0x03E8*/ __int64	GuildID; \
/*0x03F0*/ BYTE		StandState; \
/*0x03F4*/ FLOAT		BearingToTarget; \
/*0x03F8*/ bool		bOfflineMode; \
/*0x03FC*/ UINT		LastTimeStoodStill; \
/*0x0400*/ UINT		SpellCooldownETA; \
/*0x0404*/ CPhysicsInfo	LastCollision; \
/*0x0434*/ BYTE		HmmWhat; /* todo: figure out */ \
/*0x0435*/ EqItemGuid 	realEstateItemGuid; \
/*0x0448*/ DWORD		LoginSerial; \
/*0x044C*/ FLOAT		MissileRangeToTarget; \
/*0x0450*/ BYTE		IsPassenger; /* if u are on a boat or airship or whatever */ \
/*0x0454*/ UINT		NextIntimidateTime; \
/*0x0458*/ FLOAT		GetMeleeRangeVar1; /* used by GetMeleeRange */ \
/*0x045C*/ BYTE		GMRank; /* i think */ \
/*0x0460*/ int		HideMode; \
/*0x0464*/ struct _SPAWNINFO*	pViewPlayer; \
/*0x0468*/ bool		Linkdead; \
/*0x046C*/ int		PrimaryTintIndex; \
/*0x0470*/ int		ManaMax; \
/*0x0474*/ bool		bBetaBuffed; \
/*0x0478*/ int		ManaCurrent; \
/*0x047C*/ BYTE		FishingEvent; \
/*0x047D*/ CHAR		DragNames[0x2][0x40]; \
/*0x0500*/ DWORD		**ppUDP; /* UdpLibrary::UdpConnection? */ \
/*0x0504*/ DWORD		Zone; \
/*0x0508*/ BYTE		CharClass; /* Im pretty sure this isnt working */ \
/*0x0509*/ CHAR		Handle[0x20]; \
/*0x0529*/ BYTE		FindBits; \
/*0x052C*/ UINT		RespawnTimer; /* its actually TimeOfDeath...TimeStamp of when RespawnWnd will close - 0 when you're alive */ \
/*0x0530*/ UINT		LastSecondaryUseTime; \
/*0x0534*/ int		AARank;/* this really is the title id */ \
/*0x0538*/ UINT		FishingETA; \
/*0x053C*/ bool		bAnimationOnPop; \
/*0x0540*/ DWORD		PotionTimer; \
/*0x0544*/ int		AltAttack; \
/*0x0548*/ BYTE		Blind; \
/*0x0550*/ __int64		HPMax; \
/*0x0558*/ FLOAT		MyWalkSpeed; \
/*0x055C*/ UINT		LastRangedUsedTime; \
/*0x0560*/ int		Trader;	/* found in CEverQuest__RightClickedOnPlayer_x */ \
/*0x0564*/ int		NpcTintIndex; \
/*0x0568*/ FLOAT		AnimationSpeedRelated; \
/*0x056C*/ struct _EQC_INFO*	spawneqc_info; \
/*0x0570*/ struct _LAUNCHSPELLDATA	CastingData; /* size: 0x58 */ \
/*0x05C8*/ int		SecondaryTintIndex; \
/*0x05CC*/ DWORD		LastCastTime; \
/*0x05D0*/ FLOAT		RunSpeed; /*0.70 on runspeed 5... */ \
/*0x05D4*/ UINT		LastPrimaryUseTime; \
/*0x05D8*/ bool		bAlwaysShowAura; \
/*0x05D9*/ bool		bTempPet; \
/*0x05DA*/ bool		bShowHelm; \
/*0x05DC*/ int		RealEstateItemId; \
/*0x05E0*/ CHAR		LoginRelated[0x20]; \
/*0x0600*/ FLOAT		FallingStartZ; \
/*0x0604*/ int		CurrIOState; \
/*0x0608*/
...
#define EQ_ASSIST_COMPLETE              0x2bd0   // aMsgTimeStampRe
#define EQ_BEGIN_ZONE                   0x7D0B   // CEverQuest__SavePCForce
#define EQ_END_ZONE                     0x4119   // CEverQuest__DoMainLoop+B2F
#define EQ_ASSIST                       0x2F55   // do_assist(PlayerClient *,char const *)+399 20160212 live (see 52C319)
