...
//Actual Size: 0x108 (see 0x63A17C in eqgame.exe Beta dated Nov 30 2020) - eqmule
...
#define EQ_ASSIST                       0x4273   // do_assist(PlayerClient *,char const *)+399 20160212 live (see 52C319)
