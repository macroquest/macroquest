...
//Actual Size: 0x148 (see 0x5A05B7 in eqgame.exe Beta dated Nov 27 2017) - eqmule
...
/*0x0014*/ int	EvolvingCurrentLevel;
/*0x0018*/ int	MerchantQuantity;
/*0x001C*/ bool	bRealEstateItemPlaceable;
/*0x001D*/ bool	bDisableAugTexture;
/*0x001E*/ CHAR	ActorTag1[0x1e];
/*0x0040*/ __int64	DontKnow;
/*0x0048*/ int	AugFlag;
/*0x004C*/ int	Power;
/*0x0050*/ int	RealEstateID;
...
/*0x006C*/ int	OrnamentationIcon;
/*0x0070*/ int	NoDropFlag;
/*0x0074*/ CHAR	ActorTag2[0x1e];
/*0x0094*/ int	EvolvingMaxLevel;
...
/*0x0114*/ int	Charges;
/*0x0118*/ struct _CXSTR *SaveString;
/*0x011C*/ UINT	RespawnTime;
/*0x0120*/ bool	bConvertable;
/*0x0121*/ bool	EvolvingExpOn;
/*0x0122*/ EqItemGuid ItemGUID;
/*0x0134*/ bool	bCollected;
//start of ItemClient
...
/*0x018C*/ int		DontKnowYet; \
/*0x0190*/ BYTE		Blind; \
/*0x0194*/ UINT		ACounter; /* not sure what this one is for*/ \
/*0x0198*/ UINT		StunTimer; \
/*0x019C*/ bool		LFG; \
/*0x01A0*/ int		WarCry; \
/*0x01A4*/ DWORD		PotionTimer; \
...
/*0x01AC*/ int		ManaCurrent; \
/*0x01B0*/ struct _EQC_INFO*	spawneqc_info; \
/*0x01B4*/ int		IsAttacking; /* need to investigate */ \
/*0x01B8*/ CHAR		Handle[0x20]; \
/*0x01D8*/ int		Buyer; \
/*0x01DC*/ UINT		NextIntimidateTime; \
/*0x01E0*/ UINT		LastSecondaryUseTime; \
/*0x01E4*/ bool		bBuffTimersOnHold; /* no you can't control this client side so unless you want to get banned leave it alone */ \
/*0x01E8*/ UINT		LastRangedUsedTime; \
/*0x01EC*/ bool		bAttackRelated; \
/*0x01ED*/ bool		Sneak; \
/*0x01F0*/ DWORD		Zone; \
/*0x01F4*/ FLOAT		AnimationSpeedRelated; \
/*0x01F8*/ bool		PvPFlag; \
/*0x01F9*/ BYTE		TitleVisible; \
/*0x01FC*/ void		*pTouchingSwitch; /* need to get that in here : struct _EQSWITCH */ \
/*0x0200*/ BYTE		StandState; \
/*0x0204*/ int		SomethingElse; \
/*0x0208*/ bool		bShowHelm; \
/*0x0209*/ bool		bStationary; \
/*0x0210*/ __int64	GuildID; \
/*0x0218*/ DWORD		LoginSerial; \
/*0x021C*/ UINT		LastResendAddPlayerPacket; \
/*0x0220*/ DWORD		Meditating; \
/*0x0224*/ int		Deity; \
/*0x0228*/ EqItemGuid 	realEstateItemGuid; \
/*0x023C*/ int		PrimaryTintIndex; \
/*0x0240*/ BYTE		Type2; /* check */ \
/*0x0241*/ BYTE		FD; \
/*0x0242*/ bool		bSwitchMoved; /* true when a door moves near the spawn */ \
/*0x0243*/ BYTE		LastAttack; \
/*0x0244*/ BYTE		InPvPArea; /* are we in a PvP area? */ \
/*0x0248*/ UINT		LastRefresh; \
/*0x024C*/ int		AFK; \
/*0x0250*/ CHAR		DragNames[0x2][0x40]; \
/*0x02D0*/ struct _LAUNCHSPELLDATA	CastingData; /* size: 0x58 */ \
/*0x0328*/ UINT		LastMealTime; /* last time we eat or drank */ \
/*0x032C*/ int		RealEstateItemId; \
/*0x0330*/ int		SomeData[0x2]; \
/*0x0338*/ CHAR		DraggingPlayer[0x40]; \
/*0x0378*/ int		AltAttack; \
/*0x037C*/ int		HPCurrent; \
/*0x0380*/ void		*pRaceGenderInfo; /* todo this is not a void* so... map the CRaceGenderInfo class */ \
/*0x0384*/ int		Stuff; \
/*0x0388*/ BYTE		HmmWhat; /* todo: figure out */ \
/*0x0389*/ BYTE		Level; \
/*0x038C*/ int		NpcTintIndex; \
/*0x0390*/ int		ManaMax; \
/*0x0394*/ BYTE		IntimidateCount; \
/*0x0398*/ UINT		LastTick; \
/*0x039C*/ FLOAT		MerchantGreed; \
/*0x03A0*/ struct _SPAWNINFO*	pViewPlayer; \
/*0x03A4*/ BYTE		CharClass; /* Im pretty sure this isnt working */ \
/*0x03A5*/ BYTE		FishingEvent; \
/*0x03A8*/ int		Trader;	/* found in CEverQuest__RightClickedOnPlayer_x */ \
/*0x03AC*/ FLOAT		CameraOffset; \
/*0x03B0*/ CHAR		Suffix[0x80]; \
/*0x0430*/ UINT		LastPrimaryUseTime; \
/*0x0434*/ UINT		TimeStamp; /* updates all the time including when on a mount */ \
/*0x0438*/ UINT		EnduranceMax; \
/*0x043C*/ FLOAT		BearingToTarget; \
/*0x0440*/ CPhysicsInfo	LastCollision; \
/*0x0470*/ BYTE		GMRank; /* i think */ \
/*0x0471*/ bool		bBetaBuffed; \
/*0x0474*/ FLOAT		GetMeleeRangeVar1; /* used by GetMeleeRange */ \
/*0x0478*/ bool		bTempPet; \
/*0x0479*/ CHAR		GM; \
/*0x047C*/ DWORD		**ppUDP; /* UdpLibrary::UdpConnection? */ \
/*0x0480*/ int		AARank;/* this really is the title id */ \
/*0x0484*/ UINT		RespawnTimer; /* its actually TimeOfDeath...TimeStamp of when RespawnWnd will close - 0 when you're alive */ \
/*0x0488*/ bool		Linkdead; \
/*0x0489*/ bool		Mercenary; \
/*0x048A*/ bool		bOfflineMode; \
/*0x048C*/ FLOAT		ViewHeight; \
/*0x0490*/ UINT		SpellCooldownETA; \
/*0x0494*/ int		LastCastNum; \
/*0x0498*/ int		GuildStatus; \
/*0x049C*/ UINT		FishingETA; \
/*0x04A0*/ UINT		MasterID; \
/*0x04A4*/ int		berserker; \
/*0x04A8*/ UINT		CombatSkillUsed[0x2]; \
/*0x04B0*/ int		RealEstateID; \
/*0x04B4*/ bool		bAlwaysShowAura; \
/*0x04B8*/ int		Anon; /* found in EQPlayer__SetNameSpriteTint_x */ \
/*0x04BC*/ int		DoSpecialMelee; \
/*0x04C0*/ BYTE		IsPassenger; /* if u are on a boat or airship or whatever */ \
/*0x04C4*/ UINT		MinuteTimer; \
/*0x04C8*/ int		EnduranceCurrent; \
/*0x04CC*/ UINT		LastTrapDamageTime; \
/*0x04D0*/ BYTE		FindBits; \
/*0x04D1*/ BYTE		Light; \
/*0x04D4*/ UINT		SpellGemETA[0xf]; /*InnateETA is now the last member in this array */ \
/*0x0510*/ UINT		CombatSkillTicks[0x2]; \
/*0x0518*/ UINT		NextSwim; \
/*0x051C*/ bool		bAnimationOnPop; \
/*0x0520*/ int		HPMax; \
/*0x0524*/ UINT		CorpseDragCount; \
/*0x0528*/ int		CurrIOState; \
/*0x052C*/ bool		bSummoned; /* by a PC or by anyone? need to investigate */ \
/*0x0530*/ int		PetID; \
/*0x0534*/ FLOAT		MissileRangeToTarget; \
/*0x0538*/ UINT		SitStartTime; \
/*0x053C*/ FLOAT		MyWalkSpeed; \
/*0x0540*/ int		HideMode; \
/*0x0544*/ CHAR		LoginRelated[0x20]; \
/*0x0564*/ CHAR		Title[0x80]; \
/*0x05E4*/ int		SecondaryTintIndex; \
/*0x05E8*/ UINT		LastTimeStoodStill; \
/*0x05EC*/ FLOAT		FallingStartZ; \
/*0x05F0*/ DWORD		LastCastTime; \
...
#define EQ_ASSIST_COMPLETE              0x72C5   // aMsg_time_stamp
#define EQ_BEGIN_ZONE                   0x64AC   // CEverQuest__SavePCForce
#define EQ_END_ZONE                     0x6AB1   // CEverQuest__DoMainLoop+B2F
#define EQ_ASSIST                       0x3D11   // do_assist(PlayerClient *,char const *)+399 20160212 live (see 52C319)
