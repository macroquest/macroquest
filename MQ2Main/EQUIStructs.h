...
/*0x0030*/ UINT		BlinkFadeStartTime; \
...
/*0x00D0*/ COLORREF DisabledBackground; \
...
/*0x00D7*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
...
/*0x013C*/ DWORD	XMLIndex; \
/*0x0140*/ RECT		ClipRectClient; \
/*0x0150*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0151*/ bool		bClientRectChanged; \
/*0x0152*/ BYTE     bResizableMask; \
/*0x0153*/ bool		bTopAnchoredToTop; \
/*0x0154*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0155*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x0156*/ bool		bClipToParent; \
/*0x0158*/ int		TopOffset; \
/*0x015C*/ int		BottomOffset; \
/*0x0160*/ BYTE		TargetAlpha; \
...
/*0x0185*/ bool		Fades; \
/*0x0186*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
