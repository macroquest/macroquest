...
/*0x0018*/ BYTE		Unknown0x0014[0x10]; \
/*0x0028*/ ARGBCOLOR	BGColor; \
/*0x002c*/ BYTE		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x002d*/ BYTE		Unknown0x002d[0x3]; \
/*0x0030*/ DWORD	FadeDuration; \
/*0x0034*/ BYTE		Enabled; \
/*0x0035*/ BYTE		Unknown0x0035[0xb]; \
/*0x0040*/ struct _CXSTR*	WindowText; /*CXWnd__GetWindowTextA_x has this one*/ \
/*0x0044*/ BYTE		Unknown0x0044[0x2a]; \
/*0x006e*/ BYTE		MouseOver; /*found in CXWnd__SetMouseOver_x*/ \
/*0x006f*/ BYTE		Unknown0x006f; \
/*0x0070*/ BYTE		ValidCXWnd; /*IsValid has this one*/\
/*0x0071*/ BYTE		Faded; \
/*0x0072*/ BYTE		Unknown0x0072[0xe]; \
/*0x0080*/ DWORD	TickCount2; \
...
/*0x0108*/ BYTE		Unknown0x0108[0x14]; \
/*0x011c*/ LPVOID	DrawTemplate; \
...
/*0x0158*/ BYTE		Unknown0x0158[0x2c]; \
/*0x0184*/ DWORD	HScrollPos; \
/*0x0188*/ BYTE		Unknown0x0188[0x10]; \
/*0x0198*/ BYTE		Fades; \
/*0x0199*/ BYTE		Unknown0x0199[0x7]; \
/*0x01a0*/ DWORD	TimeMouseOver; \
/*0x01a4*/ BYTE		Unknown0x01a4; \
/*0x01a5*/ BYTE		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x01a6*/ BYTE		Unknown0x01a6[0x6]; \
/*0x01ac*/ DWORD	VScrollPos; \
/*0x01b0*/ BYTE		Unknown0x01b0[0x1c]; \
...
/*0x01d4*/ BYTE		Unknown0x01d4[0x1c];
/*0x01f0*/
...
//size is 0x288 see 8D2DFE in eqgame.exe dated 11 Jul 2016 Test - eqmule
typedef struct _CBUTTONWND {
/*0x000*/ struct    _CXWND Wnd;
/*0x1f0*/ BYTE      Unknown[0x4];
...
//size 0x2f8 see 4BC729 in Jul 11 2016 test -eqmule
...
// Actual Size: 0x938 (see 4B96F0) in Jul 11 2016 Test - eqmule
