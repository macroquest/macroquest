...
/*0x0030*/ BYTE		MouseOver; /*found in CXWnd__SetMouseOver_x*/ \
...
/*0x0178*/ BYTE		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0179*/ BYTE		Unknown0x0179[0x3]; \
/*0x017c*/ DWORD	FadeDuration; \
/*0x0180*/ DWORD	VScrollMax; \
...
/*0x01a8*/ BYTE		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
