...
/*0x006c*/ BYTE         Enabled; \
/*0x006d*/ BYTE         Unknown0x006d[0x14]; \
/*0x0081*/ BYTE         ValidCXWnd; /*IsValid has this one*/\
/*0x0082*/ BYTE         Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x0083*/ BYTE         Unknown0x0083; \
...
/*0x00c0*/ DWORD        ZLayer; /*found in CXWndManager__DrawWindows_x*/ \
/*0x00c4*/ BYTE         Alpha; \
/*0x00c5*/ BYTE         Unknown0x00c5[0x7]; \
/*0x00cc*/ DWORD        BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x "BGType" in ini */ \
/*0x00d0*/ BYTE         Unknown0x00d0[0x24]; \
/*0x00f4*/ DWORD        VScrollPos; \
/*0x00f8*/ BYTE         Unknown0x00f8[0x24]; \
/*0x011c*/ BYTE         dShow; \
/*0x011d*/ BYTE         Unknown0x011d[0x27]; \
/*0x0144*/ LPVOID       DrawTemplate; \
...
/*0x015c*/ ARGBCOLOR    BGColor; \
/*0x0160*/ BYTE         Unknown0x0160[0x6]; \
/*0x0166*/ BYTE         Locked; /*found in CSidlScreenWnd__LoadIniInfo_x*/ \
/*0x0167*/ BYTE         Unknown0x0167[0x15]; \
/*0x017c*/ DWORD        TickCount2; \
/*0x0180*/ BYTE         Unknown0x0180[0x10]; \
/*0x0190*/ BYTE         Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
