...
/*0x0028*/ int		BottomOffset; \
/*0x002C*/ UINT		LastBlinkFadeRefreshTime; \
/*0x0030*/ int		VScrollPos; \
/*0x0034*/ bool		bEscapableLocked; \
/*0x0035*/ BYTE		FadeAlpha; \
/*0x0038*/ tagSIZE	MaxClientSize; \
/*0x0040*/ bool		bClipToParent; \
/*0x0041*/ BYTE     bResizableMask; \
/*0x0044*/ RECT		ClipRectScreen; \
/*0x0054*/ int		DeleteCount; \
/*0x0058*/ void *pController; \
/*0x005C*/ RECT		TransitionRect; \
/*0x006C*/ DWORD	XMLIndex; \
/*0x0070*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x0071*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0074*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x0078*/ bool		bUseInLayoutVertical; \
/*0x007C*/ int		ParentAndContextMenuArrayIndex; \
/*0x0080*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0081*/ bool		bKeepOnScreen; \
...
/*0x00AC*/ bool		bHCenterTooltip; \
/*0x00B0*/ RECT		OldLocation; \
/*0x00C0*/ bool		bIsParentOrContextMenuWindow; \
...
/*0x00D0*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x00D4*/ RECT		Location; \
/*0x00E4*/ void	    *pFont; \
/*0x00E8*/ bool		bBottomAnchoredToTop; \
/*0x00E9*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
...
/*0x00F8*/ int	Transition; \
/*0x00FC*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0100*/ UINT		BlinkFadeFreq; \
/*0x0104*/ COLORREF DisabledBackground; \
/*0x0108*/ UINT		TransitionStartTick; \
/*0x010C*/ int		managerArrayIndex; \
/*0x0110*/ tagSIZE	MinClientSize; \
/*0x0118*/ bool		bCaptureTitle; \
/*0x011C*/ void		*pLayoutStrategy; \
/*0x0120*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x0121*/ bool		bTiled; \
/*0x0124*/ int		HScrollPos; \
/*0x0128*/ struct _CXSTR*	DataStr; \
/*0x012C*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x012D*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x012E*/ bool		bScreenClipRectChanged; \
/*0x012F*/ BYTE		TargetAlpha; \
/*0x0130*/ bool		Fades; \
/*0x0131*/ bool		bLeftAnchoredToLeft; \
/*0x0132*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0134*/ RECT		ClipRectClient; \
/*0x0144*/ UINT		BlinkFadeStartTime; \
/*0x0148*/ DWORD  BackgroundDrawType; \
/*0x014C*/ bool		bIsTransitioning; \
/*0x014D*/ bool		bClientRectChanged; \
/*0x0150*/ int		BlinkDuration; \
/*0x0154*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
...
/*0x0168*/ bool		bTopAnchoredToTop; \
/*0x0169*/ bool		dShow; \
/*0x016A*/ bool		bBringToTopWhenClicked; \
/*0x016B*/ BYTE		Alpha; \
/*0x016C*/ bool		bMaximizable; \
/*0x016D*/ bool		bMarkedForDelete; \
/*0x016E*/ BYTE		StartAlpha; \
/*0x016F*/ bool		bActive; \
/*0x0170*/ DWORD	FadeDelay; \
/*0x0174*/ UINT		BlinkFadeDuration; \
/*0x0178*/ __int64		Data; \
/*0x0180*/ int		BlinkState; \
/*0x0184*/ bool		Minimized; \
/*0x0188*/ int		HScrollMax; \
/*0x018C*/ struct _CSIDLWND* pWndFocusOther; \
...
/*0x01C4*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x1c */
/*0x01e0*/
...
// 10-27-2003 Lax
//Size 0x338 see 68AD8F in 13 Feb 2017 Live exe -eqmule
...
/*0x284*/ struct _CXSTR *CommandHistory[0x28]; // ->0x198
/*0x324*/ int HistoryIndex;
/*0x328*/ int HistoryLastShown;
/*0x32c*/ int FontSize;//style but yeah...
/*0x330*/ int AlwaysChathereIndex;//menu
/*0x334*/ int DontKnow;
/*0x338*/
...
//Feb 13 Live 2017 see 79F832 - eqmule
