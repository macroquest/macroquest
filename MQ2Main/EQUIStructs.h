...
/*0x0034*/ DWORD        BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x "BGType" in ini */ \
/*0x0038*/ BYTE         Unknown0x0038[0x4]; \
/*0x003c*/ DWORD        HScrollPos; \
/*0x0040*/ BYTE         Unknown0x0040[0x8]; \
/*0x0048*/ DWORD        HScrollMax; \
/*0x004c*/ BYTE         Unknown0x004c[0x20]; \
/*0x006c*/ DWORD        VScrollMax; \
/*0x0070*/ BYTE         Unknown0x0070[0x8]; \
/*0x0078*/ ARGBCOLOR    BGColor; \
/*0x007c*/ BYTE         Fades; \
...
/*0x0094*/ BYTE         Unknown0x0094[0x24]; \
/*0x00b8*/ DWORD        FadeDuration; \
...
/*0x00e4*/ BYTE         Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x00e5*/ BYTE         Faded; \
/*0x00e6*/ BYTE         Unknown0x00e6[0x6]; \
...
/*0x010d*/ BYTE         Unknown0x010d[0x2]; \
/*0x010f*/ BYTE         Enabled; \
/*0x0110*/ BYTE         Unknown0x0110[0x4]; \
/*0x0114*/ RECT         OldLocation; \
/*0x0124*/ BYTE         Unknown0x0124[0x8]; \
/*0x012c*/ DWORD        TickCount2; \
/*0x0130*/ BYTE         Unknown0x0130[0x4]; \
/*0x0134*/ BYTE         dShow; \
/*0x0135*/ BYTE         Unknown0x0135[0x3]; \
/*0x0138*/ DWORD        UnknownCW; /*found in OnProcessFrame*/\
/*0x013c*/ BYTE         Unknown0x013c[0xa]; \
/*0x0146*/ BYTE         MouseOver; /*found in CXWnd__SetMouseOver_x*/ \
/*0x0147*/ BYTE         Unknown0x0147[0x5]; \
/*0x014c*/ DWORD        TimeMouseOver; \
/*0x0150*/ BYTE         Unknown0x0150[0x14]; \
/*0x0164*/ DWORD        VScrollPos; \
/*0x0168*/ BYTE         Unknown0x0168[0x4]; \
/*0x016c*/ BYTE         ValidCXWnd; /*IsValid has this one*/\
/*0x016d*/ BYTE         Unknown0x016d[0x1b]; \
/*0x0188*/ BYTE         Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0189*/ BYTE         Unknown0x0189[0xf]; \
/*0x0198*/ BYTE         Alpha; \
/*0x0199*/ BYTE         Unknown0x0199[0x30]; \
