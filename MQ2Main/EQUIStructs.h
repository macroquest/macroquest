...
/*0x0065*/ BYTE		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x0066*/ BYTE		Locked; /*found in CSidlScreenWnd__LoadIniInfo_x*/ \
/*0x0067*/ BYTE		Unknown0x0067[0x15]; \
/*0x007c*/ struct _CXSTR*	WindowText; /*CXWnd__GetWindowTextA_x has this one*/ \
/*0x0080*/ BYTE		Unknown0x0080[0x4]; \
/*0x0084*/ DWORD	VScrollMax; \
/*0x0088*/ BYTE		Unknown0x0088[0xc]; \
/*0x0094*/ struct _CXSTR*	XMLToolTip; /*found in CSidlManager__CreateLabel_x*/ \
/*0x0098*/ BYTE		Minimized; \
/*0x0099*/ BYTE		Unknown0x0099[0x23]; \
/*0x00bc*/ DWORD	UnknownCW; /*found in OnProcessFrame*/\
/*0x00c0*/ DWORD	ZLayer; /*found in CXWndManager__DrawWindows_x*/ \
/*0x00c4*/ BYTE		Unknown0x00c4[0x8]; \
/*0x00cc*/ BYTE		MouseOver; /*found in CXWnd__SetMouseOver_x*/ \
/*0x00cd*/ BYTE		Unknown0x00cd[0xf]; \
/*0x00dc*/ ARGBCOLOR	BGColor; \
/*0x00e0*/ BYTE		Unknown0x00e0[0x18]; \
/*0x00f8*/ DWORD	VScrollPos; \
...
/*0x0144*/ BYTE		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0145*/ BYTE		Unknown0x0145[0x13]; \
/*0x0158*/ BYTE		Alpha; \
/*0x0159*/ BYTE		Unknown0x0159[0xb]; \
/*0x0164*/ BYTE		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0165*/ BYTE		Unknown0x0165[0xa]; \
/*0x016f*/ BYTE		ValidCXWnd; /*IsValid has this one*/\
/*0x0170*/ BYTE		Unknown0x0170[0x10]; \
/*0x0180*/ BYTE		Fades; \
/*0x0181*/ BYTE		Unknown0x0181[0x17]; \
...
/*0x01b0*/ DWORD	HScrollMax; \
/*0x01b4*/ BYTE		Unknown0x01b4[0x28]; \
/*0x01dc*/ BYTE		Enabled; \
/*0x01dd*/ BYTE		Unknown0x01dd[0x0b];
/*0x01e8*/
