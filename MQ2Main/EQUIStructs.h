...
/*0x0014*/ BYTE         Unknown0x0014[0x24]; \
/*0x0038*/ struct _CSIDLWND*    pParentWindow; /*CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x003c*/ BYTE         Unknown0x003c[0x24]; \
/*0x0060*/ BYTE         CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0061*/ BYTE         Unknown0x0061[0xb]; \
/*0x006c*/ DWORD        HScrollPos; \
/*0x0070*/ BYTE         Unknown0x0070[0x4]; \
/*0x0074*/ struct _CXSTR*       XMLToolTip; /*found in CSidlManager__CreateLabel_x*/ \
/*0x0078*/ BYTE         Unknown0x0078[0x4]; \
/*0x007c*/ BYTE         Fades; \
/*0x007d*/ BYTE         Unknown0x007d[0x7]; \
/*0x0084*/ DWORD        TimeMouseOver; \
/*0x0088*/ BYTE         Unknown0x0088[0x1c]; \
/*0x00a4*/ DWORD        VScrollPos; \
/*0x00a8*/ BYTE         Unknown0x00a8[0x4]; \
/*0x00ac*/ BYTE         MouseOver; /*found in CXWnd__SetMouseOver_x*/ \
/*0x00ad*/ BYTE         Unknown0x00ad[0x3]; \
/*0x00b0*/ DWORD        TickCount2; \
/*0x00b4*/ BYTE         Unknown0x00b4[0x28]; \
/*0x00dc*/ LPVOID       DrawTemplate; \
/*0x00e0*/ DWORD        HScrollMax; \
/*0x00e4*/ BYTE         Unknown0x00e4[0x28]; \
/*0x010c*/ RECT         OldLocation; \
/*0x011c*/ BYTE         Unknown0x011c[0x4]; \
/*0x0120*/ ARGBCOLOR    BGColor; \
/*0x0124*/ DWORD        XMLIndex; \
/*0x0128*/ BYTE         Unknown0x0128[0x8]; \
/*0x0130*/ BYTE         Minimized; \
/*0x0131*/ BYTE         Unknown0x0131[0x3]; \
/*0x0134*/ RECT         Location; \
/*0x0144*/ BYTE         ValidCXWnd; /*IsValid has this one*/\
/*0x0145*/ BYTE         Unknown0x0145[0x3]; \
/*0x0148*/ struct _CXSTR*       Tooltip; /*found in CSidlManager__CreateLabel_x*/ \
/*0x014c*/ BYTE         Unknown0x014c[0x4]; \
/*0x0150*/ DWORD        WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x0154*/ BYTE         Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x0155*/ BYTE         Unknown0x0155[0x10]; \
/*0x0165*/ BYTE         Locked; /*found in CSidlScreenWnd__LoadIniInfo_x*/ \
/*0x0166*/ BYTE         Unknown0x0166; \
/*0x0167*/ BYTE         Enabled; \
/*0x0168*/ BYTE         Unknown0x0168[0x4]; \
/*0x016c*/ DWORD        FadeDuration; \
/*0x0170*/ BYTE         Unknown0x0170; \
/*0x0171*/ BYTE         Faded; \
/*0x0172*/ BYTE         Unknown0x0172[0xa]; \
/*0x017c*/ DWORD        ZLayer; /*found in CXWndManager__DrawWindows_x*/ \
/*0x0180*/ DWORD        UnknownCW; /*found in OnProcessFrame*/\
/*0x0184*/ BYTE         Unknown0x0184[0x10]; \
/*0x0194*/ BYTE         Alpha; \
/*0x0195*/ BYTE         Unknown0x0195[0x2f]; \
/*0x01c4*/ struct _CXSTR*       WindowText; /*CXWnd__GetWindowTextA_x has this one*/ \
/*0x01c8*/ DWORD        VScrollMax; \
/*0x01cc*/ BYTE         dShow; \
/*0x01cd*/ BYTE         Unknown0x01cd[0x7]; \
/*0x01d4*/ BYTE         Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x01d5*/ BYTE         FadeToAlpha; /*found in CSidlScreenWnd__StoreIniInfo_x*/\
/*0x01d6*/ BYTE         Unknown0x01d6[0x2]; \
/*0x01d8*/ DWORD        BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x "BGType" in ini */ \
...
//size is 22ch in eqgame dated Nov 18 2014 (see 5CB77D) -eqmule
#define CSW \
...
// Actual Size: 0x92c8 (see 49B903) in Nov 18 2014 test - eqmule
...
// Actual Size: 0x2e4 (see 49B23E) in Nov 18 2014 test - eqmule
...
// Actual Size: 0x8c0 (see 49B0D2) in Nov 18 2014 test - eqmule
...
// Actual Size: 0x714 (see 49AF66) in Nov 18 2014 test - eqmule
...
// Individual Gems
// Actual Size: 0x304 (see 76E778) in Nov 18 2014 test - eqmule
...
/*0x0230*/ BYTE         Unknown0x0230[0xa8];
...
// Actual Size: 0x2bc (see 49B352) in Nov 18 2014 test - eqmule
...
// Actual Size: 0x2b8 (see 76E889) in Nov 18 2014 test - eqmule
...
// Actual Size: 0x60c (see 6B88BF) in Nov 18 2014 test - eqmule
...
/*0x02c0*/ BYTE         Unknown0x02c0[0x350];
/*0x060c*/
} EQITEMWINDOW, *PEQITEMWINDOW;

//CLootWnd__CLootWnd (aLootwnd)
// Actual Size: 0x3b0 (see 49B6D5) in Nov 18 2014 test - eqmule
...
// pLines address (0x5a0) = 0x24c + 0x0354 (address of pMapViewMapVfTable)
// Actual Size: 0x63c (see 49ADC7) in Nov 18 2014 test - eqmule
...
// Actual Size: 0x2c8 (see 49B7EF) in Nov 18 2014 test - eqmule
...
// Actual Size: 0x92c (see 49A802) in Nov 18 2014 test - eqmule
...
// Actual Size: 0x39c (see 49AAF5) in Nov 18 2014 test - eqmule
...
// Actual Size: 0x308 (see 49B84B) in Nov 18 2014 test - eqmule
