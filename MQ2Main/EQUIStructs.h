...
/*0x0054*/ BYTE         Unknown0x0054; \
/*0x0055*/ BYTE         Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0056*/ BYTE         Unknown0x0056[0x1f]; \
/*0x0075*/ BYTE         Locked; /*found in CSidlScreenWnd__LoadIniInfo_x*/ \
/*0x0076*/ BYTE         Unknown0x0076[0x6]; \
/*0x007c*/ DWORD        VScrollPos; \
/*0x0080*/ BYTE         Unknown0x0080[0x4]; \
/*0x0084*/ DWORD        ZLayer; /*found in CXWndManager__DrawWindows_x*/ \
/*0x0088*/ LPVOID       DrawTemplate; \
/*0x008c*/ BYTE         Unknown0x008c[0x4]; \
/*0x0090*/ DWORD        BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x "BGType" in ini */ \
/*0x0094*/ BYTE         Unknown0x0094[0x1c]; \
/*0x00b0*/ BYTE         ValidCXWnd; /*IsValid has this one*/\
/*0x00b1*/ BYTE         Unknown0x00b1[0x27]; \
/*0x00d8*/ BYTE         Minimized; \
/*0x00d9*/ BYTE         Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
...
/*0x00e4*/ ARGBCOLOR    BGColor; \
/*0x00e8*/ DWORD        HScrollMax; \
/*0x00ec*/ BYTE         Unknown0x00ec[0x3c]; \
...
/*0x0184*/ BYTE         FadeToAlpha; /*found in CSidlScreenWnd__StoreIniInfo_x*/\
/*0x0185*/ BYTE         Alpha; \
/*0x0186*/ BYTE         dShow; \
/*0x0187*/ BYTE         Unknown0x0187; \
...
/*0x0198*/ DWORD        FadeDuration; \
/*0x019c*/ DWORD        XMLIndex; \
/*0x01a0*/ BYTE         Unknown0x01a0[0x10]; \
/*0x01b0*/ DWORD        HScrollPos; \
/*0x01b4*/ DWORD        TimeMouseOver; \
...
// Actual Size: 0x384 (see 4BB117) in Mar 18 2016 Live - eqmule
...
// Actual Size: 0x2d8 (see 4BB28D) in Mar 18 2016 Live - eqmule
