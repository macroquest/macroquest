...
EQLIB_VAR DWORD pinstCGuildTributeMasterWnd;
...
EQLIB_VAR DWORD pinstCLeadershipWnd;
EQLIB_VAR DWORD pinstCLFGuildWnd;
EQLIB_VAR DWORD pinstCMIZoneSelectWnd;
EQLIB_VAR DWORD pinstCAdventureMerchantWnd;
...
EQLIB_VAR DWORD pinstCTradeskillWnd;
EQLIB_VAR DWORD pinstCTributeBenefitWnd;
EQLIB_VAR DWORD pinstCTributeMasterWnd;
