...
EQLIB_VAR CHAR gszLastError[MAX_STRING];
EQLIB_VAR CHAR gszLastSyntaxError[MAX_STRING];
EQLIB_VAR CHAR gszLastMQ2DataError[MAX_STRING];

EQLIB_API PSPAWNINFO pNamingSpawn;
EQLIB_API CHAR gszSpawnNPCName[MAX_STRING];
EQLIB_API CHAR gszSpawnPlayerName[MAX_STRING];
EQLIB_API CHAR gszSpawnMountName[MAX_STRING];
EQLIB_API CHAR gszSpawnPetName[MAX_STRING];
EQLIB_API CHAR gszSpawnCorpseName[MAX_STRING];
