...
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0020*/ tagSIZE	MaxClientSize; \
/*0x0028*/ bool		bClientClipRectChanged; \
/*0x0029*/ bool		bFullyScreenClipped; \
/*0x002C*/ void		*pLayoutStrategy; \
/*0x0030*/ int		RightOffset; \
/*0x0034*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x0035*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x0038*/ struct _CXSTR*	DataStr; \
/*0x003C*/ tagSIZE	MinClientSize; \
/*0x0044*/ bool		bBottomAnchoredToTop; \
/*0x0045*/ bool		bTopAnchoredToTop; \
/*0x0048*/ int		ParentAndContextMenuArrayIndex; \
/*0x004C*/ BYTE     bResizableMask; \
/*0x004D*/ BYTE		Alpha; \
...
/*0x0108*/ bool		bUseInLayoutVertical; \
...
/*0x0130*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0131*/ bool		Faded; \
/*0x0134*/ UINT		BlinkFadeDuration; \
...
/*0x015D*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x0160*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x1c */ \
/*0x017C*/ void   *TitlePiece; \
/*0x0180*/ void	*IconTextureAnim; \
/*0x0184*/ bool bClickThroughMenuItemStatus; /* on/off */ \
...
/*0x01C8*/ bool		bUseInLayoutHorizontal; \
/*0x01C9*/ bool		bMarkedForDelete; \
/*0x01CA*/ bool		bMaximized; \
/*0x01CC*/ void	    *pFont; \
/*0x01D0*/ bool		bHCenterTooltip; \
...
// CBazaarSearchWnd_size: 0x92c8 (see 4CCFBA) in Dec  2 2017 Beta - eqmule
...
// CPlayerWindow_size: 0x2e0 (see 4CC7FD) in Dec  2 2017 Beta - eqmule
...
// CTargetWindow_size: 0x8c0 (see 4CC694) in Dec  2 2017 Beta - eqmule
...
// CBuffWindow_size: 0x710 (see 4CC528) in Dec  2 2017 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x310 (see 7A31E8) in Dec  2 2017 Beta - eqmule
...
// CCastSpellWnd_size: 0x2c8 (see 4CC90E) in Dec  2 2017 Beta - eqmule
...
// CInvSlotWnd_size: 0x2c8 (see 7A32F9) in Dec  2 2017 Beta - eqmule
...
// CItemDisplayWindow_size: 0x608 (see 6ED59F) in Dec  2 2017 Beta - eqmule
...
// CLootWnd_size: 0x390 (see 4CCCD0) in Dec  2 2017 Beta - eqmule
...
// CMapViewWnd_size: 0x638 (see 4CC389) in Dec  2 2017 Beta - eqmule
...
// CMerchantWnd_size: 0x440 (see 4CCE4E) in Dec  2 2017 Beta - eqmule
...
// CPetInfoWindow_size: 0x8c0 (see 4CBDC0) in Dec  2 2017 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a0 (see 4CC0B3) in Dec  2 2017 Beta - eqmule
...
// CTradeWnd__size: 0x2e8 (see 4CCF04) in Dec  2 2017 Beta - eqmule
