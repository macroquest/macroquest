...
// actual size 0x1E8 in Dec  4 2017 Beta (see 0x8D40CD) - eqmule
...
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x001D*/ bool		Faded; \
/*0x0020*/ RECT		ClipRectClient; \
/*0x0030*/ void		*pLayoutStrategy; \
/*0x0034*/ BYTE		TargetAlpha; \
/*0x0035*/ bool		bClipToParent; \
/*0x0038*/ void	*IconTextureAnim; \
/*0x003C*/ bool		bUseInLayoutHorizontal; \
/*0x003D*/ bool		Fades; \
/*0x0040*/ UINT		BlinkFadeFreq; \
/*0x0044*/ bool		bScreenClipRectChanged; \
/*0x0048*/ LONG		BlinkStartTimer; \
/*0x004C*/ DWORD	XMLIndex; \
/*0x0050*/ int		BottomOffset; \
/*0x0054*/ DWORD  BackgroundDrawType; \
/*0x0058*/ bool		bAction; \
/*0x005C*/ int		managerArrayIndex; \
/*0x0060*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0061*/ bool		Enabled; \
/*0x0064*/ int		BlinkState; \
/*0x0068*/ int		DeleteCount; \
/*0x006C*/ int		HScrollMax; \
/*0x0070*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0074*/ UINT		BlinkFadeDuration; \
/*0x0078*/ int		ParentAndContextMenuArrayIndex; \
/*0x007C*/ bool		bCaptureTitle; \
/*0x007D*/ bool		bIsParentOrContextMenuWindow; \
/*0x007E*/ BYTE     bResizableMask; \
/*0x0080*/ __int64		Data; \
/*0x0088*/ void   *TitlePiece; \
/*0x008C*/ void	    *pFont; \
/*0x0090*/ void* pTipTextObject; \
...
/*0x00A4*/ int		RightOffset; \
/*0x00A8*/ RECT		TransitionRect; \
/*0x00B8*/ bool		bClientRectChanged; \
/*0x00B9*/ bool		bClientClipRectChanged; \
/*0x00BA*/ bool		bMaximizable; \
/*0x00BC*/ int	Transition; \
/*0x00C0*/ bool		bEscapableLocked; \
/*0x00C1*/ bool		Minimized; \
/*0x00C4*/ UINT		TransitionDuration; \
/*0x00C8*/ RECT		IconRect; \
/*0x00D8*/ void   *TitlePiece2; \
/*0x00DC*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
...
/*0x0101*/ bool		dShow; \
/*0x0102*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x0103*/ bool		bMarkedForDelete; \
/*0x0104*/ bool		bRightAnchoredToLeft; \
/*0x0105*/ bool		bMaximized; \
/*0x0106*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x0107*/ BYTE		StartAlpha; \
/*0x0108*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x0109*/ bool		bTopAnchoredToTop; \
/*0x010C*/ DWORD	LastTimeMouseOver; \
/*0x0110*/ bool		bTiled; \
/*0x0114*/ tagSIZE	MaxClientSize; \
/*0x011C*/ RECT		ClipRectScreen; \
/*0x012C*/ int		LeftOffset; \
...
/*0x014C*/ DWORD	FadeDelay; \
/*0x0150*/ UINT		FadeDuration; \
/*0x0154*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x0158*/ struct _CXSTR*	DataStr; \
...
/*0x0180*/ COLORREF DisabledBackground; \
/*0x0184*/ bool		bIsTransitioning; \
/*0x0185*/ bool		bKeepOnScreen; \
/*0x0188*/ tagSIZE	MinClientSize; \
/*0x0190*/ int		BlinkDuration; \
/*0x0194*/ BYTE		FadeAlpha; \
/*0x0195*/ bool		bBottomAnchoredToTop; \
/*0x0198*/ int		TopOffset; \
/*0x019C*/ UINT		BlinkFadeStartTime; \
/*0x01A0*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x01A4*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x01A5*/ bool		bLeftAnchoredToLeft; \
/*0x01A6*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x01A7*/ bool		bBringToTopWhenClicked; \
/*0x01A8*/ bool		bHCenterTooltip; \
/*0x01AC*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x01B0*/ int		HScrollPos; \
/*0x01B4*/ void*	pTextObject; \
/*0x01B8*/ int		VScrollPos; \
/*0x01BC*/ bool		bUseInLayoutVertical; \
/*0x01C0*/ void	*DrawTemplate; \
/*0x01C4*/ RECT		OldLocation; \
/*0x01D4*/ bool		bFullyScreenClipped; \
/*0x01D5*/ BYTE Filler0x01D5[0x3];
/*0x01D8*/
...
// CBazaarSearchWnd_size: 0x92c0 (see 4CCDAA) in Dec  9 2017 Beta - eqmule
...
// CPlayerWindow_size: 0x2d8 (see 4CC5ED) in Dec  9 2017 Beta - eqmule
...
// CTargetWindow_size: 0x8b8 (see 4CC484) in Dec  9 2017 Beta - eqmule
...
// CBuffWindow_size: 0x708 (see 4CC318) in Dec  9 2017 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x308 (see 7A34F8) in Dec  9 2017 Beta - eqmule
...
// CCastSpellWnd_size: 0x2c0 (see 4CC6FE) in Dec  9 2017 Beta - eqmule
...
// CInvSlotWnd_size: 0x2c0 (see 7A3609) in Dec  9 2017 Beta - eqmule
...
// CItemDisplayWindow_size: 0x600 (see 6ED5EF) in Dec  9 2017 Beta - eqmule
...
// CLootWnd_size: 0x388 (see 4CCAC0) in Dec  9 2017 Beta - eqmule
...
// CMapViewWnd_size: 0x628 (see 4CC179) in Dec  9 2017 Beta - eqmule
...
// CPetInfoWindow_size: 0x8b8 (see 4CBBB0) in Dec  9 2017 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x398 (see 4CBEA3) in Dec  9 2017 Beta - eqmule
...
// CTradeWnd__size: 0x2e0 (see 4CCCF4) in Dec  9 2017 Beta - eqmule
