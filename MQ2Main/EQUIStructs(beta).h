...
/*0x0040*/ BYTE		Unknown0x0040[0x20]; \
/*0x0060*/ BYTE		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x0061*/ BYTE		Unknown0x0061[0x7]; \
/*0x0068*/ DWORD	VScrollPos; \
/*0x006c*/ BYTE		Unknown0x006c[0x25]; \
/*0x0091*/ BYTE		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0092*/ BYTE		Unknown0x0092[0x2]; \
/*0x0094*/ BYTE		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0095*/ BYTE		Unknown0x0095[0x27]; \
...
/*0x00e0*/ BYTE		ValidCXWnd; /*IsValid has this one*/\
/*0x00e1*/ BYTE		Unknown0x00e1[0x13]; \
/*0x00f4*/ DWORD	TickCount2; \
...
/*0x0109*/ BYTE		Unknown0x0109; \
/*0x010a*/ BYTE		Fades; \
/*0x010b*/ BYTE		Unknown0x010b[0x5]; \
...
/*0x0136*/ BYTE		Enabled; \
/*0x0137*/ BYTE		Unknown0x0137[0x5]; \
/*0x013c*/ BYTE		Minimized; \
/*0x013d*/ BYTE		Unknown0x013d[0x3b]; \
...
/*0x0184*/ DWORD	HScrollMax; \
/*0x0188*/ BYTE		Unknown0x0188[0x3]; \
/*0x018b*/ BYTE		MouseOver; /*found in CXWnd__SetMouseOver_x*/ \
/*0x018c*/ DWORD	UnknownCW; /*found in OnProcessFrame*/\
...
/*0x01b8*/ BYTE		Locked; /*found in CSidlScreenWnd__LoadIniInfo_x*/ \
/*0x01b9*/ BYTE		Unknown0x01b9[0x7]; \
/*0x01c0*/ DWORD	TimeMouseOver; \
...
/*0x01dc*/ BYTE		Unknown0x01dc[0x0c];
/*0x01e8*/
