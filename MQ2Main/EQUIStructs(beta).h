...
/*0x0054*/ BYTE     bResizableMask; \
/*0x0058*/ int		BottomOffset; \
/*0x005C*/ LONG		BlinkStartTimer; \
/*0x0060*/ bool		bBorder; \
/*0x0061*/ bool		bUseInLayoutHorizontal; \
/*0x0062*/ bool		Minimized; \
...
/*0x00C0*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x00C4*/ bool		bClientClipRectChanged; \
/*0x00C8*/ void*	pTextObject; \
/*0x00CC*/ void   *TitlePiece2; \
/*0x00D0*/ bool		bIsTransitioning; \
/*0x00D1*/ BYTE		Alpha; \
/*0x00D2*/ bool		bHCenterTooltip; \
/*0x00D4*/ UINT		TransitionDuration; \
/*0x00D8*/ bool		bLeftAnchoredToLeft; \
/*0x00D9*/ bool		bBorder2; \
/*0x00DC*/ int		ParentAndContextMenuArrayIndex; \
/*0x00E0*/ DWORD	FadeDelay; \
...
/*0x0138*/ void	*IconTextureAnim; \
/*0x013C*/ RECT		TransitionRect; \
/*0x014C*/ void		*pLayoutStrategy; \
/*0x0150*/ bool		bScreenClipRectChanged; \
/*0x0151*/ bool		bRightAnchoredToLeft; \
/*0x0152*/ bool		bMarkedForDelete; \
...
/*0x0198*/ bool		Faded; \
/*0x019C*/ int		BlinkState; \
/*0x01A0*/ UINT		BlinkFadeStartTime; \
...
/*0x01C4*/ int		RightOffset; \
/*0x01C8*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x01CC*/ int		HScrollMax; \
/*0x01D0*/ int		BlinkDuration; \
/*0x01D4*/ bool		bFullyScreenClipped; \
/*0x01D8*/ RECT		ClipRectScreen; \
/*0x01E8*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x01EC*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x01F0*/ \
public: \
			bool IsVisible() \
			{ \
...
// CBazaarSearchWnd_size: 0x92d8 (see 54CB5E) in Oct 27 2019 Beta - eqmule
...
// CPlayerWindow_size: 0x2f0 (see 54C44E) in Oct 27 2019 Beta - eqmule
...
// CTargetWindow_size: 0x8d0 (see 54C2E5) in Oct 27 2019 Beta - eqmule
...
// CBuffWindow_size: 0x720 (see 54C189) in Oct 27 2019 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x328 (see 8002AB) in Oct 27 2019 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d8 (see 54C547) in Oct 27 2019 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d8 (see 8003BC) in Oct 27 2019 Beta - eqmule
...
// CItemDisplayWindow_size: 0x630 (see 7633B2) in Oct 27 2019 Beta - eqmule
...
// CLootWnd_size: 0x3a0 (see 54C8B6) in Oct 27 2019 Beta - eqmule
...
// CMapViewWnd_size: 0x658 (see 54BFEA) in Oct 27 2019 Beta - eqmule
...
// CMerchantWnd_size: 0x450 (see 54CA12) in Oct 27 2019 Beta - eqmule
...
// CPetInfoWindow_size: 0x8d0 (see 54BA41) in Oct 27 2019 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3b0 (see 54BD32) in Oct 27 2019 Beta - eqmule
...
// CTradeWnd__size: 0x2f8 (see 54CAB8) in Oct 27 2019 Beta - eqmule
...
// CFactionWnd__size: 0x280 (see 54CC04) in Oct 27 2019 Beta - eqmule
