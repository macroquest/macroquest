...
// actual size 0x1F8 in Oct 20 2020 Beta (see 0x93C76D) - eqmule
// actual size 0x1E0 in Oct 24 2020 Beta (see 0x93DB9D) - eqmule
// actual size 0x1F0 in Oct 29 2020 Beta (see 0x93DC2D) - eqmule
// actual size 0x1E0 in Oct 30 2020 Beta (see 0x93E9FD) - eqmule
// actual size 0x1E8 in Nov  3 2020 Beta (see 0x93EAFD) - eqmule
#define CXW_NO_VTABLE \
private: \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ bool		Fades; \
/*0x0020*/ int		DeleteCount; \
/*0x0024*/ bool		bTiled; \
/*0x0025*/ bool		bIsTransitioning; \
/*0x0026*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x0028*/ void	    *pFont; \
/*0x002C*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0030*/ int		BottomOffset; \
/*0x0034*/ int		TopOffset; \
/*0x0038*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x003C*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x0040*/ bool		bMaximized; \
/*0x0044*/ int		HScrollPos; \
/*0x0048*/ RECT		TransitionRect; \
/*0x0058*/ void* pTipTextObject; \
/*0x005C*/ bool		bClientRectChanged; \
/*0x005D*/ bool		bClipToParent; \
/*0x005E*/ bool		bScreenClipRectChanged; \
/*0x0060*/ tagSIZE	MaxClientSize; \
/*0x0068*/ bool		bClientClipRectChanged; \
/*0x0069*/ bool		bCaptureTitle; \
/*0x006C*/ void *pController; \
/*0x0070*/ bool		bKeepOnScreen; \
/*0x0074*/ DWORD	XMLIndex; \
/*0x0078*/ BYTE		Alpha; \
/*0x007C*/ int		BlinkDuration; \
/*0x0080*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0084*/ int		VScrollMax; \
/*0x0088*/ BYTE		FadeAlpha; \
/*0x0089*/ BYTE     bResizableMask; \
/*0x008A*/ bool		Minimized; \
/*0x008C*/ tagSIZE	MinClientSize; \
/*0x0094*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x0098*/ void*	pTextObject; \
...
/*0x00C0*/ bool		dShow; \
/*0x00C1*/ bool		bBringToTopWhenClicked; \
/*0x00C4*/ RECT		ClientRect; \
/*0x00D4*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x00D8*/ bool		bUseInLayoutVertical; \
/*0x00D9*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x00DC*/ void   *TitlePiece; \
/*0x00E0*/ bool		bEscapableLocked; \
/*0x00E1*/ bool		bBorder2; \
/*0x00E4*/ DWORD  BackgroundDrawType; \
/*0x00E8*/ void	*IconTextureAnim; \
/*0x00EC*/ BYTE		StartAlpha; \
/*0x00ED*/ bool		bFullyScreenClipped; \
/*0x00EE*/ bool		bMaximizable; \
/*0x00EF*/ bool		bIsParentOrContextMenuWindow; \
/*0x00F0*/ void		*pLayoutStrategy; \
/*0x00F4*/ RECT		Location; \
/*0x0104*/ bool		bTopAnchoredToTop; \
/*0x0108*/ int		VScrollPos; \
/*0x010C*/ RECT		ClipRectScreen; \
/*0x011C*/ bool		bBottomAnchoredToTop; \
...
/*0x013C*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x013D*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x013E*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x013F*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x0140*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x0144*/ UINT		BlinkFadeDuration; \
/*0x0148*/ int		ParentAndContextMenuArrayIndex; \
/*0x014C*/ LONG		BlinkStartTimer; \
/*0x0150*/ bool		bLeftAnchoredToLeft; \
/*0x0154*/ UINT		FadeDuration; \
/*0x0158*/ bool		bAction; \
/*0x0159*/ bool		bHCenterTooltip; \
/*0x015C*/ UINT		TransitionDuration; \
/*0x0160*/ COLORREF DisabledBackground; \
/*0x0164*/ bool		bBorder; \
/*0x0168*/ UINT		BlinkFadeFreq; \
/*0x016C*/ bool		Faded; \
/*0x016D*/ bool		bMarkedForDelete; \
/*0x016E*/ bool		bRightAnchoredToLeft; \
/*0x0170*/ int		HScrollMax; \
/*0x0174*/ bool		bActive; \
/*0x0178*/ int		managerArrayIndex; \
/*0x017C*/ UINT		BlinkFadeStartTime; \
/*0x0180*/ bool bClickThroughMenuItemStatus; /* on/off */ \
...
/*0x018C*/ void	*DrawTemplate; \
/*0x0190*/ RECT		ClipRectClient; \
/*0x01A0*/ UINT		LastBlinkFadeRefreshTime; \
/*0x01A4*/ UINT		TransitionStartTick; \
/*0x01A8*/ __int64		Data; \
/*0x01B0*/ struct _CXSTR*	DataStr; \
/*0x01B4*/ bool		bUseInLayoutHorizontal; \
/*0x01B5*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x01B8*/ RECT		IconRect; \
/*0x01C8*/ bool		Enabled; \
/*0x01CC*/ DWORD	FadeDelay; \
/*0x01D0*/ int		BlinkState; \
/*0x01D4*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x01D8*/ int		LeftOffset; \
/*0x01DC*/ BYTE		TargetAlpha; \
...
// CBazaarSearchWnd_size: 0x92d0 (see 55AC9E) in Nov  3 2020 Beta - eqmule
...
// CPlayerWindow_size: 0x2e8 (see 55A58E) in Nov  3 2020 Beta - eqmule
...
// CTargetWindow_size: 0x8c8 (see 55A425) in Nov  3 2020 Beta - eqmule
...
// CBuffWindow_size: 0x718 (see 55A2C9) in Nov  3 2020 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x320 (see 7FBB0B) in Nov  3 2020 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d0 (see 55A687) in Nov  3 2020 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d0 (see 7FBC1C) in Nov  3 2020 Beta - eqmule
...
// CItemDisplayWindow_size: 0x628 (see 75E912) in Nov  3 2020 Beta - eqmule
...
// CLootWnd_size: 0x398 (see 55A9F6) in Nov  3 2020 Beta - eqmule
...
// CMapViewWnd_size: 0x648 (see 55A12A) in Nov  3 2020 Beta - eqmule
...
// CMerchantWnd_size: 0x448 (see 55AB52) in Nov  3 2020 Beta - eqmule
...
// CPetInfoWindow_size: 0x8c8 (see 559B81) in Nov  3 2020 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a0 (see 559E72) in Nov  3 2020 Beta - eqmule
...
// CTradeWnd__size: 0x2f0 (see 55ABF8) in Nov  3 2020 Beta - eqmule
...
// CFactionWnd__size: 0x278 (see 55AD44) in Nov  3 2020 Beta - eqmule
