...
// actual size 0x1E8 in Nov  1 2019 Beta (see 0x94CADD) - eqmule
// actual size 0x1F0 in Nov  3 2019 Beta (see 0x94B52D) - eqmule
// actual size 0x1E0 in Nov  4 2019 Beta (see 0x94B28D) - eqmule
#define CXW_NO_VTABLE \
private: \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x0020*/ BYTE     bResizableMask; \
/*0x0024*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x0028*/ bool		bEscapableLocked; \
/*0x002C*/ LONG		BlinkStartTimer; \
/*0x0030*/ UINT		FadeDuration; \
/*0x0034*/ UINT		TransitionDuration; \
/*0x0038*/ void	*IconTextureAnim; \
/*0x003C*/ int		ParentAndContextMenuArrayIndex; \
/*0x0040*/ bool		bIsTransitioning; \
/*0x0041*/ bool		bUseInLayoutHorizontal; \
/*0x0042*/ bool		bTopAnchoredToTop; \
/*0x0043*/ bool		bBorder2; \
/*0x0044*/ BYTE		StartAlpha; \
/*0x0045*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x0048*/ struct _CSIDLWND* pWndFocusOther; \
/*0x004C*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x004D*/ bool		bCaptureTitle; \
/*0x0050*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0054*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
...
/*0x0094*/ RECT		IconRect; \
/*0x00A4*/ UINT		BlinkFadeStartTime; \
...
/*0x00AE*/ bool		Faded; \
/*0x00AF*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x00B0*/ RECT		ClipRectScreen; \
/*0x00C0*/ void	*DrawTemplate; \
/*0x00C4*/ bool		bUseInLayoutVertical; \
/*0x00C8*/ int	Transition; \
/*0x00CC*/ int		DeleteCount; \
/*0x00D0*/ DWORD  BackgroundDrawType; \
/*0x00D4*/ int		RightOffset; \
/*0x00D8*/ DWORD	FadeDelay; \
/*0x00DC*/ bool		bBottomAnchoredToTop; \
/*0x00E0*/ int		HScrollPos; \
/*0x00E8*/ __int64		Data; \
/*0x00F0*/ bool		dShow; \
/*0x00F1*/ bool		bActive; \
/*0x00F4*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x00F8*/ UINT		TransitionStartTick; \
/*0x00FC*/ void	    *pFont; \
/*0x0100*/ bool		bAction; \
/*0x0104*/ UINT		BlinkFadeFreq; \
/*0x0108*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x010C*/ BYTE		Alpha; \
/*0x0110*/ void   *TitlePiece2; \
/*0x0114*/ bool		bMaximized; \
/*0x0118*/ DWORD	XMLIndex; \
/*0x011C*/ bool		bBorder; \
/*0x011D*/ BYTE		FadeAlpha; \
/*0x011E*/ bool		bIsParentOrContextMenuWindow; \
/*0x0120*/ RECT		Location; \
/*0x0130*/ bool		bClientClipRectChanged; \
...
/*0x016C*/ RECT		TransitionRect; \
/*0x017C*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x017D*/ bool		Minimized; \
/*0x017E*/ bool		bClientRectChanged; \
/*0x0180*/ struct _CXSTR*	DataStr; \
/*0x0184*/ bool		bRightAnchoredToLeft; \
/*0x0185*/ bool		bKeepOnScreen; \
/*0x0186*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x0188*/ void *pController; \
/*0x018C*/ int		BlinkState; \
/*0x0190*/ bool		bFullyScreenClipped; \
/*0x0191*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0194*/ void*	pTextObject; \
/*0x0198*/ BYTE		TargetAlpha; \
/*0x019C*/ void		*pLayoutStrategy; \
/*0x01A0*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x01A1*/ bool		bTiled; \
/*0x01A2*/ bool		bBringToTopWhenClicked; \
/*0x01A3*/ bool		bScreenClipRectChanged; \
/*0x01A4*/ RECT		ClipRectClient; \
/*0x01B4*/ bool		bMaximizable; \
/*0x01B8*/ int		VScrollMax; \
/*0x01BC*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x01C0*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x01D8*/ bool		bClipToParent; \
/*0x01D9*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x01DA*/ bool		bMarkedForDelete; \
/*0x01DB*/ bool		bHCenterTooltip; \
/*0x01DC*/ void   *TitlePiece; \
/*0x01E0*/ \
public: \
			bool IsVisible() \
			{ \
...
// CBazaarSearchWnd_size: 0x92c8 (see 54D1EE) in Nov  4 2019 Beta - eqmule
...
// CPlayerWindow_size: 0x2e0 (see 54CADE) in Nov  4 2019 Beta - eqmule
...
// CTargetWindow_size: 0x8c0 (see 54C975) in Nov  4 2019 Beta - eqmule
...
// CBuffWindow_size: 0x710 (see 54C819) in Nov  4 2019 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x318 (see 80230B) in Nov  4 2019 Beta - eqmule
...
// CCastSpellWnd_size: 0x2c8 (see 54CBD7) in Nov  4 2019 Beta - eqmule
...
// CInvSlotWnd_size: 0x2c8 (see 80240C) in Nov  4 2019 Beta - eqmule
...
// CItemDisplayWindow_size: 0x620 (see 765692) in Nov  4 2019 Beta - eqmule
...
// CLootWnd_size: 0x390 (see 54CF46) in Nov  4 2019 Beta - eqmule
...
// CMapViewWnd_size: 0x638 (see 54C67A) in Nov  4 2019 Beta - eqmule
...
// CMerchantWnd_size: 0x440 (see 54D0A2) in Nov  4 2019 Beta - eqmule
...
// CPetInfoWindow_size: 0x8c0 (see 54C0D1) in Nov  4 2019 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a0 (see 54C3C2) in Nov  4 2019 Beta - eqmule
...
// CTradeWnd__size: 0x2e8 (see 54D148) in Nov  4 2019 Beta - eqmule
...
// CFactionWnd__size: 0x270 (see 54D294) in Nov  4 2019 Beta - eqmule
