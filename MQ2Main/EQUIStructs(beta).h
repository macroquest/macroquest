...
/*0x0020*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x0024*/ bool		bBringToTopWhenClicked; \
/*0x0025*/ bool		bClientClipRectChanged; \
/*0x0028*/ int		LeftOffset; \
/*0x002C*/ int		HScrollPos; \
/*0x0030*/ void		*pLayoutStrategy; \
/*0x0034*/ bool		Minimized; \
/*0x0035*/ bool		dShow; \
...
/*0x0064*/ int		ParentAndContextMenuArrayIndex; \
/*0x0068*/ BYTE		FadeAlpha; \
/*0x006C*/ DWORD	XMLIndex; \
/*0x0070*/ int		BlinkState; \
/*0x0074*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x0078*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x007C*/ void*	pTextObject; \
/*0x0080*/ bool		bMaximizable; \
/*0x0081*/ BYTE		StartAlpha; \
/*0x0084*/ int		VScrollMax; \
/*0x0088*/ int	Transition; \
/*0x008C*/ LONG		BlinkStartTimer; \
/*0x0090*/ int		TopOffset; \
/*0x0094*/ RECT		ClipRectClient; \
/*0x00A4*/ RECT		Location; \
/*0x00B4*/ tagSIZE	MaxClientSize; \
/*0x00BC*/ UINT		FadeDuration; \
/*0x00C0*/ __int64		Data; \
/*0x00C8*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x00C9*/ bool		Faded; \
/*0x00CC*/ RECT		ClipRectScreen; \
/*0x00DC*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x00E0*/ UINT		BlinkFadeDuration; \
/*0x00E4*/ UINT		BlinkFadeStartTime; \
/*0x00E8*/ RECT		IconRect; \
/*0x00F8*/ bool		bAction; \
/*0x00FC*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
/*0x0100*/ bool		bMarkedForDelete; \
/*0x0104*/ DWORD  BackgroundDrawType; \
/*0x0108*/ bool		bMaximized; \
/*0x0109*/ bool		bActive; \
/*0x010A*/ bool		bIsTransitioning; \
/*0x010C*/ UINT		TransitionDuration; \
/*0x0110*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x0111*/ bool		bUseInLayoutVertical; \
/*0x0114*/ UINT		LastBlinkFadeRefreshTime; \
/*0x0118*/ void *pController; \
...
/*0x0126*/ bool		bFullyScreenClipped; \
/*0x0127*/ bool		bBottomAnchoredToTop; \
/*0x0128*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x012C*/ int		HScrollMax; \
/*0x0130*/ int		VScrollPos; \
/*0x0134*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x0135*/ bool		bTopAnchoredToTop; \
/*0x0136*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x0137*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x0138*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x013C*/ void	*IconTextureAnim; \
/*0x0140*/ int		managerArrayIndex; \
/*0x0144*/ COLORREF DisabledBackground; \
/*0x0148*/ RECT		ClientRect; \
/*0x0158*/ bool		bClientRectChanged; \
/*0x0159*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x015C*/ struct _CXSTR*	DataStr; \
/*0x0160*/ int		BottomOffset; \
/*0x0164*/ DWORD	LastTimeMouseOver; \
/*0x0168*/ RECT		TransitionRect; \
/*0x0178*/ void	*DrawTemplate; \
/*0x017C*/ bool		bTiled; \
/*0x0180*/ DWORD	FadeDelay; \
...
/*0x018A*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x018C*/ void	    *pFont; \
/*0x0190*/ UINT		BlinkFadeFreq; \
/*0x0194*/ bool		bCaptureTitle; \
/*0x0195*/ bool		bUseInLayoutHorizontal; \
/*0x0196*/ bool		bEscapableLocked; \
/*0x0197*/ BYTE     bResizableMask; \
/*0x0198*/ bool		bScreenClipRectChanged; \
/*0x019C*/ int		RightOffset; \
/*0x01A0*/ bool		bRightAnchoredToLeft; \
/*0x01A4*/ RECT		OldLocation; \
/*0x01B4*/ tagSIZE	MinClientSize; \
/*0x01BC*/ BYTE		Alpha; \
/*0x01BD*/ bool		bBorder2; \
/*0x01C0*/ void   *TitlePiece; \
/*0x01C4*/ bool		bHCenterTooltip; \
/*0x01C8*/ UINT		TransitionStartTick; \
/*0x01CC*/ BYTE		TargetAlpha; \
/*0x01D0*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x01D4*/ int		BlinkDuration; \
/*0x01D8*/ bool		bLeftAnchoredToLeft; \
/*0x01DC*/ int		DeleteCount; \
/*0x01E0*/ bool		bClipToParent; \
...
// CBazaarSearchWnd_size: 0x92d0 (see 53990D) in Nov 11 2018 Beta - eqmule
...
// CPlayerWindow_size: 0x2e8 (see 539200) in Nov 11 2018 Beta - eqmule
...
// CTargetWindow_size: 0x8c8 (see 53909B) in Nov 11 2018 Beta - eqmule
...
// CBuffWindow_size: 0x718 (see 538F3F) in Nov 11 2018 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x320 (see 7E8DBB) in Nov 11 2018 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d0 (see 5392F9) in Nov 11 2018 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d0 (see 7E8ECC) in Nov 11 2018 Beta - eqmule
...
// CItemDisplayWindow_size: 0x628 (see 749262) in Nov 11 2018 Beta - eqmule
...
// CLootWnd_size: 0x398 (see 539665) in Nov 11 2018 Beta - eqmule
...
// CMapViewWnd_size: 0x648 (see 538DA0) in Nov 11 2018 Beta - eqmule
...
// CMerchantWnd_size: 0x448 (see 5397C1) in Nov 11 2018 Beta - eqmule
...
// CPetInfoWindow_size: 0x8c8 (see 5387DA) in Nov 11 2018 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a8 (see 538ACB) in Nov 11 2018 Beta - eqmule
...
// CTradeWnd__size: 0x2f0 (see 539867) in Nov 11 2018 Beta - eqmule
