...
// actual size 0x1F0 in Nov 20 2017 Beta (see 0x8D3EED) - eqmule
#define CXW_NO_VTABLE \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ UINT		BlinkFadeFreq; \
/*0x0020*/ UINT		BlinkFadeDuration; \
/*0x0024*/ bool		bCaptureTitle; \
/*0x0028*/ int		BlinkDuration; \
/*0x002C*/ UINT		BlinkFadeStartTime; \
...
/*0x0048*/ void *pController; \
/*0x004C*/ bool		bIsParentOrContextMenuWindow; \
/*0x0050*/ void	*DrawTemplate; \
/*0x0054*/ RECT		OldLocation; \
/*0x0064*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x1c */ \
/*0x0080*/ bool		Minimized; \
/*0x0081*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x0084*/ int		LeftOffset; \
/*0x0088*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0089*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x008C*/ int		HScrollMax; \
/*0x0090*/ bool		Faded; \
/*0x0094*/ DWORD	LastTimeMouseOver; \
/*0x0098*/ bool		bAction; \
/*0x0099*/ bool		bBottomAnchoredToTop; \
/*0x009A*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x009B*/ bool		dShow; \
/*0x009C*/ bool		bUseInLayoutVertical; \
...
/*0x00A4*/ bool		bHCenterTooltip; \
/*0x00A8*/ RECT		ClipRectScreen; \
/*0x00B8*/ __int64		Data; \
/*0x00C0*/ bool		bClientClipRectChanged; \
/*0x00C1*/ bool		bActive; \
/*0x00C4*/ RECT		ClipRectClient; \
/*0x00D4*/ DWORD	XMLIndex; \
/*0x00D8*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x00DC*/ int		BlinkState; \
/*0x00E0*/ int		VScrollMax; \
/*0x00E4*/ BYTE		StartAlpha; \
/*0x00E8*/ LONG		BlinkStartTimer; \
/*0x00EC*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
...
/*0x0101*/ bool		Fades; \
/*0x0102*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
...
/*0x01A5*/ bool		bScreenClipRectChanged; \
/*0x01A6*/ bool		bKeepOnScreen; \
/*0x01A7*/ bool		bTiled; \
/*0x01A8*/ bool		bTopAnchoredToTop; \
/*0x01AC*/ void	    *pFont; \
/*0x01B0*/ bool		bBringToTopWhenClicked; \
/*0x01B1*/ bool		bRightAnchoredToLeft; \
/*0x01B2*/ bool		ValidCXWnd; /* IsValid has this one */ \
...
/*0x01BC*/ RECT		IconRect; \
/*0x01CC*/ UINT		TransitionDuration; \
...
// CBazaarSearchWnd_size: 0x92d8 (see 4CC8BA) in Nov 20 2017 Beta - eqmule
...
// CPlayerWindow_size: 0x2f0 (see 4CC0FD) in Nov 20 2017 Beta - eqmule
...
// CTargetWindow_size: 0x8d0 (see 4CBF94) in Nov 20 2017 Beta - eqmule
...
// CBuffWindow_size: 0x720 (see 4CBE28) in Nov 20 2017 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x320 (see 7A2D08) in Nov 20 2017 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d8 (see 4CC20E) in Nov 20 2017 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d8 (see 7A2E19) in Nov 20 2017 Beta - eqmule
...
// CItemDisplayWindow_size: 0x618 (see 6ED30F) in Nov 20 2017 Beta - eqmule
...
// CLootWnd_size: 0x3a0 (see 4CC5D0) in Nov 20 2017 Beta - eqmule
...
// CMapViewWnd_size: 0x658 (see 4CBC89) in Nov 20 2017 Beta - eqmule
...
// CMerchantWnd_size: 0x440 (see 4CC74E) in Nov 20 2017 Beta - eqmule
...
// CPetInfoWindow_size: 0x8d0 (see 4CB6C0) in Nov 20 2017 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3b0 (see 4CB9B3) in Nov 20 2017 Beta - eqmule
...
// CTradeWnd__size: 0x2f8 (see 4CC804) in Nov 20 2017 Beta - eqmule
