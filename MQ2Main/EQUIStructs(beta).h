...
// actual size 0x1D8 in Oct 25 2017 Beta (see 0x8DCBCD) - eqmule
// actual size 0x1F0 in Oct 30 2017 Beta (see 0x8DC25D) - eqmule
// actual size 0x1F8 in Oct 31 2017 Beta (see 0x8DCEED) - eqmule
// actual size 0x1E8 in Nov  1 2017 Beta (see 0x8DC0FD) - eqmule
// actual size 0x1E0 in Nov  2 2017 Beta (see 0x8D51BD) - eqmule
#define CXW_NO_VTABLE \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ int		DeleteCount; \
/*0x0020*/ int		LeftOffset; \
/*0x0024*/ DWORD	XMLIndex; \
/*0x0028*/ bool		bScreenClipRectChanged; \
/*0x002C*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x0030*/ int	Transition; \
/*0x0034*/ bool		bUseInLayoutVertical; \
/*0x0038*/ void   *TitlePiece2; \
/*0x003C*/ UINT		BlinkFadeStartTime; \
/*0x0040*/ bool		bBringToTopWhenClicked; \
/*0x0041*/ bool		Minimized; \
/*0x0044*/ tagSIZE	MinClientSize; \
/*0x004C*/ int		VScrollMax; \
/*0x0050*/ int		BottomOffset; \
/*0x0054*/ void *pController; \
/*0x0058*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x005C*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x1c */ \
/*0x0078*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x007C*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0080*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x0081*/ bool		bIsParentOrContextMenuWindow; \
/*0x0082*/ bool		bAction; \
/*0x0084*/ int		BlinkDuration; \
/*0x0088*/ bool		bActive; \
/*0x0089*/ bool		bBottomAnchoredToTop; \
/*0x008A*/ BYTE		TargetAlpha; \
/*0x008C*/ COLORREF DisabledBackground; \
/*0x0090*/ void*	pTextObject; \
/*0x0094*/ void* pTipTextObject; \
/*0x0098*/ UINT		TransitionDuration; \
/*0x009C*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x009D*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x00A0*/ UINT		BlinkFadeDuration; \
/*0x00A4*/ BYTE     bResizableMask; \
/*0x00A8*/ int		ParentAndContextMenuArrayIndex; \
/*0x00AC*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
/*0x00B0*/ bool		bClientClipRectChanged; \
/*0x00B1*/ bool		bLeftAnchoredToLeft; \
/*0x00B4*/ int		managerArrayIndex; \
/*0x00B8*/ UINT		TransitionStartTick; \
/*0x00BC*/ bool		bRightAnchoredToLeft; \
/*0x00C0*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x00C4*/ bool		bClientRectChanged; \
/*0x00C5*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x00C6*/ bool		bTopAnchoredToTop; \
/*0x00C7*/ bool		bHCenterTooltip; \
/*0x00C8*/ RECT		ClipRectClient; \
/*0x00D8*/ bool		bMaximizable; \
/*0x00D9*/ bool		bKeepOnScreen; \
/*0x00DA*/ BYTE		Alpha; \
/*0x00DC*/ int		RightOffset; \
/*0x00E0*/ bool		bClipToParent; \
/*0x00E1*/ bool		bEscapableLocked; \
/*0x00E2*/ bool		bTiled; \
/*0x00E3*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x00E4*/ int		BlinkState; \
/*0x00E8*/ void	    *pFont; \
/*0x00EC*/ struct _CSIDLWND* pWndFocusOther; \
/*0x00F0*/ RECT		OldLocation; \
/*0x0100*/ bool		bMarkedForDelete; \
/*0x0101*/ BYTE		StartAlpha; \
/*0x0104*/ int		HScrollPos; \
/*0x0108*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0109*/ bool		dShow; \
/*0x010C*/ void	*DrawTemplate; \
/*0x0110*/ bool		Enabled; \
/*0x0111*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
...
/*0x0120*/ BYTE		FadeAlpha; \
/*0x0124*/ RECT		IconRect; \
/*0x0134*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
...
/*0x015C*/ DWORD  BackgroundDrawType; \
/*0x0160*/ int		TopOffset; \
...
/*0x0174*/ bool		bMaximized; \
/*0x0175*/ bool		bFullyScreenClipped; \
/*0x0178*/ int		HScrollMax; \
/*0x017C*/ tagSIZE	MaxClientSize; \
/*0x0184*/ UINT		BlinkFadeFreq; \
/*0x0188*/ int		VScrollPos; \
/*0x018C*/ LONG		BlinkStartTimer; \
/*0x0190*/ bool		Faded; \
/*0x0194*/ void   *TitlePiece; \
/*0x0198*/ RECT		ClientRect; \
/*0x01A8*/ bool		bUseInLayoutHorizontal; \
/*0x01AC*/ RECT		TransitionRect; \
/*0x01BC*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x01C0*/ struct _CXSTR*	DataStr; \
/*0x01C4*/ bool		bIsTransitioning; \
/*0x01C5*/ bool		bCaptureTitle; \
/*0x01C8*/ void		*pLayoutStrategy; \
/*0x01D0*/ __int64		Data; \
/*0x01D8*/ bool		Fades; \
/*0x01D9*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x01DA*/ BYTE Filler0x01DA[0x6];
/*0x01E0*/
...
/*0x290*/ struct _CXSTR *CommandHistory[0x28]; // ->0x198
...
/*0x230*/ struct _CSIDLWND *DisplayWnd;
/*0x234*/ PVOID pName; 
/*0x238*/ PVOID pIcon; 
...
/*0x0228*/ BYTE         Unknown0x0230[0x90];
...
// Actual Size: 0x92c8 (see 4CD03A) in Nov  2 2017 Beta - eqmule
...
// Actual Size: 0x2e0 (see 4CC87D) in Nov  2 2017 Beta - eqmule
...
// Actual Size: 0x8c0 (see 4CC714) in Nov  2 2017 Beta - eqmule
...
// Actual Size: 0x710 (see 4CC5A8) in Nov  2 2017 Beta - eqmule
...
// Individual Gems 
// Actual Size: 0x310 (see 7A4158) in Nov  2 2017 Beta - eqmule
...
// Actual Size: 0x2c8 (see 4CC98E) in Nov  2 2017 Beta - eqmule
...
// Actual Size: 0x2c8 (see 7A4269) in Nov  2 2017 Beta - eqmule
...
// Actual Size: 0x608 (see 6EE97F) in Nov  2 2017 Beta - eqmule
...
// Actual Size: 0x390 (see 4CCD50) in Nov  2 2017 Beta - eqmule
...
// Actual Size: 0x638 (see 4CC409) in Nov  2 2017 Beta - eqmule
...
// Actual Size: 0x420 (see 4CCECE) in Nov  2 2017 Beta - eqmule
...
/*0x0258*/ BYTE Unknown0x0258[0x1c8];
/*0x0420*/
} EQMERCHWINDOW, *PEQMERCHWINDOW;

//CPetInfoWindow__CPetInfoWindow aPetinfowindow
// Actual Size: 0x8c0 (see 4CBE40) in Nov  2 2017 Beta - eqmule
...
//aClasscolorD
// Actual Size: 0x3a0 (see 4CC133) in Nov  2 2017 Beta - eqmule
...
// Actual Size: 0x2e8 (see 4CCF84) in Nov  2 2017 Beta - eqmule
