...
// actual size 0x1E8 in Oct 28 2017 Beta (see 0x8DC89D) - eqmule
...
/*0x0024*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0025*/ bool		dShow; \
/*0x0026*/ bool		Faded; \
/*0x0028*/ int		VScrollPos; \
/*0x002C*/ bool		bScreenClipRectChanged; \
/*0x0030*/ int		DeleteCount; \
/*0x0034*/ UINT		TransitionStartTick; \
/*0x0038*/ bool		Enabled; \
/*0x0039*/ bool		bClientRectChanged; \
/*0x0040*/ __int64		Data; \
/*0x0048*/ void*	pTextObject; \
/*0x004C*/ bool		bBringToTopWhenClicked; \
/*0x004D*/ bool		bUseInLayoutVertical; \
/*0x004E*/ bool		bMaximizable; \
/*0x0050*/ COLORREF DisabledBackground; \
/*0x0054*/ DWORD  BackgroundDrawType; \
/*0x0058*/ bool		bBottomAnchoredToTop; \
/*0x0059*/ bool		bRightAnchoredToLeft; \
/*0x005C*/ UINT		FadeDuration; \
/*0x0060*/ BYTE		StartAlpha; \
...
/*0x0084*/ UINT		TransitionDuration; \
/*0x0088*/ tagSIZE	MaxClientSize; \
/*0x0090*/ void		*pLayoutStrategy; \
/*0x0094*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0098*/ tagSIZE	MinClientSize; \
/*0x00A0*/ UINT		LastBlinkFadeRefreshTime; \
/*0x00A4*/ UINT		BlinkFadeFreq; \
/*0x00A8*/ BYTE     bResizableMask; \
...
/*0x00F0*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x00F4*/ RECT		IconRect; \
...
/*0x010D*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x010E*/ bool		bEscapableLocked; \
/*0x0110*/ int		HScrollPos; \
/*0x0114*/ bool		bClientClipRectChanged; \
/*0x0118*/ int		BottomOffset; \
/*0x011C*/ bool		bMarkedForDelete; \
/*0x0120*/ RECT		Location; \
/*0x0130*/ bool		bIsParentOrContextMenuWindow; \
/*0x0134*/ void	*DrawTemplate; \
/*0x0138*/ bool		bTiled; \
/*0x013C*/ void   *TitlePiece; \
/*0x0140*/ bool		bHCenterTooltip; \
/*0x0144*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x1c */ \
/*0x0160*/ DWORD	XMLIndex; \
/*0x0164*/ void *pController; \
/*0x0168*/ DWORD	FadeDelay; \
/*0x016C*/ bool		Minimized; \
/*0x0170*/ LONG		BlinkStartTimer; \
/*0x0174*/ bool		bFullyScreenClipped; \
/*0x0178*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x017C*/ BYTE		FadeAlpha; \
/*0x0180*/ int		BlinkDuration; \
/*0x0184*/ bool		bCaptureTitle; \
/*0x0188*/ RECT		ClipRectScreen; \
/*0x0198*/ bool		bClipToParent; \
/*0x0199*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x019C*/ int		TopOffset; \
/*0x01A0*/ bool		bTopAnchoredToTop; \
/*0x01A1*/ bool		bActive; \
/*0x01A2*/ BYTE		TargetAlpha; \
/*0x01A3*/ bool		bAction; \
/*0x01A4*/ int		managerArrayIndex; \
/*0x01A8*/ RECT		OldLocation; \
/*0x01B8*/ bool		bLeftAnchoredToLeft; \
/*0x01B9*/ BYTE		Alpha; \
/*0x01BC*/ UINT		BlinkFadeDuration; \
/*0x01C0*/ bool		bKeepOnScreen; \
/*0x01C4*/ struct _CXSTR*	DataStr; \
/*0x01C8*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x01CC*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x01D0*/ DWORD	LastTimeMouseOver; \
/*0x01D4*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x01D8*/ void	*IconTextureAnim; \
/*0x01DC*/ bool		bUseInLayoutHorizontal; \
/*0x01E0*/ int	Transition; \
/*0x01E4*/ int		BlinkState; \
/*0x01E8*/ int		RightOffset; \
/*0x01EC*/ void   *TitlePiece2; \
/*0x01F0*/ bool		Fades; \
/*0x01F1*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x01F4*/ int		VScrollMax; \
/*0x01F8*/
...
// Actual Size: 0x92e0 (see 4CDDCA) in Oct 26 2017 Beta - eqmule
...
// Actual Size: 0x2f8 (see 4CD60D) in Oct 26 2017 Beta - eqmule
...
// Actual Size: 0x8d8 (see 4CD4A4) in Oct 26 2017 Beta - eqmule
...
// Actual Size: 0x728 (see 4CD338) in Oct 26 2017 Beta - eqmule
...
// Individual Gems 
// Actual Size: 0x328 (see 7ABD48) in Oct 26 2017 Beta - eqmule
...
// Actual Size: 0x2e0 (see 4CD71E) in Oct 26 2017 Beta - eqmule
...
// Actual Size: 0x2e0 (see 7ABE59) in Oct 26 2017 Beta - eqmule
...
// Actual Size: 0x620 (see 6EFD1F) in Oct 26 2017 Beta - eqmule
...
// Actual Size: 0x3a8 (see 4CDAE0) in Oct 26 2017 Beta - eqmule
...
// Actual Size: 0x668 (see 4CD199) in Oct 26 2017 Beta - eqmule
...
// Actual Size: 0x438 (see 4CD21E) in Oct 31 2017 Beta - eqmule
...
/*0x0270*/ BYTE Unknown0x0270[0x1c8];
/*0x0438*/
} EQMERCHWINDOW, *PEQMERCHWINDOW;

//CPetInfoWindow__CPetInfoWindow aPetinfowindow
// Actual Size: 0x8d8 (see 4CCBD0) in Oct 26 2017 Beta - eqmule
...
//aClasscolorD
// Actual Size: 0x3b8 (see 4CCEC3) in Oct 26 2017 Beta - eqmule
...
// Actual Size: 0x300 (see 4CDD14) in Oct 26 2017 Beta - eqmule
