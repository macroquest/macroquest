...
/*0x0020*/ LPVOID	DrawTemplate; \
/*0x0024*/ BYTE		Unknown0x0024[0x4]; \
/*0x0028*/ BYTE		Fades; \
/*0x0029*/ BYTE		Unknown0x0029[0x17]; \
...
/*0x006c*/ BYTE		Unknown0x006c[0x28]; \
/*0x0094*/ BYTE		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0095*/ BYTE		Unknown0x0095; \
/*0x0096*/ BYTE		MouseOver; /*found in CXWnd__SetMouseOver_x*/ \
/*0x0097*/ BYTE		Faded; \
/*0x0098*/ BYTE		Minimized; \
/*0x0099*/ BYTE		Unknown0x0099[0x7]; \
/*0x00a0*/ ARGBCOLOR	BGColor; \
/*0x00a4*/ BYTE		Unknown0x00a4[0x4]; \
/*0x00a8*/ BYTE		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
...
/*0x00c0*/ BYTE		Unknown0x00c0[0x9]; \
/*0x00c9*/ BYTE		ValidCXWnd; /*IsValid has this one*/\
/*0x00ca*/ BYTE		Unknown0x00ca[0x2]; \
/*0x00cc*/ DWORD	UnknownCW; /*found in OnProcessFrame*/\
/*0x00d0*/ BYTE		Unknown0x00d0[0x10]; \
/*0x00e0*/ DWORD	TickCount2; \
/*0x00e4*/ BYTE		Unknown0x00e4[0xc]; \
/*0x00f0*/ DWORD	ZLayer; /*found in CXWndManager__DrawWindows_x*/ \
...
/*0x012c*/ DWORD	HScrollPos; \
/*0x0130*/ BYTE		Unknown0x0130[0x14]; \
/*0x0144*/ DWORD	TimeMouseOver; \
/*0x0148*/ BYTE		Unknown0x0148[0x14]; \
/*0x015c*/ struct _CXSTR*	Tooltip; /*found in CSidlManager__CreateLabel_x*/ \
/*0x0160*/ BYTE		Unknown0x0160[0x2a]; \
/*0x018a*/ BYTE		Enabled; \
/*0x018b*/ BYTE		Unknown0x018b[0x5]; \
/*0x0190*/ RECT		OldLocation; \
/*0x01a0*/ BYTE		FadeToAlpha; /*found in CSidlScreenWnd__StoreIniInfo_x*/\
/*0x01a1*/ BYTE		Unknown0x01a1[0xf]; \
/*0x01b0*/ DWORD	FadeDuration; \
/*0x01b4*/ DWORD	VScrollMax; \
/*0x01b8*/ BYTE		Unknown0x01b8[0x8]; \
/*0x01c0*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x "BGType" in ini */ \
/*0x01c4*/ BYTE		Unknown0x01c4[0xd]; \
/*0x01d1*/ BYTE		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x01d2*/ BYTE		Unknown0x01d2[0x6]; \
/*0x01d8*/ BYTE		dShow; \
/*0x01d9*/ BYTE		Unknown0x01d9[0x10]; \
/*0x01e9*/ BYTE		Locked; /*found in CSidlScreenWnd__LoadIniInfo_x*/ \
/*0x01ea*/ BYTE		Unknown0x01ea[0x06];
/*0x01f0*/
