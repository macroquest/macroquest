...
// actual size 0x1E0 in Dec 14 2019 Beta (see 0x95100D) - eqmule
#define CXW_NO_VTABLE \
private: \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ BYTE		Alpha; \
/*0x001D*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x001E*/ bool		bMaximized; \
/*0x001F*/ bool		bBorder2; \
/*0x0020*/ bool		bCaptureTitle; \
/*0x0021*/ bool		bAction; \
/*0x0022*/ bool		bFullyScreenClipped; \
/*0x0024*/ int		ParentAndContextMenuArrayIndex; \
/*0x0028*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x002C*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x002D*/ bool		bEscapableLocked; \
/*0x0030*/ int		VScrollMax; \
...
/*0x0040*/ bool		bBorder; \
/*0x0044*/ COLORREF DisabledBackground; \
/*0x0048*/ int		BlinkDuration; \
/*0x004C*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x0050*/ bool		Enabled; \
/*0x0054*/ int		HScrollMax; \
/*0x0058*/ RECT		ClientRect; \
/*0x0068*/ UINT		BlinkFadeFreq; \
/*0x006C*/ int		LeftOffset; \
/*0x0070*/ bool		dShow; \
/*0x0071*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x0072*/ bool		bClientRectChanged; \
/*0x0073*/ bool		bScreenClipRectChanged; \
/*0x0074*/ DWORD	FadeDelay; \
/*0x0078*/ RECT		ClipRectClient; \
/*0x0088*/ void   *TitlePiece; \
/*0x008C*/ int		managerArrayIndex; \
/*0x0090*/ tagSIZE	MaxClientSize; \
/*0x0098*/ bool		bHCenterTooltip; \
...
/*0x00A4*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x00A8*/ int		RightOffset; \
/*0x00AC*/ BYTE     bResizableMask; \
/*0x00B0*/ RECT		ClipRectScreen; \
/*0x00C0*/ BYTE		FadeAlpha; \
/*0x00C4*/ UINT		TransitionDuration; \
/*0x00C8*/ tagSIZE	MinClientSize; \
/*0x00D0*/ bool		bUseInLayoutVertical; \
/*0x00D4*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x00EC*/ bool		bClipToParent; \
/*0x00ED*/ bool		Fades; \
/*0x00F0*/ int		HScrollPos; \
/*0x00F4*/ RECT		Location; \
/*0x0104*/ LONG		BlinkStartTimer; \
/*0x0108*/ int		BottomOffset; \
/*0x010C*/ bool		Minimized; \
/*0x0110*/ UINT		BlinkFadeDuration; \
/*0x0114*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x0118*/ void	    *pFont; \
/*0x011C*/ int		DeleteCount; \
/*0x0120*/ UINT		TransitionStartTick; \
/*0x0124*/ void   *TitlePiece2; \
/*0x0128*/ __int64		Data; \
/*0x0130*/ void*	pTextObject; \
/*0x0134*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x0135*/ bool		bLeftAnchoredToLeft; \
/*0x0136*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x0137*/ bool		bBottomAnchoredToTop; \
/*0x0138*/ bool		bMaximizable; \
/*0x0139*/ bool		bActive; \
/*0x013C*/ struct _CSIDLWND* pWndFocusOther; \
/*0x0140*/ void	*DrawTemplate; \
/*0x0144*/ DWORD  BackgroundDrawType; \
/*0x0148*/ int	Transition; \
/*0x014C*/ bool		bBringToTopWhenClicked; \
/*0x0150*/ int		VScrollPos; \
/*0x0154*/ bool		Faded; \
/*0x0155*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0158*/ UINT		LastBlinkFadeRefreshTime; \
...
/*0x016D*/ bool		bRightAnchoredToLeft; \
/*0x0170*/ struct _CXSTR*	DataStr; \
/*0x0174*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0175*/ bool		bTiled; \
/*0x0176*/ bool		bUseInLayoutHorizontal; \
/*0x0177*/ bool		bKeepOnScreen; \
/*0x0178*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x017C*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x0180*/ RECT		TransitionRect; \
/*0x0190*/ bool		bIsTransitioning; \
/*0x0191*/ BYTE		StartAlpha; \
/*0x0194*/ DWORD	LastTimeMouseOver; \
...
/*0x019D*/ bool		bIsParentOrContextMenuWindow; \
/*0x019E*/ bool		bTopAnchoredToTop; \
/*0x01A0*/ UINT		FadeDuration; \
/*0x01A4*/ int		BlinkState; \
/*0x01A8*/ void* pTipTextObject; \
/*0x01AC*/ BYTE		TargetAlpha; \
/*0x01B0*/ void *pController; \
/*0x01B4*/ RECT		OldLocation; \
/*0x01C4*/ int		TopOffset; \
/*0x01C8*/ RECT		IconRect; \
/*0x01D8*/ void		*pLayoutStrategy; \
...
// CBazaarSearchWnd_size: 0x92c8 (see 5515CE) in Dec 14 2019 Beta - eqmule
...
// CPlayerWindow_size: 0x2e0 (see 550EBE) in Dec 14 2019 Beta - eqmule
...
// CTargetWindow_size: 0x8c0 (see 550D55) in Dec 14 2019 Beta - eqmule
...
// CBuffWindow_size: 0x710 (see 550BF9) in Dec 14 2019 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x318 (see 8075FB) in Dec 14 2019 Beta - eqmule
...
// CCastSpellWnd_size: 0x2c8 (see 550FB7) in Dec 14 2019 Beta - eqmule
...
// CInvSlotWnd_size: 0x2c8 (see 80770C) in Dec 14 2019 Beta - eqmule
...
// CItemDisplayWindow_size: 0x620 (see 76AB72) in Dec 14 2019 Beta - eqmule
...
// CLootWnd_size: 0x390 (see 551326) in Dec 14 2019 Beta - eqmule
...
// CMapViewWnd_size: 0x638 (see 550A5A) in Dec 14 2019 Beta - eqmule
...
// CMerchantWnd_size: 0x440 (see 551482) in Dec 14 2019 Beta - eqmule
...
// CPetInfoWindow_size: 0x8c0 (see 5504B1) in Dec 14 2019 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a0 (see 5507A2) in Dec 14 2019 Beta - eqmule
...
// CTradeWnd__size: 0x2e8 (see 551528) in Dec 14 2019 Beta - eqmule
...
// CFactionWnd__size: 0x270 (see 551674) in Dec 14 2019 Beta - eqmule
