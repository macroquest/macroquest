...
// actual size 0x1E8 in Dec 17 2019 Beta (see 0x952A1D) - eqmule
#define CXW_NO_VTABLE \
private: \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ bool		bTopAnchoredToTop; \
/*0x0020*/ RECT		IconRect; \
/*0x0030*/ UINT		LastBlinkFadeRefreshTime; \
/*0x0034*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0038*/ bool		bAction; \
/*0x003C*/ int		VScrollMax; \
/*0x0040*/ bool		bEscapableLocked; \
/*0x0041*/ bool		dShow; \
/*0x0044*/ int		RightOffset; \
/*0x0048*/ bool		bCaptureTitle; \
/*0x0049*/ bool		Enabled; \
/*0x004A*/ bool		bClientClipRectChanged; \
/*0x004C*/ DWORD	LastTimeMouseOver; \
/*0x0050*/ __int64		Data; \
/*0x0058*/ bool		bLeftAnchoredToLeft; \
/*0x005C*/ int		managerArrayIndex; \
/*0x0060*/ DWORD  BackgroundDrawType; \
...
/*0x0094*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0098*/ BYTE		Alpha; \
/*0x009C*/ RECT		ClipRectClient; \
...
/*0x00D4*/ bool		bFullyScreenClipped; \
/*0x00D5*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x00D6*/ bool		bClientRectChanged; \
/*0x00D8*/ DWORD	XMLIndex; \
/*0x00DC*/ UINT		TransitionDuration; \
/*0x00E0*/ bool		bKeepOnScreen; \
/*0x00E1*/ bool		bRightAnchoredToLeft; \
/*0x00E2*/ bool		bScreenClipRectChanged; \
/*0x00E4*/ int		BlinkState; \
/*0x00E8*/ BYTE		StartAlpha; \
/*0x00E9*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x00EA*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
...
/*0x0106*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
...
/*0x0124*/ bool		bIsParentOrContextMenuWindow; \
...
/*0x0160*/ bool bClickThroughMenuItemStatus; /* on/off */ \
...
/*0x018C*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
...
/*0x01B9*/ bool		bActive; \
/*0x01BA*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
...
/*0x01E1*/ BYTE     bResizableMask; \
/*0x01E2*/ bool		bTiled; \
/*0x01E3*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
...
// CBazaarSearchWnd_size: 0x92d0 (see 5514DE) in Dec 17 2019 Beta - eqmule
...
// CPlayerWindow_size: 0x2e8 (see 550DCE) in Dec 17 2019 Beta - eqmule
...
// CTargetWindow_size: 0x8c8 (see 550C65) in Dec 17 2019 Beta - eqmule
...
// CBuffWindow_size: 0x718 (see 550B09) in Dec 17 2019 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x320 (see 80873B) in Dec 17 2019 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d0 (see 550EC7) in Dec 17 2019 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d0 (see 80884C) in Dec 17 2019 Beta - eqmule
...
// CItemDisplayWindow_size: 0x628 (see 76BB82) in Dec 17 2019 Beta - eqmule
...
// CLootWnd_size: 0x398 (see 551236) in Dec 17 2019 Beta - eqmule
...
// CMapViewWnd_size: 0x648 (see 55096A) in Dec 17 2019 Beta - eqmule
...
// CMerchantWnd_size: 0x448 (see 551392) in Dec 17 2019 Beta - eqmule
...
// CPetInfoWindow_size: 0x8c8 (see 5503C1) in Dec 17 2019 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a8 (see 5506B2) in Dec 17 2019 Beta - eqmule
...
// CTradeWnd__size: 0x2f0 (see 551438) in Dec 17 2019 Beta - eqmule
...
// CFactionWnd__size: 0x278 (see 551584) in Dec 17 2019 Beta - eqmule
