...
// actual size 0x1E0 in Nov 25 2019 Beta (see 0x95153D) - eqmule
// actual size 0x1F0 in Dec  1 2019 Beta (see 0x95144D) - eqmule
// actual size 0x1F8 in Dec  3 2019 Beta (see 0x9513FD) - eqmule
// actual size 0x1E8 in Dec  5 2019 Beta (see 0x95270D) - eqmule
// actual size 0x200 in Dec  6 2019 Beta (see 0x9520CD) - eqmule
#define CXW_NO_VTABLE \
private: \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ LONG		BlinkStartTimer; \
/*0x0020*/ int		managerArrayIndex; \
/*0x0028*/ __int64		Data; \
/*0x0030*/ bool		bClipToParent; \
/*0x0034*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x0038*/ UINT		BlinkFadeDuration; \
/*0x003C*/ bool		bAction; \
/*0x0040*/ void	    *pFont; \
/*0x0044*/ bool		bClientClipRectChanged; \
/*0x0048*/ int		HScrollMax; \
/*0x004C*/ bool		bRightAnchoredToLeft; \
/*0x004D*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x004E*/ BYTE     bResizableMask; \
/*0x004F*/ bool		bBottomAnchoredToTop; \
/*0x0050*/ bool		bUseInLayoutHorizontal; \
/*0x0054*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x0058*/ UINT		BlinkFadeFreq; \
/*0x005C*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0060*/ void* pTipTextObject; \
/*0x0064*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x0065*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x0068*/ UINT		TransitionDuration; \
/*0x006C*/ bool		bClientRectChanged; \
/*0x0070*/ int		BottomOffset; \
/*0x0074*/ bool		bKeepOnScreen; \
/*0x0075*/ bool		bMarkedForDelete; \
/*0x0076*/ BYTE		StartAlpha; \
/*0x0078*/ void	*DrawTemplate; \
/*0x007C*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0080*/ void *pController; \
/*0x0084*/ DWORD  BackgroundDrawType; \
/*0x0088*/ COLORREF DisabledBackground; \
...
/*0x0090*/ RECT		OldLocation; \
/*0x00A0*/ RECT		IconRect; \
/*0x00B0*/ bool		Fades; \
/*0x00B4*/ RECT		ClipRectScreen; \
/*0x00C4*/ bool		bTopAnchoredToTop; \
/*0x00C8*/ RECT		ClipRectClient; \
/*0x00D8*/ DWORD	FadeDelay; \
/*0x00DC*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x00E0*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x00E4*/ UINT		BlinkFadeStartTime; \
/*0x00E8*/ int		TopOffset; \
/*0x00EC*/ UINT		FadeDuration; \
/*0x00F0*/ bool		bTiled; \
/*0x00F4*/ UINT		LastBlinkFadeRefreshTime; \
/*0x00F8*/ bool		dShow; \
/*0x00FC*/ int		LeftOffset; \
/*0x0100*/ BYTE		TargetAlpha; \
/*0x0104*/ void	*IconTextureAnim; \
/*0x0108*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0109*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x010A*/ BYTE		FadeAlpha; \
/*0x010B*/ bool		bBorder; \
/*0x010C*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
/*0x0110*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0114*/ bool		bHCenterTooltip; \
/*0x0118*/ RECT		ClientRect; \
/*0x0128*/ bool		bEscapableLocked; \
/*0x0129*/ bool		bScreenClipRectChanged; \
/*0x012C*/ int	Transition; \
/*0x0130*/ bool		bIsParentOrContextMenuWindow; \
/*0x0134*/ int		BlinkState; \
/*0x0138*/ struct _CXSTR*	DataStr; \
/*0x013C*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x013D*/ bool		bLeftAnchoredToLeft; \
/*0x0140*/ int		VScrollPos; \
/*0x0144*/ bool		Enabled; \
/*0x0148*/ int		HScrollPos; \
/*0x014C*/ bool		bCaptureTitle; \
/*0x0150*/ tagSIZE	MinClientSize; \
/*0x0158*/ BYTE		Alpha; \
/*0x0159*/ bool		bIsTransitioning; \
/*0x015C*/ int		BlinkDuration; \
/*0x0160*/ int		ParentAndContextMenuArrayIndex; \
/*0x0164*/ void*	pTextObject; \
/*0x0168*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x016C*/ bool		bUseInLayoutVertical; \
/*0x0170*/ void   *TitlePiece2; \
/*0x0174*/ bool		bActive; \
/*0x0175*/ bool		bFullyScreenClipped; \
/*0x0178*/ void		*pLayoutStrategy; \
/*0x017C*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x0180*/ int		VScrollMax; \
/*0x0184*/ struct _CSIDLWND* pWndFocusOther; \
/*0x0188*/ bool		bMaximized; \
/*0x0189*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x018A*/ bool		bBorder2; \
/*0x018C*/ int		RightOffset; \
/*0x0190*/ int		DeleteCount; \
/*0x0194*/ bool		bMaximizable; \
/*0x0198*/ void   *TitlePiece; \
/*0x019C*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x01A0*/ DWORD	XMLIndex; \
/*0x01A4*/ RECT		Location; \
...
/*0x01C4*/ bool		Faded; \
/*0x01C8*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x01E0*/ bool		Minimized; \
/*0x01E4*/ DWORD	LastTimeMouseOver; \
/*0x01E8*/ bool		bBringToTopWhenClicked; \
/*0x01EC*/ RECT		TransitionRect; \
...
/*0x258*/ void*		Unknown0x258;//most likely a CTextureAnimation*
/* CButtonDrawTemplate Start */
/*0x25c*/ PCXSTR	Name;
/*0x260*/ void*		Normal;//CTextureAnimation
/*0x264*/ void*		taPressed;
/*0x268*/ void*		Flyby;
/*0x26c*/ void*		taDisabled;
/*0x270*/ void*		PressedFlyby;
/*0x274*/ void*		PressedDisabled;
/*0x278*/ void*		NormalDecal;
/*0x27c*/ void*		PressedDecal;
/*0x280*/ void*		FlybyDecal;
/*0x284*/ void*		DisabledDecal;
/*0x288*/ void*		PressedFlybyDecal;
/*0x28c*/ void*		PressedDisabledDecal;
/*0x290*/ bool		bAllowButtonClickThrough;
/*0x291*/ bool		bCoolDownDoDelayedStart;
/*0x292*/ bool		bIsCheckbox;
/*0x293*/ bool		bIsDrawLasso;
/*0x294*/ UINT		ButtonStyle;
/*0x298*/
...
// CBazaarSearchWnd_size: 0x92e8 (see 55076E) in Dec  6 2019 Beta - eqmule
...
// CPlayerWindow_size: 0x300 (see 55005E) in Dec  6 2019 Beta - eqmule
...
// CTargetWindow_size: 0x8e0 (see 54FEF5) in Dec  6 2019 Beta - eqmule
...
// CBuffWindow_size: 0x730 (see 54FD99) in Dec  6 2019 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x338 (see 80817B) in Dec  6 2019 Beta - eqmule
...
// CCastSpellWnd_size: 0x2e8 (see 550157) in Dec  6 2019 Beta - eqmule
...
// CInvSlotWnd_size: 0x2e8 (see 80828C) in Dec  6 2019 Beta - eqmule
...
// CItemDisplayWindow_size: 0x640 (see 76B4F2) in Dec  6 2019 Beta - eqmule
...
// CLootWnd_size: 0x3b0 (see 5504C6) in Dec  6 2019 Beta - eqmule
...
// CMapViewWnd_size: 0x678 (see 54FBFA) in Dec  6 2019 Beta - eqmule
...
// CMerchantWnd_size: 0x460 (see 550622) in Dec  6 2019 Beta - eqmule
...
// CPetInfoWindow_size: 0x8e0 (see 54F651) in Dec  6 2019 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3c0 (see 54F942) in Dec  6 2019 Beta - eqmule
...
// CTradeWnd__size: 0x308 (see 5506C8) in Dec  6 2019 Beta - eqmule
...
// CFactionWnd__size: 0x290 (see 550814) in Dec  6 2019 Beta - eqmule
