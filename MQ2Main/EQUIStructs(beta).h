...
/*0x0020*/ bool		Enabled; \
/*0x0021*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0024*/ RECT		Location; \
/*0x0034*/ bool		bActive; \
/*0x0038*/ int		VScrollPos; \
/*0x003C*/ bool		bEscapableLocked; \
/*0x003D*/ bool		bMaximizable; \
/*0x0040*/ RECT		ClipRectScreen; \
/*0x0050*/ DWORD	FadeDelay; \
/*0x0054*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0055*/ bool		bBottomAnchoredToTop; \
/*0x0058*/ int		BottomOffset; \
/*0x005C*/ DWORD  BackgroundDrawType; \
/*0x0060*/ int		HScrollMax; \
/*0x0064*/ UINT		BlinkFadeDuration; \
...
/*0x0074*/ void   *TitlePiece; \
/*0x0078*/ struct _CXSTR*	DataStr; \
/*0x007C*/ int		LeftOffset; \
/*0x0080*/ UINT		BlinkFadeFreq; \
/*0x0084*/ void	*IconTextureAnim; \
/*0x0088*/ DWORD	XMLIndex; \
/*0x008C*/ UINT		FadeDuration; \
/*0x0090*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0091*/ bool		bUseInLayoutHorizontal; \
/*0x0092*/ BYTE     bResizableMask; \
/*0x0093*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x0094*/ bool		bScreenClipRectChanged; \
/*0x0095*/ bool		bBringToTopWhenClicked; \
/*0x0098*/ void	    *pFont; \
/*0x009C*/ bool		bLeftAnchoredToLeft; \
/*0x00A0*/ void* pTipTextObject; \
/*0x00A4*/ int		DeleteCount; \
/*0x00A8*/ UINT		BlinkFadeStartTime; \
/*0x00AC*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x00AD*/ bool		ValidCXWnd; /* IsValid has this one */ \
...
/*0x00DD*/ bool		bUseInLayoutVertical; \
/*0x00E0*/ UINT		TransitionDuration; \
/*0x00E4*/ bool		Minimized; \
/*0x00E5*/ BYTE		TargetAlpha; \
/*0x00E6*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x00E8*/ int		BlinkDuration; \
/*0x00EC*/ UINT		LastBlinkFadeRefreshTime; \
/*0x00F0*/ RECT		ClientRect; \
/*0x0100*/ bool		bClientClipRectChanged; \
/*0x0104*/ void		*pLayoutStrategy; \
/*0x0108*/ BYTE		StartAlpha; \
/*0x0109*/ bool		bHCenterTooltip; \
/*0x010C*/ int	Transition; \
/*0x0110*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x0114*/ bool		bClipToParent; \
/*0x0118*/ RECT		OldLocation; \
...
/*0x0160*/ bool		dShow; \
/*0x0164*/ void	*DrawTemplate; \
/*0x0168*/ bool		bMaximized; \
/*0x0169*/ bool		bCaptureTitle; \
...
/*0x018C*/ bool		bRightAnchoredToLeft; \
/*0x0190*/ UINT		TransitionStartTick; \
/*0x0194*/ RECT		TransitionRect; \
/*0x01A8*/ __int64		Data; \
/*0x01B0*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x01B4*/ bool		bAction; \
/*0x01B5*/ BYTE		Alpha; \
/*0x01B8*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x1c */ \
/*0x01D4*/ int		TopOffset; \
/*0x01D8*/ bool		bIsTransitioning; \
/*0x01DC*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x01E0*/ bool		bFullyScreenClipped; \
/*0x01E1*/ bool		Fades; \
...
/*0x01EC*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x01ED*/ bool		bTopAnchoredToTop; \
...
// CBazaarSearchWnd_size: 0x92d8 (see 4CD14A) in Nov 21 2017 Beta - eqmule
...
// CPlayerWindow_size: 0x2f0 (see 4CC98D) in Nov 21 2017 Beta - eqmule
...
// CTargetWindow_size: 0x8d0 (see 4CC824) in Nov 21 2017 Beta - eqmule
...
// CBuffWindow_size: 0x720 (see 4CC6B8) in Nov 21 2017 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x320 (see 7A3478) in Nov 21 2017 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d8 (see 4CCA9E) in Nov 21 2017 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d8 (see 7A3589) in Nov 21 2017 Beta - eqmule
...
// CItemDisplayWindow_size: 0x618 (see 6EDC2F) in Nov 21 2017 Beta - eqmule
...
// CLootWnd_size: 0x3a0 (see 4CCE60) in Nov 21 2017 Beta - eqmule
...
// CMapViewWnd_size: 0x658 (see 4CC519) in Nov 21 2017 Beta - eqmule
...
// CMerchantWnd_size: 0x440 (see 4CCFDE) in Nov 21 2017 Beta - eqmule
...
// CPetInfoWindow_size: 0x8d0 (see 4CBF50) in Nov 21 2017 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3b0 (see 4CC243) in Nov 21 2017 Beta - eqmule
...
// CTradeWnd__size: 0x2f8 (see 4CD094) in Nov 21 2017 Beta - eqmule
