...
// actual size 0x1F0 in Oct 27 2017 Beta (see 0x8DC73D) - eqmule
...
/*0x0098*/ bool		bUseInLayoutVertical; \
/*0x009C*/ UINT		BlinkFadeFreq; \
/*0x00A0*/ bool		Fades; \
/*0x00A1*/ bool		bKeepOnScreen; \
...
/*0x00F4*/ bool		bScreenClipRectChanged; \
/*0x00F5*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x00F8*/ RECT		Location; \
/*0x0108*/ bool		bLeftAnchoredToLeft; \
/*0x0109*/ bool		bEscapableLocked; \
/*0x010A*/ bool		ValidCXWnd; /* IsValid has this one */ \
...
/*0x0130*/ bool		dShow; \
/*0x0131*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x0132*/ bool		bCaptureTitle; \
/*0x0133*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0134*/ int		DeleteCount; \
/*0x0138*/ bool		bTiled; \
/*0x0139*/ bool		bBottomAnchoredToTop; \
...
/*0x0194*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
...
/*0x01B9*/ bool		bBringToTopWhenClicked; \
/*0x01BC*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x01C0*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x1c */ \
/*0x01DC*/ tagSIZE	MinClientSize; \
/*0x01E4*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x01E5*/ BYTE		FadeAlpha; \
...
// Actual Size: 0x418 (see 4CDD8E) in Oct 28 2017 Beta - eqmule
...
/*0x0260*/ BYTE Unknown0x0260[0x1b8];
/*0x0418*/
