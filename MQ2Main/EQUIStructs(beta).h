...
// actual size 0x1E0 in Dec 16 2019 Beta (see 0x9519FD) - eqmule
#define CXW_NO_VTABLE \
private: \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ UINT		FadeDuration; \
/*0x0020*/ void		*pLayoutStrategy; \
/*0x0024*/ bool		bCaptureTitle; \
/*0x0025*/ BYTE     bResizableMask; \
/*0x0028*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x002C*/ DWORD	LastTimeMouseOver; \
/*0x0030*/ void	    *pFont; \
/*0x0034*/ tagSIZE	MinClientSize; \
/*0x003C*/ bool		bBorder; \
/*0x003D*/ bool		bUseInLayoutVertical; \
/*0x003E*/ bool		bRightAnchoredToLeft; \
/*0x003F*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x0040*/ __int64		Data; \
/*0x0048*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x004C*/ void	*IconTextureAnim; \
/*0x0050*/ BYTE		TargetAlpha; \
/*0x0051*/ bool		bClipToParent; \
/*0x0052*/ bool		bUseInLayoutHorizontal; \
/*0x0053*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x0054*/ int		managerArrayIndex; \
/*0x0058*/ bool		bTopAnchoredToTop; \
/*0x005C*/ RECT		Location; \
/*0x006C*/ bool		bAction; \
/*0x006D*/ bool		Minimized; \
...
/*0x0088*/ bool		bBottomAnchoredToTop; \
/*0x0089*/ bool		bClientClipRectChanged; \
/*0x008A*/ bool		Enabled; \
/*0x008C*/ int	Transition; \
/*0x0090*/ RECT		ClientRect; \
/*0x00A0*/ bool		bIsParentOrContextMenuWindow; \
/*0x00A4*/ void* pTipTextObject; \
/*0x00A8*/ UINT		TransitionStartTick; \
/*0x00AC*/ int		VScrollMax; \
/*0x00B0*/ UINT		BlinkFadeFreq; \
/*0x00B4*/ bool		bKeepOnScreen; \
/*0x00B5*/ bool		Faded; \
/*0x00B6*/ bool		bMaximized; \
/*0x00B8*/ int		BottomOffset; \
/*0x00BC*/ int		ParentAndContextMenuArrayIndex; \
/*0x00C0*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x00C4*/ void*	pTextObject; \
/*0x00C8*/ int		TopOffset; \
/*0x00CC*/ UINT		TransitionDuration; \
/*0x00D0*/ DWORD	XMLIndex; \
...
/*0x00E0*/ bool		bMaximizable; \
/*0x00E4*/ int		LeftOffset; \
/*0x00E8*/ int		DeleteCount; \
/*0x00EC*/ RECT		OldLocation; \
/*0x00FC*/ COLORREF DisabledBackground; \
...
/*0x010C*/ int		HScrollMax; \
/*0x0110*/ bool		Fades; \
/*0x0111*/ bool		bBorder2; \
/*0x0112*/ bool		bBringToTopWhenClicked; \
/*0x0114*/ struct _CSIDLWND* pWndFocusOther; \
/*0x0118*/ UINT		LastBlinkFadeRefreshTime; \
/*0x011C*/ void   *TitlePiece2; \
/*0x0120*/ bool		bScreenClipRectChanged; \
/*0x0124*/ tagSIZE	MaxClientSize; \
/*0x012C*/ int		VScrollPos; \
...
/*0x0144*/ RECT		ClipRectClient; \
/*0x0154*/ int		RightOffset; \
/*0x0158*/ struct _CXSTR*	DataStr; \
/*0x015C*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
...
/*0x0178*/ int		HScrollPos; \
/*0x017C*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
/*0x0180*/ BYTE		StartAlpha; \
/*0x0181*/ bool		bFullyScreenClipped; \
/*0x0182*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x0184*/ DWORD	FadeDelay; \
/*0x0188*/ RECT		IconRect; \
/*0x0198*/ RECT		ClipRectScreen; \
/*0x01A8*/ int		BlinkDuration; \
/*0x01AC*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x01AD*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x01B0*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x01C8*/ bool		bClientRectChanged; \
/*0x01C9*/ bool		dShow; \
/*0x01CA*/ bool		bIsTransitioning; \
/*0x01CC*/ void	*DrawTemplate; \
/*0x01D0*/ bool		bTiled; \
/*0x01D1*/ BYTE		FadeAlpha; \
/*0x01D4*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x01D8*/ bool		bEscapableLocked; \
/*0x01D9*/ bool		bHCenterTooltip; \
...
// CBazaarSearchWnd_size: 0x92c8 (see 5516EE) in Dec 16 2019 Beta - eqmule
...
// CPlayerWindow_size: 0x2e0 (see 550FDE) in Dec 16 2019 Beta - eqmule
...
// CTargetWindow_size: 0x8c0 (see 550E75) in Dec 16 2019 Beta - eqmule
...
// CBuffWindow_size: 0x710 (see 550D19) in Dec 16 2019 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x318 (see 8082BB) in Dec 16 2019 Beta - eqmule
...
// CCastSpellWnd_size: 0x2c8 (see 5510D7) in Dec 16 2019 Beta - eqmule
...
// CInvSlotWnd_size: 0x2c8 (see 8083CC) in Dec 16 2019 Beta - eqmule
...
// CItemDisplayWindow_size: 0x620 (see 76B4C2) in Dec 16 2019 Beta - eqmule
...
// CLootWnd_size: 0x390 (see 551446) in Dec 16 2019 Beta - eqmule
...
// CMapViewWnd_size: 0x638 (see 550B7A) in Dec 16 2019 Beta - eqmule
...
// CMerchantWnd_size: 0x440 (see 5515A2) in Dec 16 2019 Beta - eqmule
...
// CPetInfoWindow_size: 0x8c0 (see 5505D1) in Dec 16 2019 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a0 (see 5508C2) in Dec 16 2019 Beta - eqmule
...
// CTradeWnd__size: 0x2e8 (see 551648) in Dec 16 2019 Beta - eqmule
...
// CFactionWnd__size: 0x270 (see 551794) in Dec 16 2019 Beta - eqmule
