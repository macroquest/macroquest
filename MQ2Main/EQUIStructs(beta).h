...
/*0x0020*/ void* pTipTextObject; \
/*0x0024*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x0028*/ LONG		BlinkStartTimer; \
/*0x0030*/ __int64		Data; \
...
/*0x0070*/ bool		bMarkedForDelete; \
/*0x0074*/ int		BottomOffset; \
/*0x0078*/ void	    *pFont; \
/*0x007C*/ int		TopOffset; \
/*0x0080*/ UINT		TransitionDuration; \
/*0x0084*/ bool		bEscapableLocked; \
/*0x0085*/ bool		Minimized; \
/*0x0086*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x0088*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x008C*/ bool		bRightAnchoredToLeft; \
/*0x008D*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0090*/ int	Transition; \
/*0x0094*/ void	*DrawTemplate; \
/*0x0098*/ UINT		TransitionStartTick; \
/*0x009C*/ bool		bHCenterTooltip; \
/*0x00A0*/ int		managerArrayIndex; \
/*0x00A4*/ bool		bUseInLayoutVertical; \
/*0x00A8*/ void *pController; \
/*0x00AC*/ bool		bKeepOnScreen; \
/*0x00AD*/ bool		bActive; \
/*0x00AE*/ bool		Fades; \
/*0x00B0*/ UINT		BlinkFadeStartTime; \
/*0x00B4*/ bool		bBottomAnchoredToTop; \
/*0x00B5*/ bool		bBringToTopWhenClicked; \
...
/*0x00CC*/ int		BlinkDuration; \
/*0x00D0*/ bool		bTiled; \
/*0x00D4*/ void   *TitlePiece; \
/*0x00D8*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
...
/*0x0100*/ int		HScrollMax; \
/*0x0104*/ BYTE		StartAlpha; \
/*0x0108*/ RECT		IconRect; \
/*0x0118*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x011C*/ tagSIZE	MinClientSize; \
/*0x0124*/ BYTE		TargetAlpha; \
/*0x0125*/ bool		bUseInLayoutHorizontal; \
/*0x0128*/ void		*pLayoutStrategy; \
/*0x012C*/ bool		bFullyScreenClipped; \
/*0x012D*/ bool		bScreenClipRectChanged; \
/*0x012E*/ bool		bAction; \
/*0x012F*/ bool		bClientRectChanged; \
/*0x0130*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x0134*/ int		RightOffset; \
/*0x0138*/ UINT		BlinkFadeFreq; \
/*0x013C*/ void*	pTextObject; \
/*0x0140*/ struct _CSIDLWND* pWndFocusOther; \
/*0x0144*/ bool		bMaximized; \
/*0x0148*/ void	*IconTextureAnim; \
/*0x014C*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x0150*/ int		HScrollPos; \
/*0x0154*/ UINT		LastBlinkFadeRefreshTime; \
/*0x0158*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x1c */ \
/*0x0174*/ DWORD	LastTimeMouseOver; \
/*0x0178*/ bool		bIsParentOrContextMenuWindow; \
/*0x0179*/ bool		bTopAnchoredToTop; \
/*0x017A*/ bool		bIsTransitioning; \
/*0x017B*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x017C*/ UINT		BlinkFadeDuration; \
/*0x0180*/ RECT		Location; \
/*0x0190*/ RECT		ClipRectClient; \
/*0x01A0*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x01A4*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x01A8*/ DWORD	XMLIndex; \
/*0x01AC*/ bool		Faded; \
/*0x01AD*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x01AE*/ bool		bClientClipRectChanged; \
/*0x01AF*/ bool		bCaptureTitle; \
/*0x01B0*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x01B1*/ bool		Enabled; \
/*0x01B4*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x01B8*/ bool		bLeftAnchoredToLeft; \
/*0x01BC*/ tagSIZE	MaxClientSize; \
/*0x01C4*/ bool		bClipToParent; \
/*0x01C8*/ int		LeftOffset; \
/*0x01CC*/ int		DeleteCount; \
/*0x01D0*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x01D4*/ UINT		FadeDuration; \
/*0x01D8*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x01DC*/ RECT		ClipRectScreen; \
...
/*0x240*/ struct _CSIDLWND *DisplayWnd;
/*0x244*/ PVOID pName; 
/*0x248*/ PVOID pIcon; 
...
//size 0x308 see 4CEE3D in Nov  7 2017 Beta -eqmule
...
// CBazaarSearchWnd_size: 0x92d8 (see 4CCF9A) in Nov 27 2017 Beta - eqmule
...
// CPlayerWindow_size: 0x2f0 (see 4CC7DD) in Nov 27 2017 Beta - eqmule
...
// CTargetWindow_size: 0x8d0 (see 4CC674) in Nov 27 2017 Beta - eqmule
...
// CBuffWindow_size: 0x720 (see 4CC508) in Nov 27 2017 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x320 (see 7A47B8) in Nov 27 2017 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d8 (see 4CC8EE) in Nov 27 2017 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d8 (see 7A48C9) in Nov 27 2017 Beta - eqmule
...
// CItemDisplayWindow_size: 0x618 (see 6EF03F) in Nov 27 2017 Beta - eqmule
...
// CLootWnd_size: 0x3a0 (see 4CCCB0) in Nov 27 2017 Beta - eqmule
...
// CMapViewWnd_size: 0x658 (see 4CC369) in Nov 27 2017 Beta - eqmule
...
// CMerchantWnd_size: 0x440 (see 4CCE2E) in Nov 27 2017 Beta - eqmule
...
// CPetInfoWindow_size: 0x8d0 (see 4CBDA0) in Nov 27 2017 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3b0 (see 4CC093) in Nov 27 2017 Beta - eqmule
...
// CTradeWnd__size: 0x2f8 (see 4CCEE4) in Nov 27 2017 Beta - eqmule
