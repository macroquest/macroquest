...
/*0x0024*/ BYTE		TargetAlpha; \
/*0x0028*/ void	*DrawTemplate; \
/*0x002C*/ bool		bLeftAnchoredToLeft; \
/*0x0030*/ int		TopOffset; \
/*0x0034*/ bool		bBorder; \
/*0x0038*/ RECT		IconRect; \
/*0x0048*/ RECT		ClientRect; \
/*0x0058*/ BYTE     bResizableMask; \
...
/*0x0064*/ BYTE		FadeAlpha; \
/*0x0065*/ bool		bMarkedForDelete; \
/*0x0068*/ UINT		FadeDuration; \
/*0x006C*/ bool		bIsParentOrContextMenuWindow; \
/*0x006D*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x0070*/ struct _CSIDLWND* pWndFocusOther; \
/*0x0074*/ int		ParentAndContextMenuArrayIndex; \
/*0x0078*/ bool		bBorder2; \
/*0x007C*/ UINT		TransitionDuration; \
/*0x0080*/ bool		dShow; \
/*0x0081*/ BYTE		Alpha; \
...
/*0x0088*/ int		DeleteCount; \
/*0x008C*/ UINT		BlinkFadeDuration; \
/*0x0090*/ void		*pLayoutStrategy; \
/*0x0094*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0095*/ bool		bBottomAnchoredToTop; \
/*0x0096*/ bool		bRightAnchoredToLeft; \
/*0x0098*/ int		RightOffset; \
/*0x009C*/ tagSIZE	MinClientSize; \
/*0x00A4*/ bool		bClientRectChanged; \
/*0x00A8*/ void   *TitlePiece2; \
/*0x00AC*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x00AD*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x00B0*/ LONG		BlinkStartTimer; \
/*0x00B4*/ bool		bBringToTopWhenClicked; \
/*0x00B5*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x00B8*/ void	    *pFont; \
/*0x00BC*/ tagSIZE	MaxClientSize; \
/*0x00C4*/ int		BlinkDuration; \
/*0x00C8*/ BYTE		StartAlpha; \
/*0x00C9*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x00CC*/ void   *TitlePiece; \
/*0x00D0*/ bool		bUseInLayoutVertical; \
/*0x00D4*/ void	*IconTextureAnim; \
/*0x00D8*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x00D9*/ bool		Fades; \
/*0x00DA*/ bool		bKeepOnScreen; \
...
/*0x01D9*/ bool		bTiled; \
/*0x01DA*/ bool		bEscapableLocked; \
/*0x01DC*/ int		LeftOffset; \
/*0x01E0*/ int		BlinkState; \
...
// CBazaarSearchWnd_size: 0x92d0 (see 53950D) in Nov  9 2018 Beta - eqmule
...
// CPlayerWindow_size: 0x2e8 (see 538E00) in Nov  9 2018 Beta - eqmule
...
// CTargetWindow_size: 0x8c8 (see 538C9B) in Nov  9 2018 Beta - eqmule
...
// CBuffWindow_size: 0x718 (see 538B3F) in Nov  9 2018 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x320 (see 7E9D8B) in Nov  9 2018 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d0 (see 538EF9) in Nov  9 2018 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d0 (see 7E9E9C) in Nov  9 2018 Beta - eqmule
...
// CItemDisplayWindow_size: 0x628 (see 749DC2) in Nov  9 2018 Beta - eqmule
...
// CLootWnd_size: 0x398 (see 539265) in Nov  9 2018 Beta - eqmule
...
// CMapViewWnd_size: 0x648 (see 5389A0) in Nov  9 2018 Beta - eqmule
...
// CMerchantWnd_size: 0x448 (see 5393C1) in Nov  9 2018 Beta - eqmule
...
// CPetInfoWindow_size: 0x8c8 (see 5383DA) in Nov  9 2018 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a8 (see 5386CB) in Nov  9 2018 Beta - eqmule
...
// CTradeWnd__size: 0x2f0 (see 539467) in Nov  9 2018 Beta - eqmule
