...
/*0x0099*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x009C*/ void	*DrawTemplate; \
/*0x00A0*/ bool		bIsParentOrContextMenuWindow; \
/*0x00A1*/ BYTE		TargetAlpha; \
/*0x00A2*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x00A3*/ bool		bEscapableLocked; \
/*0x00A4*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x00A8*/ __int64		Data; \
/*0x00B0*/ bool		bScreenClipRectChanged; \
/*0x00B1*/ bool		bMaximized; \
/*0x00B2*/ bool		bUseInLayoutVertical; \
/*0x00B4*/ tagSIZE	MinClientSize; \
/*0x00BC*/ BYTE		FadeAlpha; \
/*0x00BD*/ bool		bIsTransitioning; \
/*0x00C0*/ UINT		FadeDuration; \
/*0x00C4*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
...
/*0x0104*/ bool		bHCenterTooltip; \
/*0x0108*/ void		*pLayoutStrategy; \
/*0x010C*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
...
/*0x0158*/ bool		Minimized; \
/*0x015C*/ void* pTipTextObject; \
/*0x0160*/ void	    *pFont; \
/*0x0164*/ bool bClickThroughMenuItemStatus; /* on/off */ \
...
/*0x01E8*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
...
// CBazaarSearchWnd_size: 0x92d8 (see 55A80E) in Nov 19 2020 Beta - eqmule
...
//aAPwcsincombat
// CPlayerWindow_size: 0x2f0 (see 55A0FE) in Nov 19 2020 Beta - eqmule
...
// CTargetWindow_size: 0x8d0 (see 559F95) in Nov 19 2020 Beta - eqmule
...
// CBuffWindow_size: 0x720 (see 559E39) in Nov 19 2020 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x328 (see 7FBC1B) in Nov 19 2020 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d8 (see 55A1F7) in Nov 19 2020 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d8 (see 7FBD2C) in Nov 19 2020 Beta - eqmule
...
// CItemDisplayWindow_size: 0x630 (see 75E8F2) in Nov 19 2020 Beta - eqmule
...
// CLootWnd_size: 0x3a0 (see 55A566) in Nov 19 2020 Beta - eqmule
...
// CMapViewWnd_size: 0x658 (see 559C9A) in Nov 19 2020 Beta - eqmule
...
// CMerchantWnd_size: 0x450 (see 55A6C2) in Nov 19 2020 Beta - eqmule
...
// CPetInfoWindow_size: 0x8d0 (see 5596F1) in Nov 19 2020 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a8 (see 5599E2) in Nov 19 2020 Beta - eqmule
...
// CTradeWnd__size: 0x2f8 (see 55A768) in Nov 19 2020 Beta - eqmule
...
// CFactionWnd__size: 0x280 (see 55A8B4) in Nov 19 2020 Beta - eqmule
