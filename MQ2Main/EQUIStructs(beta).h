...
// actual size 0x1D8 in Oct 31 2019 Beta (see 0x94B62D) - eqmule
// actual size 0x1E0 in Nov  7 2019 Beta (see 0x94E02D) - eqmule
// actual size 0x1E8 in Nov  8 2019 Beta (see 0x94C53D) - eqmule
// actual size 0x1F0 in Nov  9 2019 Beta (see 0x94EC0D) - eqmule
#define CXW_NO_VTABLE \
private: \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ BYTE     bResizableMask; \
/*0x0020*/ int	Transition; \
...
/*0x0034*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x004C*/ int		RightOffset; \
/*0x0050*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x0054*/ UINT		FadeDuration; \
/*0x0058*/ bool		bClientClipRectChanged; \
/*0x005C*/ UINT		TransitionStartTick; \
/*0x0060*/ bool		bLeftAnchoredToLeft; \
/*0x0061*/ bool		bActive; \
/*0x0064*/ int		BlinkDuration; \
/*0x0068*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x0069*/ bool		bHCenterTooltip; \
/*0x006A*/ bool		bKeepOnScreen; \
/*0x006B*/ bool		bRightAnchoredToLeft; \
/*0x006C*/ bool		bTiled; \
/*0x0070*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x0074*/ BYTE		TargetAlpha; \
/*0x0078*/ DWORD	LastTimeMouseOver; \
/*0x007C*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x007D*/ bool		bCaptureTitle; \
/*0x0080*/ DWORD  BackgroundDrawType; \
/*0x0084*/ bool		Minimized; \
/*0x0088*/ int		HScrollPos; \
/*0x008C*/ bool		bUseInLayoutVertical; \
/*0x008D*/ bool		bBringToTopWhenClicked; \
/*0x008E*/ bool		bMarkedForDelete; \
/*0x008F*/ bool		bBottomAnchoredToTop; \
/*0x0090*/ bool		Enabled; \
/*0x0091*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x0092*/ bool		bIsParentOrContextMenuWindow; \
/*0x0094*/ int		LeftOffset; \
/*0x0098*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x009C*/ int		HScrollMax; \
/*0x00A0*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x00A1*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x00A2*/ bool		bFullyScreenClipped; \
/*0x00A4*/ RECT		ClipRectClient; \
/*0x00B4*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x00B8*/ bool		bUseInLayoutHorizontal; \
/*0x00BC*/ int		ParentAndContextMenuArrayIndex; \
/*0x00C0*/ UINT		LastBlinkFadeRefreshTime; \
/*0x00C4*/ bool		bBorder2; \
/*0x00C8*/ int		DeleteCount; \
/*0x00CC*/ void	*IconTextureAnim; \
/*0x00D0*/ int		VScrollPos; \
/*0x00D4*/ BYTE		StartAlpha; \
/*0x00D5*/ bool		bClientRectChanged; \
/*0x00D8*/ UINT		BlinkFadeStartTime; \
/*0x00DC*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x00E0*/ bool		bTopAnchoredToTop; \
...
/*0x00EC*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x00F0*/ RECT		Location; \
/*0x0100*/ bool		Faded; \
/*0x0101*/ bool		dShow; \
/*0x0102*/ bool		bMaximizable; \
/*0x0104*/ RECT		ClientRect; \
/*0x0114*/ UINT		BlinkFadeFreq; \
/*0x0118*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x011C*/ bool		bMaximized; \
/*0x0120*/ UINT		TransitionDuration; \
/*0x0124*/ bool		bBorder; \
/*0x0128*/ void		*pLayoutStrategy; \
/*0x012C*/ struct _CSIDLWND* pWndFocusOther; \
/*0x0130*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0134*/ RECT		OldLocation; \
/*0x0144*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x0148*/ void*	pTextObject; \
/*0x014C*/ int		managerArrayIndex; \
/*0x0150*/ BYTE		Alpha; \
/*0x0154*/ DWORD	FadeDelay; \
/*0x0158*/ void   *TitlePiece; \
/*0x015C*/ void   *TitlePiece2; \
/*0x0160*/ LONG		BlinkStartTimer; \
/*0x0164*/ DWORD	XMLIndex; \
/*0x0168*/ RECT		TransitionRect; \
/*0x0178*/ bool		bScreenClipRectChanged; \
/*0x017C*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0180*/ bool		bIsTransitioning; \
/*0x0184*/ void *pController; \
/*0x0188*/ tagSIZE	MaxClientSize; \
/*0x0190*/ __int64		Data; \
...
/*0x01B4*/ bool		bEscapableLocked; \
/*0x01B5*/ bool		bAction; \
/*0x01B6*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x01B8*/ COLORREF DisabledBackground; \
/*0x01BC*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x01C0*/ RECT		ClipRectScreen; \
/*0x01D0*/ void	    *pFont; \
/*0x01D4*/ void* pTipTextObject; \
/*0x01D8*/ UINT		BlinkFadeDuration; \
/*0x01DC*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
...
// CBazaarSearchWnd_size: 0x92d8 (see 54F3CE) in Nov  9 2019 Beta - eqmule
...
// CPlayerWindow_size: 0x2f0 (see 54ECBE) in Nov  9 2019 Beta - eqmule
...
// CTargetWindow_size: 0x8d0 (see 54EB55) in Nov  9 2019 Beta - eqmule
...
// CBuffWindow_size: 0x720 (see 54E9F9) in Nov  9 2019 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x328 (see 80598B) in Nov  9 2019 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d8 (see 54EDB7) in Nov  9 2019 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d8 (see 805A9C) in Nov  9 2019 Beta - eqmule
...
// CItemDisplayWindow_size: 0x630 (see 7689B2) in Nov  9 2019 Beta - eqmule
...
// CLootWnd_size: 0x3a0 (see 54F126) in Nov  9 2019 Beta - eqmule
...
// CMapViewWnd_size: 0x658 (see 54E85A) in Nov  9 2019 Beta - eqmule
...
// CMerchantWnd_size: 0x450 (see 54F282) in Nov  9 2019 Beta - eqmule
...
// CPetInfoWindow_size: 0x8d0 (see 54E2B1) in Nov  9 2019 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3b0 (see 54E5A2) in Nov  9 2019 Beta - eqmule
...
// CTradeWnd__size: 0x2f8 (see 54F328) in Nov  9 2019 Beta - eqmule
...
// CFactionWnd__size: 0x280 (see 54F474) in Nov  9 2019 Beta - eqmule
