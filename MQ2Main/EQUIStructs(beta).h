...
// actual size 0x1F8 in Dec  8 2019 Beta (see 0x952E2D) - eqmule
// actual size 0x1F0 in Dec 13 2019 Beta (see 0x951FCD) - eqmule
// actual size 0x1E0 in Dec 15 2019 Beta (see 0x951FFD) - eqmule
#define CXW_NO_VTABLE \
private: \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ UINT		BlinkFadeStartTime; \
/*0x0020*/ bool		bClientClipRectChanged; \
/*0x0021*/ bool		bUseInLayoutHorizontal; \
/*0x0022*/ bool		bUseInLayoutVertical; \
/*0x0024*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x0028*/ bool		bMaximized; \
/*0x002C*/ void	*IconTextureAnim; \
/*0x0030*/ int		HScrollMax; \
/*0x0034*/ bool		bIsParentOrContextMenuWindow; \
/*0x0038*/ void *pController; \
/*0x003C*/ void		*pLayoutStrategy; \
/*0x0040*/ DWORD	LastTimeMouseOver; \
/*0x0044*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
/*0x0048*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x004C*/ bool		bBringToTopWhenClicked; \
/*0x004D*/ bool		bClipToParent; \
/*0x004E*/ BYTE		Alpha; \
/*0x004F*/ bool		bActive; \
/*0x0050*/ bool		bLeftAnchoredToLeft; \
/*0x0051*/ bool		bBorder; \
/*0x0054*/ void*	pTextObject; \
/*0x0058*/ void	    *pFont; \
/*0x005C*/ tagSIZE	MaxClientSize; \
/*0x0064*/ bool		bTopAnchoredToTop; \
/*0x0068*/ LONG		BlinkStartTimer; \
/*0x006C*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x006D*/ BYTE		StartAlpha; \
/*0x006E*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x0070*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x0088*/ int		BottomOffset; \
/*0x008C*/ UINT		BlinkFadeFreq; \
/*0x0090*/ UINT		LastBlinkFadeRefreshTime; \
/*0x0094*/ bool		Faded; \
/*0x0095*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0098*/ DWORD	XMLIndex; \
/*0x009C*/ int		HScrollPos; \
/*0x00A0*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x00A4*/ void	*DrawTemplate; \
/*0x00A8*/ int		BlinkState; \
/*0x00AC*/ bool		bBottomAnchoredToTop; \
/*0x00AD*/ bool		bRightAnchoredToLeft; \
/*0x00B0*/ RECT		IconRect; \
/*0x00C0*/ RECT		TransitionRect; \
/*0x00D0*/ RECT		ClipRectScreen; \
/*0x00E0*/ int	Transition; \
/*0x00E4*/ int		RightOffset; \
/*0x00E8*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x00E9*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x00EC*/ int		BlinkDuration; \
/*0x00F0*/ int		TopOffset; \
/*0x00F4*/ BYTE     bResizableMask; \
/*0x00F8*/ int		LeftOffset; \
/*0x00FC*/ bool		bTiled; \
/*0x00FD*/ bool		bScreenClipRectChanged; \
/*0x0100*/ UINT		BlinkFadeDuration; \
/*0x0108*/ __int64		Data; \
/*0x0110*/ UINT		FadeDuration; \
/*0x0114*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0118*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x0119*/ bool		bKeepOnScreen; \
/*0x011A*/ bool		bAction; \
/*0x011B*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x011C*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0120*/ void   *TitlePiece; \
/*0x0124*/ int		VScrollPos; \
/*0x0128*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0129*/ bool		Minimized; \
/*0x012C*/ struct _CSIDLWND* pWndFocusOther; \
/*0x0130*/ void* pTipTextObject; \
/*0x0134*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x0138*/ RECT		ClientRect; \
/*0x0148*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x014C*/ void   *TitlePiece2; \
/*0x0150*/ bool		bHCenterTooltip; \
/*0x0151*/ bool		bCaptureTitle; \
/*0x0154*/ int		managerArrayIndex; \
/*0x0158*/ BYTE		TargetAlpha; \
/*0x0159*/ bool		bEscapableLocked; \
/*0x015A*/ bool		bMarkedForDelete; \
/*0x015B*/ bool		bBorder2; \
/*0x015C*/ DWORD	FadeDelay; \
/*0x0160*/ int		VScrollMax; \
/*0x0164*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0168*/ struct _CXSTR*	DataStr; \
/*0x016C*/ RECT		ClipRectClient; \
/*0x017C*/ int		ParentAndContextMenuArrayIndex; \
/*0x0180*/ bool		bMaximizable; \
/*0x0181*/ BYTE		FadeAlpha; \
/*0x0184*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x0188*/ bool		Fades; \
/*0x018C*/ int		DeleteCount; \
...
/*0x0194*/ tagSIZE	MinClientSize; \
/*0x019C*/ bool		bClientRectChanged; \
/*0x01A0*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x01A4*/ bool		dShow; \
/*0x01A5*/ bool		bFullyScreenClipped; \
/*0x01A6*/ bool		Enabled; \
/*0x01A8*/ DWORD  BackgroundDrawType; \
/*0x01AC*/ COLORREF DisabledBackground; \
/*0x01B0*/ UINT		TransitionStartTick; \
/*0x01B4*/ UINT		TransitionDuration; \
/*0x01B8*/ RECT		OldLocation; \
/*0x01C8*/ RECT		Location; \
/*0x01D8*/ bool		bIsTransitioning; \
...
/*0x0238*/ void*	Unknown0x258;//most likely a CTextureAnimation*
...
// CBazaarSearchWnd_size: 0x92c8 (see 55163E) in Dec 15 2019 Beta - eqmule
...
// CPlayerWindow_size: 0x2e0 (see 550F2E) in Dec 15 2019 Beta - eqmule
...
// CTargetWindow_size: 0x8c0 (see 550DC5) in Dec 15 2019 Beta - eqmule
...
// CBuffWindow_size: 0x710 (see 550C69) in Dec 15 2019 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x318 (see 808B3B) in Dec 15 2019 Beta - eqmule
...
// CCastSpellWnd_size: 0x2c8 (see 551027) in Dec 15 2019 Beta - eqmule
...
// CInvSlotWnd_size: 0x2c8 (see 808C3C) in Dec 15 2019 Beta - eqmule
...
// CItemDisplayWindow_size: 0x620 (see 76BD62) in Dec 15 2019 Beta - eqmule
...
// CLootWnd_size: 0x390 (see 551396) in Dec 15 2019 Beta - eqmule
...
// CMapViewWnd_size: 0x638 (see 550ACA) in Dec 15 2019 Beta - eqmule
...
// CMerchantWnd_size: 0x440 (see 5514F2) in Dec 15 2019 Beta - eqmule
...
// CPetInfoWindow_size: 0x8c0 (see 550521) in Dec 15 2019 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a0 (see 550812) in Dec 15 2019 Beta - eqmule
...
// CTradeWnd__size: 0x2e8 (see 551598) in Dec 15 2019 Beta - eqmule
...
// CFactionWnd__size: 0x270 (see 5516E4) in Dec 15 2019 Beta - eqmule
