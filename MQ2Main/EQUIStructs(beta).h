...
private: \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ RECT		ClipRectClient; \
/*0x002C*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x002D*/ bool		bBottomAnchoredToTop; \
/*0x0030*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x0034*/ int		LeftOffset; \
/*0x0038*/ LONG		BlinkStartTimer; \
/*0x003C*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x003D*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x003E*/ bool		dShow; \
/*0x003F*/ bool		bActive; \
/*0x0040*/ bool		bUseInLayoutVertical; \
/*0x0044*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x0048*/ RECT		IconRect; \
/*0x0058*/ int		VScrollMax; \
/*0x005C*/ bool		bKeepOnScreen; \
/*0x0060*/ int		BottomOffset; \
/*0x0064*/ bool		bIsParentOrContextMenuWindow; \
/*0x0068*/ void	*IconTextureAnim; \
/*0x006C*/ DWORD  BackgroundDrawType; \
/*0x0070*/ UINT		BlinkFadeStartTime; \
/*0x0074*/ bool		bBringToTopWhenClicked; \
/*0x0078*/ void*	pTextObject; \
/*0x007C*/ bool		bClipToParent; \
/*0x0080*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0084*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x0088*/ RECT		TransitionRect; \
/*0x0098*/ COLORREF DisabledBackground; \
/*0x009C*/ void		*pLayoutStrategy; \
/*0x00A0*/ DWORD	XMLIndex; \
/*0x00A4*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x00A8*/ bool		bMaximizable; \
/*0x00A9*/ bool		bBorder2; \
/*0x00AC*/ void   *TitlePiece; \
/*0x00B0*/ struct _CSIDLWND* pWndFocusOther; \
/*0x00B4*/ bool		bClientClipRectChanged; \
/*0x00B5*/ bool		Enabled; \
/*0x00B8*/ int		BlinkState; \
/*0x00BC*/ BYTE     bResizableMask; \
/*0x00C0*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x00C4*/ bool		bMaximized; \
/*0x00C8*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x00CC*/ bool		bTiled; \
/*0x00D0*/ UINT		LastBlinkFadeRefreshTime; \
/*0x00D4*/ UINT		BlinkFadeDuration; \
/*0x00D8*/ RECT		ClipRectScreen; \
/*0x00E8*/ DWORD	LastTimeMouseOver; \
/*0x00EC*/ bool		bAction; \
/*0x00F0*/ int		BlinkDuration; \
/*0x00F4*/ int		managerArrayIndex; \
/*0x00F8*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x00F9*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x00FC*/ int		VScrollPos; \
/*0x0100*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0104*/ void *pController; \
/*0x0108*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x0120*/ BYTE		TargetAlpha; \
/*0x0124*/ int		TopOffset; \
/*0x0128*/ UINT		BlinkFadeFreq; \
/*0x012C*/ bool		Faded; \
/*0x012D*/ BYTE		Alpha; \
/*0x012E*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x012F*/ bool		bBorder; \
/*0x0130*/ RECT		Location; \
/*0x0140*/ UINT		TransitionStartTick; \
/*0x0144*/ tagSIZE	MinClientSize; \
/*0x014C*/ bool		bMarkedForDelete; \
/*0x0150*/ int		HScrollMax; \
/*0x0154*/ bool		bIsTransitioning; \
/*0x0158*/ void	*DrawTemplate; \
/*0x015C*/ void	    *pFont; \
/*0x0160*/ bool		bTopAnchoredToTop; \
/*0x0161*/ bool		bFullyScreenClipped; \
/*0x0162*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x0164*/ int	Transition; \
/*0x0168*/ bool		Minimized; \
/*0x016C*/ tagSIZE	MaxClientSize; \
/*0x0174*/ bool		bRightAnchoredToLeft; \
/*0x0178*/ UINT		FadeDuration; \
/*0x017C*/ bool		bUseInLayoutHorizontal; \
/*0x0180*/ int		ParentAndContextMenuArrayIndex; \
/*0x0184*/ BYTE		FadeAlpha; \
/*0x0185*/ bool		bScreenClipRectChanged; \
/*0x0186*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0188*/ __int64		Data; \
/*0x0190*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x0194*/ void   *TitlePiece2; \
/*0x0198*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
/*0x019C*/ bool		bEscapableLocked; \
/*0x01A0*/ RECT		OldLocation; \
/*0x01B0*/ BYTE		StartAlpha; \
/*0x01B1*/ bool		bHCenterTooltip; \
/*0x01B4*/ struct _CXSTR*	DataStr; \
/*0x01B8*/ int		RightOffset; \
/*0x01BC*/ bool		bLeftAnchoredToLeft; \
/*0x01C0*/ DWORD	FadeDelay; \
/*0x01C4*/ int		HScrollPos; \
/*0x01C8*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x01C9*/ bool		Fades; \
/*0x01CA*/ bool		bCaptureTitle; \
/*0x01CC*/ int		DeleteCount; \
/*0x01D0*/ void* pTipTextObject; \
/*0x01D4*/ UINT		TransitionDuration; \
/*0x01D8*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x01DC*/ RECT		ClientRect; \
/*0x01EC*/ bool		bClientRectChanged; \
/*0x01ED*/ BYTE Filler0x01ED[0x3]; \
/*0x01F0*/ \
public: \
			bool IsVisible() \
			{ \
...
// CBazaarSearchWnd_size: 0x92d8 (see 54F27E) in Nov 17 2019 Beta - eqmule
...
// CPlayerWindow_size: 0x2f0 (see 54EB6E) in Nov 17 2019 Beta - eqmule
...
// CTargetWindow_size: 0x8d0 (see 54EA05) in Nov 17 2019 Beta - eqmule
...
// CBuffWindow_size: 0x720 (see 54E8A9) in Nov 17 2019 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x328 (see 80600B) in Nov 17 2019 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d8 (see 54EC67) in Nov 17 2019 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d8 (see 80611C) in Nov 17 2019 Beta - eqmule
...
// CItemDisplayWindow_size: 0x630 (see 7692A2) in Nov 17 2019 Beta - eqmule
...
// CLootWnd_size: 0x3a0 (see 54EFD6) in Nov 17 2019 Beta - eqmule
...
// CMapViewWnd_size: 0x658 (see 54E70A) in Nov 17 2019 Beta - eqmule
...
// CMerchantWnd_size: 0x450 (see 54F132) in Nov 17 2019 Beta - eqmule
...
// CPetInfoWindow_size: 0x8d0 (see 54E161) in Nov 17 2019 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3b0 (see 54E452) in Nov 17 2019 Beta - eqmule
...
// CTradeWnd__size: 0x2f8 (see 54F1D8) in Nov 17 2019 Beta - eqmule
...
// CFactionWnd__size: 0x280 (see 54F324) in Nov 17 2019 Beta - eqmule
