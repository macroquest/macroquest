...
/*0x007D*/ bool		bIsTransitioning; \
/*0x0080*/ DWORD  BackgroundDrawType; \
/*0x0084*/ UINT		BlinkFadeDuration; \
/*0x0088*/ bool		bAction; \
/*0x008C*/ RECT		ClipRectScreen; \
/*0x009C*/ bool		bClipToParent; \
...
/*0x00D1*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x00D2*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x00D3*/ bool		bLeftAnchoredToLeft; \
/*0x00D4*/ int	Transition; \
/*0x00D8*/ UINT		FadeDuration; \
/*0x00DC*/ bool		bRightAnchoredToLeft; \
/*0x00DD*/ bool		bEscapableLocked; \
/*0x00DE*/ BYTE		StartAlpha; \
/*0x00E0*/ void	    *pFont; \
/*0x00E4*/ tagSIZE	MaxClientSize; \
/*0x00EC*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x00ED*/ bool		bTopAnchoredToTop; \
...
/*0x00F8*/ bool		bBringToTopWhenClicked; \
...
/*0x011D*/ BYTE		TargetAlpha; \
/*0x011E*/ bool		bBottomAnchoredToTop; \
/*0x0120*/ int		ParentAndContextMenuArrayIndex; \
/*0x0124*/ int		VScrollPos; \
/*0x0128*/ void	*IconTextureAnim; \
/*0x012C*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
...
/*0x0150*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x0154*/ RECT		TransitionRect; \
/*0x0164*/ void* pTipTextObject; \
/*0x0168*/ bool		bMaximized; \
/*0x0169*/ bool		bBorder2; \
/*0x0170*/ __int64		Data; \
...
/*0x0188*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
...
/*0x01C8*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x01CC*/ bool		bCaptureTitle; \
/*0x01CD*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x01CE*/ bool		Minimized; \
/*0x01CF*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x01D0*/ bool		Fades; \
...
// CBazaarSearchWnd_size: 0x92d8 (see 53DE7D) in Nov 25 2018 Beta - eqmule
...
// CPlayerWindow_size: 0x2f0 (see 53D770) in Nov 25 2018 Beta - eqmule
...
// CTargetWindow_size: 0x8d0 (see 53D60B) in Nov 25 2018 Beta - eqmule
...
// CBuffWindow_size: 0x720 (see 53D4AF) in Nov 25 2018 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x328 (see 7ECFFB) in Nov 25 2018 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d8 (see 53D869) in Nov 25 2018 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d8 (see 7ED10C) in Nov 25 2018 Beta - eqmule
...
// CItemDisplayWindow_size: 0x630 (see 74D0E2) in Nov 25 2018 Beta - eqmule
...
// CLootWnd_size: 0x3a0 (see 53DBD5) in Nov 25 2018 Beta - eqmule
...
// CMapViewWnd_size: 0x658 (see 53D310) in Nov 25 2018 Beta - eqmule
...
// CMerchantWnd_size: 0x450 (see 53DD31) in Nov 25 2018 Beta - eqmule
...
// CPetInfoWindow_size: 0x8d0 (see 53CD4A) in Nov 25 2018 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3b0 (see 53D03B) in Nov 25 2018 Beta - eqmule
...
// CTradeWnd__size: 0x2f8 (see 53DDD7) in Nov 25 2018 Beta - eqmule
