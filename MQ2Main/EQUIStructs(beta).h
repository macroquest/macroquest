...
/*0x0028*/ bool		bIsParentOrContextMenuWindow; \
...
/*0x003D*/ bool		bBringToTopWhenClicked; \
/*0x0040*/ RECT		ClipRectClient; \
/*0x0050*/ int		HScrollPos; \
/*0x0054*/ RECT		OldLocation; \
/*0x0064*/ bool		bFullyScreenClipped; \
/*0x0068*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x1c */ \
/*0x0084*/ UINT		BlinkFadeStartTime; \
/*0x0088*/ struct _CXSTR*	DataStr; \
/*0x008C*/ bool		Enabled; \
/*0x0090*/ DWORD	FadeDelay; \
/*0x0094*/ bool		bIsTransitioning; \
/*0x0098*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x009C*/ void* pTipTextObject; \
/*0x00A0*/ int		RightOffset; \
/*0x00A4*/ BYTE		Alpha; \
/*0x00A5*/ bool		bClientClipRectChanged; \
/*0x00A8*/ COLORREF DisabledBackground; \
/*0x00AC*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x00AD*/ BYTE     bResizableMask; \
/*0x00AE*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x00AF*/ bool		bMarkedForDelete; \
/*0x00B0*/ __int64		Data; \
/*0x00B8*/ bool		bActive; \
...
/*0x013C*/ DWORD  BackgroundDrawType; \
...
/*0x016C*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x016D*/ BYTE		StartAlpha; \
...
/*0x01E0*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
...
// Actual Size: 0x428 (see 4CD18E) in Nov  1 2017 Beta - eqmule
...
/*0x0260*/ BYTE Unknown0x0260[0x1c8];
/*0x0428*/
