...
// actual size 0x1E8 in Nov 24 2018 Beta (see 0x92B9FD) - eqmule
...
/*0x0051*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x0052*/ bool		bTopAnchoredToTop; \
/*0x0053*/ bool		bTiled; \
...
/*0x005C*/ RECT		OldLocation; \
/*0x006C*/ bool		bMaximizable; \
/*0x0070*/ int		BlinkDuration; \
/*0x0074*/ DWORD	XMLIndex; \
/*0x0078*/ BYTE		TargetAlpha; \
/*0x0079*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x007C*/ struct _CSIDLWND* pWndFocusOther; \
/*0x0080*/ bool		bIsTransitioning; \
/*0x0081*/ bool		bEscapableLocked; \
...
/*0x009B*/ bool		bRightAnchoredToLeft; \
/*0x009C*/ bool		bMaximized; \
/*0x009D*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x009E*/ bool		Faded; \
/*0x00A0*/ RECT		ClientRect; \
/*0x00B0*/ UINT		BlinkFadeStartTime; \
/*0x00B4*/ bool		bClipToParent; \
/*0x00B8*/ RECT		ClipRectScreen; \
/*0x00C8*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x00CC*/ void		*pLayoutStrategy; \
/*0x00D0*/ RECT		ClipRectClient; \
/*0x00E0*/ DWORD  BackgroundDrawType; \
/*0x00E4*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x00E8*/ tagSIZE	MaxClientSize; \
/*0x00F0*/ bool		bBorder; \
/*0x00F1*/ bool		bClientRectChanged; \
/*0x00F4*/ int		VScrollPos; \
/*0x00F8*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x00FC*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x00FD*/ bool		bBorder2; \
/*0x0100*/ int		ParentAndContextMenuArrayIndex; \
...
/*0x010D*/ bool		bScreenClipRectChanged; \
/*0x0110*/ tagSIZE	MinClientSize; \
/*0x0118*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0119*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x011C*/ RECT		Location; \
/*0x012C*/ bool		bAction; \
/*0x0130*/ void	*DrawTemplate; \
/*0x0134*/ bool		bKeepOnScreen; \
/*0x0135*/ bool		Enabled; \
/*0x0138*/ int		DeleteCount; \
/*0x013C*/ bool		bUseInLayoutVertical; \
/*0x013D*/ bool		bBottomAnchoredToTop; \
/*0x013E*/ BYTE     bResizableMask; \
/*0x013F*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x0140*/ UINT		TransitionStartTick; \
/*0x0144*/ int		BlinkState; \
/*0x0148*/ bool		bIsParentOrContextMenuWindow; \
/*0x014C*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x0150*/ void* pTipTextObject; \
/*0x0154*/ void   *TitlePiece; \
/*0x0158*/ UINT		FadeDuration; \
/*0x015C*/ int		HScrollPos; \
/*0x0160*/ int		LeftOffset; \
/*0x0164*/ void	    *pFont; \
/*0x0168*/ bool		Fades; \
/*0x016C*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x1c */ \
/*0x0188*/ DWORD	LastTimeMouseOver; \
/*0x018C*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0190*/ RECT		TransitionRect; \
...
// CBazaarSearchWnd_size: 0x92d0 (see 53DAFD) in Nov 24 2018 Beta - eqmule
...
// CPlayerWindow_size: 0x2e8 (see 53D3F0) in Nov 24 2018 Beta - eqmule
...
// CTargetWindow_size: 0x8c8 (see 53D28B) in Nov 24 2018 Beta - eqmule
...
// CBuffWindow_size: 0x718 (see 53D12F) in Nov 24 2018 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x320 (see 7EDC2B) in Nov 24 2018 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d0 (see 53D4E9) in Nov 24 2018 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d0 (see 7EDD3C) in Nov 24 2018 Beta - eqmule
...
// CItemDisplayWindow_size: 0x628 (see 74DCD2) in Nov 24 2018 Beta - eqmule
...
// CLootWnd_size: 0x398 (see 53D855) in Nov 24 2018 Beta - eqmule
...
// CMapViewWnd_size: 0x648 (see 53CF90) in Nov 24 2018 Beta - eqmule
...
// CMerchantWnd_size: 0x448 (see 53D9B1) in Nov 24 2018 Beta - eqmule
...
// CPetInfoWindow_size: 0x8c8 (see 53C9CA) in Nov 24 2018 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a8 (see 53CCBB) in Nov 24 2018 Beta - eqmule
...
// CTradeWnd__size: 0x2f0 (see 53DA57) in Nov 24 2018 Beta - eqmule
