...
// actual size 0x1E8 in Nov 11 2018 Beta (see 0x926D1D) - eqmule
// actual size 0x1F8 in Nov 12 2018 Beta (see 0x926EDD) - eqmule
#define CXW_NO_VTABLE \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ int		DeleteCount; \
/*0x0020*/ int		managerArrayIndex; \
/*0x0024*/ int		HScrollMax; \
/*0x0028*/ RECT		OldLocation; \
/*0x0038*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x003C*/ bool		bTopAnchoredToTop; \
/*0x0040*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0044*/ bool		bClientRectChanged; \
/*0x0048*/ UINT		BlinkFadeDuration; \
/*0x004C*/ bool		bBringToTopWhenClicked; \
/*0x0050*/ UINT		FadeDuration; \
/*0x0054*/ bool		Fades; \
/*0x0058*/ tagSIZE	MaxClientSize; \
/*0x0060*/ UINT		BlinkFadeFreq; \
/*0x0064*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x0068*/ bool		bLeftAnchoredToLeft; \
/*0x0069*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x006C*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0070*/ bool		bFullyScreenClipped; \
/*0x0074*/ void *pController; \
/*0x0078*/ bool		bKeepOnScreen; \
/*0x0079*/ bool		bBorder2; \
/*0x007C*/ struct _CSIDLWND* pWndFocusOther; \
/*0x0080*/ int		VScrollMax; \
/*0x0084*/ bool		Enabled; \
/*0x0085*/ bool		bScreenClipRectChanged; \
/*0x0086*/ bool		bCaptureTitle; \
/*0x0087*/ bool		bRightAnchoredToLeft; \
/*0x0088*/ int		TopOffset; \
/*0x008C*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0090*/ DWORD	LastTimeMouseOver; \
/*0x0094*/ int		RightOffset; \
/*0x0098*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x1c */ \
/*0x00B4*/ BYTE		TargetAlpha; \
/*0x00B8*/ int		BlinkDuration; \
...
/*0x00C8*/ bool		bBorder; \
/*0x00C9*/ bool		bClientClipRectChanged; \
/*0x00CA*/ bool		bTiled; \
/*0x00CB*/ bool		bMaximizable; \
/*0x00CC*/ BYTE     bResizableMask; \
/*0x00D0*/ void   *TitlePiece2; \
/*0x00D4*/ DWORD	XMLIndex; \
/*0x00D8*/ BYTE		Alpha; \
/*0x00D9*/ bool		bIsTransitioning; \
/*0x00DA*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x00DC*/ int		ParentAndContextMenuArrayIndex; \
/*0x00E0*/ int	Transition; \
/*0x00E4*/ RECT		ClipRectScreen; \
/*0x00F4*/ bool		dShow; \
/*0x00F8*/ struct _CXSTR*	DataStr; \
/*0x00FC*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0100*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x0104*/ UINT		LastBlinkFadeRefreshTime; \
/*0x0108*/ bool		bActive; \
/*0x010C*/ RECT		ClientRect; \
/*0x011C*/ bool		bEscapableLocked; \
/*0x0120*/ UINT		TransitionDuration; \
/*0x0124*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x0128*/ bool		bAction; \
/*0x0129*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x012A*/ bool		bClipToParent; \
/*0x012B*/ bool		bBottomAnchoredToTop; \
/*0x012C*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
/*0x0130*/ RECT		ClipRectClient; \
/*0x0140*/ bool		bUseInLayoutHorizontal; \
/*0x0144*/ void	*DrawTemplate; \
/*0x0148*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x0149*/ bool		Minimized; \
/*0x014A*/ bool		bHCenterTooltip; \
/*0x014C*/ void* pTipTextObject; \
/*0x0150*/ DWORD	FadeDelay; \
/*0x0154*/ BYTE		StartAlpha; \
/*0x0158*/ int		HScrollPos; \
/*0x015C*/ void   *TitlePiece; \
/*0x0160*/ bool		bMarkedForDelete; \
/*0x0164*/ UINT		TransitionStartTick; \
/*0x0168*/ int		VScrollPos; \
/*0x016C*/ bool		Faded; \
/*0x0170*/ void	*IconTextureAnim; \
/*0x0174*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x0178*/ void		*pLayoutStrategy; \
/*0x017C*/ bool		bUseInLayoutVertical; \
/*0x017D*/ bool		bMaximized; \
/*0x017E*/ BYTE		FadeAlpha; \
/*0x0180*/ DWORD  BackgroundDrawType; \
/*0x0184*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x0188*/ void*	pTextObject; \
/*0x018C*/ int		BlinkState; \
...
/*0x0194*/ int		BottomOffset; \
/*0x0198*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x019C*/ RECT		Location; \
/*0x01AC*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x01B0*/ int		LeftOffset; \
/*0x01B4*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x01B8*/ tagSIZE	MinClientSize; \
/*0x01C0*/ bool		bIsParentOrContextMenuWindow; \
/*0x01C4*/ void	    *pFont; \
/*0x01C8*/ __int64		Data; \
/*0x01D0*/ RECT		TransitionRect; \
/*0x01E0*/ COLORREF DisabledBackground; \
/*0x01E4*/ RECT		IconRect; \
...
// CBazaarSearchWnd_size: 0x92e0 (see 5392BD) in Nov 12 2018 Beta - eqmule
...
// CPlayerWindow_size: 0x2f8 (see 538BB0) in Nov 12 2018 Beta - eqmule
...
// CTargetWindow_size: 0x8d8 (see 538A4B) in Nov 12 2018 Beta - eqmule
...
// CBuffWindow_size: 0x728 (see 5388EF) in Nov 12 2018 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x330 (see 7E8E4B) in Nov 12 2018 Beta - eqmule
...
// CCastSpellWnd_size: 0x2e0 (see 538CA9) in Nov 12 2018 Beta - eqmule
...
// CInvSlotWnd_size: 0x2e0 (see 7E8F4C) in Nov 12 2018 Beta - eqmule
...
// CItemDisplayWindow_size: 0x638 (see 748F82) in Nov 12 2018 Beta - eqmule
...
// CLootWnd_size: 0x3a8 (see 539015) in Nov 12 2018 Beta - eqmule
...
// CMapViewWnd_size: 0x668 (see 538750) in Nov 12 2018 Beta - eqmule
...
// CMerchantWnd_size: 0x458 (see 539171) in Nov 12 2018 Beta - eqmule
...
// CPetInfoWindow_size: 0x8d8 (see 53818A) in Nov 12 2018 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3b8 (see 53847B) in Nov 12 2018 Beta - eqmule
...
// CTradeWnd__size: 0x300 (see 539217) in Nov 12 2018 Beta - eqmule
