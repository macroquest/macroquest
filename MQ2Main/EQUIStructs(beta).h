...
// actual size 0x1E0 in Oct 22 2020 Beta (see 0x93C4FD) - eqmule
...
/*0x0025*/ bool bClickThroughMenuItemStatus; /* on/off */ \
...
/*0x0054*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x0058*/ UINT		FadeDuration; \
/*0x005C*/ BYTE		FadeAlpha; \
/*0x005D*/ BYTE		TargetAlpha; \
/*0x005E*/ bool		bBorder2; \
/*0x005F*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
...
/*0x007E*/ bool		bBottomAnchoredToTop; \
...
/*0x00F5*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x00F6*/ BYTE		StartAlpha; \
/*0x00F8*/ struct _CSIDLWND* pWndFocusOther; \
...
/*0x011D*/ bool		bTiled; \
/*0x011E*/ bool		bFullyScreenClipped; \
/*0x0120*/ RECT		Location; \
/*0x0130*/ bool		bKeepOnScreen; \
...
/*0x0159*/ bool		bTopAnchoredToTop; \
/*0x015A*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x015B*/ bool		bLeftAnchoredToLeft; \
...
// CBazaarSearchWnd_size: 0x92c8 (see 558CEE) in Oct 22 2020 Beta - eqmule
...
// CPlayerWindow_size: 0x2e0 (see 5585DE) in Oct 22 2020 Beta - eqmule
...
// CTargetWindow_size: 0x8c0 (see 558475) in Oct 22 2020 Beta - eqmule
...
// CBuffWindow_size: 0x710 (see 558319) in Oct 22 2020 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x318 (see 7F97DB) in Oct 22 2020 Beta - eqmule
...
// CCastSpellWnd_size: 0x2c8 (see 5586D7) in Oct 22 2020 Beta - eqmule
...
// CInvSlotWnd_size: 0x2c8 (see 7F98EC) in Oct 22 2020 Beta - eqmule
...
// CItemDisplayWindow_size: 0x620 (see 75C762) in Oct 22 2020 Beta - eqmule
...
// CLootWnd_size: 0x390 (see 558A46) in Oct 22 2020 Beta - eqmule
...
// CMapViewWnd_size: 0x638 (see 55817A) in Oct 22 2020 Beta - eqmule
...
// CMerchantWnd_size: 0x440 (see 558BA2) in Oct 22 2020 Beta - eqmule
...
// CPetInfoWindow_size: 0x8c0 (see 557BD1) in Oct 22 2020 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x398 (see 557EC2) in Oct 22 2020 Beta - eqmule
...
// CTradeWnd__size: 0x2e8 (see 558C48) in Oct 22 2020 Beta - eqmule
...
// CFactionWnd__size: 0x270 (see 558D94) in Oct 22 2020 Beta - eqmule
