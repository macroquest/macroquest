...
// actual size 0x1F0 in Sep  9 2019 Test (see 0x94001D) - eqmule
// actual size 0x1E8 in Oct 20 2019 Beta (see 0x943AFD) - eqmule
// actual size 0x1E0 in Oct 21 2019 Beta (see 0x945A7D) - eqmule
// actual size 0x1F8 in Oct 23 2019 Beta (see 0x94562D) - eqmule
#define CXW_NO_VTABLE \
private: \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ RECT		TransitionRect; \
/*0x002C*/ bool		bBottomAnchoredToTop; \
/*0x0030*/ UINT		BlinkFadeFreq; \
/*0x0034*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x0038*/ int		HScrollMax; \
/*0x003C*/ bool		dShow; \
/*0x003D*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x0040*/ void* pTipTextObject; \
/*0x0044*/ bool		bAction; \
/*0x0045*/ bool		Fades; \
/*0x0046*/ bool		bClientRectChanged; \
/*0x0048*/ tagSIZE	MaxClientSize; \
/*0x0050*/ RECT		IconRect; \
/*0x0060*/ void	*IconTextureAnim; \
/*0x0064*/ bool		bIsParentOrContextMenuWindow; \
/*0x0065*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0068*/ int		BlinkState; \
/*0x006C*/ UINT		FadeDuration; \
/*0x0070*/ int		DeleteCount; \
/*0x0074*/ bool		bHCenterTooltip; \
/*0x0075*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x0076*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x0078*/ void		*pLayoutStrategy; \
/*0x007C*/ COLORREF DisabledBackground; \
/*0x0080*/ bool		bBorder; \
/*0x0084*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x0088*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x008C*/ bool		bClientClipRectChanged; \
/*0x0090*/ int		RightOffset; \
/*0x0094*/ tagSIZE	MinClientSize; \
/*0x009C*/ void   *TitlePiece2; \
/*0x00A0*/ __int64		Data; \
/*0x00A8*/ bool		bFullyScreenClipped; \
/*0x00A9*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x00AC*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x00C4*/ bool		Enabled; \
/*0x00C8*/ DWORD	XMLIndex; \
/*0x00CC*/ bool		bKeepOnScreen; \
/*0x00D0*/ int		LeftOffset; \
/*0x00D4*/ struct _CXSTR*	DataStr; \
/*0x00D8*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x00DC*/ bool		bMaximizable; \
/*0x00E0*/ int		BlinkDuration; \
/*0x00E4*/ bool		bActive; \
/*0x00E5*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x00E6*/ bool		Faded; \
/*0x00E8*/ int		BottomOffset; \
/*0x00EC*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x00F0*/ bool		bUseInLayoutVertical; \
/*0x00F4*/ void *pController; \
/*0x00F8*/ bool		bCaptureTitle; \
/*0x00FC*/ void*	pTextObject; \
/*0x0100*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x0104*/ UINT		TransitionDuration; \
/*0x0108*/ int	Transition; \
/*0x010C*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0110*/ bool		bTopAnchoredToTop; \
/*0x0114*/ DWORD	FadeDelay; \
/*0x0118*/ int		managerArrayIndex; \
/*0x011C*/ RECT		Location; \
/*0x012C*/ bool		bScreenClipRectChanged; \
/*0x0130*/ int		TopOffset; \
/*0x0134*/ BYTE		Alpha; \
/*0x0138*/ DWORD	LastTimeMouseOver; \
/*0x013C*/ RECT		ClientRect; \
/*0x014C*/ bool		bTiled; \
/*0x0150*/ int		ParentAndContextMenuArrayIndex; \
/*0x0154*/ bool		bClipToParent; \
/*0x0155*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0158*/ RECT		ClipRectClient; \
/*0x0168*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
/*0x016C*/ RECT		OldLocation; \
/*0x017C*/ void	    *pFont; \
/*0x0180*/ void	*DrawTemplate; \
/*0x0184*/ bool		Minimized; \
/*0x0188*/ DWORD  BackgroundDrawType; \
/*0x018C*/ int		HScrollPos; \
/*0x0190*/ BYTE     bResizableMask; \
/*0x0194*/ UINT		TransitionStartTick; \
/*0x0198*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0199*/ bool		bBringToTopWhenClicked; \
/*0x019C*/ LONG		BlinkStartTimer; \
/*0x01A0*/ bool		bIsTransitioning; \
/*0x01A4*/ UINT		BlinkFadeDuration; \
/*0x01A8*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x01A9*/ bool		bMaximized; \
/*0x01AC*/ int		VScrollPos; \
/*0x01B0*/ BYTE		FadeAlpha; \
/*0x01B4*/ UINT		LastBlinkFadeRefreshTime; \
/*0x01B8*/ bool		bEscapableLocked; \
/*0x01BC*/ void   *TitlePiece; \
/*0x01C0*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x01C4*/ bool		bRightAnchoredToLeft; \
/*0x01C8*/ RECT		ClipRectScreen; \
/*0x01D8*/ int		VScrollMax; \
/*0x01DC*/ struct _CSIDLWND* pWndFocusOther; \
/*0x01E0*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x01E4*/ bool		bBorder2; \
/*0x01E5*/ bool		bMarkedForDelete; \
/*0x01E6*/ BYTE		TargetAlpha; \
/*0x01E7*/ bool		bUseInLayoutHorizontal; \
/*0x01E8*/ BYTE		StartAlpha; \
/*0x01E9*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x01EC*/ UINT		BlinkFadeStartTime; \
/*0x01F0*/ bool		bLeftAnchoredToLeft; \
...
// CBazaarSearchWnd_size: 0x92e0 (see 54A2BE) in Oct 23 2019 Beta - eqmule
...
// CPlayerWindow_size: 0x2f8 (see 549BAE) in Oct 23 2019 Beta - eqmule
...
// CTargetWindow_size: 0x8d8 (see 549A45) in Oct 23 2019 Beta - eqmule
...
// CBuffWindow_size: 0x728 (see 5498E9) in Oct 23 2019 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x330 (see 7FCEFB) in Oct 23 2019 Beta - eqmule
...
// CCastSpellWnd_size: 0x2e0 (see 549CA7) in Oct 23 2019 Beta - eqmule
...
// CInvSlotWnd_size: 0x2e0 (see 7FD00C) in Oct 23 2019 Beta - eqmule
...
// CItemDisplayWindow_size: 0x638 (see 760162) in Oct 23 2019 Beta - eqmule
...
// CLootWnd_size: 0x3a8 (see 54A016) in Oct 23 2019 Beta - eqmule
...
// CMapViewWnd_size: 0x668 (see 54974A) in Oct 23 2019 Beta - eqmule
...
// CMerchantWnd_size: 0x458 (see 54A172) in Oct 23 2019 Beta - eqmule
...
// CPetInfoWindow_size: 0x8d8 (see 5491A1) in Oct 23 2019 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3b8 (see 549492) in Oct 23 2019 Beta - eqmule
...
// CTradeWnd__size: 0x300 (see 54A218) in Oct 23 2019 Beta - eqmule
...
// CFactionWnd__size: 0x288 (see 54A364) in Oct 23 2019 Beta - eqmule
