...
// actual size 0x1E0 in Dec 11 2017 Beta (see 0x8D400D) - eqmule
#define CXW_NO_VTABLE \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ bool		bAction; \
/*0x0020*/ DWORD	XMLIndex; \
/*0x0024*/ bool		bScreenClipRectChanged; \
/*0x0028*/ UINT		TransitionStartTick; \
/*0x002C*/ bool		bHCenterTooltip; \
/*0x0030*/ UINT		FadeDuration; \
/*0x0034*/ BYTE		FadeAlpha; \
/*0x0038*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x003C*/ RECT		Location; \
/*0x004C*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x004D*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
...
/*0x006C*/ COLORREF DisabledBackground; \
...
/*0x0072*/ bool		bBringToTopWhenClicked; \
...
/*0x007D*/ bool		bActive; \
/*0x007E*/ bool		bLeftAnchoredToLeft; \
/*0x0080*/ UINT		LastBlinkFadeRefreshTime; \
/*0x0084*/ int		BlinkState; \
/*0x0088*/ BYTE		TargetAlpha; \
/*0x008C*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x0090*/ DWORD	LastTimeMouseOver; \
/*0x0094*/ int		VScrollPos; \
/*0x0098*/ bool		bMaximized; \
/*0x0099*/ bool		bKeepOnScreen; \
/*0x009A*/ bool		Minimized; \
...
/*0x0108*/ bool		bRightAnchoredToLeft; \
/*0x0109*/ BYTE		StartAlpha; \
/*0x010A*/ bool		bIsParentOrContextMenuWindow; \
/*0x010B*/ BYTE		Alpha; \
/*0x010C*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x1c */ \
/*0x0128*/ int		BottomOffset; \
/*0x012C*/ bool		dShow; \
/*0x0130*/ void	*DrawTemplate; \
/*0x0134*/ int		LeftOffset; \
/*0x0138*/ RECT		TransitionRect; \
/*0x0148*/ void   *TitlePiece2; \
/*0x014C*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x014D*/ bool		bUseInLayoutHorizontal; \
/*0x014E*/ bool		bClientRectChanged; \
/*0x0150*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
...
/*0x0170*/ bool		bClipToParent; \
/*0x0171*/ bool		Enabled; \
/*0x0174*/ int		DeleteCount; \
/*0x0178*/ int		managerArrayIndex; \
/*0x0180*/ __int64		Data; \
/*0x0188*/ int	Transition; \
/*0x018C*/ int		TopOffset; \
/*0x0190*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x0191*/ bool		bEscapableLocked; \
/*0x0192*/ bool		Fades; \
/*0x0194*/ struct _CXSTR*	DataStr; \
/*0x0198*/ tagSIZE	MaxClientSize; \
/*0x01A0*/ DWORD  BackgroundDrawType; \
/*0x01A4*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x01A8*/ bool		bCaptureTitle; \
/*0x01A9*/ bool		bUseInLayoutVertical; \
/*0x01AC*/ UINT		BlinkFadeDuration; \
/*0x01B0*/ void *pController; \
/*0x01B4*/ void	    *pFont; \
/*0x01B8*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x01B9*/ bool		bMaximizable; \
/*0x01BC*/ UINT		TransitionDuration; \
/*0x01C0*/ void		*pLayoutStrategy; \
/*0x01C4*/ void   *TitlePiece; \
/*0x01C8*/ bool		bClientClipRectChanged; \
/*0x01C9*/ bool		bTopAnchoredToTop; \
/*0x01CA*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x01CB*/ bool		bIsTransitioning; \
/*0x01CC*/ RECT		IconRect; \
/*0x01DC*/ bool		bMarkedForDelete; \
/*0x01DD*/ BYTE Filler0x01DD[0x3];
/*0x01E0*/
...
// CBazaarSearchWnd_size: 0x92c8 (see 4CCEAA) in Dec 11 2017 Beta - eqmule
...
// CPlayerWindow_size: 0x2e0 (see 4CC6ED) in Dec 11 2017 Beta - eqmule
...
// CTargetWindow_size: 0x8c0 (see 4CC584) in Dec 11 2017 Beta - eqmule
...
// CBuffWindow_size: 0x710 (see 4CC418) in Dec 11 2017 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x310 (see 7A30F8) in Dec 11 2017 Beta - eqmule
...
// CCastSpellWnd_size: 0x2c8 (see 4CC7FE) in Dec 11 2017 Beta - eqmule
...
// CInvSlotWnd_size: 0x2c8 (see 7A3209) in Dec 11 2017 Beta - eqmule
...
// CItemDisplayWindow_size: 0x608 (see 6ED74F) in Dec 11 2017 Beta - eqmule
...
// CLootWnd_size: 0x390 (see 4CCBC0) in Dec 11 2017 Beta - eqmule
...
// CMapViewWnd_size: 0x638 (see 4CC279) in Dec 11 2017 Beta - eqmule
...
// CMerchantWnd_size: 0x440 (see 4CCD3E) in Dec 11 2017 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a0 (see 4CBFA3) in Dec 11 2017 Beta - eqmule
...
// CTradeWnd__size: 0x2e8 (see 4CCDF4) in Dec 11 2017 Beta - eqmule
