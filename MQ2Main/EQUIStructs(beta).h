...
// actual size 0x1E0 in Nov  6 2017 Beta (see 0x8D4F3D) - eqmule
// actual size 0x1E8 in Nov  8 2017 Beta (see 0x8D52FD) - eqmule
// actual size 0x1F0 in Nov  9 2017 Beta (see 0x8D477D) - eqmule
#define CXW_NO_VTABLE \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ bool		bFullyScreenClipped; \
/*0x0020*/ int		DeleteCount; \
/*0x0024*/ void *pController; \
/*0x0028*/ BYTE     bResizableMask; \
/*0x0029*/ bool		bBottomAnchoredToTop; \
/*0x002A*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x002C*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x0030*/ RECT		ClientRect; \
/*0x0040*/ UINT		LastBlinkFadeRefreshTime; \
/*0x0044*/ void	    *pFont; \
/*0x0048*/ UINT		TransitionStartTick; \
/*0x004C*/ struct _CSIDLWND* pWndFocusOther; \
/*0x0050*/ bool		bMaximizable; \
/*0x0054*/ void   *TitlePiece; \
/*0x0058*/ tagSIZE	MinClientSize; \
/*0x0060*/ bool		bScreenClipRectChanged; \
/*0x0061*/ bool		dShow; \
/*0x0064*/ int		BottomOffset; \
/*0x0068*/ bool		bIsTransitioning; \
/*0x0069*/ BYTE		FadeAlpha; \
/*0x006C*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0070*/ void	*DrawTemplate; \
/*0x0074*/ bool		bTiled; \
/*0x0078*/ int		VScrollMax; \
/*0x007C*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0080*/ bool		Fades; \
/*0x0084*/ RECT		IconRect; \
/*0x0094*/ void*	pTextObject; \
/*0x0098*/ bool		bEscapableLocked; \
/*0x0099*/ bool		bClipToParent; \
/*0x009A*/ bool		bTopAnchoredToTop; \
/*0x009C*/ int		managerArrayIndex; \
/*0x00A0*/ RECT		TransitionRect; \
/*0x00B0*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x00B1*/ bool		bClientRectChanged; \
/*0x00B2*/ bool		bMaximized; \
/*0x00B4*/ COLORREF DisabledBackground; \
/*0x00B8*/ bool		bUseInLayoutHorizontal; \
/*0x00B9*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x00BC*/ DWORD	LastTimeMouseOver; \
/*0x00C0*/ bool		bActive; \
/*0x00C4*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x1c */ \
/*0x00E0*/ bool		Faded; \
/*0x00E4*/ UINT		TransitionDuration; \
/*0x00E8*/ UINT		BlinkFadeFreq; \
/*0x00EC*/ BYTE		TargetAlpha; \
/*0x00ED*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x00EE*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x00EF*/ bool		bBringToTopWhenClicked; \
/*0x00F0*/ UINT		BlinkFadeStartTime; \
/*0x00F4*/ int		TopOffset; \
/*0x00F8*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
/*0x00FC*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x0100*/ RECT		OldLocation; \
/*0x0110*/ int		HScrollMax; \
/*0x0114*/ bool		bIsParentOrContextMenuWindow; \
/*0x0115*/ bool		Minimized; \
/*0x0118*/ RECT		ClipRectClient; \
...
/*0x0134*/ bool		bCaptureTitle; \
/*0x0138*/ tagSIZE	MaxClientSize; \
/*0x0140*/ int		RightOffset; \
/*0x0144*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0145*/ BYTE		Alpha; \
/*0x0148*/ void   *TitlePiece2; \
/*0x014C*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x014D*/ BYTE		StartAlpha; \
/*0x014E*/ bool		Enabled; \
/*0x0150*/ int		BlinkDuration; \
/*0x0154*/ bool		bHCenterTooltip; \
/*0x0158*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x015C*/ void* pTipTextObject; \
/*0x0160*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x0161*/ bool		bLeftAnchoredToLeft; \
/*0x0164*/ void		*pLayoutStrategy; \
/*0x0168*/ bool		bUseInLayoutVertical; \
/*0x016C*/ RECT		ClipRectScreen; \
/*0x0180*/ __int64		Data; \
/*0x0188*/ bool		bRightAnchoredToLeft; \
/*0x018C*/ RECT		Location; \
/*0x019C*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x01A0*/ DWORD	XMLIndex; \
/*0x01A4*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x01A8*/ int		LeftOffset; \
/*0x01AC*/ LONG		BlinkStartTimer; \
/*0x01B0*/ bool		bClientClipRectChanged; \
/*0x01B4*/ struct _CXSTR*	DataStr; \
/*0x01B8*/ UINT		BlinkFadeDuration; \
/*0x01BC*/ int	Transition; \
/*0x01C0*/ DWORD  BackgroundDrawType; \
/*0x01C4*/ bool		bMarkedForDelete; \
/*0x01C8*/ UINT		FadeDuration; \
/*0x01CC*/ bool		bAction; \
...
/*0x01DC*/ int		BlinkState; \
/*0x01E0*/ bool		bKeepOnScreen; \
/*0x01E4*/ int		ParentAndContextMenuArrayIndex; \
/*0x01E8*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x01EC*/ DWORD	FadeDelay; \
/*0x01F0*/
...
// CBazaarSearchWnd_size: 0x92d8 (see 4CCB6A) in Nov  9 2017 Beta - eqmule
...
// CPlayerWindow_size: 0x2f0 (see 4CC3AD) in Nov  9 2017 Beta - eqmule
...
// CTargetWindow_size: 0x8d0 (see 4CC244) in Nov  9 2017 Beta - eqmule
...
// CBuffWindow_size: 0x720 (see 4CC0D8) in Nov  9 2017 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x320 (see 7A34B8) in Nov  9 2017 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d8 (see 4CC4BE) in Nov  9 2017 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d8 (see 7A35C9) in Nov  9 2017 Beta - eqmule
...
// CItemDisplayWindow_size: 0x618 (see 6ED2CF) in Nov  9 2017 Beta - eqmule
...
// CLootWnd_size: 0x3a0 (see 4CC880) in Nov  9 2017 Beta - eqmule
...
// CMapViewWnd_size: 0x658 (see 4CBF39) in Nov  9 2017 Beta - eqmule
...
// CMerchantWnd_size: 0x440 (see 4CC9FE) in Nov  9 2017 Beta - eqmule
...
// CPetInfoWindow_size: 0x8d0 (see 4CB970) in Nov  9 2017 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3b0 (see 4CBC63) in Nov  9 2017 Beta - eqmule
...
// CTradeWnd__size: 0x2f8 (see 4CCAB4) in Nov  9 2017 Beta - eqmule
