...
/*0x0024*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0028*/ bool		Fades; \
/*0x002C*/ int		ParentAndContextMenuArrayIndex; \
/*0x0030*/ bool		bBringToTopWhenClicked; \
/*0x0034*/ tagSIZE	MaxClientSize; \
/*0x003C*/ BYTE		StartAlpha; \
/*0x003D*/ bool		bMaximizable; \
/*0x003E*/ bool		bUseInLayoutHorizontal; \
/*0x003F*/ bool		bKeepOnScreen; \
/*0x0040*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x0044*/ struct _CSIDLWND* pWndFocusOther; \
/*0x0048*/ int		BottomOffset; \
/*0x004C*/ bool		Faded; \
/*0x0050*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
/*0x0054*/ DWORD	FadeDelay; \
/*0x0058*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x005C*/ int		BlinkState; \
/*0x0060*/ void	*IconTextureAnim; \
/*0x0064*/ UINT		TransitionDuration; \
/*0x0068*/ DWORD	XMLIndex; \
/*0x006C*/ bool		bBorder; \
/*0x0070*/ void	*DrawTemplate; \
/*0x0074*/ bool		bMaximized; \
/*0x0075*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x0076*/ bool		bTopAnchoredToTop; \
/*0x0078*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x007C*/ RECT		Location; \
/*0x008C*/ int		HScrollPos; \
/*0x0090*/ int		VScrollPos; \
/*0x0094*/ int		managerArrayIndex; \
/*0x0098*/ bool		bActive; \
/*0x0099*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x009A*/ bool		bAction; \
/*0x009C*/ DWORD	LastTimeMouseOver; \
...
/*0x00C0*/ bool		bBorder2; \
/*0x00C1*/ bool		bIsTransitioning; \
/*0x00C2*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x00C4*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x00C8*/ bool		bClientClipRectChanged; \
/*0x00CC*/ int	Transition; \
/*0x00D0*/ int		TopOffset; \
/*0x00D4*/ tagSIZE	MinClientSize; \
/*0x00DC*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x00E0*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x00E4*/ bool		Minimized; \
/*0x00E5*/ bool		bMarkedForDelete; \
/*0x00E8*/ void* pTipTextObject; \
/*0x00EC*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x00ED*/ bool		bClipToParent; \
/*0x00EE*/ bool		bRightAnchoredToLeft; \
/*0x00F0*/ void *pController; \
/*0x00F4*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x00F8*/ RECT		IconRect; \
/*0x0108*/ int		BlinkDuration; \
/*0x010C*/ BYTE     bResizableMask; \
/*0x0110*/ void		*pLayoutStrategy; \
/*0x0114*/ UINT		BlinkFadeDuration; \
/*0x0118*/ bool		bClientRectChanged; \
/*0x0119*/ bool		bEscapableLocked; \
/*0x011A*/ bool		bFullyScreenClipped; \
/*0x011C*/ int		LeftOffset; \
/*0x0120*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0121*/ bool		bCaptureTitle; \
/*0x0124*/ UINT		LastBlinkFadeRefreshTime; \
/*0x0128*/ UINT		BlinkFadeStartTime; \
/*0x012C*/ LONG		BlinkStartTimer; \
/*0x0130*/ UINT		FadeDuration; \
/*0x0134*/ UINT		TransitionStartTick; \
/*0x0138*/ BYTE		TargetAlpha; \
/*0x013C*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0140*/ RECT		ClipRectScreen; \
/*0x0150*/ bool		dShow; \
/*0x0151*/ bool		bHCenterTooltip; \
/*0x0154*/ RECT		TransitionRect; \
/*0x0164*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x0165*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x0168*/ __int64		Data; \
/*0x0170*/ void   *TitlePiece; \
/*0x0174*/ RECT		OldLocation; \
/*0x0184*/ int		RightOffset; \
/*0x0188*/ BYTE		FadeAlpha; \
/*0x0189*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x018A*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x018B*/ BYTE		Alpha; \
/*0x018C*/ void   *TitlePiece2; \
/*0x0190*/ void*	pTextObject; \
/*0x0194*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x01AC*/ bool		bBottomAnchoredToTop; \
/*0x01B0*/ UINT		BlinkFadeFreq; \
/*0x01B4*/ bool		bIsParentOrContextMenuWindow; \
/*0x01B5*/ bool		bUseInLayoutVertical; \
/*0x01B6*/ bool		bTiled; \
/*0x01B8*/ void	    *pFont; \
/*0x01BC*/ struct _CXSTR*	DataStr; \
/*0x01C0*/ bool		bScreenClipRectChanged; \
/*0x01C4*/ int		VScrollMax; \
...
// CBazaarSearchWnd_size: 0x92c8 (see 550AAE) in Dec  9 2019 Beta - eqmule
...
// CPlayerWindow_size: 0x2e0 (see 55039E) in Dec  9 2019 Beta - eqmule
...
// CTargetWindow_size: 0x8c0 (see 550235) in Dec  9 2019 Beta - eqmule
...
// CBuffWindow_size: 0x710 (see 5500D9) in Dec  9 2019 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x318 (see 80808B) in Dec  9 2019 Beta - eqmule
...
// CCastSpellWnd_size: 0x2c8 (see 550497) in Dec  9 2019 Beta - eqmule
...
// CInvSlotWnd_size: 0x2c8 (see 80818C) in Dec  9 2019 Beta - eqmule
...
// CItemDisplayWindow_size: 0x620 (see 76B282) in Dec  9 2019 Beta - eqmule
...
// CLootWnd_size: 0x390 (see 550806) in Dec  9 2019 Beta - eqmule
...
// CMapViewWnd_size: 0x638 (see 54FF3A) in Dec  9 2019 Beta - eqmule
...
// CMerchantWnd_size: 0x440 (see 550962) in Dec  9 2019 Beta - eqmule
...
// CPetInfoWindow_size: 0x8c0 (see 54F991) in Dec  9 2019 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a0 (see 54FC82) in Dec  9 2019 Beta - eqmule
...
// CTradeWnd__size: 0x2e8 (see 550A08) in Dec  9 2019 Beta - eqmule
...
// CFactionWnd__size: 0x270 (see 550B54) in Dec  9 2019 Beta - eqmule
