...
/*0x0030*/ bool		bMarkedForDelete; \
/*0x0031*/ bool		bUseInLayoutVertical; \
/*0x0032*/ bool		bTiled; \
/*0x0034*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0038*/ BYTE		Alpha; \
/*0x0039*/ bool		bMaximized; \
/*0x003A*/ bool		bIsTransitioning; \
/*0x003B*/ BYTE     bResizableMask; \
...
/*0x0045*/ bool		bHCenterTooltip; \
/*0x0046*/ bool		bCaptureTitle; \
/*0x0047*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x0048*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x004C*/ BYTE		StartAlpha; \
/*0x004D*/ bool		Minimized; \
...
/*0x0070*/ bool		Enabled; \
/*0x0074*/ UINT		TransitionStartTick; \
/*0x0078*/ bool		bEscapableLocked; \
/*0x0079*/ bool		bClientRectChanged; \
/*0x007A*/ bool		bScreenClipRectChanged; \
/*0x007B*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
...
/*0x00BD*/ bool		bBringToTopWhenClicked; \
...
/*0x00ED*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
...
/*0x0199*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
...
// CBazaarSearchWnd_size: 0x92d0 (see 55A96E) in Nov  9 2020 Beta - eqmule
...
// CPlayerWindow_size: 0x2e8 (see 55A25E) in Nov  9 2020 Beta - eqmule
...
// CTargetWindow_size: 0x8c8 (see 55A0F5) in Nov  9 2020 Beta - eqmule
...
// CBuffWindow_size: 0x718 (see 559F99) in Nov  9 2020 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x320 (see 7FB86B) in Nov  9 2020 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d0 (see 55A357) in Nov  9 2020 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d0 (see 7FB97C) in Nov  9 2020 Beta - eqmule
...
// CItemDisplayWindow_size: 0x628 (see 75E462) in Nov  9 2020 Beta - eqmule
...
// CLootWnd_size: 0x398 (see 55A6C6) in Nov  9 2020 Beta - eqmule
...
// CMapViewWnd_size: 0x648 (see 559DFA) in Nov  9 2020 Beta - eqmule
...
// CMerchantWnd_size: 0x448 (see 55A822) in Nov  9 2020 Beta - eqmule
...
// CPetInfoWindow_size: 0x8c8 (see 559851) in Nov  9 2020 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a0 (see 559B42) in Nov  9 2020 Beta - eqmule
...
// CTradeWnd__size: 0x2f0 (see 55A8C8) in Nov  9 2020 Beta - eqmule
...
// CFactionWnd__size: 0x278 (see 55AA14) in Nov  9 2020 Beta - eqmule
