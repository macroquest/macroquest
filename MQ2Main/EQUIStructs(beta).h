...
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ RECT		ClipRectScreen; \
/*0x002C*/ int		ParentAndContextMenuArrayIndex; \
/*0x0030*/ __int64		Data; \
/*0x0038*/ struct _CSIDLWND* pWndFocusOther; \
/*0x003C*/ bool		bTiled; \
/*0x003D*/ bool		bIsParentOrContextMenuWindow; \
/*0x003E*/ bool		bClientRectChanged; \
/*0x003F*/ bool		bActive; \
/*0x0040*/ int		RightOffset; \
/*0x0044*/ RECT		OldLocation; \
/*0x0054*/ bool		bBottomAnchoredToTop; \
/*0x0058*/ UINT		TransitionDuration; \
/*0x005C*/ RECT		Location; \
/*0x006C*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0070*/ int		managerArrayIndex; \
/*0x0074*/ int		BlinkState; \
/*0x0078*/ bool		bBringToTopWhenClicked; \
/*0x007C*/ UINT		BlinkFadeStartTime; \
/*0x0080*/ DWORD	FadeDelay; \
/*0x0084*/ void   *TitlePiece; \
/*0x0088*/ int		BlinkDuration; \
/*0x008C*/ void* pTipTextObject; \
/*0x0090*/ bool		bClientClipRectChanged; \
/*0x0091*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x0092*/ bool		bUseInLayoutHorizontal; \
/*0x0093*/ bool		Faded; \
/*0x0094*/ bool		Enabled; \
/*0x0098*/ DWORD	XMLIndex; \
/*0x009C*/ bool		bMaximized; \
/*0x00A0*/ void   *TitlePiece2; \
/*0x00A4*/ bool		bClipToParent; \
/*0x00A8*/ tagSIZE	MaxClientSize; \
/*0x00B0*/ bool		bTopAnchoredToTop; \
/*0x00B1*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x00B4*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x00B8*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x00BC*/ UINT		BlinkFadeDuration; \
/*0x00C0*/ int		TopOffset; \
/*0x00C4*/ tagSIZE	MinClientSize; \
/*0x00CC*/ bool		bKeepOnScreen; \
/*0x00CD*/ BYTE		FadeAlpha; \
/*0x00D0*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x00D4*/ UINT		BlinkFadeFreq; \
/*0x00D8*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x00DC*/ BYTE		TargetAlpha; \
/*0x00E0*/ void		*pLayoutStrategy; \
/*0x00E4*/ bool		bLeftAnchoredToLeft; \
/*0x00E5*/ bool		bEscapableLocked; \
/*0x00E8*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x00EC*/ bool		Minimized; \
/*0x00F0*/ DWORD	LastTimeMouseOver; \
/*0x00F4*/ bool		bIsTransitioning; \
/*0x00F5*/ bool		bCaptureTitle; \
/*0x00F6*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x00F8*/ int		DeleteCount; \
/*0x00FC*/ DWORD  BackgroundDrawType; \
/*0x0100*/ RECT		ClipRectClient; \
/*0x0110*/ UINT		FadeDuration; \
...
/*0x0130*/ bool		bAction; \
/*0x0131*/ bool		dShow; \
/*0x0134*/ RECT		IconRect; \
/*0x0144*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0148*/ void *pController; \
/*0x014C*/ bool		bBorder2; \
/*0x014D*/ bool		bBorder; \
/*0x0150*/ UINT		LastBlinkFadeRefreshTime; \
/*0x0154*/ UINT		TransitionStartTick; \
/*0x0158*/ int	Transition; \
/*0x015C*/ bool		bUseInLayoutVertical; \
/*0x0160*/ void*	pTextObject; \
/*0x0164*/ void	*IconTextureAnim; \
/*0x0168*/ bool		bHCenterTooltip; \
/*0x0169*/ BYTE		StartAlpha; \
/*0x016C*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x0170*/ bool		bRightAnchoredToLeft; \
/*0x0174*/ LONG		BlinkStartTimer; \
/*0x0178*/ RECT		TransitionRect; \
/*0x0188*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x018C*/ struct _CXSTR*	DataStr; \
/*0x0190*/ int		LeftOffset; \
/*0x0194*/ int		VScrollMax; \
/*0x0198*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x1c */ \
/*0x01B4*/ bool		bMaximizable; \
/*0x01B5*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x01B6*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x01B7*/ BYTE		Alpha; \
/*0x01B8*/ COLORREF DisabledBackground; \
/*0x01BC*/ bool		bScreenClipRectChanged; \
/*0x01C0*/ void	    *pFont; \
/*0x01C4*/ int		HScrollMax; \
/*0x01C8*/ int		BottomOffset; \
/*0x01CC*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x01D0*/ int		VScrollPos; \
/*0x01D4*/ bool		bFullyScreenClipped; \
/*0x01D5*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x01D8*/ int		HScrollPos; \
/*0x01DC*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
/*0x01E0*/ BYTE     bResizableMask; \
/*0x01E1*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x01E2*/ bool		Fades; \
/*0x01E3*/ BYTE Filler0x01E3[0x5];
/*0x01E8*/
...
//size is 0x210 see 7AB889 in Oct 28 2017 Beta -eqmule
...
// CBazaarSearchWnd_size: 0x92d0 (see 53932D) in Nov  3 2018 Beta - eqmule
...
// CPlayerWindow_size: 0x2e8 (see 538C20) in Nov  3 2018 Beta - eqmule
...
// CTargetWindow_size: 0x8c8 (see 538ABB) in Nov  3 2018 Beta - eqmule
...
// CBuffWindow_size: 0x718 (see 53895F) in Nov  3 2018 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x320 (see 7E806B) in Nov  3 2018 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d0 (see 538D19) in Nov  3 2018 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d0 (see 7E817C) in Nov  3 2018 Beta - eqmule
...
// CItemDisplayWindow_size: 0x628 (see 748522) in Nov  3 2018 Beta - eqmule
...
// CLootWnd_size: 0x398 (see 539085) in Nov  3 2018 Beta - eqmule
...
// CMapViewWnd_size: 0x648 (see 5387C0) in Nov  3 2018 Beta - eqmule
...
// CMerchantWnd_size: 0x448 (see 5391E1) in Nov  3 2018 Beta - eqmule
...
// CPetInfoWindow_size: 0x8c8 (see 5381FA) in Nov  3 2018 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a8 (see 5384EB) in Nov  3 2018 Beta - eqmule
...
// CTradeWnd__size: 0x2f0 (see 539287) in Nov  3 2018 Beta - eqmule
