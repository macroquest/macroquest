...
/*0x0055*/ bool		bFullyScreenClipped; \
...
/*0x0074*/ BYTE		Alpha; \
/*0x0075*/ BYTE		StartAlpha; \
/*0x0076*/ bool		bBottomAnchoredToTop; \
/*0x0077*/ bool		bUseInLayoutVertical; \
/*0x0078*/ DWORD	FadeDelay; \
/*0x007C*/ bool		bClientRectChanged; \
/*0x007D*/ bool		Enabled; \
/*0x0080*/ int		VScrollMax; \
/*0x0084*/ void   *TitlePiece; \
/*0x0088*/ bool		dShow; \
/*0x0089*/ bool		bCaptureTitle; \
/*0x008C*/ void	*DrawTemplate; \
/*0x0090*/ bool		bTiled; \
/*0x0094*/ RECT		OldLocation; \
/*0x00A4*/ UINT		FadeDuration; \
/*0x00A8*/ RECT		IconRect; \
/*0x00B8*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x00BC*/ int		managerArrayIndex; \
...
/*0x0130*/ bool		bTopAnchoredToTop; \
/*0x0134*/ void* pTipTextObject; \
/*0x0138*/ bool		bLeftAnchoredToLeft; \
...
/*0x015A*/ BYTE		FadeAlpha; \
/*0x015C*/ UINT		LastBlinkFadeRefreshTime; \
/*0x0160*/ void	*IconTextureAnim; \
/*0x0164*/ bool		bUseInLayoutHorizontal; \
/*0x0165*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x0166*/ bool		ValidCXWnd; /* IsValid has this one */ \
...
/*0x0180*/ bool		bBorder; \
/*0x0181*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
...
/*0x0194*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
...
/*0x01A5*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
...
/*0x01E8*/ bool		bMaximizable; \
/*0x01EC*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
