...
// actual size 0x1F0 in Oct 19 2020 Beta (see 0x93BBFD) - eqmule
// actual size 0x1F8 in Oct 20 2020 Beta (see 0x93C76D) - eqmule
#define CXW_NO_VTABLE \
private: \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ bool		Faded; \
/*0x001D*/ bool		bUseInLayoutVertical; \
/*0x0020*/ void	*IconTextureAnim; \
/*0x0024*/ bool		bEscapableLocked; \
...
/*0x007C*/ DWORD	XMLIndex; \
/*0x0080*/ int	Transition; \
/*0x0084*/ bool		bClientClipRectChanged; \
/*0x0085*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0086*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0087*/ bool		bClipToParent; \
...
/*0x00B4*/ int		RightOffset; \
/*0x00B8*/ bool		bRightAnchoredToLeft; \
/*0x00BC*/ void   *TitlePiece2; \
/*0x00C0*/ bool		bFullyScreenClipped; \
/*0x00C1*/ bool		bScreenClipRectChanged; \
/*0x00C4*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x00DC*/ UINT		LastBlinkFadeRefreshTime; \
/*0x00E0*/ bool		bLeftAnchoredToLeft; \
/*0x00E4*/ UINT		TransitionStartTick; \
/*0x00E8*/ int		managerArrayIndex; \
/*0x00EC*/ bool		bBorder; \
...
/*0x012D*/ BYTE		StartAlpha; \
/*0x012E*/ bool		bBringToTopWhenClicked; \
/*0x0130*/ void*	pTextObject; \
/*0x0134*/ bool		bActive; \
/*0x0135*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x0136*/ bool		bTiled; \
...
// CBazaarSearchWnd_size: 0x92e0 (see 558A6E) in Oct 20 2020 Beta - eqmule
...
//aAPwcsincombat
// CPlayerWindow_size: 0x2f8 (see 55835E) in Oct 20 2020 Beta - eqmule
...
// CTargetWindow_size: 0x8d8 (see 5581F5) in Oct 20 2020 Beta - eqmule
...
// CBuffWindow_size: 0x728 (see 558099) in Oct 20 2020 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x330 (see 7FA4EB) in Oct 20 2020 Beta - eqmule
...
// CCastSpellWnd_size: 0x2e0 (see 558457) in Oct 20 2020 Beta - eqmule
...
// CInvSlotWnd_size: 0x2e0 (see 7FA5FC) in Oct 20 2020 Beta - eqmule
...
// CItemDisplayWindow_size: 0x638 (see 75D102) in Oct 20 2020 Beta - eqmule
...
// CLootWnd_size: 0x3a8 (see 5587C6) in Oct 20 2020 Beta - eqmule
...
// CMapViewWnd_size: 0x668 (see 557EFA) in Oct 20 2020 Beta - eqmule
...
// CMerchantWnd_size: 0x458 (see 558922) in Oct 20 2020 Beta - eqmule
...
// CPetInfoWindow_size: 0x8d8 (see 557951) in Oct 20 2020 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3b0 (see 557C42) in Oct 20 2020 Beta - eqmule
...
// CTradeWnd__size: 0x300 (see 5589C8) in Oct 20 2020 Beta - eqmule
...
// CFactionWnd__size: 0x288 (see 558B14) in Oct 20 2020 Beta - eqmule
