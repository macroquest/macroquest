...
/*0x0028*/ bool		dShow; \
/*0x0029*/ bool		Minimized; \
/*0x002C*/ int		BottomOffset; \
/*0x0030*/ bool		bBottomAnchoredToTop; \
/*0x0031*/ bool		bMaximized; \
/*0x0032*/ bool		bEscapableLocked; \
/*0x0034*/ RECT		IconRect; \
/*0x0044*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0045*/ bool		bLeftAnchoredToLeft; \
/*0x0048*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x004C*/ int		HScrollPos; \
/*0x0050*/ BYTE     bResizableMask; \
/*0x0051*/ bool		Fades; \
/*0x0052*/ bool		bFullyScreenClipped; \
/*0x0054*/ int		ParentAndContextMenuArrayIndex; \
/*0x0058*/ bool		bAction; \
/*0x005C*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x0060*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x0064*/ bool		bIsTransitioning; \
/*0x0065*/ bool		bRightAnchoredToLeft; \
/*0x0068*/ RECT		ClientRect; \
/*0x0078*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x007C*/ RECT		TransitionRect; \
/*0x008C*/ bool		bKeepOnScreen; \
/*0x0090*/ int		RightOffset; \
/*0x0094*/ UINT		BlinkFadeDuration; \
/*0x0098*/ void		*pLayoutStrategy; \
/*0x009C*/ void* pTipTextObject; \
/*0x00A0*/ int		DeleteCount; \
/*0x00A4*/ DWORD	XMLIndex; \
/*0x00A8*/ bool		bMarkedForDelete; \
/*0x00A9*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x00AC*/ UINT		LastBlinkFadeRefreshTime; \
/*0x00B0*/ RECT		ClipRectClient; \
/*0x00C0*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x00C1*/ bool		bActive; \
/*0x00C4*/ DWORD  BackgroundDrawType; \
/*0x00C8*/ bool		bUseInLayoutVertical; \
/*0x00C9*/ BYTE		FadeAlpha; \
/*0x00CC*/ tagSIZE	MinClientSize; \
/*0x00D4*/ struct _CXSTR*	DataStr; \
/*0x00D8*/ int		LeftOffset; \
/*0x00DC*/ int		TopOffset; \
/*0x00E0*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x00E4*/ UINT		BlinkFadeStartTime; \
/*0x00E8*/ bool		bBorder; \
/*0x00EC*/ DWORD	FadeDelay; \
/*0x00F0*/ int		BlinkDuration; \
/*0x00F4*/ UINT		TransitionDuration; \
/*0x00F8*/ int		BlinkState; \
/*0x00FC*/ int		VScrollMax; \
/*0x0100*/ bool		bScreenClipRectChanged; \
/*0x0101*/ bool		Enabled; \
/*0x0104*/ tagSIZE	MaxClientSize; \
/*0x010C*/ int		VScrollPos; \
/*0x0110*/ bool		bBorder2; \
/*0x0114*/ int	Transition; \
/*0x0118*/ DWORD	LastTimeMouseOver; \
/*0x011C*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x0120*/ bool		bCaptureTitle; \
/*0x0121*/ bool		bHCenterTooltip; \
/*0x0122*/ bool		Faded; \
/*0x0123*/ bool		bMaximizable; \
/*0x0124*/ BYTE		StartAlpha; \
/*0x0128*/ RECT		OldLocation; \
/*0x0138*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x013C*/ UINT		TransitionStartTick; \
/*0x0140*/ void*	pTextObject; \
/*0x0144*/ bool		bClipToParent; \
/*0x0148*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x014C*/ void *pController; \
/*0x0150*/ UINT		BlinkFadeFreq; \
/*0x0154*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x016C*/ bool		bClientClipRectChanged; \
...
/*0x0189*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x018C*/ int		HScrollMax; \
/*0x0190*/ bool		bIsParentOrContextMenuWindow; \
/*0x0194*/ RECT		ClipRectScreen; \
/*0x01A4*/ COLORREF DisabledBackground; \
/*0x01A8*/ bool		bTiled; \
/*0x01AC*/ void   *TitlePiece2; \
/*0x01B0*/ void	*DrawTemplate; \
/*0x01B4*/ int		managerArrayIndex; \
/*0x01B8*/ bool bClickThroughMenuItemStatus; /* on/off */ \
...
/*0x01C8*/ __int64		Data; \
/*0x01D0*/ bool		bTopAnchoredToTop; \
/*0x01D1*/ BYTE		TargetAlpha; \
/*0x01D2*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x01D3*/ BYTE		Alpha; \
/*0x01D4*/ bool		bBringToTopWhenClicked; \
/*0x01D5*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x01D8*/ UINT		FadeDuration; \
/*0x01DC*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x01E0*/ void	    *pFont; \
/*0x01E4*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
...
// CBazaarSearchWnd_size: 0x92d0 (see 54F3CE) in Nov 16 2019 Beta - eqmule
...
// CPlayerWindow_size: 0x2e8 (see 54ECBE) in Nov 16 2019 Beta - eqmule
...
// CTargetWindow_size: 0x8c8 (see 54EB55) in Nov 16 2019 Beta - eqmule
...
// CBuffWindow_size: 0x718 (see 54E9F9) in Nov 16 2019 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x320 (see 806E1B) in Nov 16 2019 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d0 (see 54EDB7) in Nov 16 2019 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d0 (see 806F2C) in Nov 16 2019 Beta - eqmule
...
// CItemDisplayWindow_size: 0x628 (see 769E22) in Nov 16 2019 Beta - eqmule
...
// CLootWnd_size: 0x398 (see 54F126) in Nov 16 2019 Beta - eqmule
...
// CMapViewWnd_size: 0x648 (see 54E85A) in Nov 16 2019 Beta - eqmule
...
// CMerchantWnd_size: 0x448 (see 54F282) in Nov 16 2019 Beta - eqmule
...
// CPetInfoWindow_size: 0x8c8 (see 54E2B1) in Nov 16 2019 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a8 (see 54E5A2) in Nov 16 2019 Beta - eqmule
...
// CTradeWnd__size: 0x2f0 (see 54F328) in Nov 16 2019 Beta - eqmule
...
// CFactionWnd__size: 0x278 (see 54F474) in Nov 16 2019 Beta - eqmule
