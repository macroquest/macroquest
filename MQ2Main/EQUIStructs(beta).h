...
/*0x002D*/ BYTE     bResizableMask; \
/*0x002E*/ bool		bBorder2; \
/*0x0030*/ __int64		Data; \
/*0x0038*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x003C*/ bool		bMarkedForDelete; \
...
/*0x0058*/ bool		Enabled; \
/*0x0059*/ bool		bTopAnchoredToTop; \
/*0x005A*/ bool		bIsParentOrContextMenuWindow; \
/*0x005C*/ void   *TitlePiece2; \
/*0x0060*/ void		*pLayoutStrategy; \
/*0x0064*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x0065*/ bool		bUseInLayoutVertical; \
...
/*0x0080*/ bool		bMaximized; \
/*0x0084*/ int		HScrollPos; \
...
/*0x0104*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0105*/ bool		bScreenClipRectChanged; \
/*0x0106*/ bool		bLeftAnchoredToLeft; \
/*0x0108*/ void	    *pFont; \
/*0x010C*/ UINT		BlinkFadeFreq; \
/*0x0110*/ int		TopOffset; \
/*0x0114*/ bool		Minimized; \
/*0x0115*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0116*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x0118*/ UINT		FadeDuration; \
/*0x011C*/ bool		bClientClipRectChanged; \
/*0x011D*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x011E*/ bool		bRightAnchoredToLeft; \
/*0x0120*/ RECT		OldLocation; \
/*0x0130*/ RECT		IconRect; \
...
/*0x014C*/ DWORD  BackgroundDrawType; \
/*0x0150*/ BYTE		TargetAlpha; \
/*0x0151*/ bool		bMaximizable; \
/*0x0154*/ RECT		ClipRectClient; \
/*0x0164*/ DWORD	FadeDelay; \
/*0x0168*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0169*/ bool		bBottomAnchoredToTop; \
/*0x016A*/ bool		bIsTransitioning; \
/*0x016B*/ bool		bClientRectChanged; \
/*0x016C*/ BYTE		Alpha; \
/*0x016D*/ bool		bFullyScreenClipped; \
/*0x016E*/ bool		bBorder; \
/*0x0170*/ struct _CSIDLWND* pWndFocusOther; \
/*0x0174*/ bool		bCaptureTitle; \
/*0x0178*/ DWORD	LastTimeMouseOver; \
/*0x017C*/ bool		bActive; \
/*0x0180*/ LONG		BlinkStartTimer; \
/*0x0184*/ bool		bAction; \
/*0x0185*/ bool		Fades; \
/*0x0186*/ bool		bHCenterTooltip; \
...
// CBazaarSearchWnd_size: 0x92c8 (see 538F8D) in Nov  8 2018 Beta - eqmule
...
// CPlayerWindow_size: 0x2e0 (see 538880) in Nov  8 2018 Beta - eqmule
...
// CTargetWindow_size: 0x8c0 (see 53871B) in Nov  8 2018 Beta - eqmule
...
// CBuffWindow_size: 0x710 (see 5385BF) in Nov  8 2018 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x318 (see 7E829B) in Nov  8 2018 Beta - eqmule
...
// CCastSpellWnd_size: 0x2c8 (see 538979) in Nov  8 2018 Beta - eqmule
...
// CInvSlotWnd_size: 0x2c8 (see 7E83AC) in Nov  8 2018 Beta - eqmule
...
// CItemDisplayWindow_size: 0x620 (see 7488A2) in Nov  8 2018 Beta - eqmule
...
// CLootWnd_size: 0x390 (see 538CE5) in Nov  8 2018 Beta - eqmule
...
// CMapViewWnd_size: 0x638 (see 538420) in Nov  8 2018 Beta - eqmule
...
// CMerchantWnd_size: 0x440 (see 538E41) in Nov  8 2018 Beta - eqmule
...
// CPetInfoWindow_size: 0x8c0 (see 537E5A) in Nov  8 2018 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a0 (see 53814B) in Nov  8 2018 Beta - eqmule
...
// CTradeWnd__size: 0x2e8 (see 538EE7) in Nov  8 2018 Beta - eqmule
