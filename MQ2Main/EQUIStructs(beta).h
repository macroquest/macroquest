...
/*0x0024*/ RECT		ClipRectClient; \
/*0x0034*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x0038*/ void   *TitlePiece; \
/*0x003C*/ bool		bTiled; \
/*0x0040*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0044*/ tagSIZE	MaxClientSize; \
...
/*0x00DC*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x00E0*/ RECT		Location; \
/*0x00F0*/ bool		bBorder; \
/*0x00F1*/ bool		Enabled; \
/*0x00F2*/ bool		bFullyScreenClipped; \
/*0x00F3*/ bool		bAction; \
/*0x00F4*/ int		BottomOffset; \
/*0x00F8*/ BYTE		StartAlpha; \
/*0x00F9*/ BYTE		FadeAlpha; \
/*0x00FA*/ bool		bRightAnchoredToLeft; \
/*0x00FB*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
...
/*0x0120*/ void	    *pFont; \
/*0x0124*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x0125*/ bool		bBottomAnchoredToTop; \
...
/*0x013C*/ int		ParentAndContextMenuArrayIndex; \
/*0x0140*/ void*	pTextObject; \
/*0x0144*/ bool		bCaptureTitle; \
/*0x0145*/ bool		Fades; \
/*0x0146*/ BYTE		TargetAlpha; \
/*0x0147*/ bool		bHCenterTooltip; \
/*0x0148*/ int		RightOffset; \
/*0x014C*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0150*/ void   *TitlePiece2; \
/*0x0154*/ int		VScrollPos; \
/*0x0158*/ bool		bMaximizable; \
/*0x015C*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x0160*/ UINT		TransitionStartTick; \
/*0x0164*/ bool		bTopAnchoredToTop; \
/*0x0168*/ int		BlinkState; \
/*0x016C*/ bool		bKeepOnScreen; \
/*0x016D*/ bool		bClientRectChanged; \
/*0x016E*/ bool		bClipToParent; \
/*0x016F*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x0170*/ bool		bUseInLayoutVertical; \
/*0x0174*/ int		BlinkDuration; \
/*0x0178*/ tagSIZE	MinClientSize; \
/*0x0180*/ struct _CSIDLWND* pWndFocusOther; \
/*0x0184*/ LONG		BlinkStartTimer; \
/*0x0188*/ int		LeftOffset; \
/*0x018C*/ bool		dShow; \
/*0x018D*/ bool		bActive; \
/*0x0190*/ RECT		OldLocation; \
/*0x01A0*/ bool		Faded; \
/*0x01A1*/ bool		bLeftAnchoredToLeft; \
...
/*0x01B5*/ bool		bScreenClipRectChanged; \
/*0x01B8*/ void *pController; \
/*0x01BC*/ UINT		BlinkFadeFreq; \
/*0x01C0*/ int		VScrollMax; \
/*0x01C4*/ bool		bMarkedForDelete; \
/*0x01C5*/ bool		Minimized; \
/*0x01C6*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x01C7*/ BYTE		Alpha; \
/*0x01C8*/ int		HScrollPos; \
/*0x01CC*/ RECT		ClientRect; \
/*0x01DC*/ bool		bIsParentOrContextMenuWindow; \
/*0x01DD*/ bool		bBringToTopWhenClicked; \
/*0x01DE*/ BYTE     bResizableMask; \
/*0x01DF*/ BYTE Filler0x01DF[0x1]; \
/*0x01E0*/ \
public: \
			bool IsVisible() \
			{ \
...
// CBazaarSearchWnd_size: 0x92c8 (see 54A80E) in Oct 21 2019 Beta - eqmule
...
// CPlayerWindow_size: 0x2e0 (see 54A0FE) in Oct 21 2019 Beta - eqmule
...
// CTargetWindow_size: 0x8c0 (see 549F95) in Oct 21 2019 Beta - eqmule
...
// CBuffWindow_size: 0x710 (see 549E39) in Oct 21 2019 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x318 (see 7FCCBB) in Oct 21 2019 Beta - eqmule
...
// CCastSpellWnd_size: 0x2c8 (see 54A1F7) in Oct 21 2019 Beta - eqmule
...
// CInvSlotWnd_size: 0x2c8 (see 7FCDBC) in Oct 21 2019 Beta - eqmule
...
// CItemDisplayWindow_size: 0x620 (see 75FE12) in Oct 21 2019 Beta - eqmule
...
// CLootWnd_size: 0x390 (see 54A566) in Oct 21 2019 Beta - eqmule
...
// CMapViewWnd_size: 0x638 (see 549C9A) in Oct 21 2019 Beta - eqmule
...
// CMerchantWnd_size: 0x440 (see 54A6C2) in Oct 21 2019 Beta - eqmule
...
// CPetInfoWindow_size: 0x8c0 (see 5496F1) in Oct 21 2019 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a0 (see 5499E2) in Oct 21 2019 Beta - eqmule
...
// CTradeWnd__size: 0x2e8 (see 54A768) in Oct 21 2019 Beta - eqmule
...
// CFactionWnd__size: 0x270 (see 54A8B4) in Oct 21 2019 Beta - eqmule
