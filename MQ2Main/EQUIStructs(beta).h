...
// actual size 0x1F0 in Oct 28 2020 Beta (see 0x93EC8D) - eqmule
...
/*0x006E*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x006F*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x0070*/ bool		Faded; \
/*0x0074*/ void*	pTextObject; \
/*0x0078*/ RECT		TransitionRect; \
/*0x0088*/ bool		bActive; \
/*0x008C*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x0090*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
...
/*0x00AC*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x00B0*/ __int64		Data; \
/*0x00B8*/ bool		bCaptureTitle; \
/*0x00BC*/ int		LeftOffset; \
/*0x00C0*/ int		BlinkDuration; \
/*0x00C4*/ int		ParentAndContextMenuArrayIndex; \
...
/*0x0160*/ bool		bRightAnchoredToLeft; \
...
/*0x017C*/ int		HScrollPos; \
/*0x0180*/ bool		bScreenClipRectChanged; \
/*0x0181*/ bool		bUseInLayoutHorizontal; \
/*0x0184*/ int		VScrollMax; \
/*0x0188*/ bool		bUseInLayoutVertical; \
/*0x0189*/ BYTE		FadeAlpha; \
/*0x018A*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x018C*/ UINT		FadeDuration; \
/*0x0190*/ RECT		Location; \
/*0x01A0*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
...
/*0x01BC*/ bool		bClientClipRectChanged; \
...
// CBazaarSearchWnd_size: 0x92d8 (see 55A91E) in Oct 28 2020 Beta - eqmule
...
//aAPwcsincombat
// CPlayerWindow_size: 0x2f0 (see 55A20E) in Oct 28 2020 Beta - eqmule
...
// CTargetWindow_size: 0x8d0 (see 55A0A5) in Oct 28 2020 Beta - eqmule
...
// CBuffWindow_size: 0x720 (see 559F49) in Oct 28 2020 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x328 (see 7FBDDB) in Oct 28 2020 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d8 (see 55A307) in Oct 28 2020 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d8 (see 7FBEEC) in Oct 28 2020 Beta - eqmule
...
// CItemDisplayWindow_size: 0x630 (see 75EAE2) in Oct 28 2020 Beta - eqmule
...
// CLootWnd_size: 0x3a0 (see 55A676) in Oct 28 2020 Beta - eqmule
...
// CMapViewWnd_size: 0x658 (see 559DAA) in Oct 28 2020 Beta - eqmule
...
// CMerchantWnd_size: 0x450 (see 55A7D2) in Oct 28 2020 Beta - eqmule
...
// CPetInfoWindow_size: 0x8d0 (see 559801) in Oct 28 2020 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a8 (see 559AF2) in Oct 28 2020 Beta - eqmule
...
// CTradeWnd__size: 0x2f8 (see 55A878) in Oct 28 2020 Beta - eqmule
...
// CFactionWnd__size: 0x280 (see 55A9C4) in Oct 28 2020 Beta - eqmule
