...
/*0x0020*/ void*	pTextObject; \
/*0x0024*/ RECT		OldLocation; \
/*0x0034*/ bool		bBringToTopWhenClicked; \
/*0x0035*/ bool		bBorder2; \
/*0x0038*/ void *pController; \
/*0x003C*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x003D*/ bool		bUseInLayoutVertical; \
/*0x003E*/ bool		dShow; \
/*0x003F*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0040*/ bool		Minimized; \
/*0x0044*/ DWORD  BackgroundDrawType; \
/*0x0048*/ int		ParentAndContextMenuArrayIndex; \
/*0x004C*/ bool		bClientRectChanged; \
/*0x0050*/ void	    *pFont; \
/*0x0054*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x0055*/ bool		bIsTransitioning; \
/*0x0056*/ bool		bCaptureTitle; \
/*0x0058*/ __int64		Data; \
/*0x0060*/ void   *TitlePiece; \
/*0x0064*/ bool		bBorder; \
/*0x0068*/ struct _CXSTR*	DataStr; \
/*0x006C*/ bool		bAction; \
/*0x0070*/ int	Transition; \
/*0x0074*/ bool		bFullyScreenClipped; \
/*0x0075*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x0078*/ int		BottomOffset; \
/*0x007C*/ RECT		TransitionRect; \
/*0x008C*/ bool		bScreenClipRectChanged; \
/*0x008D*/ bool		bUseInLayoutHorizontal; \
...
/*0x00B4*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
/*0x00B8*/ bool		bBottomAnchoredToTop; \
/*0x00B9*/ bool		bRightAnchoredToLeft; \
/*0x00BA*/ bool		bLeftAnchoredToLeft; \
/*0x00BC*/ void		*pLayoutStrategy; \
...
/*0x00D8*/ int		RightOffset; \
/*0x00DC*/ UINT		BlinkFadeDuration; \
/*0x00E0*/ DWORD	LastTimeMouseOver; \
/*0x00E4*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x00E8*/ BYTE		TargetAlpha; \
/*0x00E9*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x00EA*/ bool		bMaximized; \
/*0x00EC*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x00F0*/ UINT		TransitionDuration; \
/*0x00F4*/ bool		bMarkedForDelete; \
/*0x00F5*/ bool		bClipToParent; \
/*0x00F6*/ bool		bIsParentOrContextMenuWindow; \
/*0x00F8*/ RECT		ClientRect; \
/*0x0108*/ RECT		ClipRectClient; \
/*0x0118*/ bool		bActive; \
/*0x0119*/ bool		bTiled; \
/*0x011C*/ tagSIZE	MaxClientSize; \
/*0x0124*/ int		LeftOffset; \
/*0x0128*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x0129*/ BYTE		FadeAlpha; \
/*0x012A*/ bool		Fades; \
...
/*0x01A4*/ bool		bTopAnchoredToTop; \
/*0x01A5*/ bool		Enabled; \
/*0x01A8*/ COLORREF DisabledBackground; \
/*0x01AC*/ BYTE		StartAlpha; \
/*0x01AD*/ BYTE     bResizableMask; \
/*0x01B0*/ UINT		FadeDuration; \
/*0x01B4*/ struct _CSIDLWND* pWndFocusOther; \
/*0x01B8*/ int		VScrollMax; \
/*0x01BC*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
...
// CBazaarSearchWnd_size: 0x92c0 (see 54F14E) in Nov 11 2019 Beta - eqmule
...
// CPlayerWindow_size: 0x2d8 (see 54EA3E) in Nov 11 2019 Beta - eqmule
...
// CTargetWindow_size: 0x8b8 (see 54E8D5) in Nov 11 2019 Beta - eqmule
...
// CBuffWindow_size: 0x708 (see 54E779) in Nov 11 2019 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x310 (see 80594B) in Nov 11 2019 Beta - eqmule
...
// CCastSpellWnd_size: 0x2c0 (see 54EB37) in Nov 11 2019 Beta - eqmule
...
// CInvSlotWnd_size: 0x2c0 (see 805A5C) in Nov 11 2019 Beta - eqmule
...
// CLootWnd_size: 0x388 (see 54EEA6) in Nov 11 2019 Beta - eqmule
...
// CMapViewWnd_size: 0x628 (see 54E5DA) in Nov 11 2019 Beta - eqmule
...
// CMerchantWnd_size: 0x438 (see 54F002) in Nov 11 2019 Beta - eqmule
...
// CPetInfoWindow_size: 0x8b8 (see 54E031) in Nov 11 2019 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x398 (see 54E322) in Nov 11 2019 Beta - eqmule
...
// CTradeWnd__size: 0x2e0 (see 54F0A8) in Nov 11 2019 Beta - eqmule
...
// CFactionWnd__size: 0x268 (see 54F1F4) in Nov 11 2019 Beta - eqmule
