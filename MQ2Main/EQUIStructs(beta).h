...
/*0x0034*/ struct _CXSTR*	WindowText; /*CXWnd__GetWindowTextA_x has this one*/ \
/*0x0038*/ BYTE		Unknown0x0038[0x3]; \
/*0x003b*/ BYTE		Faded; \
/*0x003c*/ BYTE		Unknown0x003c[0x4]; \
/*0x0040*/ LPVOID	DrawTemplate; \
/*0x0044*/ BYTE		Unknown0x0044[0x8]; \
/*0x004c*/ DWORD	TimeMouseOver; \
...
/*0x008c*/ BYTE		Unknown0x008c[0x1c]; \
/*0x00a8*/ DWORD	ZLayer; /*found in CXWndManager__DrawWindows_x*/ \
/*0x00ac*/ BYTE		Unknown0x00ac[0x4]; \
/*0x00b0*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x "BGType" in ini */ \
/*0x00b4*/ DWORD	UnknownCW; /*found in OnProcessFrame*/\
...
/*0x00f4*/ BYTE		Fades; \
/*0x00f5*/ BYTE		Unknown0x00f5[0x28]; \
/*0x011d*/ BYTE		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x011e*/ BYTE		Unknown0x011e[0x7]; \
/*0x0125*/ BYTE		Enabled; \
/*0x0126*/ BYTE		Unknown0x0126[0x2e]; \
/*0x0154*/ BYTE		ValidCXWnd; /*IsValid has this one*/\
/*0x0155*/ BYTE		Unknown0x0155[0x3]; \
/*0x0158*/ ARGBCOLOR	BGColor; \
/*0x015c*/ BYTE		Unknown0x015c[0x2]; \
/*0x015e*/ BYTE		MouseOver; /*found in CXWnd__SetMouseOver_x*/ \
/*0x015f*/ BYTE		Minimized; \
/*0x0160*/ BYTE		Unknown0x0160[0x4]; \
/*0x0164*/ BYTE		Alpha; \
/*0x0165*/ BYTE		Unknown0x0165[0x3]; \
/*0x0168*/ DWORD	HScrollPos; \
/*0x016c*/ BYTE		Unknown0x016c[0x4]; \
/*0x0170*/ DWORD	HScrollMax; \
/*0x0174*/ BYTE		Unknown0x0174[0x10]; \
/*0x0184*/ DWORD	FadeDuration; \
/*0x0188*/ DWORD	VScrollMax; \
/*0x018c*/ struct _CXSTR*	Tooltip; /*found in CSidlManager__CreateLabel_x*/ \
/*0x0190*/ BYTE		Unknown0x0190[0x10]; \
/*0x01a0*/ BYTE		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x01a1*/ BYTE		Unknown0x01a1[0x3]; \
/*0x01a4*/ DWORD	VScrollPos; \
/*0x01a8*/ BYTE		Unknown0x01a8[0x34]; \
/*0x01dc*/ BYTE		FadeToAlpha; /*found in CSidlScreenWnd__StoreIniInfo_x*/\
/*0x01dd*/ BYTE		Unknown0x01dd[0x8]; \
/*0x01e5*/ BYTE		Locked; /*found in CSidlScreenWnd__LoadIniInfo_x*/ \
/*0x01e6*/ BYTE		Unknown0x01e6[0x02];
/*0x01e8*/
...
//size 0x2f8 see 4BE58E in Oct 12 2016 beta -eqmule
