...
// actual size 0x1E8 in Nov 10 2019 Beta (see 0x94EB3D) - eqmule
#define CXW_NO_VTABLE \
private: \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ bool		bLeftAnchoredToLeft; \
/*0x0020*/ UINT		TransitionStartTick; \
/*0x0024*/ UINT		BlinkFadeStartTime; \
/*0x0028*/ RECT		ClientRect; \
/*0x0038*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x0039*/ bool		bKeepOnScreen; \
/*0x003C*/ int		VScrollMax; \
/*0x0040*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x0044*/ int		BlinkDuration; \
/*0x0048*/ BYTE		TargetAlpha; \
/*0x0049*/ bool		bTiled; \
/*0x004C*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0050*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x0054*/ LONG		BlinkStartTimer; \
/*0x0058*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x0059*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x005A*/ bool		bEscapableLocked; \
/*0x005B*/ bool		bScreenClipRectChanged; \
/*0x005C*/ bool		bFullyScreenClipped; \
...
/*0x0070*/ RECT		IconRect; \
/*0x0080*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0081*/ bool		bBorder2; \
/*0x0084*/ void	    *pFont; \
/*0x0088*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x008C*/ bool		Faded; \
/*0x0090*/ int		ParentAndContextMenuArrayIndex; \
/*0x0094*/ int		HScrollPos; \
/*0x0098*/ bool		bCaptureTitle; \
/*0x009C*/ int		BottomOffset; \
/*0x00A0*/ BYTE     bResizableMask; \
/*0x00A4*/ void   *TitlePiece; \
/*0x00A8*/ bool		bActive; \
/*0x00AC*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x00B0*/ UINT		LastBlinkFadeRefreshTime; \
/*0x00B4*/ bool		bIsTransitioning; \
/*0x00B5*/ bool		bClientClipRectChanged; \
/*0x00B6*/ bool		bAction; \
/*0x00B7*/ BYTE		Alpha; \
...
/*0x00DC*/ int		managerArrayIndex; \
/*0x00E0*/ UINT		TransitionDuration; \
/*0x00E4*/ int		TopOffset; \
/*0x00E8*/ int	Transition; \
/*0x00EC*/ void	*DrawTemplate; \
/*0x00F0*/ tagSIZE	MinClientSize; \
/*0x00F8*/ BYTE		FadeAlpha; \
/*0x00F9*/ bool		Minimized; \
/*0x00FA*/ bool		bBottomAnchoredToTop; \
/*0x00FB*/ bool		bTopAnchoredToTop; \
/*0x00FC*/ int		BlinkState; \
/*0x0100*/ void   *TitlePiece2; \
/*0x0104*/ RECT		Location; \
/*0x0114*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x0118*/ bool		bMaximized; \
/*0x0119*/ bool		bUseInLayoutVertical; \
/*0x011C*/ RECT		ClipRectScreen; \
/*0x012C*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
...
/*0x0138*/ DWORD  BackgroundDrawType; \
/*0x013C*/ UINT		FadeDuration; \
/*0x0140*/ bool		Enabled; \
/*0x0144*/ RECT		TransitionRect; \
/*0x0154*/ bool		bClipToParent; \
/*0x0158*/ COLORREF DisabledBackground; \
/*0x015C*/ bool		bHCenterTooltip; \
/*0x0160*/ void	*IconTextureAnim; \
/*0x0164*/ DWORD	XMLIndex; \
/*0x0168*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x0169*/ bool		bIsParentOrContextMenuWindow; \
...
/*0x017C*/ bool		bClientRectChanged; \
/*0x017D*/ bool		Fades; \
/*0x017E*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x0180*/ int		LeftOffset; \
/*0x0184*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x0188*/ bool		bMaximizable; \
/*0x0189*/ bool		bUseInLayoutHorizontal; \
/*0x018A*/ bool		bBringToTopWhenClicked; \
/*0x018B*/ bool		dShow; \
/*0x018C*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0190*/ __int64		Data; \
/*0x0198*/ struct _CXSTR*	DataStr; \
/*0x019C*/ UINT		BlinkFadeFreq; \
/*0x01A0*/ int		DeleteCount; \
/*0x01A4*/ BYTE		StartAlpha; \
/*0x01A8*/ RECT		ClipRectClient; \
...
// CBazaarSearchWnd_size: 0x92d0 (see 54F79E) in Nov 10 2019 Beta - eqmule
...
// CPlayerWindow_size: 0x2e8 (see 54F08E) in Nov 10 2019 Beta - eqmule
...
// CTargetWindow_size: 0x8c8 (see 54EF25) in Nov 10 2019 Beta - eqmule
...
// CBuffWindow_size: 0x718 (see 54EDC9) in Nov 10 2019 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x320 (see 8055BB) in Nov 10 2019 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d0 (see 54F187) in Nov 10 2019 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d0 (see 8056CC) in Nov 10 2019 Beta - eqmule
...
// CItemDisplayWindow_size: 0x628 (see 7687F2) in Nov 10 2019 Beta - eqmule
...
// CLootWnd_size: 0x398 (see 54F4F6) in Nov 10 2019 Beta - eqmule
...
// CMapViewWnd_size: 0x648 (see 54EC2A) in Nov 10 2019 Beta - eqmule
...
// CMerchantWnd_size: 0x448 (see 54F652) in Nov 10 2019 Beta - eqmule
...
// CPetInfoWindow_size: 0x8c8 (see 54E681) in Nov 10 2019 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a8 (see 54E972) in Nov 10 2019 Beta - eqmule
...
// CTradeWnd__size: 0x2f0 (see 54F6F8) in Nov 10 2019 Beta - eqmule
...
// CFactionWnd__size: 0x278 (see 54F844) in Nov 10 2019 Beta - eqmule
