...
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ void	*IconTextureAnim; \
/*0x0020*/ UINT		TransitionStartTick; \
/*0x0024*/ RECT		TransitionRect; \
/*0x0034*/ void   *TitlePiece2; \
/*0x0038*/ UINT		BlinkFadeDuration; \
/*0x003C*/ bool		bMaximizable; \
/*0x003D*/ bool		bKeepOnScreen; \
/*0x003E*/ bool		bMarkedForDelete; \
/*0x003F*/ bool		bClipToParent; \
/*0x0040*/ DWORD	LastTimeMouseOver; \
/*0x0044*/ DWORD	XMLIndex; \
/*0x0048*/ struct _CSIDLWND* pWndFocusOther; \
/*0x004C*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0050*/ bool		bFullyScreenClipped; \
/*0x0054*/ int		RightOffset; \
/*0x0058*/ int		HScrollPos; \
/*0x005C*/ bool		Minimized; \
/*0x0060*/ UINT		BlinkFadeStartTime; \
...
/*0x0154*/ int		BlinkDuration; \
/*0x0158*/ tagSIZE	MaxClientSize; \
/*0x0160*/ bool		bHCenterTooltip; \
/*0x0161*/ BYTE     bResizableMask; \
...
/*0x0194*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x0198*/ int		BlinkState; \
/*0x019C*/ bool		bLeftAnchoredToLeft; \
/*0x01A0*/ UINT		FadeDuration; \
/*0x01A4*/ bool		bBorder; \
/*0x01A5*/ bool		bBringToTopWhenClicked; \
/*0x01A6*/ bool		bBorder2; \
/*0x01A8*/ void	    *pFont; \
/*0x01AC*/ UINT		TransitionDuration; \
/*0x01B0*/ bool		bClientClipRectChanged; \
/*0x01B4*/ RECT		IconRect; \
/*0x01C4*/ bool		bScreenClipRectChanged; \
/*0x01C5*/ bool		bAction; \
/*0x01C6*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x01C8*/ __int64		Data; \
/*0x01D0*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x01D1*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x01D4*/ UINT		BlinkFadeFreq; \
/*0x01D8*/ RECT		ClipRectScreen; \
/*0x01E8*/
...
// CBazaarSearchWnd_size: 0x92d0 (see 540AAD) in Dec  5 2018 Beta - eqmule
...
// CPlayerWindow_size: 0x2e8 (see 5403A0) in Dec  5 2018 Beta - eqmule
...
// CTargetWindow_size: 0x8c8 (see 54023B) in Dec  5 2018 Beta - eqmule
...
// CBuffWindow_size: 0x718 (see 5400DF) in Dec  5 2018 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x320 (see 7F050B) in Dec  5 2018 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d0 (see 540499) in Dec  5 2018 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d0 (see 7F061C) in Dec  5 2018 Beta - eqmule
...
// CItemDisplayWindow_size: 0x628 (see 750642) in Dec  5 2018 Beta - eqmule
...
// CLootWnd_size: 0x398 (see 540805) in Dec  5 2018 Beta - eqmule
...
// CMapViewWnd_size: 0x648 (see 53FF40) in Dec  5 2018 Beta - eqmule
...
// CMerchantWnd_size: 0x448 (see 540961) in Dec  5 2018 Beta - eqmule
...
// CPetInfoWindow_size: 0x8c8 (see 53F97A) in Dec  5 2018 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a8 (see 53FC6B) in Dec  5 2018 Beta - eqmule
...
// CTradeWnd__size: 0x2f0 (see 540A07) in Dec  5 2018 Beta - eqmule
...
// CFactionWnd__size: 0x278 (see 540B53) in Dec  5 2018 Beta - eqmule
