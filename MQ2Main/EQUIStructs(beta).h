...
/*0x0058*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x005C*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x0060*/ BYTE		FadeAlpha; \
/*0x0068*/ __int64		Data; \
...
/*0x0089*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x008C*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x0090*/ bool		bMaximized; \
/*0x0091*/ bool		bScreenClipRectChanged; \
/*0x0092*/ bool		bFullyScreenClipped; \
/*0x0094*/ void	    *pFont; \
/*0x0098*/ int		BottomOffset; \
/*0x009C*/ int		DeleteCount; \
/*0x00A0*/ bool		bTiled; \
/*0x00A4*/ int		HScrollMax; \
/*0x00A8*/ DWORD  BackgroundDrawType; \
/*0x00AC*/ tagSIZE	MaxClientSize; \
/*0x00B4*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x00B8*/ int		TopOffset; \
/*0x00BC*/ bool		bBorder; \
/*0x00C0*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x00C4*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x00C5*/ bool		dShow; \
/*0x00C6*/ bool		Minimized; \
/*0x00C7*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x00C8*/ RECT		OldLocation; \
/*0x00D8*/ UINT		TransitionStartTick; \
/*0x00DC*/ bool		bCaptureTitle; \
/*0x00DD*/ bool		bLeftAnchoredToLeft; \
...
/*0x00EC*/ RECT		ClipRectScreen; \
/*0x00FC*/ bool		bClientClipRectChanged; \
/*0x0100*/ tagSIZE	MinClientSize; \
/*0x0108*/ int		LeftOffset; \
/*0x010C*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0110*/ struct _CXSTR*	DataStr; \
/*0x0114*/ LONG		BlinkStartTimer; \
/*0x0118*/ RECT		TransitionRect; \
/*0x0128*/ bool		bBorder2; \
/*0x0129*/ bool		bBottomAnchoredToTop; \
/*0x012C*/ RECT		Location; \
/*0x013C*/ int		managerArrayIndex; \
/*0x0140*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x0144*/ UINT		LastBlinkFadeRefreshTime; \
/*0x0148*/ RECT		ClientRect; \
/*0x0158*/ bool		bRightAnchoredToLeft; \
/*0x0159*/ bool		bClipToParent; \
...
/*0x016C*/ int		BlinkState; \
/*0x0170*/ bool		bEscapableLocked; \
/*0x0171*/ BYTE		StartAlpha; \
/*0x0174*/ DWORD	FadeDelay; \
/*0x0178*/ void	*DrawTemplate; \
/*0x017C*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x017D*/ bool		Enabled; \
...
/*0x01DC*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x01DD*/ bool		bMaximizable; \
/*0x01DE*/ bool		bBringToTopWhenClicked; \
/*0x01DF*/ bool		bKeepOnScreen; \
/*0x01E0*/ UINT		BlinkFadeFreq; \
/*0x01E4*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x01E8*/ UINT		FadeDuration; \
/*0x01EC*/ bool		bClientRectChanged; \
/*0x01ED*/ bool		bUseInLayoutVertical; \
...
// CBazaarSearchWnd_size: 0x92d8 (see 53C40D) in Nov 19 2018 Beta - eqmule
...
// CPlayerWindow_size: 0x2f0 (see 53BD00) in Nov 19 2018 Beta - eqmule
...
// CTargetWindow_size: 0x8d0 (see 53BB9B) in Nov 19 2018 Beta - eqmule
...
// CBuffWindow_size: 0x720 (see 53BA3F) in Nov 19 2018 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x328 (see 7EB91B) in Nov 19 2018 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d8 (see 53BDF9) in Nov 19 2018 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d8 (see 7EBA2C) in Nov 19 2018 Beta - eqmule
...
// CItemDisplayWindow_size: 0x630 (see 74BD02) in Nov 19 2018 Beta - eqmule
...
// CLootWnd_size: 0x3a0 (see 53C165) in Nov 19 2018 Beta - eqmule
...
// CMapViewWnd_size: 0x658 (see 53B8A0) in Nov 19 2018 Beta - eqmule
...
// CMerchantWnd_size: 0x450 (see 53C2C1) in Nov 19 2018 Beta - eqmule
...
// CPetInfoWindow_size: 0x8d0 (see 53B2DA) in Nov 19 2018 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3b0 (see 53B5CB) in Nov 19 2018 Beta - eqmule
...
// CTradeWnd__size: 0x2f8 (see 53C367) in Nov 19 2018 Beta - eqmule
