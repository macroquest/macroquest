...
/*0x002C*/ bool		bAction; \
/*0x002D*/ bool		Minimized; \
/*0x002E*/ BYTE     bResizableMask; \
/*0x0030*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
...
/*0x0059*/ bool		bCaptureTitle; \
/*0x005C*/ int		HScrollPos; \
/*0x0060*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0064*/ tagSIZE	MaxClientSize; \
/*0x006C*/ bool		bClipToParent; \
...
/*0x00E4*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
...
/*0x0100*/ BYTE		StartAlpha; \
/*0x0101*/ bool		bRightAnchoredToLeft; \
/*0x0104*/ struct _CSIDLWND* pWndFocusOther; \
/*0x0108*/ DWORD  BackgroundDrawType; \
/*0x010C*/ int		BlinkState; \
/*0x0110*/ struct _CXSTR*	DataStr; \
/*0x0114*/ bool		bFullyScreenClipped; \
/*0x0118*/ LONG		BlinkStartTimer; \
/*0x011C*/ int		RightOffset; \
/*0x0120*/ BYTE		TargetAlpha; \
/*0x0121*/ bool		Fades; \
/*0x0124*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x1c */ \
/*0x0140*/ bool		bScreenClipRectChanged; \
/*0x0141*/ bool		bActive; \
/*0x0144*/ int		BlinkDuration; \
/*0x0148*/ void	    *pFont; \
/*0x014C*/ void   *TitlePiece; \
/*0x0150*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x0154*/ int		VScrollPos; \
/*0x0158*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x015C*/ UINT		BlinkFadeFreq; \
/*0x0160*/ __int64		Data; \
...
/*0x017C*/ bool		bClientClipRectChanged; \
/*0x0180*/ int		HScrollMax; \
/*0x0184*/ bool		bTiled; \
/*0x0185*/ bool		dShow; \
/*0x0188*/ void* pTipTextObject; \
/*0x018C*/ UINT		FadeDuration; \
/*0x0190*/ RECT		IconRect; \
/*0x01A0*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x01A4*/ void *pController; \
/*0x01A8*/ int		LeftOffset; \
/*0x01AC*/ bool		bMaximized; \
/*0x01B0*/ int	Transition; \
/*0x01B4*/ int		TopOffset; \
/*0x01B8*/ BYTE		Alpha; \
/*0x01B9*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x01BC*/ void		*pLayoutStrategy; \
/*0x01C0*/ bool		Faded; \
/*0x01C4*/ RECT		TransitionRect; \
/*0x01D4*/ RECT		ClientRect; \
...
// CBazaarSearchWnd_size: 0x92d0 (see 4CD00A) in Nov 10 2017 Beta - eqmule
...
// CPlayerWindow_size: 0x2e8 (see 4CC84D) in Nov 10 2017 Beta - eqmule
...
// CTargetWindow_size: 0x8c8 (see 4CC6E4) in Nov 10 2017 Beta - eqmule
...
// CBuffWindow_size: 0x718 (see 4CC578) in Nov 10 2017 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x318 (see 7A3548) in Nov 10 2017 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d0 (see 4CC95E) in Nov 10 2017 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d0 (see 7A3659) in Nov 10 2017 Beta - eqmule
...
// CItemDisplayWindow_size: 0x610 (see 6ED66F) in Nov 10 2017 Beta - eqmule
...
// CLootWnd_size: 0x398 (see 4CCD20) in Nov 10 2017 Beta - eqmule
...
// CMapViewWnd_size: 0x648 (see 4CC3D9) in Nov 10 2017 Beta - eqmule
...
// CMerchantWnd_size: 0x438 (see 4CCE9E) in Nov 10 2017 Beta - eqmule
...
// CPetInfoWindow_size: 0x8c8 (see 4CBE10) in Nov 10 2017 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a8 (see 4CC103) in Nov 10 2017 Beta - eqmule
...
// CTradeWnd__size: 0x2f0 (see 4CCF54) in Nov 10 2017 Beta - eqmule
