...
// actual size 0x1E8 in Nov  9 2018 Beta (see 0x927A1D) - eqmule
// actual size 0x1F8 in Nov 10 2018 Beta (see 0x927C0D) - eqmule
#define CXW_NO_VTABLE \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ bool		bMaximizable; \
/*0x0020*/ void *pController; \
/*0x0024*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x0025*/ bool		bBottomAnchoredToTop; \
/*0x0028*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x002C*/ BYTE		FadeAlpha; \
/*0x0030*/ __int64		Data; \
/*0x0038*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x003C*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x0040*/ bool		bMarkedForDelete; \
/*0x0044*/ void   *TitlePiece2; \
/*0x0048*/ bool		dShow; \
/*0x0049*/ bool		bTiled; \
/*0x004A*/ bool		Faded; \
/*0x004C*/ int		BlinkState; \
/*0x0050*/ tagSIZE	MinClientSize; \
/*0x0058*/ int		RightOffset; \
/*0x005C*/ BYTE		TargetAlpha; \
/*0x0060*/ RECT		ClipRectScreen; \
/*0x0070*/ struct _CSIDLWND* pWndFocusOther; \
/*0x0074*/ DWORD	XMLIndex; \
/*0x0078*/ COLORREF DisabledBackground; \
/*0x007C*/ BYTE		Alpha; \
/*0x007D*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0080*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x1c */ \
/*0x009C*/ int		BlinkDuration; \
/*0x00A0*/ void	*DrawTemplate; \
/*0x00A4*/ void	    *pFont; \
/*0x00A8*/ bool		bEscapableLocked; \
/*0x00A9*/ bool		bBorder2; \
/*0x00AC*/ int		LeftOffset; \
/*0x00B0*/ bool		bClientClipRectChanged; \
/*0x00B4*/ UINT		BlinkFadeDuration; \
/*0x00B8*/ RECT		TransitionRect; \
/*0x00C8*/ bool		bLeftAnchoredToLeft; \
/*0x00CC*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x00D0*/ int		HScrollMax; \
/*0x00D4*/ bool		bUseInLayoutHorizontal; \
/*0x00D5*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x00D8*/ int		TopOffset; \
/*0x00DC*/ DWORD	LastTimeMouseOver; \
/*0x00E0*/ void		*pLayoutStrategy; \
/*0x00E4*/ bool		bClientRectChanged; \
/*0x00E5*/ bool		bIsTransitioning; \
/*0x00E8*/ DWORD  BackgroundDrawType; \
/*0x00EC*/ bool		bRightAnchoredToLeft; \
/*0x00ED*/ bool		bHCenterTooltip; \
/*0x00F0*/ struct _CXSTR*	DataStr; \
/*0x00F4*/ UINT		TransitionDuration; \
/*0x00F8*/ BYTE		StartAlpha; \
/*0x00F9*/ bool		bAction; \
/*0x00FC*/ void* pTipTextObject; \
/*0x0100*/ bool		bMaximized; \
/*0x0104*/ int		DeleteCount; \
/*0x0108*/ RECT		Location; \
/*0x0118*/ UINT		TransitionStartTick; \
/*0x011C*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x0120*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x0121*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0122*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0123*/ bool		Fades; \
/*0x0124*/ int		HScrollPos; \
/*0x0128*/ bool		bIsParentOrContextMenuWindow; \
...
/*0x0144*/ int		VScrollPos; \
/*0x0148*/ bool		Enabled; \
/*0x014C*/ LONG		BlinkStartTimer; \
/*0x0150*/ bool		bBorder; \
/*0x0154*/ void   *TitlePiece; \
/*0x0158*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
/*0x015C*/ bool		bFullyScreenClipped; \
/*0x0160*/ void*	pTextObject; \
/*0x0164*/ bool		bUseInLayoutVertical; \
/*0x0165*/ bool		bTopAnchoredToTop; \
/*0x0166*/ bool		bClipToParent; \
/*0x0168*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x016C*/ bool		bScreenClipRectChanged; \
/*0x0170*/ RECT		ClipRectClient; \
/*0x0180*/ bool		Minimized; \
/*0x0184*/ UINT		BlinkFadeStartTime; \
/*0x0188*/ int		VScrollMax; \
...
/*0x0195*/ bool		bCaptureTitle; \
/*0x0196*/ bool		bKeepOnScreen; \
/*0x0198*/ int		managerArrayIndex; \
/*0x019C*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x01A0*/ RECT		ClientRect; \
/*0x01B0*/ bool		bActive; \
/*0x01B4*/ int		BottomOffset; \
/*0x01B8*/ int	Transition; \
/*0x01BC*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x01BD*/ BYTE     bResizableMask; \
/*0x01C0*/ RECT		IconRect; \
/*0x01D0*/ DWORD	FadeDelay; \
/*0x01D4*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x01D8*/ RECT		OldLocation; \
/*0x01E8*/ tagSIZE	MaxClientSize; \
/*0x01F0*/ UINT		BlinkFadeFreq; \
...
// CBazaarSearchWnd_size: 0x92e0 (see 5396ED) in Nov 10 2018 Beta - eqmule
...
// CPlayerWindow_size: 0x2f8 (see 538FE0) in Nov 10 2018 Beta - eqmule
...
// CTargetWindow_size: 0x8d8 (see 538E7B) in Nov 10 2018 Beta - eqmule
...
// CBuffWindow_size: 0x728 (see 538D1F) in Nov 10 2018 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x330 (see 7E97CB) in Nov 10 2018 Beta - eqmule
...
// CCastSpellWnd_size: 0x2e0 (see 5390D9) in Nov 10 2018 Beta - eqmule
...
// CInvSlotWnd_size: 0x2e0 (see 7E98DC) in Nov 10 2018 Beta - eqmule
...
// CItemDisplayWindow_size: 0x638 (see 749BA2) in Nov 10 2018 Beta - eqmule
...
// CLootWnd_size: 0x3a8 (see 539445) in Nov 10 2018 Beta - eqmule
...
// CMapViewWnd_size: 0x668 (see 538B80) in Nov 10 2018 Beta - eqmule
...
// CMerchantWnd_size: 0x458 (see 5395A1) in Nov 10 2018 Beta - eqmule
...
// CPetInfoWindow_size: 0x8d8 (see 5385BA) in Nov 10 2018 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3b8 (see 5388AB) in Nov 10 2018 Beta - eqmule
...
// CTradeWnd__size: 0x300 (see 539647) in Nov 10 2018 Beta - eqmule
