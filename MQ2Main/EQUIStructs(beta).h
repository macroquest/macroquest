...
// actual size 0x1E8 in Dec  1 2017 Beta (see 0x8D3ADD) - eqmule
...
/*0x0020*/ UINT		BlinkFadeStartTime; \
/*0x0024*/ struct _CSIDLWND* pWndFocusOther; \
/*0x0028*/ bool		bUseInLayoutHorizontal; \
/*0x002C*/ tagSIZE	MinClientSize; \
/*0x0034*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0038*/ int		LeftOffset; \
/*0x003C*/ RECT		OldLocation; \
/*0x004C*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x004D*/ bool		bLeftAnchoredToLeft; \
/*0x0050*/ void	    *pFont; \
/*0x0054*/ int		HScrollMax; \
/*0x0058*/ BYTE     bResizableMask; \
/*0x0059*/ bool		bRightAnchoredToLeft; \
/*0x005A*/ bool		bFullyScreenClipped; \
/*0x005B*/ bool		Fades; \
/*0x005C*/ BYTE		Alpha; \
/*0x005D*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0060*/ int		ParentAndContextMenuArrayIndex; \
/*0x0064*/ bool		bBringToTopWhenClicked; \
...
/*0x0078*/ UINT		BlinkFadeDuration; \
/*0x007C*/ bool		bAction; \
/*0x007D*/ bool		bTopAnchoredToTop; \
/*0x0080*/ void		*pLayoutStrategy; \
/*0x0084*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x0088*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x1c */ \
/*0x00A4*/ bool		bIsTransitioning; \
...
/*0x00C0*/ __int64		Data; \
/*0x00C8*/ struct _CXSTR*	DataStr; \
/*0x00CC*/ bool		bIsParentOrContextMenuWindow; \
/*0x00D0*/ int		managerArrayIndex; \
/*0x00D4*/ RECT		Location; \
/*0x00E4*/ bool		bKeepOnScreen; \
...
/*0x0104*/ RECT		ClipRectClient; \
/*0x0114*/ bool		bClientRectChanged; \
/*0x0115*/ bool		bEscapableLocked; \
/*0x0116*/ bool		bUseInLayoutVertical; \
/*0x0118*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
...
/*0x0140*/ int		DeleteCount; \
/*0x0144*/ COLORREF DisabledBackground; \
/*0x0148*/ tagSIZE	MaxClientSize; \
/*0x0150*/ void   *TitlePiece2; \
/*0x0154*/ int		TopOffset; \
/*0x0158*/ BYTE		TargetAlpha; \
/*0x0159*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x015C*/ int		VScrollMax; \
...
/*0x0174*/ bool		bTiled; \
/*0x0178*/ void   *TitlePiece; \
/*0x017C*/ BYTE		StartAlpha; \
/*0x0180*/ DWORD	FadeDelay; \
/*0x0184*/ bool		bMaximizable; \
/*0x0185*/ bool		Enabled; \
/*0x0188*/ UINT		FadeDuration; \
/*0x018C*/ void* pTipTextObject; \
/*0x0190*/ int	Transition; \
/*0x0194*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x0195*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x0196*/ bool		bClipToParent; \
/*0x0197*/ bool		bMaximized; \
/*0x0198*/ int		BlinkDuration; \
/*0x019C*/ BYTE		FadeAlpha; \
/*0x01A0*/ DWORD	LastTimeMouseOver; \
/*0x01A4*/ DWORD  BackgroundDrawType; \
/*0x01A8*/ void*	pTextObject; \
...
/*0x01CC*/ bool		bClientClipRectChanged; \
/*0x01D0*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x01D4*/ bool		bScreenClipRectChanged; \
/*0x01D5*/ bool		bMarkedForDelete; \
/*0x01D6*/ bool		bBottomAnchoredToTop; \
/*0x01D8*/ RECT		IconRect; \
/*0x01E8*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
...
// CBazaarSearchWnd_size: 0x92d8 (see 4CCBBA) in Dec  3 2017 Beta - eqmule
...
// CPlayerWindow_size: 0x2f0 (see 4CC3FD) in Dec  3 2017 Beta - eqmule
...
// CTargetWindow_size: 0x8d0 (see 4CC294) in Dec  3 2017 Beta - eqmule
...
// CBuffWindow_size: 0x720 (see 4CC128) in Dec  3 2017 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x320 (see 7A3F28) in Dec  3 2017 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d8 (see 4CC50E) in Dec  3 2017 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d8 (see 7A4039) in Dec  3 2017 Beta - eqmule
...
// CItemDisplayWindow_size: 0x618 (see 6EE68F) in Dec  3 2017 Beta - eqmule
...
// CLootWnd_size: 0x3a0 (see 4CC8D0) in Dec  3 2017 Beta - eqmule
...
// CMapViewWnd_size: 0x658 (see 4CBF89) in Dec  3 2017 Beta - eqmule
...
// CMerchantWnd_size: 0x450 (see 4CCA4E) in Dec  3 2017 Beta - eqmule
...
// CPetInfoWindow_size: 0x8d0 (see 4CB9C0) in Dec  3 2017 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3b0 (see 4CBCB3) in Dec  3 2017 Beta - eqmule
...
// CTradeWnd__size: 0x2f8 (see 4CCB04) in Dec  3 2017 Beta - eqmule
