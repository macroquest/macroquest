...
// actual size 0x1F0 in Oct 21 2020 Beta (see 0x93D16D) - eqmule
...
/*0x002C*/ int		RightOffset; \
/*0x0030*/ bool		dShow; \
/*0x0031*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x0034*/ int		LeftOffset; \
/*0x0038*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0039*/ bool		bRightAnchoredToLeft; \
/*0x003A*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x003B*/ BYTE		FadeAlpha; \
/*0x003C*/ bool		bMaximizable; \
/*0x0040*/ UINT		TransitionDuration; \
/*0x0044*/ BYTE		StartAlpha; \
/*0x0045*/ bool		bUseInLayoutVertical; \
...
/*0x0047*/ bool		bScreenClipRectChanged; \
/*0x0048*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x0049*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x004A*/ bool		bIsTransitioning; \
/*0x004B*/ bool		bBorder; \
...
/*0x0050*/ bool		bActive; \
/*0x0054*/ void	    *pFont; \
/*0x0058*/ void	*IconTextureAnim; \
/*0x005C*/ BYTE     bResizableMask; \
/*0x0060*/ void   *TitlePiece; \
/*0x0064*/ bool		bLeftAnchoredToLeft; \
/*0x0065*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
...
/*0x007C*/ int	Transition; \
/*0x0080*/ bool		bHCenterTooltip; \
...
/*0x00B4*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x00B5*/ bool		bIsParentOrContextMenuWindow; \
/*0x00B8*/ void*	pTextObject; \
/*0x00BC*/ UINT		BlinkFadeFreq; \
/*0x00C0*/ RECT		ClientRect; \
/*0x00D0*/ DWORD	LastTimeMouseOver; \
/*0x00D4*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x00D8*/ bool		bCaptureTitle; \
...
/*0x00F4*/ int		BlinkDuration; \
/*0x00F8*/ bool		bTopAnchoredToTop; \
/*0x00F9*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x00FA*/ bool		bClientClipRectChanged; \
...
/*0x015C*/ struct _CSIDLWND* pWndFocusOther; \
...
/*0x0192*/ bool		bBottomAnchoredToTop; \
/*0x0194*/ DWORD	XMLIndex; \
/*0x0198*/ bool		bBorder2; \
/*0x0199*/ bool		bMarkedForDelete; \
/*0x019A*/ bool		Faded; \
/*0x019B*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x019C*/ void   *TitlePiece2; \
/*0x01A0*/ DWORD	FadeDelay; \
/*0x01A4*/ int		BlinkState; \
/*0x01A8*/ RECT		IconRect; \
/*0x01B8*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x01D0*/ UINT		LastBlinkFadeRefreshTime; \
/*0x01D4*/ BYTE		Alpha; \
/*0x01D8*/ int		HScrollPos; \
/*0x01DC*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x01E0*/ \
public: \
			bool IsVisible() \
			{ \
...
// CBazaarSearchWnd_size: 0x92c8 (see 55A96E) in Oct 24 2020 Beta - eqmule
...
// CPlayerWindow_size: 0x2e0 (see 55A25E) in Oct 24 2020 Beta - eqmule
...
// CTargetWindow_size: 0x8c0 (see 55A0F5) in Oct 24 2020 Beta - eqmule
...
// CBuffWindow_size: 0x710 (see 559F99) in Oct 24 2020 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x318 (see 7FB7CB) in Oct 24 2020 Beta - eqmule
...
// CCastSpellWnd_size: 0x2c8 (see 55A357) in Oct 24 2020 Beta - eqmule
...
// CInvSlotWnd_size: 0x2c8 (see 7FB8DC) in Oct 24 2020 Beta - eqmule
...
// CItemDisplayWindow_size: 0x620 (see 75E4F2) in Oct 24 2020 Beta - eqmule
...
// CLootWnd_size: 0x390 (see 55A6C6) in Oct 24 2020 Beta - eqmule
...
// CMapViewWnd_size: 0x638 (see 559DFA) in Oct 24 2020 Beta - eqmule
...
// CMerchantWnd_size: 0x440 (see 55A822) in Oct 24 2020 Beta - eqmule
...
// CPetInfoWindow_size: 0x8c0 (see 559851) in Oct 24 2020 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x398 (see 559B42) in Oct 24 2020 Beta - eqmule
...
// CTradeWnd__size: 0x2e8 (see 55A8C8) in Oct 24 2020 Beta - eqmule
...
// CFactionWnd__size: 0x270 (see 55AA14) in Oct 24 2020 Beta - eqmule
