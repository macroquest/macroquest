...
// actual size 0x1F0 in Oct 25 2020 Beta (see 0x93E4ED) - eqmule
...
/*0x0021*/ bool		bCaptureTitle; \
/*0x0024*/ UINT		FadeDuration; \
...
/*0x0050*/ BYTE		StartAlpha; \
/*0x0051*/ bool		bMarkedForDelete; \
/*0x0054*/ void	    *pFont; \
/*0x0058*/ UINT		BlinkFadeFreq; \
/*0x005C*/ int		LeftOffset; \
/*0x0060*/ bool		bAction; \
/*0x0061*/ bool		bMaximized; \
/*0x0064*/ RECT		ClipRectClient; \
/*0x0074*/ LONG		BlinkStartTimer; \
...
/*0x0086*/ bool		bUseInLayoutVertical; \
/*0x0088*/ int	Transition; \
/*0x008C*/ bool		bBottomAnchoredToTop; \
/*0x0090*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x00A8*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x00AC*/ struct _CXSTR*	DataStr; \
/*0x00B0*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x00B1*/ bool		bEscapableLocked; \
/*0x00B4*/ int		HScrollPos; \
/*0x00B8*/ bool		Minimized; \
/*0x00B9*/ bool bClickThroughMenuItemStatus; /* on/off */ \
...
/*0x0104*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
...
/*0x01B0*/ void* pTipTextObject; \
/*0x01B4*/ RECT		ClipRectScreen; \
/*0x01C4*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
/*0x01C8*/ DWORD  BackgroundDrawType; \
/*0x01CC*/ bool		bIsParentOrContextMenuWindow; \
/*0x01D0*/ DWORD	XMLIndex; \
/*0x01D4*/ bool		bLeftAnchoredToLeft; \
/*0x01D5*/ bool		bClientClipRectChanged; \
/*0x01D6*/ bool		bIsTransitioning; \
...
/*0x01EA*/ bool		ValidCXWnd; /* IsValid has this one */ \
...
// CBazaarSearchWnd_size: 0x92d8 (see 55AE2E) in Oct 25 2020 Beta - eqmule
...
//aAPwcsincombat
// CPlayerWindow_size: 0x2f0 (see 55A71E) in Oct 25 2020 Beta - eqmule
...
// CTargetWindow_size: 0x8d0 (see 55A5B5) in Oct 25 2020 Beta - eqmule
...
// CBuffWindow_size: 0x720 (see 55A459) in Oct 25 2020 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x328 (see 7FBCAB) in Oct 25 2020 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d8 (see 55A817) in Oct 25 2020 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d8 (see 7FBDBC) in Oct 25 2020 Beta - eqmule
...
// CItemDisplayWindow_size: 0x630 (see 75EB82) in Oct 25 2020 Beta - eqmule
...
// CLootWnd_size: 0x3a0 (see 55AB86) in Oct 25 2020 Beta - eqmule
...
// CMapViewWnd_size: 0x658 (see 55A2BA) in Oct 25 2020 Beta - eqmule
...
// CMerchantWnd_size: 0x450 (see 55ACE2) in Oct 25 2020 Beta - eqmule
...
// CPetInfoWindow_size: 0x8d0 (see 559D11) in Oct 25 2020 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a8 (see 55A002) in Oct 25 2020 Beta - eqmule
...
// CTradeWnd__size: 0x2f8 (see 55AD88) in Oct 25 2020 Beta - eqmule
...
// CFactionWnd__size: 0x280 (see 55AED4) in Oct 25 2020 Beta - eqmule
