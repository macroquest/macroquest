...
// actual size 0x1E0 in Oct 25 2019 Beta (see 0x94861D) - eqmule
// actual size 0x1F8 in Oct 26 2019 Beta (see 0x948C4D) - eqmule
#define CXW_NO_VTABLE \
private: \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ DWORD  BackgroundDrawType; \
/*0x0020*/ bool		dShow; \
/*0x0024*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0028*/ void   *TitlePiece; \
/*0x002C*/ UINT		TransitionDuration; \
/*0x0030*/ bool		bBottomAnchoredToTop; \
/*0x0031*/ bool		bClientClipRectChanged; \
/*0x0032*/ bool		bScreenClipRectChanged; \
/*0x0033*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x0034*/ bool		bFullyScreenClipped; \
/*0x0035*/ bool		bKeepOnScreen; \
/*0x0038*/ UINT		BlinkFadeDuration; \
/*0x003C*/ int	Transition; \
/*0x0040*/ void* pTipTextObject; \
/*0x0044*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0048*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x004C*/ bool		bClientRectChanged; \
/*0x004D*/ bool		bEscapableLocked; \
/*0x004E*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0050*/ int		DeleteCount; \
/*0x0054*/ BYTE		TargetAlpha; \
/*0x0055*/ bool		bIsParentOrContextMenuWindow; \
/*0x0056*/ BYTE     bResizableMask; \
/*0x0058*/ int		LeftOffset; \
/*0x005C*/ bool		Enabled; \
/*0x0060*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x0064*/ bool		bMarkedForDelete; \
/*0x0065*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x0068*/ void	*DrawTemplate; \
/*0x006C*/ bool		bActive; \
/*0x006D*/ bool		Fades; \
/*0x0070*/ RECT		ClipRectScreen; \
/*0x0080*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
...
/*0x0098*/ int		managerArrayIndex; \
/*0x009C*/ RECT		IconRect; \
/*0x00AC*/ DWORD	FadeDelay; \
/*0x00B0*/ __int64		Data; \
/*0x00B8*/ BYTE		FadeAlpha; \
/*0x00BC*/ UINT		BlinkFadeStartTime; \
/*0x00C0*/ UINT		FadeDuration; \
/*0x00C4*/ void	    *pFont; \
...
/*0x00E4*/ UINT		BlinkFadeFreq; \
/*0x00E8*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x00E9*/ bool		bClipToParent; \
...
/*0x00F1*/ bool		bIsTransitioning; \
/*0x00F4*/ void*	pTextObject; \
/*0x00F8*/ bool		bBorder2; \
/*0x00FC*/ int		TopOffset; \
/*0x0100*/ COLORREF DisabledBackground; \
/*0x0104*/ int		HScrollMax; \
/*0x0108*/ bool		bBorder; \
/*0x0109*/ bool		Minimized; \
/*0x010C*/ UINT		TransitionStartTick; \
/*0x0110*/ bool		bUseInLayoutVertical; \
/*0x0111*/ bool		bHCenterTooltip; \
/*0x0114*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x012C*/ bool		bMaximized; \
/*0x012D*/ bool		bRightAnchoredToLeft; \
/*0x0130*/ int		ParentAndContextMenuArrayIndex; \
/*0x0134*/ void *pController; \
/*0x0138*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x013C*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0140*/ DWORD	LastTimeMouseOver; \
/*0x0144*/ RECT		ClientRect; \
/*0x0154*/ bool		bCaptureTitle; \
/*0x0158*/ int		VScrollMax; \
/*0x015C*/ int		BlinkDuration; \
/*0x0160*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x0161*/ bool		bTopAnchoredToTop; \
/*0x0164*/ int		VScrollPos; \
/*0x0168*/ struct _CSIDLWND* pWndFocusOther; \
/*0x016C*/ void   *TitlePiece2; \
/*0x0170*/ UINT		LastBlinkFadeRefreshTime; \
/*0x0174*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x0178*/ tagSIZE	MinClientSize; \
...
/*0x0190*/ RECT		OldLocation; \
/*0x01A0*/ bool		bBringToTopWhenClicked; \
/*0x01A4*/ int		BottomOffset; \
/*0x01A8*/ bool		Faded; \
/*0x01AC*/ RECT		TransitionRect; \
...
/*0x01D0*/ bool		bAction; \
/*0x01D4*/ void		*pLayoutStrategy; \
/*0x01D8*/ bool		bTiled; \
/*0x01DC*/ DWORD	XMLIndex; \
/*0x01E0*/ bool		bUseInLayoutHorizontal; \
/*0x01E4*/ LONG		BlinkStartTimer; \
/*0x01E8*/ void	*IconTextureAnim; \
/*0x01EC*/ BYTE		Alpha; \
...
// CBazaarSearchWnd_size: 0x92e0 (see 54CEAE) in Oct 26 2019 Beta - eqmule
...
// CPlayerWindow_size: 0x2f8 (see 54C79E) in Oct 26 2019 Beta - eqmule
...
// CTargetWindow_size: 0x8d8 (see 54C635) in Oct 26 2019 Beta - eqmule
...
// CBuffWindow_size: 0x728 (see 54C4D9) in Oct 26 2019 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x330 (see 7FFE6B) in Oct 26 2019 Beta - eqmule
...
// CCastSpellWnd_size: 0x2e0 (see 54C897) in Oct 26 2019 Beta - eqmule
...
// CInvSlotWnd_size: 0x2e0 (see 7FFF7C) in Oct 26 2019 Beta - eqmule
...
// CItemDisplayWindow_size: 0x638 (see 763472) in Oct 26 2019 Beta - eqmule
...
// CLootWnd_size: 0x3a8 (see 54CC06) in Oct 26 2019 Beta - eqmule
...
// CMapViewWnd_size: 0x668 (see 54C33A) in Oct 26 2019 Beta - eqmule
...
// CMerchantWnd_size: 0x458 (see 54CD62) in Oct 26 2019 Beta - eqmule
...
// CPetInfoWindow_size: 0x8d8 (see 54BD91) in Oct 26 2019 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3b8 (see 54C082) in Oct 26 2019 Beta - eqmule
...
// CTradeWnd__size: 0x300 (see 54CE08) in Oct 26 2019 Beta - eqmule
...
// CFactionWnd__size: 0x288 (see 54CF54) in Oct 26 2019 Beta - eqmule
