...
// actual size 0x1E8 in Nov 18 2017 Beta (see 0x8D45ED) - eqmule
// actual size 0x1E0 in Nov 19 2017 Beta (see 0x8D4CED) - eqmule
// actual size 0x1F0 in Nov 21 2017 Beta (see 0x8D4A5D) - eqmule
// actual size 0x1D8 in Nov 22 2017 Beta (see 0x8D475D) - eqmule
#define CXW_NO_VTABLE \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ int		ParentAndContextMenuArrayIndex; \
/*0x0020*/ bool		Faded; \
/*0x0024*/ void		*pLayoutStrategy; \
/*0x0028*/ bool		bMarkedForDelete; \
/*0x0029*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x002A*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x002C*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x1c */ \
/*0x0048*/ RECT		OldLocation; \
/*0x0058*/ bool		bCaptureTitle; \
/*0x005C*/ tagSIZE	MinClientSize; \
/*0x0064*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0068*/ DWORD	LastTimeMouseOver; \
/*0x006C*/ UINT		BlinkFadeDuration; \
/*0x0070*/ void	*IconTextureAnim; \
/*0x0074*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x0078*/ void *pController; \
/*0x007C*/ int		HScrollMax; \
/*0x0080*/ bool		bClipToParent; \
/*0x0084*/ RECT		ClipRectClient; \
/*0x0094*/ void   *TitlePiece; \
/*0x0098*/ void	    *pFont; \
/*0x00A0*/ __int64		Data; \
/*0x00A8*/ int	Transition; \
/*0x00AC*/ void* pTipTextObject; \
...
/*0x00B4*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x00B8*/ UINT		BlinkFadeStartTime; \
/*0x00BC*/ UINT		BlinkFadeFreq; \
/*0x00C0*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x00C4*/ bool		dShow; \
/*0x00C5*/ bool		bBottomAnchoredToTop; \
/*0x00C8*/ int		VScrollPos; \
/*0x00CC*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x00D0*/ RECT		ClientRect; \
/*0x00E0*/ int		TopOffset; \
/*0x00E4*/ void*	pTextObject; \
/*0x00E8*/ RECT		TransitionRect; \
/*0x00F8*/ int		VScrollMax; \
/*0x00FC*/ int		managerArrayIndex; \
/*0x0100*/ LONG		BlinkStartTimer; \
/*0x0104*/ int		BottomOffset; \
/*0x0108*/ BYTE		Alpha; \
/*0x010C*/ UINT		TransitionStartTick; \
/*0x0110*/ UINT		LastBlinkFadeRefreshTime; \
/*0x0114*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x0115*/ bool		Enabled; \
/*0x0116*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0118*/ int		BlinkState; \
/*0x011C*/ struct _CXSTR*	DataStr; \
/*0x0120*/ bool		bAction; \
/*0x0124*/ COLORREF DisabledBackground; \
/*0x0128*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x0129*/ bool		bFullyScreenClipped; \
/*0x012A*/ bool		bTiled; \
/*0x012B*/ bool		bClientRectChanged; \
/*0x012C*/ BYTE		TargetAlpha; \
/*0x0130*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x0134*/ bool		bBringToTopWhenClicked; \
/*0x0138*/ RECT		Location; \
/*0x0148*/ bool		bIsTransitioning; \
/*0x0149*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x014A*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x014C*/ tagSIZE	MaxClientSize; \
/*0x0154*/ bool		bLeftAnchoredToLeft; \
/*0x0155*/ bool		bHCenterTooltip; \
/*0x0158*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x015C*/ bool		Minimized; \
/*0x015D*/ bool		Fades; \
/*0x015E*/ bool		bActive; \
/*0x015F*/ BYTE     bResizableMask; \
/*0x0160*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x0164*/ int		RightOffset; \
/*0x0168*/ UINT		FadeDuration; \
/*0x016C*/ bool		bIsParentOrContextMenuWindow; \
/*0x0170*/ void	*DrawTemplate; \
/*0x0174*/ bool		bUseInLayoutHorizontal; \
/*0x0175*/ bool		bTopAnchoredToTop; \
/*0x0176*/ bool		bClientClipRectChanged; \
/*0x0178*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x017C*/ DWORD  BackgroundDrawType; \
/*0x0180*/ bool		bKeepOnScreen; \
/*0x0181*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0184*/ DWORD	FadeDelay; \
/*0x0188*/ bool		bScreenClipRectChanged; \
/*0x0189*/ bool		bMaximized; \
/*0x018C*/ void   *TitlePiece2; \
/*0x0190*/ RECT		ClipRectScreen; \
/*0x01A0*/ bool		bUseInLayoutVertical; \
/*0x01A1*/ BYTE		FadeAlpha; \
/*0x01A2*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x01A3*/ bool		bEscapableLocked; \
/*0x01A4*/ RECT		IconRect; \
/*0x01B4*/ int		BlinkDuration; \
/*0x01B8*/ UINT		TransitionDuration; \
/*0x01BC*/ struct _CSIDLWND* pWndFocusOther; \
/*0x01C0*/ int		DeleteCount; \
/*0x01C4*/ int		LeftOffset; \
/*0x01C8*/ int		HScrollPos; \
/*0x01CC*/ DWORD	XMLIndex; \
/*0x01D0*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x01D4*/ bool		bMaximizable; \
/*0x01D5*/ bool		bRightAnchoredToLeft; \
/*0x01D6*/ BYTE		StartAlpha; \
/*0x01D7*/ BYTE Filler0x01D7[0x1];
/*0x01D8*/
...
//Size 0x220 in Nov 16 2017 Beta exe see 604A6D - eqmule
#define SIDL \
...
//Size 0x368 see 69B3DD in Oct 25 2017 Beta exe -eqmule
...
/*0x234*/ CHAR TellTarget[0x40];//for sure
/*0x274*/ int Language;
...
/*0x288*/ struct _CXSTR *CommandHistory[0x28]; // see 690DAA in apr 11 2017 test
/*0x328*/ int HistoryIndex;
/*0x32c*/ int HistoryLastShown;
/*0x330*/ int FontSize;//style but yeah...
...
//aSpelldisplaywi
// Actual size 0x270 Oct 25 2017 Beta see 7B63FF -eqmule
typedef struct _EQSPELLINFOWINDOW 
{ 
/*0x000*/ struct _CSIDLWND Wnd;
/*0x220*/ PVOID WindowID;
/*0x224*/ PVOID pDuration;
/*0x228*/ struct _CSIDLWND *DisplayWnd;
/*0x22c*/ PVOID pName; 
/*0x230*/ PVOID pIcon; 
...
//size 0x200 see 7ABF69 in Oct 25 2017 Beta -eqmule
...
//size 0x2f0 see 4CEC9B in Nov 22 2017 Beta -eqmule
...
//oct 25 2017 Beta see 7BC082 - eqmule
...
// CBazaarSearchWnd_size: 0x92c0 (see 4CCEFA) in Nov 22 2017 Beta - eqmule
...
// CPlayerWindow_size: 0x2d8 (see 4CC73D) in Nov 22 2017 Beta - eqmule
...
// CTargetWindow_size: 0x8b8 (see 4CC5D4) in Nov 22 2017 Beta - eqmule
...
// CBuffWindow_size: 0x708 (see 4CC468) in Nov 22 2017 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x308 (see 7A34D8) in Nov 22 2017 Beta - eqmule
...
// CCastSpellWnd_size: 0x2c0 (see 4CC84E) in Nov 22 2017 Beta - eqmule
...
// CInvSlotWnd_size: 0x2c0 (see 7A35E9) in Nov 22 2017 Beta - eqmule
...
// CItemDisplayWindow_size: 0x600 (see 6ED82F) in Nov 22 2017 Beta - eqmule
...
//CLootWnd__CLootWnd_x aLootwnd
// CLootWnd_size: 0x388 (see 4CCC10) in Nov 22 2017 Beta - eqmule
...
// CMapViewWnd_size: 0x628 (see 4CC2C9) in Nov 22 2017 Beta - eqmule
typedef struct _EQMAPWINDOW {
/*0x0000*/ struct _CSIDLWND     Wnd;
/*0x0220*/ BYTE         Unknown0x0220[0x40];
/*0x0260*/ CHAR         shortzonename[0x80];
/*0x02e0*/ BYTE         Unknown0x0280[0x3c];
...
// CMerchantWnd_size: 0x428 (see 4CCD8E) in Nov 22 2017 Beta - eqmule
...
/*0x0250*/ BYTE Unknown0x0250[0x1d8];
/*0x0428*/
} EQMERCHWINDOW, *PEQMERCHWINDOW;

//CPetInfoWindow__CPetInfoWindow aPetinfowindow
// CPetInfoWindow_size: 0x8b8 (see 4CBD00) in Nov 22 2017 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x398 (see 4CBFF3) in Nov 22 2017 Beta - eqmule
...
// CTradeWnd__size: 0x2e0 (see 4CCE44) in Nov 22 2017 Beta - eqmule
