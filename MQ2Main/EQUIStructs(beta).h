...
// actual size 0x1F0 in Nov 14 2020 Beta (see 0x93E55D) - eqmule
#define CXW_NO_VTABLE \
private: \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ UINT		BlinkFadeDuration; \
/*0x0020*/ BYTE		TargetAlpha; \
/*0x0021*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x0024*/ RECT		IconRect; \
/*0x0034*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
...
/*0x006C*/ bool		bCaptureTitle; \
/*0x0070*/ RECT		TransitionRect; \
/*0x0080*/ LONG		BlinkStartTimer; \
/*0x0084*/ tagSIZE	MaxClientSize; \
/*0x008C*/ bool		bFullyScreenClipped; \
/*0x008D*/ bool		bActive; \
/*0x008E*/ bool		bScreenClipRectChanged; \
/*0x0090*/ DWORD	LastTimeMouseOver; \
/*0x0094*/ RECT		OldLocation; \
/*0x00A4*/ RECT		Location; \
/*0x00B4*/ void	    *pFont; \
/*0x00B8*/ int		VScrollPos; \
/*0x00BC*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
/*0x00C0*/ bool		bUseInLayoutVertical; \
/*0x00C4*/ struct _CXSTR*	DataStr; \
/*0x00C8*/ bool		bIsTransitioning; \
/*0x00C9*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x00CA*/ bool		bIsParentOrContextMenuWindow; \
/*0x00CC*/ RECT		ClipRectScreen; \
/*0x00DC*/ BYTE		StartAlpha; \
/*0x00DD*/ bool		bClientRectChanged; \
/*0x00E0*/ UINT		TransitionStartTick; \
/*0x00E4*/ int		LeftOffset; \
/*0x00E8*/ bool		Faded; \
/*0x00E9*/ bool		bBottomAnchoredToTop; \
/*0x00EA*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
...
/*0x0104*/ bool		bBringToTopWhenClicked; \
/*0x0105*/ bool		bLeftAnchoredToLeft; \
...
/*0x0126*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x0128*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x012C*/ bool		bBorder2; \
/*0x0130*/ int		BottomOffset; \
...
/*0x01A0*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x01A8*/ __int64		Data; \
...
/*0x01BC*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
...
// CBazaarSearchWnd_size: 0x92d8 (see 55A65E) in Nov 14 2020 Beta - eqmule
...
//aAPwcsincombat
// CPlayerWindow_size: 0x2f0 (see 559F4E) in Nov 14 2020 Beta - eqmule
...
// CTargetWindow_size: 0x8d0 (see 559DE5) in Nov 14 2020 Beta - eqmule
...
// CBuffWindow_size: 0x720 (see 559C89) in Nov 14 2020 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x328 (see 7FC05B) in Nov 14 2020 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d8 (see 55A047) in Nov 14 2020 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d8 (see 7FC16C) in Nov 14 2020 Beta - eqmule
...
// CItemDisplayWindow_size: 0x630 (see 75EC52) in Nov 14 2020 Beta - eqmule
...
// CLootWnd_size: 0x3a0 (see 55A3B6) in Nov 14 2020 Beta - eqmule
...
// CMapViewWnd_size: 0x658 (see 559AEA) in Nov 14 2020 Beta - eqmule
...
// CMerchantWnd_size: 0x450 (see 55A512) in Nov 14 2020 Beta - eqmule
...
// CPetInfoWindow_size: 0x8d0 (see 559541) in Nov 14 2020 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a8 (see 559832) in Nov 14 2020 Beta - eqmule
...
// CTradeWnd__size: 0x2f8 (see 55A5B8) in Nov 14 2020 Beta - eqmule
...
// CFactionWnd__size: 0x280 (see 55A704) in Nov 14 2020 Beta - eqmule
