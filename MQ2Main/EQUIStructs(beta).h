...
// actual size 0x1E8 in Nov 15 2018 Beta (see 0x927E5D) - eqmule
// actual size 0x1F0 in Nov 16 2018 Beta (see 0x929C0D) - eqmule
#define CXW_NO_VTABLE \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ bool		bRightAnchoredToLeft; \
/*0x001D*/ bool		dShow; \
/*0x001E*/ bool		bHCenterTooltip; \
/*0x0020*/ RECT		OldLocation; \
/*0x0030*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x0031*/ bool		bBorder; \
/*0x0034*/ void	*IconTextureAnim; \
/*0x0038*/ void		*pLayoutStrategy; \
...
/*0x0071*/ bool		bMarkedForDelete; \
/*0x0074*/ int		BlinkDuration; \
/*0x0078*/ int		VScrollPos; \
/*0x007C*/ bool		Minimized; \
/*0x0080*/ struct _CSIDLWND* pWndFocusOther; \
/*0x0084*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x0088*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0089*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
...
/*0x00B0*/ bool		bEscapableLocked; \
/*0x00B4*/ UINT		LastBlinkFadeRefreshTime; \
/*0x00B8*/ int	Transition; \
...
/*0x00D8*/ UINT		TransitionStartTick; \
/*0x00DC*/ bool		bAction; \
/*0x00E0*/ RECT		ClipRectClient; \
/*0x00F0*/ bool		bCaptureTitle; \
/*0x00F4*/ void   *TitlePiece2; \
/*0x00F8*/ bool		bMaximized; \
/*0x00F9*/ bool		Faded; \
...
/*0x00FC*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x0100*/ int		LeftOffset; \
/*0x0104*/ int		RightOffset; \
/*0x0108*/ BYTE		StartAlpha; \
/*0x010C*/ DWORD	LastTimeMouseOver; \
/*0x0110*/ bool		bLeftAnchoredToLeft; \
...
/*0x011C*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
...
/*0x0199*/ BYTE     bResizableMask; \
/*0x019A*/ bool		bKeepOnScreen; \
/*0x019B*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x019C*/ LONG		BlinkStartTimer; \
/*0x01A0*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x01A1*/ bool		bIsParentOrContextMenuWindow; \
/*0x01A4*/ RECT		IconRect; \
/*0x01B4*/ BYTE		FadeAlpha; \
/*0x01B8*/ RECT		TransitionRect; \
/*0x01C8*/ bool		Enabled; \
/*0x01C9*/ bool		bBringToTopWhenClicked; \
/*0x01CC*/ void   *TitlePiece; \
/*0x01D0*/ RECT		ClientRect; \
/*0x01E0*/ bool		bClipToParent; \
/*0x01E4*/ DWORD  BackgroundDrawType; \
/*0x01E8*/ BYTE		Alpha; \
/*0x01E9*/ bool		bClientRectChanged; \
/*0x01EA*/ bool		bUseInLayoutHorizontal; \
...
// CBazaarSearchWnd_size: 0x92d8 (see 53C10D) in Nov 16 2018 Beta - eqmule
...
// CPlayerWindow_size: 0x2f0 (see 53BA00) in Nov 16 2018 Beta - eqmule
...
// CTargetWindow_size: 0x8d0 (see 53B89B) in Nov 16 2018 Beta - eqmule
...
// CBuffWindow_size: 0x720 (see 53B73F) in Nov 16 2018 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x328 (see 7EBB9B) in Nov 16 2018 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d8 (see 53BAF9) in Nov 16 2018 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d8 (see 7EBCAC) in Nov 16 2018 Beta - eqmule
...
// CItemDisplayWindow_size: 0x630 (see 74BD92) in Nov 16 2018 Beta - eqmule
...
// CLootWnd_size: 0x3a0 (see 53BE65) in Nov 16 2018 Beta - eqmule
...
// CMapViewWnd_size: 0x658 (see 53B5A0) in Nov 16 2018 Beta - eqmule
...
// CMerchantWnd_size: 0x450 (see 53BFC1) in Nov 16 2018 Beta - eqmule
...
// CPetInfoWindow_size: 0x8d0 (see 53AFDA) in Nov 16 2018 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3b0 (see 53B2CB) in Nov 16 2018 Beta - eqmule
...
// CTradeWnd__size: 0x2f8 (see 53C067) in Nov 16 2018 Beta - eqmule
