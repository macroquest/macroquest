...
// actual size 0x1F0 in Nov 30 2017 Beta (see 0x8D3E6D) - eqmule
...
/*0x003D*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x003E*/ bool		bMaximizable; \
/*0x0040*/ int		BottomOffset; \
/*0x0044*/ DWORD	FadeDelay; \
/*0x0048*/ RECT		IconRect; \
/*0x0058*/ BYTE		StartAlpha; \
/*0x0059*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x005A*/ bool		bClientClipRectChanged; \
/*0x005B*/ bool		Fades; \
/*0x005C*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0060*/ bool		dShow; \
/*0x0061*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0064*/ RECT		ClipRectClient; \
...
/*0x00C6*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x00C8*/ LONG		BlinkStartTimer; \
/*0x00CC*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x00D0*/ int		TopOffset; \
/*0x00D4*/ bool		bClipToParent; \
/*0x00D8*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x00DC*/ UINT		TransitionDuration; \
/*0x00E0*/ bool		bKeepOnScreen; \
/*0x00E4*/ int		ParentAndContextMenuArrayIndex; \
...
/*0x00FC*/ int		HScrollMax; \
/*0x0100*/ tagSIZE	MinClientSize; \
/*0x0108*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x010C*/ bool		bBringToTopWhenClicked; \
/*0x010D*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x0110*/ void   *TitlePiece2; \
/*0x0114*/ UINT		TransitionStartTick; \
/*0x0118*/ void	*IconTextureAnim; \
/*0x011C*/ void		*pLayoutStrategy; \
/*0x0120*/ bool		bHCenterTooltip; \
/*0x0121*/ bool		bUseInLayoutHorizontal; \
/*0x0124*/ DWORD	LastTimeMouseOver; \
/*0x0128*/ bool		bIsParentOrContextMenuWindow; \
/*0x012C*/ UINT		FadeDuration; \
/*0x0130*/ bool		bEscapableLocked; \
/*0x0134*/ void	    *pFont; \
/*0x0138*/ int	Transition; \
...
/*0x0188*/ bool		bLeftAnchoredToLeft; \
/*0x0189*/ bool		bMarkedForDelete; \
/*0x018A*/ bool		bCaptureTitle; \
/*0x018C*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x0190*/ bool		Enabled; \
/*0x0194*/ void*	pTextObject; \
/*0x0198*/ int		VScrollPos; \
/*0x019C*/ RECT		TransitionRect; \
/*0x01AC*/ int		managerArrayIndex; \
/*0x01B0*/ void   *TitlePiece; \
/*0x01B4*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
...
/*0x01E4*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x01E5*/ bool		bTiled; \
/*0x01E6*/ BYTE		FadeAlpha; \
/*0x01E7*/ BYTE Filler0x01E7[0x1];
/*0x01E8*/
...
// CBazaarSearchWnd_size: 0x92d0 (see 4CCC4A) in Dec  1 2017 Beta - eqmule
...
// CPlayerWindow_size: 0x2e8 (see 4CC48D) in Dec  1 2017 Beta - eqmule
...
// CTargetWindow_size: 0x8c8 (see 4CC324) in Dec  1 2017 Beta - eqmule
...
// CBuffWindow_size: 0x718 (see 4CC1B8) in Dec  1 2017 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x318 (see 7A2628) in Dec  1 2017 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d0 (see 4CC59E) in Dec  1 2017 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d0 (see 7A2739) in Dec  1 2017 Beta - eqmule
...
// CItemDisplayWindow_size: 0x610 (see 6ECF7F) in Dec  1 2017 Beta - eqmule
...
// CLootWnd_size: 0x398 (see 4CC960) in Dec  1 2017 Beta - eqmule
...
// CMapViewWnd_size: 0x648 (see 4CC019) in Dec  1 2017 Beta - eqmule
...
// CMerchantWnd_size: 0x448 (see 4CCADE) in Dec  1 2017 Beta - eqmule
...
// CPetInfoWindow_size: 0x8c8 (see 4CBA50) in Dec  1 2017 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a8 (see 4CBD43) in Dec  1 2017 Beta - eqmule
...
// CTradeWnd__size: 0x2f0 (see 4CCB94) in Dec  1 2017 Beta - eqmule
