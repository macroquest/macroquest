...
enum UIType
{
   ...
   UI_Class=0,
   UI_RGB=1,
   UI_RGBText=2,//new since the patch on Dec 05 2017 beta see 0x90C01C -eqmule
   UI_Point=3,
   UI_Size=4,
   UI_TextureInfo=5,
   UI_Frame=6,
...
// actual size 0x1E0 in Dec  2 2017 Beta (see 0x8D481D) - eqmule
// actual size 0x1F8 in Dec  6 2017 Beta (see 0x8D59BD) - eqmule
// actual size 0x1F0 in Dec  8 2017 Beta (see 0x8D3CFD) - eqmule
// actual size 0x1D8 in Dec  9 2017 Beta (see 0x8D488D) - eqmule
// actual size 0x1E8 in Dec 10 2017 Beta (see 0x8D428D) - eqmule
#define CXW_NO_VTABLE \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ bool		Enabled; \
/*0x0020*/ RECT		OldLocation; \
/*0x0030*/ bool		bMaximized; \
/*0x0034*/ RECT		IconRect; \
/*0x0044*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0045*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x0046*/ bool		bClientRectChanged; \
/*0x0047*/ bool		bIsParentOrContextMenuWindow; \
/*0x0048*/ bool		bActive; \
/*0x0049*/ bool		bUseInLayoutHorizontal; \
/*0x004C*/ int		LeftOffset; \
/*0x0050*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x0054*/ void   *TitlePiece; \
/*0x0058*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x005C*/ bool		bScreenClipRectChanged; \
/*0x0060*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0064*/ bool		bAction; \
/*0x0068*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
/*0x006C*/ void	*DrawTemplate; \
/*0x0070*/ UINT		FadeDuration; \
/*0x0074*/ bool		Minimized; \
/*0x0078*/ RECT		ClipRectScreen; \
/*0x0088*/ BYTE		TargetAlpha; \
/*0x008C*/ UINT		BlinkFadeFreq; \
/*0x0090*/ COLORREF DisabledBackground; \
/*0x0094*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x0098*/ RECT		Location; \
/*0x00A8*/ void	*IconTextureAnim; \
/*0x00AC*/ void *pController; \
/*0x00B0*/ BYTE		FadeAlpha; \
/*0x00B4*/ DWORD	LastTimeMouseOver; \
/*0x00B8*/ bool		bIsTransitioning; \
/*0x00BC*/ RECT		ClientRect; \
/*0x00CC*/ RECT		TransitionRect; \
/*0x00DC*/ tagSIZE	MaxClientSize; \
/*0x00E4*/ int		RightOffset; \
/*0x00E8*/ int		DeleteCount; \
/*0x00EC*/ int	Transition; \
/*0x00F0*/ bool		bLeftAnchoredToLeft; \
/*0x00F4*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x00F8*/ LONG		BlinkStartTimer; \
/*0x00FC*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x00FD*/ bool		bTiled; \
/*0x0100*/ struct _CXSTR*	DataStr; \
/*0x0104*/ void		*pLayoutStrategy; \
/*0x0108*/ __int64		Data; \
/*0x0110*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0114*/ UINT		LastBlinkFadeRefreshTime; \
/*0x0118*/ UINT		BlinkFadeDuration; \
/*0x011C*/ void   *TitlePiece2; \
/*0x0120*/ BYTE     bResizableMask; \
/*0x0124*/ int		BottomOffset; \
/*0x0128*/ int		managerArrayIndex; \
/*0x012C*/ bool		bBottomAnchoredToTop; \
/*0x012D*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0130*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x0134*/ tagSIZE	MinClientSize; \
/*0x013C*/ RECT		ClipRectClient; \
/*0x014C*/ int		VScrollMax; \
/*0x0150*/ bool		bUseInLayoutVertical; \
/*0x0154*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x1c */ \
/*0x0170*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x0174*/ void*	pTextObject; \
/*0x0178*/ int		VScrollPos; \
/*0x017C*/ int		BlinkState; \
/*0x0180*/ void	    *pFont; \
/*0x0184*/ struct _CSIDLWND* pWndFocusOther; \
/*0x0188*/ bool		bMarkedForDelete; \
/*0x0189*/ bool		bHCenterTooltip; \
/*0x018A*/ bool		bKeepOnScreen; \
/*0x018C*/ int		HScrollPos; \
/*0x0190*/ int		TopOffset; \
/*0x0194*/ int		HScrollMax; \
/*0x0198*/ void* pTipTextObject; \
/*0x019C*/ bool		bClipToParent; \
/*0x019D*/ bool		bClientClipRectChanged; \
/*0x01A0*/ DWORD	FadeDelay; \
/*0x01A4*/ bool		bBringToTopWhenClicked; \
/*0x01A8*/ UINT		TransitionStartTick; \
/*0x01AC*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x01AD*/ bool		dShow; \
/*0x01AE*/ bool		bMaximizable; \
/*0x01B0*/ UINT		TransitionDuration; \
/*0x01B4*/ int		BlinkDuration; \
/*0x01B8*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x01BC*/ bool		bEscapableLocked; \
/*0x01BD*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x01BE*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x01BF*/ BYTE		StartAlpha; \
/*0x01C0*/ bool		Faded; \
/*0x01C1*/ bool		Fades; \
/*0x01C2*/ bool		bFullyScreenClipped; \
/*0x01C4*/ int		ParentAndContextMenuArrayIndex; \
/*0x01C8*/ DWORD  BackgroundDrawType; \
/*0x01CC*/ bool		bCaptureTitle; \
/*0x01D0*/ UINT		BlinkFadeStartTime; \
/*0x01D4*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x01D5*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x01D8*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x01DC*/ BYTE		Alpha; \
/*0x01DD*/ bool		bTopAnchoredToTop; \
/*0x01E0*/ DWORD	XMLIndex; \
/*0x01E4*/ bool		bRightAnchoredToLeft; \
/*0x01E5*/ BYTE Filler0x01E5[0x3];
/*0x01E8*/
...
// CBazaarSearchWnd_size: 0x92d0 (see 4CD08A) in Dec 10 2017 Beta - eqmule
...
// CPlayerWindow_size: 0x2e8 (see 4CC8CD) in Dec 10 2017 Beta - eqmule
...
// CTargetWindow_size: 0x8c8 (see 4CC764) in Dec 10 2017 Beta - eqmule
...
// CBuffWindow_size: 0x718 (see 4CC5F8) in Dec 10 2017 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x318 (see 7A3318) in Dec 10 2017 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d0 (see 4CC9DE) in Dec 10 2017 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d0 (see 7A3429) in Dec 10 2017 Beta - eqmule
...
// CItemDisplayWindow_size: 0x610 (see 6ED82F) in Dec 10 2017 Beta - eqmule
...
/*0x02c4*/ BYTE         Unknown0x02c4[0x344];
...
// CLootWnd_size: 0x398 (see 4CCDA0) in Dec 10 2017 Beta - eqmule
...
// CMapViewWnd_size: 0x648 (see 4CC459) in Dec 10 2017 Beta - eqmule
...
// CMerchantWnd_size: 0x448 (see 4CCF1E) in Dec 10 2017 Beta - eqmule
...
// CPetInfoWindow_size: 0x8c8 (see 4CBE90) in Dec 10 2017 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a8 (see 4CC183) in Dec 10 2017 Beta - eqmule
...
// CTradeWnd__size: 0x2f0 (see 4CCFD4) in Dec 10 2017 Beta - eqmule
