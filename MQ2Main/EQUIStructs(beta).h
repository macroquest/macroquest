...
// actual size 0x1F0 in Nov 19 2018 Beta (see 0x9298ED) - eqmule
// actual size 0x1E8 in Nov 22 2018 Beta (see 0x92ABBD) - eqmule
...
/*0x0034*/ BYTE		StartAlpha; \
/*0x0035*/ bool		bMarkedForDelete; \
/*0x0036*/ BYTE		TargetAlpha; \
/*0x0037*/ bool		bBringToTopWhenClicked; \
/*0x0038*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x003C*/ int		VScrollPos; \
/*0x0040*/ COLORREF DisabledBackground; \
/*0x0044*/ LONG		BlinkStartTimer; \
/*0x0048*/ bool		bIsParentOrContextMenuWindow; \
/*0x0049*/ bool		bScreenClipRectChanged; \
/*0x004A*/ bool		bActive; \
/*0x004B*/ bool		bMaximized; \
/*0x004C*/ bool		bTopAnchoredToTop; \
/*0x0050*/ UINT		TransitionDuration; \
/*0x0054*/ bool		Fades; \
/*0x0055*/ bool		bLeftAnchoredToLeft; \
/*0x0058*/ int		BottomOffset; \
/*0x005C*/ bool		bTiled; \
/*0x0060*/ int		DeleteCount; \
/*0x0064*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x0068*/ void		*pLayoutStrategy; \
/*0x006C*/ DWORD	LastTimeMouseOver; \
/*0x0070*/ void	    *pFont; \
/*0x0074*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x0075*/ BYTE		FadeAlpha; \
/*0x0078*/ int		TopOffset; \
/*0x007C*/ int		BlinkDuration; \
/*0x0080*/ int		BlinkState; \
/*0x0084*/ UINT		BlinkFadeFreq; \
/*0x0088*/ bool		bHCenterTooltip; \
/*0x008C*/ UINT		TransitionStartTick; \
/*0x0090*/ bool		dShow; \
/*0x0091*/ BYTE     bResizableMask; \
/*0x0092*/ bool		bClientClipRectChanged; \
/*0x0094*/ void   *TitlePiece2; \
/*0x0098*/ UINT		LastBlinkFadeRefreshTime; \
/*0x009C*/ bool		bRightAnchoredToLeft; \
/*0x009D*/ bool		bAction; \
/*0x009E*/ bool		bMaximizable; \
/*0x00A0*/ RECT		OldLocation; \
/*0x00B0*/ int	Transition; \
/*0x00B4*/ int		ParentAndContextMenuArrayIndex; \
/*0x00B8*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x00B9*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x00BC*/ struct _CXSTR*	DataStr; \
/*0x00C0*/ bool		bFullyScreenClipped; \
/*0x00C4*/ RECT		ClipRectClient; \
/*0x00D4*/ bool		bBorder; \
/*0x00D8*/ __int64		Data; \
...
/*0x00E8*/ bool		bBottomAnchoredToTop; \
/*0x00E9*/ bool		Minimized; \
/*0x00EA*/ bool		bBorder2; \
/*0x00EB*/ bool		bUseInLayoutHorizontal; \
/*0x00EC*/ RECT		ClientRect; \
/*0x00FC*/ tagSIZE	MaxClientSize; \
/*0x0104*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
...
/*0x0110*/ bool		bClipToParent; \
/*0x0114*/ DWORD	FadeDelay; \
/*0x0118*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x011C*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x0120*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0124*/ int		managerArrayIndex; \
/*0x0128*/ bool		Enabled; \
/*0x012C*/ void	*IconTextureAnim; \
/*0x0130*/ DWORD  BackgroundDrawType; \
/*0x0134*/ UINT		BlinkFadeStartTime; \
/*0x0138*/ bool		bIsTransitioning; \
/*0x0139*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x013A*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x013C*/ UINT		BlinkFadeDuration; \
/*0x0140*/ bool		bClientRectChanged; \
/*0x0144*/ int		RightOffset; \
/*0x0148*/ bool		bCaptureTitle; \
/*0x014C*/ void   *TitlePiece; \
/*0x0150*/ struct _CSIDLWND* pWndFocusOther; \
/*0x0154*/ UINT		FadeDuration; \
/*0x0158*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x0159*/ bool		bEscapableLocked; \
/*0x015C*/ int		HScrollPos; \
/*0x0160*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x1c */ \
/*0x017C*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0180*/ void*	pTextObject; \
/*0x0184*/ int		VScrollMax; \
/*0x0188*/ bool		Faded; \
...
/*0x0191*/ bool		bUseInLayoutVertical; \
/*0x0192*/ bool		bKeepOnScreen; \
/*0x0194*/ tagSIZE	MinClientSize; \
/*0x019C*/ RECT		Location; \
/*0x01AC*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x01B0*/ BYTE		Alpha; \
/*0x01B4*/ void	*DrawTemplate; \
/*0x01B8*/ RECT		IconRect; \
/*0x01C8*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x01CC*/ void* pTipTextObject; \
/*0x01D0*/ RECT		ClipRectScreen; \
/*0x01E0*/
...
// CBazaarSearchWnd_size: 0x92c8 (see 53E0CD) in Nov 23 2018 Beta - eqmule
...
// CPlayerWindow_size: 0x2e0 (see 53D9C0) in Nov 23 2018 Beta - eqmule
...
// CTargetWindow_size: 0x8c0 (see 53D85B) in Nov 23 2018 Beta - eqmule
...
// CBuffWindow_size: 0x710 (see 53D6FF) in Nov 23 2018 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x318 (see 7EE80B) in Nov 23 2018 Beta - eqmule
...
// CCastSpellWnd_size: 0x2c8 (see 53DAB9) in Nov 23 2018 Beta - eqmule
...
// CInvSlotWnd_size: 0x2c8 (see 7EE91C) in Nov 23 2018 Beta - eqmule
...
// CItemDisplayWindow_size: 0x620 (see 74E852) in Nov 23 2018 Beta - eqmule
...
// CLootWnd_size: 0x390 (see 53DE25) in Nov 23 2018 Beta - eqmule
...
// CMapViewWnd_size: 0x638 (see 53D560) in Nov 23 2018 Beta - eqmule
...
// CMerchantWnd_size: 0x440 (see 53DF81) in Nov 23 2018 Beta - eqmule
...
// CPetInfoWindow_size: 0x8c0 (see 53CF9A) in Nov 23 2018 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a0 (see 53D28B) in Nov 23 2018 Beta - eqmule
...
// CTradeWnd__size: 0x2e8 (see 53E027) in Nov 23 2018 Beta - eqmule
