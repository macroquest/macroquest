...
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x1c */ \
/*0x0038*/ bool		bEscapableLocked; \
/*0x0039*/ bool		bFullyScreenClipped; \
/*0x003A*/ bool		bTiled; \
/*0x003C*/ void* pTipTextObject; \
/*0x0040*/ struct _CXSTR*	DataStr; \
/*0x0044*/ bool		bClipToParent; \
/*0x0045*/ bool		Faded; \
...
/*0x0070*/ bool		bUseInLayoutVertical; \
...
/*0x00A9*/ bool		Enabled; \
/*0x00AC*/ tagSIZE	MaxClientSize; \
/*0x00B4*/ int		LeftOffset; \
/*0x00B8*/ void		*pLayoutStrategy; \
/*0x00BC*/ bool		bMaximizable; \
/*0x00BD*/ BYTE		FadeAlpha; \
/*0x00C0*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
/*0x00C4*/ int	Transition; \
/*0x00C8*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
...
/*0x00E5*/ bool		bClientRectChanged; \
/*0x00E6*/ bool		bScreenClipRectChanged; \
/*0x00E8*/ RECT		TransitionRect; \
/*0x00F8*/ RECT		Location; \
/*0x0108*/ DWORD	LastTimeMouseOver; \
/*0x010C*/ int		VScrollMax; \
/*0x0110*/ bool		bCaptureTitle; \
...
/*0x014C*/ void	*DrawTemplate; \
/*0x0150*/ int		managerArrayIndex; \
/*0x0154*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x0158*/ UINT		TransitionDuration; \
/*0x015C*/ RECT		ClipRectScreen; \
/*0x016C*/ int		RightOffset; \
/*0x0170*/ void   *TitlePiece; \
/*0x0174*/ bool		bHCenterTooltip; \
/*0x0175*/ bool		bIsParentOrContextMenuWindow; \
/*0x0176*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0177*/ bool		Minimized; \
/*0x0178*/ UINT		BlinkFadeFreq; \
/*0x017C*/ bool		bTopAnchoredToTop; \
/*0x0180*/ LONG		BlinkStartTimer; \
/*0x0184*/ bool		bIsTransitioning; \
/*0x0185*/ BYTE     bResizableMask; \
/*0x0188*/ int		TopOffset; \
/*0x018C*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x018D*/ bool		dShow; \
/*0x018E*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0190*/ DWORD	FadeDelay; \
/*0x0194*/ bool		bClientClipRectChanged; \
/*0x0198*/ UINT		TransitionStartTick; \
...
/*0x01A9*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x01AA*/ BYTE		TargetAlpha; \
/*0x01AB*/ bool		bLeftAnchoredToLeft; \
/*0x01AC*/ bool		bRightAnchoredToLeft; \
/*0x01AD*/ bool		bAction; \
/*0x01B0*/ RECT		ClientRect; \
/*0x01C0*/ int		BlinkState; \
/*0x01C4*/ int		BottomOffset; \
/*0x01C8*/ BYTE		StartAlpha; \
/*0x01C9*/ bool		bKeepOnScreen; \
...
// CBazaarSearchWnd_size: 0x92c8 (see 4CCB6A) in Nov 19 2017 Beta - eqmule
...
// CPlayerWindow_size: 0x2e0 (see 4CC3AD) in Nov 19 2017 Beta - eqmule
...
// CTargetWindow_size: 0x8c0 (see 4CC244) in Nov 19 2017 Beta - eqmule
...
// CBuffWindow_size: 0x710 (see 4CC0D8) in Nov 19 2017 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x310 (see 7A3968) in Nov 19 2017 Beta - eqmule
...
// CCastSpellWnd_size: 0x2c8 (see 4CC4BE) in Nov 19 2017 Beta - eqmule
...
// CInvSlotWnd_size: 0x2c8 (see 7A3A79) in Nov 19 2017 Beta - eqmule
...
// CItemDisplayWindow_size: 0x608 (see 6EE03F) in Nov 19 2017 Beta - eqmule
...
// CLootWnd_size: 0x390 (see 4CC880) in Nov 19 2017 Beta - eqmule
...
// CMapViewWnd_size: 0x638 (see 4CBF39) in Nov 19 2017 Beta - eqmule
...
// CMerchantWnd_size: 0x430 (see 4CC9FE) in Nov 19 2017 Beta - eqmule
...
// CPetInfoWindow_size: 0x8c0 (see 4CB970) in Nov 19 2017 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a0 (see 4CBC63) in Nov 19 2017 Beta - eqmule
...
// CTradeWnd__size: 0x2e8 (see 4CCAB4) in Nov 19 2017 Beta - eqmule
