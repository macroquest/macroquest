...
/*0x0035*/ bool		bMaximized; \
/*0x0036*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0037*/ BYTE		StartAlpha; \
...
/*0x003C*/ bool		bLeftAnchoredToLeft; \
/*0x0040*/ RECT		ClipRectClient; \
/*0x0050*/ int		RightOffset; \
/*0x0054*/ int		HScrollPos; \
/*0x0058*/ tagSIZE	MinClientSize; \
/*0x0060*/ bool		Fades; \
/*0x0061*/ bool		Enabled; \
/*0x0062*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
...
/*0x00B0*/ int		VScrollMax; \
/*0x00B4*/ bool		bTopAnchoredToTop; \
/*0x00B5*/ bool		bRightAnchoredToLeft; \
/*0x00B6*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x00B8*/ void   *TitlePiece; \
/*0x00BC*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
...
/*0x00FC*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0100*/ bool		bBringToTopWhenClicked; \
/*0x0101*/ bool		bKeepOnScreen; \
...
/*0x0180*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x0184*/ bool		bUseInLayoutVertical; \
/*0x0185*/ BYTE		Alpha; \
/*0x0186*/ bool		bBorder; \
/*0x0188*/ UINT		TransitionDuration; \
/*0x018C*/ UINT		BlinkFadeDuration; \
/*0x0190*/ bool		bActive; \
/*0x0191*/ bool		bIsParentOrContextMenuWindow; \
/*0x0194*/ DWORD	LastTimeMouseOver; \
/*0x0198*/ BYTE		TargetAlpha; \
/*0x019C*/ RECT		IconRect; \
/*0x01AC*/ bool		Minimized; \
...
/*0x01D1*/ bool		bMarkedForDelete; \
/*0x01D4*/ UINT		BlinkFadeFreq; \
/*0x01D8*/ bool		bIsTransitioning; \
/*0x01D9*/ BYTE     bResizableMask; \
/*0x01DA*/ bool		bCaptureTitle; \
...
// CBazaarSearchWnd_size: 0x92d0 (see 54D8EE) in Oct 30 2019 Beta - eqmule
...
// CPlayerWindow_size: 0x2e8 (see 54D1DE) in Oct 30 2019 Beta - eqmule
...
// CTargetWindow_size: 0x8c8 (see 54D075) in Oct 30 2019 Beta - eqmule
...
// CBuffWindow_size: 0x718 (see 54CF19) in Oct 30 2019 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x320 (see 80087B) in Oct 30 2019 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d0 (see 54D2D7) in Oct 30 2019 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d0 (see 80098C) in Oct 30 2019 Beta - eqmule
...
// CItemDisplayWindow_size: 0x628 (see 763BC2) in Oct 30 2019 Beta - eqmule
...
// CLootWnd_size: 0x398 (see 54D646) in Oct 30 2019 Beta - eqmule
...
// CMapViewWnd_size: 0x648 (see 54CD7A) in Oct 30 2019 Beta - eqmule
...
// CMerchantWnd_size: 0x448 (see 54D7A2) in Oct 30 2019 Beta - eqmule
...
// CPetInfoWindow_size: 0x8c8 (see 54C7D1) in Oct 30 2019 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a8 (see 54CAC2) in Oct 30 2019 Beta - eqmule
...
// CTradeWnd__size: 0x2f0 (see 54D848) in Oct 30 2019 Beta - eqmule
...
// CFactionWnd__size: 0x278 (see 54D994) in Oct 30 2019 Beta - eqmule
