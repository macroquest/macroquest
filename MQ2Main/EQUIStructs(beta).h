...
/*0x003C*/ bool		Enabled; \
/*0x003D*/ bool		bClientClipRectChanged; \
/*0x0040*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x0044*/ int		ParentAndContextMenuArrayIndex; \
/*0x0048*/ bool		bUseInLayoutHorizontal; \
/*0x0049*/ bool		dShow; \
/*0x004A*/ BYTE		TargetAlpha; \
/*0x004B*/ bool		bBottomAnchoredToTop; \
...
/*0x0078*/ bool		bIsTransitioning; \
/*0x0079*/ bool		bFullyScreenClipped; \
/*0x007A*/ BYTE     bResizableMask; \
/*0x007C*/ UINT		TransitionDuration; \
/*0x0080*/ bool		bClientRectChanged; \
...
/*0x00D0*/ bool		Minimized; \
/*0x00D1*/ bool		bBorder2; \
/*0x00D2*/ BYTE		StartAlpha; \
...
/*0x00E8*/ void	    *pFont; \
/*0x00EC*/ bool		bBringToTopWhenClicked; \
...
/*0x0108*/ bool		bActive; \
/*0x0109*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x010A*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x010B*/ bool		bUseInLayoutVertical; \
/*0x010C*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0110*/ UINT		FadeDuration; \
/*0x0114*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
...
/*0x0140*/ BYTE		Alpha; \
/*0x0141*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
...
/*0x016D*/ bool		bClipToParent; \
/*0x0170*/ RECT		TransitionRect; \
/*0x0180*/ int		VScrollPos; \
/*0x0184*/ bool		bIsParentOrContextMenuWindow; \
...
// CBazaarSearchWnd_size: 0x92d0 (see 55BACE) in Dec  1 2020 Beta - eqmule
...
// CPlayerWindow_size: 0x2e8 (see 55B3BE) in Dec  1 2020 Beta - eqmule
...
// CTargetWindow_size: 0x8c8 (see 55B255) in Dec  1 2020 Beta - eqmule
...
// CBuffWindow_size: 0x718 (see 55B0F9) in Dec  1 2020 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x320 (see 7FC80B) in Dec  1 2020 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d0 (see 55B4B7) in Dec  1 2020 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d0 (see 7FC91C) in Dec  1 2020 Beta - eqmule
...
// CItemDisplayWindow_size: 0x628 (see 75F6D2) in Dec  1 2020 Beta - eqmule
...
// CLootWnd_size: 0x398 (see 55B826) in Dec  1 2020 Beta - eqmule
...
// CMapViewWnd_size: 0x648 (see 55AF5A) in Dec  1 2020 Beta - eqmule
...
// CMerchantWnd_size: 0x448 (see 55B982) in Dec  1 2020 Beta - eqmule
...
// CPetInfoWindow_size: 0x8c8 (see 55A9B1) in Dec  1 2020 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a0 (see 55ACA2) in Dec  1 2020 Beta - eqmule
...
// CTradeWnd__size: 0x2f0 (see 55BA28) in Dec  1 2020 Beta - eqmule
...
// CFactionWnd__size: 0x278 (see 55BB74) in Dec  1 2020 Beta - eqmule
