...
// actual size 0x1F0 in Nov 29 2019 Beta (see 0x95238D) - eqmule
// actual size 0x1E8 in Nov 30 2019 Beta (see 0x95157D) - eqmule
...
/*0x0030*/ int		BlinkState; \
/*0x0034*/ struct _CXSTR*	DataStr; \
...
/*0x0091*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
...
/*0x00A5*/ bool		bKeepOnScreen; \
/*0x00A8*/ DWORD	XMLIndex; \
/*0x00AC*/ tagSIZE	MinClientSize; \
/*0x00B4*/ UINT		TransitionStartTick; \
/*0x00B8*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x00BC*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x00BD*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x00C0*/ UINT		BlinkFadeDuration; \
/*0x00C4*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x00C5*/ bool		bBringToTopWhenClicked; \
...
/*0x00F9*/ BYTE		Alpha; \
/*0x00FA*/ bool		bIsParentOrContextMenuWindow; \
/*0x00FB*/ bool		bMarkedForDelete; \
/*0x00FC*/ UINT		FadeDuration; \
/*0x0100*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x0104*/ int		RightOffset; \
/*0x0108*/ bool		bUseInLayoutHorizontal; \
/*0x0109*/ bool		bScreenClipRectChanged; \
/*0x010A*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
...
/*0x0120*/ int		VScrollMax; \
/*0x0124*/ bool		Enabled; \
/*0x0128*/ UINT		BlinkFadeFreq; \
/*0x012C*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x0130*/ int		LeftOffset; \
/*0x0134*/ LONG		BlinkStartTimer; \
/*0x0138*/ bool		dShow; \
/*0x0139*/ bool		bClientRectChanged; \
/*0x013C*/ int		DeleteCount; \
/*0x0140*/ bool		bBorder; \
...
/*0x0160*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x0178*/ void *pController; \
/*0x017C*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x017D*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x017E*/ bool		bMaximized; \
/*0x017F*/ bool		bLeftAnchoredToLeft; \
...
/*0x0194*/ bool		bTiled; \
/*0x0195*/ bool		Minimized; \
/*0x0198*/ RECT		ClipRectClient; \
/*0x01A8*/ bool		bClipToParent; \
/*0x01AC*/ UINT		BlinkFadeStartTime; \
/*0x01B0*/ bool		bFullyScreenClipped; \
/*0x01B4*/ void   *TitlePiece; \
/*0x01B8*/ void		*pLayoutStrategy; \
/*0x01BC*/ RECT		Location; \
/*0x01CC*/ RECT		OldLocation; \
...
// CBazaarSearchWnd_size: 0x92d0 (see 55002E) in Nov 30 2019 Beta - eqmule
...
// CPlayerWindow_size: 0x2e8 (see 54F91E) in Nov 30 2019 Beta - eqmule
...
// CTargetWindow_size: 0x8c8 (see 54F7B5) in Nov 30 2019 Beta - eqmule
...
// CBuffWindow_size: 0x718 (see 54F659) in Nov 30 2019 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x320 (see 807C8B) in Nov 30 2019 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d0 (see 54FA17) in Nov 30 2019 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d0 (see 807D9C) in Nov 30 2019 Beta - eqmule
...
// CItemDisplayWindow_size: 0x628 (see 76AD02) in Nov 30 2019 Beta - eqmule
...
// CLootWnd_size: 0x398 (see 54FD86) in Nov 30 2019 Beta - eqmule
...
// CMapViewWnd_size: 0x648 (see 54F4BA) in Nov 30 2019 Beta - eqmule
...
// CMerchantWnd_size: 0x448 (see 54FEE2) in Nov 30 2019 Beta - eqmule
...
// CPetInfoWindow_size: 0x8c8 (see 54EF11) in Nov 30 2019 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a8 (see 54F202) in Nov 30 2019 Beta - eqmule
...
// CTradeWnd__size: 0x2f0 (see 54FF88) in Nov 30 2019 Beta - eqmule
...
// CFactionWnd__size: 0x278 (see 5500D4) in Nov 30 2019 Beta - eqmule
