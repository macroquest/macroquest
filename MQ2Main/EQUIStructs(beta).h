...
// actual size 0x1E8 in Nov 23 2020 Beta (see 0x93EF8D) - eqmule
// actual size 0x1F0 in Nov 25 2020 Beta (see 0x93F7CD) - eqmule
// actual size 0x1E0 in Nov 27 2020 Beta (see 0x94001D) - eqmule
#define CXW_NO_VTABLE \
private: \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x0020*/ bool		bFullyScreenClipped; \
/*0x0024*/ RECT		OldLocation; \
/*0x0034*/ tagSIZE	MinClientSize; \
/*0x003C*/ UINT		TransitionDuration; \
/*0x0040*/ bool		bBorder2; \
/*0x0041*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x0042*/ BYTE     bResizableMask; \
/*0x0044*/ int		BottomOffset; \
/*0x0048*/ RECT		IconRect; \
/*0x0058*/ int		TopOffset; \
/*0x005C*/ bool		Enabled; \
/*0x005D*/ bool		bHCenterTooltip; \
/*0x005E*/ bool		Minimized; \
/*0x005F*/ bool		bBringToTopWhenClicked; \
...
/*0x0070*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x0071*/ BYTE		StartAlpha; \
/*0x0074*/ RECT		Location; \
/*0x0084*/ bool		bClientRectChanged; \
/*0x0085*/ bool		Faded; \
/*0x0088*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x008C*/ BYTE		FadeAlpha; \
/*0x0090*/ RECT		TransitionRect; \
/*0x00A0*/ DWORD	LastTimeMouseOver; \
/*0x00A4*/ bool		bLeftAnchoredToLeft; \
/*0x00A5*/ bool		bBottomAnchoredToTop; \
/*0x00A6*/ bool		bMaximized; \
...
/*0x0104*/ void   *TitlePiece; \
/*0x0108*/ RECT		ClipRectScreen; \
/*0x0118*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x0119*/ bool		bTiled; \
/*0x011A*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x011C*/ RECT		ClientRect; \
/*0x012C*/ bool		bTopAnchoredToTop; \
...
/*0x0164*/ bool		bBorder; \
/*0x0165*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0166*/ bool		bEscapableLocked; \
/*0x0167*/ BYTE		TargetAlpha; \
...
// CBazaarSearchWnd_size: 0x92c8 (see 55B77E) in Nov 27 2020 Beta - eqmule
...
// CPlayerWindow_size: 0x2e0 (see 55B06E) in Nov 27 2020 Beta - eqmule
...
// CTargetWindow_size: 0x8c0 (see 55AF05) in Nov 27 2020 Beta - eqmule
...
// CBuffWindow_size: 0x710 (see 55ADA9) in Nov 27 2020 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x318 (see 7FD0AB) in Nov 27 2020 Beta - eqmule
...
// CCastSpellWnd_size: 0x2c8 (see 55B167) in Nov 27 2020 Beta - eqmule
...
// CInvSlotWnd_size: 0x2c8 (see 7FD1BC) in Nov 27 2020 Beta - eqmule
...
// CItemDisplayWindow_size: 0x620 (see 75FC52) in Nov 27 2020 Beta - eqmule
...
// CLootWnd_size: 0x390 (see 55B4D6) in Nov 27 2020 Beta - eqmule
...
// CMapViewWnd_size: 0x638 (see 55AC0A) in Nov 27 2020 Beta - eqmule
...
// CMerchantWnd_size: 0x440 (see 55B632) in Nov 27 2020 Beta - eqmule
...
// CPetInfoWindow_size: 0x8c0 (see 55A661) in Nov 27 2020 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x398 (see 55A952) in Nov 27 2020 Beta - eqmule
...
// CTradeWnd__size: 0x2e8 (see 55B6D8) in Nov 27 2020 Beta - eqmule
...
// CFactionWnd__size: 0x270 (see 55B824) in Nov 27 2020 Beta - eqmule
