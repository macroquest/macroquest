...
/*0x00B1*/ bool		bMaximizable; \
/*0x00B4*/ void   *TitlePiece2; \
/*0x00B8*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x00B9*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x00BA*/ bool		bBorder; \
/*0x00BB*/ bool		bTiled; \
/*0x00BC*/ bool		Fades; \
/*0x00C0*/ void *pController; \
/*0x00C4*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x00DC*/ bool		bClientClipRectChanged; \
...
/*0x0101*/ BYTE		TargetAlpha; \
/*0x0102*/ bool		Minimized; \
/*0x0103*/ bool		bBringToTopWhenClicked; \
/*0x0104*/ int		BottomOffset; \
/*0x0108*/ bool		dShow; \
/*0x0109*/ bool		bMaximized; \
/*0x010C*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0110*/ bool		bClipToParent; \
/*0x0114*/ DWORD	FadeDelay; \
/*0x0118*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
...
/*0x01A0*/ RECT		ClipRectClient; \
/*0x01B0*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x01B4*/ int		HScrollMax; \
/*0x01B8*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x01B9*/ bool		bIsTransitioning; \
/*0x01BA*/ bool		bTopAnchoredToTop; \
...
/*0x01C8*/ bool		bFullyScreenClipped; \
/*0x01C9*/ bool		bIsParentOrContextMenuWindow; \
/*0x01CC*/ struct _CXSTR*	DataStr; \
/*0x01D0*/ bool		bClientRectChanged; \
/*0x01D4*/ int		BlinkDuration; \
/*0x01D8*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x01D9*/ bool		bBottomAnchoredToTop; \
/*0x01DA*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x01DC*/ DWORD  BackgroundDrawType; \
/*0x01E0*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x01E4*/ int		TopOffset; \
/*0x01E8*/ bool		bMarkedForDelete; \
/*0x01E9*/ bool		bScreenClipRectChanged; \
...
// CBazaarSearchWnd_size: 0x92d8 (see 5589DE) in Oct 21 2020 Beta - eqmule
...
//aAPwcsincombat
// CPlayerWindow_size: 0x2f0 (see 5582CE) in Oct 21 2020 Beta - eqmule
...
// CTargetWindow_size: 0x8d0 (see 558165) in Oct 21 2020 Beta - eqmule
...
// CBuffWindow_size: 0x720 (see 558009) in Oct 21 2020 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x328 (see 7F9DFB) in Oct 21 2020 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d8 (see 5583C7) in Oct 21 2020 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d8 (see 7F9F0C) in Oct 21 2020 Beta - eqmule
...
// CItemDisplayWindow_size: 0x630 (see 75C8D2) in Oct 21 2020 Beta - eqmule
...
// CLootWnd_size: 0x3a0 (see 558736) in Oct 21 2020 Beta - eqmule
...
// CMapViewWnd_size: 0x658 (see 557E6A) in Oct 21 2020 Beta - eqmule
...
// CMerchantWnd_size: 0x450 (see 558892) in Oct 21 2020 Beta - eqmule
...
// CPetInfoWindow_size: 0x8d0 (see 5578C1) in Oct 21 2020 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a8 (see 557BB2) in Oct 21 2020 Beta - eqmule
...
// CTradeWnd__size: 0x2f8 (see 558938) in Oct 21 2020 Beta - eqmule
...
// CFactionWnd__size: 0x280 (see 558A84) in Oct 21 2020 Beta - eqmule
