...
/*0x0050*/ struct _CSIDLWND* pWndFocusOther; \
...
/*0x006C*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x006D*/ bool		Faded; \
/*0x006E*/ bool		bClientClipRectChanged; \
...
/*0x00D4*/ bool		bMarkedForDelete; \
/*0x00D5*/ BYTE		TargetAlpha; \
...
/*0x00ED*/ bool		bUseInLayoutHorizontal; \
/*0x00EE*/ bool		bBorder; \
/*0x00EF*/ bool		bMaximizable; \
/*0x00F0*/ void*	pTextObject; \
/*0x00F4*/ RECT		Location; \
/*0x0104*/ BYTE     bResizableMask; \
/*0x0105*/ bool		bHCenterTooltip; \
/*0x0106*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
...
/*0x0174*/ bool		bLeftAnchoredToLeft; \
...
/*0x0199*/ BYTE		Alpha; \
/*0x019A*/ BYTE		StartAlpha; \
/*0x019C*/ int		LeftOffset; \
/*0x01A0*/ bool		bClientRectChanged; \
...
/*0x01BA*/ bool		Minimized; \
/*0x01BC*/ RECT		ClipRectClient; \
/*0x01CC*/ bool		bUseInLayoutVertical; \
/*0x01CD*/ bool		dShow; \
/*0x01CE*/ bool		bAction; \
/*0x01CF*/ bool		bActive; \
/*0x01D0*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x01D1*/ bool		bIsParentOrContextMenuWindow; \
/*0x01D2*/ BYTE Filler0x01D2[0x6]; \
/*0x01D8*/ \
public: \
			bool IsVisible() \
			{ \
...
// CBazaarSearchWnd_size: 0x92c0 (see 54DA1E) in Oct 31 2019 Beta - eqmule
...
// CPlayerWindow_size: 0x2d8 (see 54D30E) in Oct 31 2019 Beta - eqmule
...
// CTargetWindow_size: 0x8b8 (see 54D1A5) in Oct 31 2019 Beta - eqmule
...
// CBuffWindow_size: 0x708 (see 54D049) in Oct 31 2019 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x310 (see 8027DB) in Oct 31 2019 Beta - eqmule
...
// CCastSpellWnd_size: 0x2c0 (see 54D407) in Oct 31 2019 Beta - eqmule
...
// CInvSlotWnd_size: 0x2c0 (see 8028EC) in Oct 31 2019 Beta - eqmule
...
// CLootWnd_size: 0x388 (see 54D776) in Oct 31 2019 Beta - eqmule
...
// CMapViewWnd_size: 0x628 (see 54CEAA) in Oct 31 2019 Beta - eqmule
...
// CMerchantWnd_size: 0x438 (see 54D8D2) in Oct 31 2019 Beta - eqmule
...
// CPetInfoWindow_size: 0x8b8 (see 54C901) in Oct 31 2019 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x398 (see 54CBF2) in Oct 31 2019 Beta - eqmule
...
// CTradeWnd__size: 0x2e0 (see 54D978) in Oct 31 2019 Beta - eqmule
...
// CFactionWnd__size: 0x268 (see 54DAC4) in Oct 31 2019 Beta - eqmule
