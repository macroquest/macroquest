...
// actual size 0x1F0 in Oct 27 2019 Beta (see 0x94837D) - eqmule
// actual size 0x1E0 in Oct 28 2019 Beta (see 0x948D8D) - eqmule
...
/*0x0022*/ BYTE     bResizableMask; \
/*0x0024*/ struct _CSIDLWND* pWndFocusOther; \
/*0x0028*/ bool		bCaptureTitle; \
/*0x0029*/ BYTE		FadeAlpha; \
/*0x002A*/ bool		bBorder2; \
/*0x002B*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
...
/*0x0034*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x0038*/ RECT		OldLocation; \
/*0x0048*/ bool		bMaximizable; \
/*0x004C*/ DWORD	LastTimeMouseOver; \
/*0x0050*/ int		VScrollMax; \
/*0x0054*/ bool		Enabled; \
/*0x0055*/ bool		bHCenterTooltip; \
/*0x0056*/ bool		bFullyScreenClipped; \
/*0x0058*/ RECT		ClientRect; \
/*0x0068*/ void	    *pFont; \
/*0x006C*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x006D*/ bool		bUseInLayoutHorizontal; \
/*0x006E*/ bool		Fades; \
/*0x0070*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x0074*/ int		HScrollPos; \
/*0x0078*/ bool		bClientRectChanged; \
/*0x007C*/ void *pController; \
/*0x0080*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0084*/ bool		bUseInLayoutVertical; \
/*0x0088*/ __int64		Data; \
/*0x0090*/ bool		bScreenClipRectChanged; \
/*0x0094*/ RECT		Location; \
/*0x00A4*/ DWORD	XMLIndex; \
/*0x00A8*/ int		ParentAndContextMenuArrayIndex; \
/*0x00AC*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x00AD*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x00B0*/ UINT		BlinkFadeFreq; \
/*0x00B4*/ bool		Faded; \
/*0x00B8*/ UINT		FadeDuration; \
...
/*0x00FD*/ bool		bAction; \
/*0x00FE*/ bool		bLeftAnchoredToLeft; \
/*0x0100*/ UINT		LastBlinkFadeRefreshTime; \
/*0x0104*/ COLORREF DisabledBackground; \
/*0x0108*/ bool		bActive; \
/*0x010C*/ void*	pTextObject; \
/*0x0110*/ RECT		IconRect; \
/*0x0120*/ RECT		ClipRectScreen; \
/*0x0130*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
...
/*0x0140*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0141*/ bool		bTopAnchoredToTop; \
/*0x0144*/ int		DeleteCount; \
/*0x0148*/ int		LeftOffset; \
/*0x014C*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x014D*/ bool		bClientClipRectChanged; \
/*0x0150*/ DWORD  BackgroundDrawType; \
/*0x0154*/ LONG		BlinkStartTimer; \
/*0x0158*/ tagSIZE	MinClientSize; \
/*0x0160*/ void   *TitlePiece2; \
...
/*0x0172*/ bool		bBottomAnchoredToTop; \
/*0x0174*/ int		managerArrayIndex; \
/*0x0178*/ bool		bBorder; \
/*0x0179*/ bool		bClipToParent; \
/*0x017A*/ bool		bIsParentOrContextMenuWindow; \
/*0x017C*/ int		TopOffset; \
/*0x0180*/ struct _CXSTR*	DataStr; \
/*0x0184*/ void   *TitlePiece; \
/*0x0188*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x018C*/ RECT		ClipRectClient; \
/*0x019C*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
...
/*0x01C8*/ BYTE		TargetAlpha; \
/*0x01C9*/ bool		Minimized; \
/*0x01CA*/ BYTE		Alpha; \
/*0x01CB*/ bool		bKeepOnScreen; \
/*0x01CC*/ int		BlinkDuration; \
/*0x01D0*/ void		*pLayoutStrategy; \
/*0x01D4*/ int		HScrollMax; \
/*0x01D8*/ bool		bTiled; \
...
// CBazaarSearchWnd_size: 0x92c8 (see 54C79E) in Oct 28 2019 Beta - eqmule
...
// CPlayerWindow_size: 0x2e0 (see 54C08E) in Oct 28 2019 Beta - eqmule
...
// CTargetWindow_size: 0x8c0 (see 54BF25) in Oct 28 2019 Beta - eqmule
...
// CBuffWindow_size: 0x710 (see 54BDC9) in Oct 28 2019 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x318 (see 8006DB) in Oct 28 2019 Beta - eqmule
...
// CCastSpellWnd_size: 0x2c8 (see 54C187) in Oct 28 2019 Beta - eqmule
...
// CInvSlotWnd_size: 0x2c8 (see 8007EC) in Oct 28 2019 Beta - eqmule
...
// CItemDisplayWindow_size: 0x620 (see 763A22) in Oct 28 2019 Beta - eqmule
...
// CLootWnd_size: 0x390 (see 54C4F6) in Oct 28 2019 Beta - eqmule
...
// CMapViewWnd_size: 0x638 (see 54BC2A) in Oct 28 2019 Beta - eqmule
...
// CMerchantWnd_size: 0x440 (see 54C652) in Oct 28 2019 Beta - eqmule
...
// CPetInfoWindow_size: 0x8c0 (see 54B681) in Oct 28 2019 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a0 (see 54B972) in Oct 28 2019 Beta - eqmule
...
// CTradeWnd__size: 0x2e8 (see 54C6F8) in Oct 28 2019 Beta - eqmule
...
// CFactionWnd__size: 0x270 (see 54C844) in Oct 28 2019 Beta - eqmule
