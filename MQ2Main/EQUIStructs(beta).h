...
/*0x0024*/ int		DeleteCount; \
/*0x0028*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x002C*/ RECT		ClipRectClient; \
/*0x003C*/ int		HScrollPos; \
/*0x0040*/ bool		bActive; \
/*0x0044*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
...
/*0x0056*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
...
/*0x0085*/ bool		bClientRectChanged; \
/*0x0088*/ tagSIZE	MinClientSize; \
/*0x0090*/ bool		bMaximizable; \
/*0x0091*/ bool		bBorder; \
/*0x0092*/ bool		bBorder2; \
/*0x0094*/ void*	pTextObject; \
/*0x0098*/ void   *TitlePiece; \
/*0x009C*/ int		HScrollMax; \
/*0x00A0*/ bool		bIsTransitioning; \
/*0x00A1*/ bool		bTopAnchoredToTop; \
...
/*0x00B4*/ BYTE		StartAlpha; \
/*0x00B5*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x00B8*/ int		VScrollMax; \
/*0x00BC*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x00C0*/ bool		bBottomAnchoredToTop; \
/*0x00C4*/ void* pTipTextObject; \
...
/*0x00F4*/ bool		bClientClipRectChanged; \
...
/*0x011C*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
/*0x0120*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x0124*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x013C*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x0140*/ bool		Minimized; \
/*0x0141*/ bool		bRightAnchoredToLeft; \
/*0x0142*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x0143*/ bool		bUseInLayoutVertical; \
/*0x0144*/ bool		bTiled; \
/*0x0145*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x0146*/ bool		bScreenClipRectChanged; \
/*0x0147*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x0148*/ bool		bAction; \
/*0x0149*/ BYTE		Alpha; \
/*0x014C*/ RECT		OldLocation; \
/*0x015C*/ void	*IconTextureAnim; \
/*0x0160*/ bool		bLeftAnchoredToLeft; \
/*0x0161*/ BYTE     bResizableMask; \
/*0x0164*/ void   *TitlePiece2; \
/*0x0168*/ BYTE		TargetAlpha; \
/*0x016C*/ RECT		IconRect; \
/*0x017C*/ tagSIZE	MaxClientSize; \
/*0x0184*/ DWORD	LastTimeMouseOver; \
...
/*0x01A0*/ bool		bFullyScreenClipped; \
/*0x01A4*/ UINT		BlinkFadeFreq; \
/*0x01A8*/ bool		Fades; \
/*0x01A9*/ bool		bMarkedForDelete; \
/*0x01AC*/ RECT		ClientRect; \
/*0x01BC*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x01BD*/ bool		bIsParentOrContextMenuWindow; \
/*0x01C0*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x01C4*/ int	Transition; \
/*0x01C8*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x01C9*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x01CC*/ RECT		Location; \
/*0x01DC*/ int		TopOffset; \
/*0x01E0*/ bool		dShow; \
/*0x01E1*/ bool		Enabled; \
/*0x01E4*/ struct _CSIDLWND* pWndFocusOther; \
/*0x01E8*/ bool		bHCenterTooltip; \
...
// CBazaarSearchWnd_size: 0x92d8 (see 55A8CE) in Oct 29 2020 Beta - eqmule
...
//aAPwcsincombat
// CPlayerWindow_size: 0x2f0 (see 55A1BE) in Oct 29 2020 Beta - eqmule
...
// CTargetWindow_size: 0x8d0 (see 55A055) in Oct 29 2020 Beta - eqmule
...
// CBuffWindow_size: 0x720 (see 559EF9) in Oct 29 2020 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x328 (see 7FB52B) in Oct 29 2020 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d8 (see 55A2B7) in Oct 29 2020 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d8 (see 7FB62C) in Oct 29 2020 Beta - eqmule
...
// CItemDisplayWindow_size: 0x630 (see 75E332) in Oct 29 2020 Beta - eqmule
...
// CLootWnd_size: 0x3a0 (see 55A626) in Oct 29 2020 Beta - eqmule
...
// CMapViewWnd_size: 0x658 (see 559D5A) in Oct 29 2020 Beta - eqmule
...
// CMerchantWnd_size: 0x450 (see 55A782) in Oct 29 2020 Beta - eqmule
...
// CPetInfoWindow_size: 0x8d0 (see 5597B1) in Oct 29 2020 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a8 (see 559AA2) in Oct 29 2020 Beta - eqmule
...
// CTradeWnd__size: 0x2f8 (see 55A828) in Oct 29 2020 Beta - eqmule
...
// CFactionWnd__size: 0x280 (see 55A974) in Oct 29 2020 Beta - eqmule
