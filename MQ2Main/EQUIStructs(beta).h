...
// actual size 0x1F0 in Oct 28 2016 Beta (see 0x696712) - eqmule
// actual size 0x1E8 in Oct 29 2016 Beta (see 0x696848) - eqmule
...
/*0x001f*/ BYTE		Unknown0x001f[0x11]; \
...
/*0x0058*/ BYTE		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x0059*/ BYTE		Unknown0x0059[0x1f]; \
...
/*0x0140*/ BYTE		Unknown0x0140[0x9]; \
/*0x0149*/ BYTE		Alpha; \
/*0x014a*/ BYTE		MouseOver; /*found in CXWnd__SetMouseOver_x*/ \
/*0x014b*/ BYTE		Unknown0x014b; \
/*0x014c*/ RECT		OldLocation; \
/*0x015c*/ DWORD	TimeMouseOver; \
/*0x0160*/ BYTE		Unknown0x0160[0x11]; \
/*0x0171*/ BYTE		Fades; \
/*0x0172*/ BYTE		Unknown0x0172[0x47]; \
/*0x01b9*/ BYTE		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x01ba*/ BYTE		Unknown0x01ba[0xa]; \
/*0x01c4*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x01c8*/ BYTE		Unknown0x01c8[0x20];
/*0x01e8*/
