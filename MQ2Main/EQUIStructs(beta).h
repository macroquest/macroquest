...
/*0x0022*/ bool		Minimized; \
/*0x0024*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x003C*/ bool		bClientClipRectChanged; \
/*0x003D*/ bool		bIsTransitioning; \
/*0x0040*/ UINT		TransitionStartTick; \
/*0x0044*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0048*/ bool		bFullyScreenClipped; \
/*0x0049*/ BYTE     bResizableMask; \
/*0x004A*/ bool		bClientRectChanged; \
/*0x004B*/ bool		bAction; \
/*0x004C*/ void	    *pFont; \
/*0x0050*/ RECT		Location; \
/*0x0060*/ bool		bIsParentOrContextMenuWindow; \
...
/*0x0088*/ bool		bEscapableLocked; \
/*0x008C*/ DWORD	FadeDelay; \
/*0x0090*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x0091*/ bool		bBorder2; \
/*0x0094*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x0098*/ RECT		TransitionRect; \
/*0x00A8*/ LONG		BlinkStartTimer; \
/*0x00AC*/ int		DeleteCount; \
/*0x00B0*/ bool		bBringToTopWhenClicked; \
...
/*0x0152*/ bool		bLeftAnchoredToLeft; \
/*0x0154*/ void		*pLayoutStrategy; \
/*0x0158*/ UINT		FadeDuration; \
/*0x015C*/ bool		bTopAnchoredToTop; \
/*0x015D*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
...
/*0x0185*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0188*/ void   *TitlePiece2; \
/*0x018C*/ bool		bUseInLayoutVertical; \
...
/*0x0195*/ bool		bBorder; \
/*0x0196*/ bool		dShow; \
/*0x0197*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
...
/*0x01B4*/ int		ParentAndContextMenuArrayIndex; \
...
// CBazaarSearchWnd_size: 0x92d0 (see 55B5DE) in Nov 23 2020 Beta - eqmule
...
// CPlayerWindow_size: 0x2e8 (see 55AECE) in Nov 23 2020 Beta - eqmule
...
// CTargetWindow_size: 0x8c8 (see 55AD65) in Nov 23 2020 Beta - eqmule
...
// CBuffWindow_size: 0x718 (see 55AC09) in Nov 23 2020 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x320 (see 7FC5AB) in Nov 23 2020 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d0 (see 55AFC7) in Nov 23 2020 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d0 (see 7FC6BC) in Nov 23 2020 Beta - eqmule
...
// CItemDisplayWindow_size: 0x628 (see 75F152) in Nov 23 2020 Beta - eqmule
...
// CLootWnd_size: 0x398 (see 55B336) in Nov 23 2020 Beta - eqmule
...
// CMapViewWnd_size: 0x648 (see 55AA6A) in Nov 23 2020 Beta - eqmule
...
// CMerchantWnd_size: 0x448 (see 55B492) in Nov 23 2020 Beta - eqmule
...
// CPetInfoWindow_size: 0x8c8 (see 55A4C1) in Nov 23 2020 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a0 (see 55A7B2) in Nov 23 2020 Beta - eqmule
...
// CTradeWnd__size: 0x2f0 (see 55B538) in Nov 23 2020 Beta - eqmule
...
// CFactionWnd__size: 0x278 (see 55B684) in Nov 23 2020 Beta - eqmule
