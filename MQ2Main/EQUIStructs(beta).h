...
// actual size 0x1F0 in Oct 29 2019 Beta (see 0x94A6CD) - eqmule
// actual size 0x1D8 in Oct 31 2019 Beta (see 0x94B62D) - eqmule
// actual size 0x1E8 in Nov  1 2019 Beta (see 0x94CADD) - eqmule
// actual size 0x1E0 in Nov  2 2019 Beta (see 0x94DA3D) - eqmule
#define CXW_NO_VTABLE \
private: \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ RECT		ClientRect; \
...
/*0x0054*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x0055*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x0058*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x005C*/ tagSIZE	MinClientSize; \
/*0x0064*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x0065*/ bool		bBringToTopWhenClicked; \
/*0x0066*/ bool		bMaximized; \
...
/*0x0071*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0074*/ RECT		IconRect; \
...
/*0x008C*/ bool		dShow; \
/*0x008D*/ bool		bKeepOnScreen; \
/*0x008E*/ bool		bUseInLayoutHorizontal; \
...
/*0x00B0*/ void*	pTextObject; \
/*0x00B4*/ int		HScrollPos; \
/*0x00B8*/ void	*DrawTemplate; \
/*0x00BC*/ BYTE     bResizableMask; \
/*0x00BD*/ bool		bBorder; \
/*0x00C0*/ int		managerArrayIndex; \
/*0x00C4*/ bool		bEscapableLocked; \
/*0x00C5*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x00C6*/ bool		bHCenterTooltip; \
/*0x00C7*/ bool		bMaximizable; \
/*0x00C8*/ RECT		ClipRectClient; \
/*0x00D8*/ bool		bIsTransitioning; \
...
/*0x00F4*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x00F5*/ BYTE		FadeAlpha; \
/*0x00F6*/ bool		bBottomAnchoredToTop; \
/*0x00F8*/ DWORD	XMLIndex; \
/*0x00FC*/ tagSIZE	MaxClientSize; \
/*0x0104*/ bool		bFullyScreenClipped; \
/*0x0105*/ BYTE		Alpha; \
/*0x0106*/ bool		bActive; \
/*0x0108*/ RECT		Location; \
/*0x0118*/ int	Transition; \
/*0x0120*/ __int64		Data; \
/*0x0128*/ BYTE		StartAlpha; \
/*0x0129*/ bool		bUseInLayoutVertical; \
/*0x012C*/ UINT		FadeDuration; \
/*0x0130*/ RECT		TransitionRect; \
/*0x0140*/ bool		bLeftAnchoredToLeft; \
/*0x0141*/ bool		bClientClipRectChanged; \
/*0x0142*/ bool		Enabled; \
...
/*0x016C*/ struct _CSIDLWND* pWndFocusOther; \
/*0x0170*/ int		BlinkState; \
/*0x0174*/ void   *TitlePiece; \
/*0x0178*/ void   *TitlePiece2; \
/*0x017C*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
...
/*0x018D*/ bool		bBorder2; \
/*0x018E*/ BYTE		TargetAlpha; \
/*0x018F*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x0190*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x0194*/ UINT		BlinkFadeStartTime; \
/*0x0198*/ void *pController; \
/*0x019C*/ COLORREF DisabledBackground; \
/*0x01A0*/ void	    *pFont; \
/*0x01A4*/ bool		bClipToParent; \
...
// CBazaarSearchWnd_size: 0x92c8 (see 54D2EE) in Nov  2 2019 Beta - eqmule
...
// CPlayerWindow_size: 0x2e0 (see 54CBDE) in Nov  2 2019 Beta - eqmule
...
// CTargetWindow_size: 0x8c0 (see 54CA75) in Nov  2 2019 Beta - eqmule
...
// CBuffWindow_size: 0x710 (see 54C919) in Nov  2 2019 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x318 (see 803CAB) in Nov  2 2019 Beta - eqmule
...
// CCastSpellWnd_size: 0x2c8 (see 54CCD7) in Nov  2 2019 Beta - eqmule
...
// CInvSlotWnd_size: 0x2c8 (see 803DAC) in Nov  2 2019 Beta - eqmule
...
// CItemDisplayWindow_size: 0x620 (see 766B92) in Nov  2 2019 Beta - eqmule
...
// CLootWnd_size: 0x390 (see 54D046) in Nov  2 2019 Beta - eqmule
...
// CMapViewWnd_size: 0x638 (see 54C77A) in Nov  2 2019 Beta - eqmule
...
// CMerchantWnd_size: 0x440 (see 54D1A2) in Nov  2 2019 Beta - eqmule
...
// CPetInfoWindow_size: 0x8c0 (see 54C1D1) in Nov  2 2019 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a0 (see 54C4C2) in Nov  2 2019 Beta - eqmule
...
// CTradeWnd__size: 0x2e8 (see 54D248) in Nov  2 2019 Beta - eqmule
...
// CFactionWnd__size: 0x270 (see 54D394) in Nov  2 2019 Beta - eqmule
