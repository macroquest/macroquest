...
// actual size 0x1F8 in Oct 22 2019 Beta (see 0x9446ED) - eqmule
...
/*0x0021*/ bool		Faded; \
/*0x0024*/ void	*DrawTemplate; \
/*0x0028*/ int		BlinkState; \
/*0x002C*/ RECT		ClipRectScreen; \
/*0x003C*/ void	    *pFont; \
...
/*0x0060*/ BYTE		Alpha; \
/*0x0061*/ bool		Minimized; \
/*0x0064*/ struct _CXSTR*	DataStr; \
/*0x0068*/ void	*IconTextureAnim; \
/*0x006C*/ int		RightOffset; \
/*0x0070*/ bool		dShow; \
/*0x0071*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x0072*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x0074*/ struct _CSIDLWND* pWndFocusOther; \
/*0x0078*/ bool		bMaximizable; \
/*0x007C*/ DWORD	FadeDelay; \
/*0x0080*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x0084*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0085*/ bool		bBorder; \
/*0x0088*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x008C*/ bool		bKeepOnScreen; \
/*0x0090*/ LONG		BlinkStartTimer; \
/*0x0094*/ bool		bIsParentOrContextMenuWindow; \
/*0x0095*/ bool		bCaptureTitle; \
/*0x0098*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x009C*/ RECT		IconRect; \
/*0x00AC*/ UINT		LastBlinkFadeRefreshTime; \
/*0x00B0*/ bool		bClipToParent; \
/*0x00B4*/ UINT		TransitionDuration; \
/*0x00B8*/ bool		bMarkedForDelete; \
/*0x00BC*/ DWORD  BackgroundDrawType; \
/*0x00C0*/ RECT		OldLocation; \
/*0x00D0*/ bool		bTiled; \
/*0x00D4*/ RECT		Location; \
/*0x00E4*/ bool		Enabled; \
/*0x00E5*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x00E8*/ int		LeftOffset; \
/*0x00EC*/ RECT		TransitionRect; \
/*0x00FC*/ bool		bTopAnchoredToTop; \
/*0x0100*/ int	Transition; \
/*0x0104*/ UINT		BlinkFadeStartTime; \
/*0x0108*/ bool		bMaximized; \
/*0x010C*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0110*/ COLORREF DisabledBackground; \
/*0x0114*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x0118*/ int		VScrollPos; \
/*0x011C*/ bool		bBringToTopWhenClicked; \
/*0x0120*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
/*0x0124*/ bool		bClientClipRectChanged; \
/*0x0125*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x0128*/ void   *TitlePiece; \
/*0x012C*/ int		TopOffset; \
/*0x0130*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x0148*/ UINT		FadeDuration; \
/*0x014C*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x014D*/ bool		bLeftAnchoredToLeft; \
/*0x014E*/ bool		bAction; \
...
/*0x015C*/ bool		bActive; \
/*0x0160*/ int		HScrollMax; \
/*0x0164*/ bool		bClientRectChanged; \
...
/*0x0174*/ bool		bFullyScreenClipped; \
/*0x0175*/ bool		bBorder2; \
/*0x0178*/ void* pTipTextObject; \
/*0x017C*/ int		BottomOffset; \
/*0x0180*/ bool		bIsTransitioning; \
/*0x0184*/ int		BlinkDuration; \
/*0x0188*/ bool		bScreenClipRectChanged; \
/*0x0189*/ BYTE     bResizableMask; \
/*0x018C*/ UINT		BlinkFadeFreq; \
/*0x0190*/ BYTE		StartAlpha; \
/*0x0191*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0192*/ bool		bUseInLayoutHorizontal; \
/*0x0194*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x0198*/ BYTE		TargetAlpha; \
/*0x019C*/ void   *TitlePiece2; \
/*0x01A0*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x01A4*/ int		DeleteCount; \
/*0x01A8*/ RECT		ClientRect; \
/*0x01B8*/ int		VScrollMax; \
/*0x01BC*/ UINT		TransitionStartTick; \
/*0x01C0*/ bool		bEscapableLocked; \
/*0x01C1*/ BYTE		FadeAlpha; \
/*0x01C2*/ bool		bBottomAnchoredToTop; \
/*0x01C4*/ tagSIZE	MaxClientSize; \
/*0x01CC*/ bool		bRightAnchoredToLeft; \
/*0x01D0*/ void		*pLayoutStrategy; \
/*0x01D8*/ __int64		Data; \
/*0x01E0*/ bool		Fades; \
/*0x01E4*/ UINT		BlinkFadeDuration; \
/*0x01E8*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x01EC*/ bool		bUseInLayoutVertical; \
/*0x01F0*/ int		managerArrayIndex; \
...
// CBazaarSearchWnd_size: 0x92e0 (see 54A79E) in Oct 22 2019 Beta - eqmule
...
// CPlayerWindow_size: 0x2f8 (see 54A08E) in Oct 22 2019 Beta - eqmule
...
// CTargetWindow_size: 0x8d8 (see 549F25) in Oct 22 2019 Beta - eqmule
...
// CBuffWindow_size: 0x728 (see 549DC9) in Oct 22 2019 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x330 (see 7FC48B) in Oct 22 2019 Beta - eqmule
...
// CCastSpellWnd_size: 0x2e0 (see 54A187) in Oct 22 2019 Beta - eqmule
...
// CInvSlotWnd_size: 0x2e0 (see 7FC59C) in Oct 22 2019 Beta - eqmule
...
// CItemDisplayWindow_size: 0x638 (see 75F532) in Oct 22 2019 Beta - eqmule
...
// CLootWnd_size: 0x3a8 (see 54A4F6) in Oct 22 2019 Beta - eqmule
...
// CMapViewWnd_size: 0x668 (see 549C2A) in Oct 22 2019 Beta - eqmule
...
// CMerchantWnd_size: 0x458 (see 54A652) in Oct 22 2019 Beta - eqmule
...
// CPetInfoWindow_size: 0x8d8 (see 549681) in Oct 22 2019 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3b8 (see 549972) in Oct 22 2019 Beta - eqmule
...
// CTradeWnd__size: 0x300 (see 54A6F8) in Oct 22 2019 Beta - eqmule
...
// CFactionWnd__size: 0x288 (see 54A844) in Oct 22 2019 Beta - eqmule
