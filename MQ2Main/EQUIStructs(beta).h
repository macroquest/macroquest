...
/*0x0024*/ BYTE		StartAlpha; \
/*0x0028*/ void *pController; \
/*0x002C*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
...
/*0x0045*/ BYTE		FadeAlpha; \
/*0x0046*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x0047*/ bool		bClientRectChanged; \
/*0x0048*/ BYTE		TargetAlpha; \
/*0x004C*/ int		managerArrayIndex; \
/*0x0050*/ bool		bHCenterTooltip; \
/*0x0051*/ bool		bEscapableLocked; \
/*0x0052*/ bool		bClipToParent; \
/*0x0054*/ int		VScrollMax; \
/*0x0058*/ int		RightOffset; \
/*0x005C*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0060*/ bool		bClientClipRectChanged; \
/*0x0061*/ bool		Fades; \
...
/*0x009A*/ bool		bIsTransitioning; \
/*0x009B*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x009C*/ bool		bMaximizable; \
/*0x00A0*/ UINT		LastBlinkFadeRefreshTime; \
/*0x00A4*/ int		LeftOffset; \
/*0x00A8*/ tagSIZE	MinClientSize; \
/*0x00B0*/ bool		bScreenClipRectChanged; \
/*0x00B4*/ DWORD	LastTimeMouseOver; \
/*0x00B8*/ int		HScrollPos; \
/*0x00BC*/ UINT		FadeDuration; \
/*0x00C0*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x00D8*/ bool		bBorder2; \
/*0x00D9*/ bool		bMarkedForDelete; \
/*0x00DA*/ bool		bCaptureTitle; \
/*0x00DC*/ void*	pTextObject; \
/*0x00E0*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x00E4*/ DWORD	FadeDelay; \
...
/*0x0184*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0185*/ bool		bIsParentOrContextMenuWindow; \
/*0x0188*/ struct _CXSTR*	DataStr; \
/*0x018C*/ void	*IconTextureAnim; \
/*0x0190*/ bool		bRightAnchoredToLeft; \
/*0x0191*/ bool		bFullyScreenClipped; \
...
/*0x01E0*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x01E4*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
...
// CBazaarSearchWnd_size: 0x92d8 (see 55AA1E) in Nov 17 2020 Beta - eqmule
...
//aAPwcsincombat
// CPlayerWindow_size: 0x2f0 (see 55A30E) in Nov 17 2020 Beta - eqmule
...
// CTargetWindow_size: 0x8d0 (see 55A1A5) in Nov 17 2020 Beta - eqmule
...
// CBuffWindow_size: 0x720 (see 55A049) in Nov 17 2020 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x328 (see 7FB6FB) in Nov 17 2020 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d8 (see 55A407) in Nov 17 2020 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d8 (see 7FB80C) in Nov 17 2020 Beta - eqmule
...
// CItemDisplayWindow_size: 0x630 (see 75E4F2) in Nov 17 2020 Beta - eqmule
...
// CLootWnd_size: 0x3a0 (see 55A776) in Nov 17 2020 Beta - eqmule
...
// CMapViewWnd_size: 0x658 (see 559EAA) in Nov 17 2020 Beta - eqmule
...
// CMerchantWnd_size: 0x450 (see 55A8D2) in Nov 17 2020 Beta - eqmule
...
// CPetInfoWindow_size: 0x8d0 (see 559901) in Nov 17 2020 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a8 (see 559BF2) in Nov 17 2020 Beta - eqmule
...
// CTradeWnd__size: 0x2f8 (see 55A978) in Nov 17 2020 Beta - eqmule
...
// CFactionWnd__size: 0x280 (see 55AAC4) in Nov 17 2020 Beta - eqmule
