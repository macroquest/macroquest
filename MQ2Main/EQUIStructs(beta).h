...
// actual size 0x1F0 in Nov  6 2019 Beta (see 0x94C1AD) - eqmule
...
/*0x007C*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x007D*/ bool		bAction; \
/*0x007E*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0080*/ int		RightOffset; \
/*0x0084*/ void *pController; \
/*0x0088*/ bool		bBorder; \
/*0x008C*/ struct _CXSTR*	DataStr; \
/*0x0090*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x0094*/ UINT		BlinkFadeFreq; \
/*0x0098*/ bool		Fades; \
/*0x009C*/ int		HScrollPos; \
/*0x00A0*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x00A4*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x00BC*/ bool		bIsParentOrContextMenuWindow; \
/*0x00BD*/ bool		bMarkedForDelete; \
/*0x00C0*/ void	*DrawTemplate; \
/*0x00C4*/ int		managerArrayIndex; \
/*0x00C8*/ void	*IconTextureAnim; \
/*0x00CC*/ bool		bMaximized; \
/*0x00CD*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x00D0*/ RECT		OldLocation; \
/*0x00E0*/ bool		bKeepOnScreen; \
/*0x00E4*/ UINT		FadeDuration; \
/*0x00E8*/ bool		bScreenClipRectChanged; \
/*0x00EC*/ void	    *pFont; \
...
/*0x0105*/ BYTE		FadeAlpha; \
/*0x0106*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x0108*/ COLORREF DisabledBackground; \
/*0x010C*/ void   *TitlePiece; \
/*0x0110*/ UINT		BlinkFadeDuration; \
/*0x0114*/ bool		bBorder2; \
/*0x0115*/ bool		bMaximizable; \
/*0x0116*/ bool		bCaptureTitle; \
/*0x0118*/ __int64		Data; \
/*0x0120*/ BYTE     bResizableMask; \
/*0x0121*/ bool		bBottomAnchoredToTop; \
/*0x0122*/ bool		bClientClipRectChanged; \
/*0x0124*/ UINT		TransitionStartTick; \
/*0x0128*/ bool		bTopAnchoredToTop; \
...
/*0x0138*/ bool		bClientRectChanged; \
/*0x013C*/ struct _CSIDLWND* pWndFocusOther; \
/*0x0140*/ DWORD	XMLIndex; \
/*0x0144*/ BYTE		StartAlpha; \
/*0x0145*/ bool		bHCenterTooltip; \
/*0x0146*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x0147*/ bool		Enabled; \
/*0x0148*/ void   *TitlePiece2; \
/*0x014C*/ bool		bEscapableLocked; \
/*0x0150*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0154*/ void*	pTextObject; \
/*0x0158*/ bool		bFullyScreenClipped; \
/*0x0159*/ bool		bUseInLayoutVertical; \
/*0x015C*/ int		DeleteCount; \
/*0x0160*/ DWORD	LastTimeMouseOver; \
/*0x0164*/ RECT		TransitionRect; \
...
/*0x01C0*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x01C4*/ DWORD  BackgroundDrawType; \
/*0x01C8*/ bool		bClipToParent; \
/*0x01C9*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x01CA*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x01CC*/ int		VScrollMax; \
/*0x01D0*/ int		TopOffset; \
/*0x01D4*/ DWORD	FadeDelay; \
/*0x01D8*/ int		BottomOffset; \
...
// CBazaarSearchWnd_size: 0x92d0 (see 54E80E) in Nov  8 2019 Beta - eqmule
...
// CPlayerWindow_size: 0x2e8 (see 54E0FE) in Nov  8 2019 Beta - eqmule
...
// CTargetWindow_size: 0x8c8 (see 54DF95) in Nov  8 2019 Beta - eqmule
...
// CBuffWindow_size: 0x718 (see 54DE39) in Nov  8 2019 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x320 (see 80398B) in Nov  8 2019 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d0 (see 54E1F7) in Nov  8 2019 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d0 (see 803A9C) in Nov  8 2019 Beta - eqmule
...
// CItemDisplayWindow_size: 0x628 (see 766D32) in Nov  8 2019 Beta - eqmule
...
// CLootWnd_size: 0x398 (see 54E566) in Nov  8 2019 Beta - eqmule
...
// CMapViewWnd_size: 0x648 (see 54DC9A) in Nov  8 2019 Beta - eqmule
...
// CMerchantWnd_size: 0x448 (see 54E6C2) in Nov  8 2019 Beta - eqmule
...
// CPetInfoWindow_size: 0x8c8 (see 54D6F1) in Nov  8 2019 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a8 (see 54D9E2) in Nov  8 2019 Beta - eqmule
...
// CTradeWnd__size: 0x2f0 (see 54E768) in Nov  8 2019 Beta - eqmule
...
// CFactionWnd__size: 0x278 (see 54E8B4) in Nov  8 2019 Beta - eqmule
