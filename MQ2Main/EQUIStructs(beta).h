...
/*0x100*/ LPVOID  GetMinSize; \
/*0x104*/ LPVOID  GetMaxSize; \
/*0x108*/ LPVOID  GetUntileSize; \
/*0x10c*/ LPVOID  IsPointTransparent; \
/*0x110*/ LPVOID  Unknown10c; \
/*0x114*/ LPVOID  Unknown110; \
/*0x118*/ LPVOID  Unknown114; \
...
/*0x12c*/ LPVOID  Unknown0x128; /*CXWnd__GetChildWndAt_x*/ \
/*0x130*/ LPVOID  Unknown0x12c; /*CSidlScreenWnd__GetSidlPiece_x*/ \
/*0x134*/ LPVOID  Unknown0x130; \
...
/*0x128*/ LPVOID  GetChildWndAt; /*CXWnd__GetChildWndAt_x*/ \
...
/*0x13c*/ LPVOID  AutoSetVScrollPos; \
/*0x140*/ LPVOID  AutoSetHScrollPos; \
/*0x144*/ LPVOID  SetAttributesFromSidl; \
/*0x148*/ LPVOID  nullsub_1; \
/*0x14c*/ LPVOID  Unknown0x14c; \
/*0x150*/ LPVOID  Unknown0x150; \
/*0x154*/ LPVOID  GetMinClientSize; \
/*0x158*/ LPVOID  GetMaxClientSize; \
/*0x15c*/ LPVOID  PostDraw8; \
/*0x160*/ LPVOID  UpdateLayout; \
/*0x164*/
...
VFTABLE
/*0x164*/ LPVOID  PostDraw9;
/*0x168*/ LPVOID  PostDraw10;
/*0x16c*/ LPVOID  LoadIniInfo;
/*0x170*/ LPVOID  StoreIniInfo;
/*0x174*/ LPVOID  EQObject__AsObject;
#if !defined(EMU)
...
// actual size 0x1E0 in Oct 11 2016 Beta (see 0x696338) - eqmule
// actual size 0x1E8 in Oct 12 2016 Beta (see 0x697848) - eqmule
// actual size 0x1F0 in Oct 13 2016 Beta (see 0x695FD8) - eqmule
// actual size 0x1E8 in Oct 15 2016 Beta (see 0x696852) - eqmule
// actual size 0x1F8 in Oct 18 2016 Beta (see 0x696BB8) - eqmule
...
/*0x0034*/ DWORD	HScrollMax; \
/*0x0038*/ BYTE		Unknown0x0038[0x1c]; \
/*0x0054*/ DWORD	XMLIndex; \
/*0x0058*/ BYTE		Locked; /*found in CSidlScreenWnd__LoadIniInfo_x*/ \
/*0x0059*/ BYTE		Enabled; \
/*0x005a*/ BYTE		Unknown0x005a[0x2]; \
...
/*0x006c*/ LPVOID	DrawTemplate; \
/*0x0070*/ BYTE		Unknown0x0070[0x1c]; \
...
/*0x00b4*/ BYTE		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x00b5*/ BYTE		Unknown0x00b5[0x3]; \
/*0x00b8*/ DWORD	TimeMouseOver; \
/*0x00bc*/ DWORD	ZLayer; /*found in CXWndManager__DrawWindows_x*/ \
/*0x00c0*/ BYTE		Unknown0x00c0; \
/*0x00c1*/ BYTE		MouseOver; /*found in CXWnd__SetMouseOver_x*/ \
/*0x00c2*/ BYTE		Unknown0x00c2[0x2]; \
/*0x00c4*/ DWORD	TickCount2; \
/*0x00c8*/ ARGBCOLOR	BGColor; \
/*0x00cc*/ BYTE		Unknown0x00cc[0x10]; \
/*0x00dc*/ BYTE		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x00dd*/ BYTE		Unknown0x00dd[0xf]; \
/*0x00ec*/ BYTE		Minimized; \
/*0x00ed*/ BYTE		Unknown0x00ed[0x2f]; \
...
/*0x0145*/ BYTE		Unknown0x0145[0x33]; \
/*0x0178*/ DWORD	VScrollMax; \
/*0x017c*/ BYTE		Unknown0x017c[0x2]; \
/*0x017e*/ BYTE		Faded; \
/*0x017f*/ BYTE		Unknown0x017f; \
/*0x0180*/ DWORD	UnknownCW; /*found in OnProcessFrame*/\
/*0x0184*/ BYTE		Unknown0x0184[0xc]; \
/*0x0190*/ DWORD	FadeDuration; \
/*0x0194*/ BYTE		Unknown0x0194[0x4]; \
/*0x0198*/ DWORD	VScrollPos; \
/*0x019c*/ BYTE		Unknown0x019c[0x8]; \
/*0x01a4*/ BYTE		Fades; \
/*0x01a5*/ BYTE		Unknown0x01a5[0x20]; \
/*0x01c5*/ BYTE		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x01c6*/ BYTE		Unknown0x01c6[0x12]; \
...
/*0x01e1*/ BYTE		Unknown0x01e1[0x7]; \
/*0x01e8*/ BYTE		Alpha; \
/*0x01e9*/ BYTE		Unknown0x01e9[0x0f];
/*0x01f8*/
...
// Actual Size: 0x2c0 (see 4BA50E) in Jun 28 2016 Test - eqmule
...
// Actual Size: 0x2c8 (see 796A49) in Jun 28 2016 Test - eqmule
...
// Actual Size: 0x600 (see 6E0AEF) in Jun 28 2016 Test - eqmule
...
// Actual Size: 0x390 (see 4BA8D0) in Jun 28 2016 Test - eqmule
...
// Actual Size: 0x668 (see 4B9CB5) in Jul  5 2016 Live - eqmule
...
// Actual Size: 0x2c8 (see 4BA9E9) in Jun 28 2016 Test - eqmule
...
// Actual Size: 0x8d8 (see 4BB290) in Oct 18 2016 Beta - eqmule
typedef struct _EQPETINFOWINDOW {
/*0x0000*/ struct _CSIDLWND     Wnd;
/*0x0240*/ DWORD PetSpawnID;//The pets SpawnID
/*0x0244*/ BYTE Unknown0x0234[0x4];
...
/*0x08d6*/ BYTE Unknown0x08c6[0x2];
/*0x08d8*/
} EQPETINFOWINDOW, *PEQPETINFOWINDOW;

//CRaidWindow__CRaidWindow
//aClasscolorD
// Actual Size: 0x3a0 (see 4B9CB3) in Jun 28 2016 Test - eqmule
...
// Actual Size: 0x2e8 (see 4BAA44) in Jun 28 2016 Test - eqmule
