...
/*0x0026*/ bool		bBringToTopWhenClicked; \
...
/*0x003C*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x0040*/ int	Transition; \
...
/*0x0078*/ bool		bActive; \
/*0x0079*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x007C*/ UINT		BlinkFadeStartTime; \
/*0x0080*/ tagSIZE	MaxClientSize; \
/*0x0088*/ int		LeftOffset; \
/*0x008C*/ bool		bUseInLayoutVertical; \
/*0x0090*/ UINT		BlinkFadeDuration; \
/*0x0098*/ __int64		Data; \
/*0x00A0*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
/*0x00A4*/ bool		Faded; \
/*0x00A8*/ int		ParentAndContextMenuArrayIndex; \
/*0x00AC*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x00AD*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x00AE*/ bool		bScreenClipRectChanged; \
/*0x00AF*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x00B0*/ RECT		ClipRectScreen; \
/*0x00C0*/ bool		bMaximizable; \
/*0x00C4*/ void	*DrawTemplate; \
/*0x00C8*/ DWORD	FadeDelay; \
/*0x00CC*/ UINT		LastBlinkFadeRefreshTime; \
/*0x00D0*/ bool		Fades; \
/*0x00D1*/ bool		bMarkedForDelete; \
/*0x00D2*/ bool		bClipToParent; \
/*0x00D4*/ int		TopOffset; \
/*0x00D8*/ BYTE		TargetAlpha; \
/*0x00DC*/ tagSIZE	MinClientSize; \
/*0x00E4*/ UINT		TransitionDuration; \
/*0x00E8*/ bool		bMaximized; \
/*0x00EC*/ int		RightOffset; \
/*0x00F0*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x00F1*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x00F4*/ void*	pTextObject; \
/*0x00F8*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x00F9*/ bool		bClientRectChanged; \
...
/*0x0144*/ bool		bUseInLayoutHorizontal; \
/*0x0148*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x014C*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x014D*/ BYTE		FadeAlpha; \
/*0x0150*/ UINT		TransitionStartTick; \
/*0x0154*/ RECT		ClipRectClient; \
/*0x0164*/ UINT		BlinkFadeFreq; \
...
/*0x0178*/ struct _CSIDLWND* pWndFocusOther; \
/*0x017C*/ bool		Minimized; \
/*0x0180*/ void		*pLayoutStrategy; \
/*0x0184*/ bool		bEscapableLocked; \
/*0x0185*/ bool		bRightAnchoredToLeft; \
/*0x0186*/ bool		bTopAnchoredToTop; \
/*0x0188*/ RECT		Location; \
/*0x0198*/ bool		bFullyScreenClipped; \
/*0x0199*/ bool		bKeepOnScreen; \
/*0x019C*/ void	*IconTextureAnim; \
/*0x01A0*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x01A4*/ void   *TitlePiece2; \
/*0x01A8*/ bool		bLeftAnchoredToLeft; \
/*0x01A9*/ bool		bIsParentOrContextMenuWindow; \
/*0x01AC*/ int		HScrollMax; \
/*0x01B0*/ int		BottomOffset; \
/*0x01B4*/ bool		bTiled; \
...
// CBazaarSearchWnd_size: 0x92d0 (see 4CCABA) in Dec  4 2017 Beta - eqmule
...
// CPlayerWindow_size: 0x2e8 (see 4CC2FD) in Dec  4 2017 Beta - eqmule
...
// CTargetWindow_size: 0x8c8 (see 4CC194) in Dec  4 2017 Beta - eqmule
...
// CBuffWindow_size: 0x718 (see 4CC028) in Dec  4 2017 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x318 (see 7A2CB8) in Dec  4 2017 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d0 (see 4CC40E) in Dec  4 2017 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d0 (see 7A2DC9) in Dec  4 2017 Beta - eqmule
...
// CItemDisplayWindow_size: 0x610 (see 6ED4CF) in Dec  4 2017 Beta - eqmule
...
// CLootWnd_size: 0x398 (see 4CC7D0) in Dec  4 2017 Beta - eqmule
...
// CMapViewWnd_size: 0x648 (see 4CBE89) in Dec  4 2017 Beta - eqmule
...
// CMerchantWnd_size: 0x448 (see 4CC94E) in Dec  4 2017 Beta - eqmule
...
// CPetInfoWindow_size: 0x8c8 (see 4CB8C0) in Dec  4 2017 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a8 (see 4CBBB3) in Dec  4 2017 Beta - eqmule
...
// CTradeWnd__size: 0x2f0 (see 4CCA04) in Dec  4 2017 Beta - eqmule
