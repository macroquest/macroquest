...
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
/*0x0020*/ bool		Faded; \
...
/*0x0029*/ BYTE		TargetAlpha; \
/*0x002A*/ bool		bTiled; \
/*0x002B*/ bool		bMaximized; \
/*0x002C*/ int		HScrollPos; \
/*0x0030*/ RECT		TransitionRect; \
/*0x0040*/ RECT		IconRect; \
/*0x0050*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x0054*/ int		HScrollMax; \
/*0x0058*/ DWORD	LastTimeMouseOver; \
/*0x005C*/ UINT		BlinkFadeStartTime; \
/*0x0060*/ bool		Enabled; \
/*0x0064*/ int		BlinkDuration; \
/*0x0068*/ DWORD  BackgroundDrawType; \
/*0x006C*/ void*	pTextObject; \
/*0x0070*/ bool		dShow; \
/*0x0074*/ int		RightOffset; \
/*0x0078*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x1c */ \
/*0x0094*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0098*/ struct _CXSTR*	DataStr; \
/*0x009C*/ RECT		Location; \
/*0x00AC*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x00AD*/ bool		Fades; \
/*0x00B0*/ void *pController; \
/*0x00B4*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x00B5*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x00B8*/ COLORREF DisabledBackground; \
/*0x00BC*/ int		TopOffset; \
...
/*0x00CD*/ bool		bBringToTopWhenClicked; \
/*0x00CE*/ BYTE		FadeAlpha; \
/*0x00D0*/ int	Transition; \
/*0x00D4*/ BYTE		StartAlpha; \
/*0x00D8*/ UINT		FadeDuration; \
/*0x00DC*/ bool		bIsParentOrContextMenuWindow; \
/*0x00DD*/ bool		bClientClipRectChanged; \
/*0x00DE*/ bool		bTopAnchoredToTop; \
/*0x00E0*/ RECT		OldLocation; \
/*0x00F0*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x00F4*/ int		BottomOffset; \
/*0x00F8*/ tagSIZE	MaxClientSize; \
/*0x0100*/ bool		Minimized; \
/*0x0104*/ UINT		LastBlinkFadeRefreshTime; \
/*0x0108*/ int		DeleteCount; \
/*0x010C*/ bool		bActive; \
/*0x010D*/ bool		bFullyScreenClipped; \
/*0x0110*/ int		BlinkState; \
/*0x0114*/ bool		bClientRectChanged; \
/*0x0118*/ UINT		BlinkFadeFreq; \
/*0x011C*/ void* pTipTextObject; \
/*0x0120*/ void   *TitlePiece; \
/*0x0124*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0125*/ bool		bScreenClipRectChanged; \
/*0x0126*/ bool		bMarkedForDelete; \
...
/*0x0139*/ BYTE		Alpha; \
/*0x013A*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x013B*/ bool		bMaximizable; \
...
/*0x014C*/ int		ParentAndContextMenuArrayIndex; \
/*0x0150*/ tagSIZE	MinClientSize; \
/*0x0158*/ bool		bRightAnchoredToLeft; \
/*0x0159*/ BYTE     bResizableMask; \
/*0x015A*/ bool		bKeepOnScreen; \
/*0x015B*/ bool		bBottomAnchoredToTop; \
/*0x015C*/ UINT		TransitionDuration; \
/*0x0160*/ bool		bCaptureTitle; \
/*0x0164*/ int		VScrollPos; \
/*0x0168*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x016C*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x016D*/ bool		bLeftAnchoredToLeft; \
/*0x0170*/ UINT		BlinkFadeDuration; \
/*0x0174*/ DWORD	FadeDelay; \
/*0x0178*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x017C*/ LONG		BlinkStartTimer; \
/*0x0180*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0184*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x0188*/ bool		bUseInLayoutHorizontal; \
/*0x018C*/ RECT		ClipRectScreen; \
/*0x019C*/ bool		bClipToParent; \
/*0x01A0*/ int		LeftOffset; \
/*0x01A8*/ __int64		Data; \
/*0x01B0*/ int		managerArrayIndex; \
/*0x01B4*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x01B8*/ RECT		ClipRectClient; \
/*0x01C8*/ RECT		ClientRect; \
/*0x01D8*/ void	*DrawTemplate; \
/*0x01DC*/ void		*pLayoutStrategy; \
/*0x01E0*/ bool		bAction; \
/*0x01E4*/ void	*IconTextureAnim; \
/*0x01E8*/
...
/*0x238*/ struct _CSIDLWND *DisplayWnd;
/*0x23c*/ PVOID pName; 
/*0x240*/ PVOID pIcon; 
...
// Actual Size: 0x92d0 (see 4CD14A) in Nov  3 2017 Beta - eqmule
...
// Actual Size: 0x2e8 (see 4CC98D) in Nov  3 2017 Beta - eqmule
...
// Actual Size: 0x8c8 (see 4CC824) in Nov  3 2017 Beta - eqmule
...
// Actual Size: 0x718 (see 4CC6B8) in Nov  3 2017 Beta - eqmule
...
// Individual Gems 
// Actual Size: 0x318 (see 7A3638) in Nov  3 2017 Beta - eqmule
...
// Actual Size: 0x2d0 (see 4CCA9E) in Nov  3 2017 Beta - eqmule
...
// Actual Size: 0x2d0 (see 7A3749) in Nov  3 2017 Beta - eqmule
...
// Actual Size: 0x610 (see 6ED92F) in Nov  3 2017 Beta - eqmule
...
// Actual Size: 0x398 (see 4CCE60) in Nov  3 2017 Beta - eqmule
...
// Actual Size: 0x648 (see 4CC519) in Nov  3 2017 Beta - eqmule
...
// Actual Size: 0x438 (see 4CCFDE) in Nov  3 2017 Beta - eqmule
...
// Actual Size: 0x8c8 (see 4CBF50) in Nov  3 2017 Beta - eqmule
...
//aClasscolorD
// Actual Size: 0x3a8 (see 4CC243) in Nov  3 2017 Beta - eqmule
...
// Actual Size: 0x2f0 (see 4CD094) in Nov  3 2017 Beta - eqmule
