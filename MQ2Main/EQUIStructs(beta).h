...
// actual size 0x1F0 in Nov  7 2018 Beta (see 0x926A4D) - eqmule
// actual size 0x1E0 in Nov  8 2018 Beta (see 0x92645D) - eqmule
// actual size 0x1E8 in Nov 13 2018 Beta (see 0x9270BD) - eqmule
// actual size 0x1F8 in Nov 14 2018 Beta (see 0x92815D) - eqmule
#define CXW_NO_VTABLE \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ int		HScrollPos; \
/*0x0020*/ bool		bRightAnchoredToLeft; \
/*0x0021*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x0024*/ UINT		TransitionDuration; \
/*0x0028*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x002C*/ bool		bClientClipRectChanged; \
/*0x002D*/ bool		bBorder2; \
/*0x0030*/ RECT		IconRect; \
/*0x0040*/ void   *TitlePiece; \
/*0x0044*/ bool		bHCenterTooltip; \
/*0x0048*/ RECT		TransitionRect; \
/*0x0058*/ int		TopOffset; \
/*0x005C*/ DWORD	XMLIndex; \
/*0x0060*/ int		VScrollPos; \
/*0x0064*/ bool		bTopAnchoredToTop; \
/*0x0068*/ RECT		OldLocation; \
/*0x0078*/ bool		bIsParentOrContextMenuWindow; \
/*0x0079*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x007C*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x1c */ \
/*0x0098*/ bool		bBringToTopWhenClicked; \
/*0x0099*/ bool		bFullyScreenClipped; \
/*0x009C*/ COLORREF DisabledBackground; \
/*0x00A0*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x00A4*/ void   *TitlePiece2; \
/*0x00A8*/ bool		bMaximized; \
/*0x00AC*/ RECT		ClipRectClient; \
/*0x00BC*/ BYTE		Alpha; \
/*0x00BD*/ bool		bCaptureTitle; \
/*0x00C0*/ struct _CSIDLWND* pWndFocusOther; \
/*0x00C4*/ UINT		BlinkFadeStartTime; \
/*0x00C8*/ int		BottomOffset; \
/*0x00CC*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x00D0*/ int		RightOffset; \
/*0x00D4*/ BYTE		StartAlpha; \
/*0x00D5*/ bool		bBorder; \
/*0x00D6*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x00D8*/ RECT		ClientRect; \
/*0x00E8*/ bool		bClientRectChanged; \
/*0x00EC*/ int		BlinkDuration; \
/*0x00F0*/ bool		bMaximizable; \
/*0x00F4*/ RECT		Location; \
/*0x0104*/ DWORD	FadeDelay; \
/*0x0108*/ int		ParentAndContextMenuArrayIndex; \
/*0x010C*/ bool		dShow; \
/*0x0110*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x0114*/ bool		bBottomAnchoredToTop; \
/*0x0118*/ int		VScrollMax; \
/*0x011C*/ LONG		BlinkStartTimer; \
/*0x0120*/ tagSIZE	MaxClientSize; \
/*0x0128*/ bool		bEscapableLocked; \
/*0x0129*/ bool		bUseInLayoutHorizontal; \
/*0x012C*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x0130*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
/*0x0134*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x0135*/ bool		Faded; \
/*0x0138*/ void *pController; \
/*0x013C*/ bool		bLeftAnchoredToLeft; \
/*0x013D*/ bool		bClipToParent; \
/*0x0140*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x0144*/ int		DeleteCount; \
/*0x0148*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x014C*/ bool		Enabled; \
/*0x0150*/ int		HScrollMax; \
/*0x0154*/ DWORD	LastTimeMouseOver; \
/*0x0158*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0159*/ bool		bMarkedForDelete; \
/*0x015C*/ void*	pTextObject; \
/*0x0160*/ int		BlinkState; \
/*0x0164*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x0168*/ void	    *pFont; \
/*0x016C*/ void	*IconTextureAnim; \
/*0x0170*/ int		LeftOffset; \
/*0x0174*/ void		*pLayoutStrategy; \
/*0x0178*/ UINT		TransitionStartTick; \
/*0x017C*/ BYTE		TargetAlpha; \
...
/*0x0188*/ bool		Fades; \
/*0x018C*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0190*/ BYTE     bResizableMask; \
/*0x0191*/ bool		bIsTransitioning; \
/*0x0192*/ bool		bAction; \
/*0x0194*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0198*/ UINT		BlinkFadeFreq; \
/*0x019C*/ bool		bTiled; \
/*0x019D*/ bool		Minimized; \
/*0x01A0*/ UINT		FadeDuration; \
/*0x01A4*/ BYTE		FadeAlpha; \
/*0x01A5*/ bool		bKeepOnScreen; \
/*0x01A6*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x01A7*/ bool		bActive; \
/*0x01A8*/ RECT		ClipRectScreen; \
/*0x01B8*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x01B9*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x01BC*/ DWORD  BackgroundDrawType; \
/*0x01C0*/ struct _CXSTR*	DataStr; \
/*0x01C4*/ void	*DrawTemplate; \
/*0x01C8*/ void* pTipTextObject; \
/*0x01CC*/ UINT		BlinkFadeDuration; \
/*0x01D0*/ bool		bUseInLayoutVertical; \
/*0x01D4*/ UINT		LastBlinkFadeRefreshTime; \
/*0x01D8*/ tagSIZE	MinClientSize; \
/*0x01E0*/ int	Transition; \
/*0x01E8*/ __int64		Data; \
/*0x01F0*/ bool		bScreenClipRectChanged; \
...
// CBazaarSearchWnd_size: 0x92e0 (see 539DED) in Nov 14 2018 Beta - eqmule
...
// CPlayerWindow_size: 0x2f8 (see 5396E0) in Nov 14 2018 Beta - eqmule
...
// CTargetWindow_size: 0x8d8 (see 53957B) in Nov 14 2018 Beta - eqmule
...
// CBuffWindow_size: 0x728 (see 53941F) in Nov 14 2018 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x330 (see 7E9BAB) in Nov 14 2018 Beta - eqmule
...
// CCastSpellWnd_size: 0x2e0 (see 5397D9) in Nov 14 2018 Beta - eqmule
...
// CInvSlotWnd_size: 0x2e0 (see 7E9CBC) in Nov 14 2018 Beta - eqmule
...
// CItemDisplayWindow_size: 0x638 (see 749BF2) in Nov 14 2018 Beta - eqmule
...
// CLootWnd_size: 0x3a8 (see 539B45) in Nov 14 2018 Beta - eqmule
...
// CMapViewWnd_size: 0x668 (see 539280) in Nov 14 2018 Beta - eqmule
...
// CMerchantWnd_size: 0x458 (see 539CA1) in Nov 14 2018 Beta - eqmule
...
// CPetInfoWindow_size: 0x8d8 (see 538CBA) in Nov 14 2018 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3b8 (see 538FAB) in Nov 14 2018 Beta - eqmule
...
// CTradeWnd__size: 0x300 (see 539D47) in Nov 14 2018 Beta - eqmule
