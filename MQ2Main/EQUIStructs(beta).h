...
// actual size 0x1F0 in Nov 25 2017 Beta (see 0x8D3F7D) - eqmule
// actual size 0x1D8 in Nov 26 2017 Beta (see 0x8D4B9D) - eqmule
#define CXW_NO_VTABLE \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ LONG		BlinkStartTimer; \
/*0x0020*/ __int64		Data; \
/*0x0028*/ bool		bScreenClipRectChanged; \
/*0x0029*/ bool		bTopAnchoredToTop; \
/*0x002C*/ int		TopOffset; \
/*0x0030*/ void   *TitlePiece2; \
/*0x0034*/ void   *TitlePiece; \
/*0x0038*/ bool		bActive; \
/*0x0039*/ bool		Enabled; \
...
/*0x0048*/ UINT		LastBlinkFadeRefreshTime; \
...
/*0x0050*/ DWORD	FadeDelay; \
/*0x0054*/ BYTE		StartAlpha; \
/*0x0058*/ struct _CXSTR*	DataStr; \
/*0x005C*/ COLORREF DisabledBackground; \
/*0x0060*/ int		HScrollPos; \
/*0x0064*/ bool		bTiled; \
/*0x0068*/ RECT		ClipRectScreen; \
/*0x0078*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x007C*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x0080*/ RECT		ClientRect; \
/*0x0090*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0094*/ int		RightOffset; \
/*0x0098*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x0099*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x009C*/ void		*pLayoutStrategy; \
/*0x00A0*/ tagSIZE	MinClientSize; \
/*0x00A8*/ int		BottomOffset; \
/*0x00AC*/ struct _CSIDLWND* pWndFocusOther; \
/*0x00B0*/ RECT		IconRect; \
/*0x00C0*/ bool		bHCenterTooltip; \
/*0x00C1*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x00C4*/ int		managerArrayIndex; \
/*0x00C8*/ int		DeleteCount; \
/*0x00CC*/ bool		bBringToTopWhenClicked; \
/*0x00CD*/ bool		bFullyScreenClipped; \
/*0x00CE*/ bool		bMarkedForDelete; \
/*0x00D0*/ RECT		Location; \
/*0x00E0*/ void	*DrawTemplate; \
/*0x00E4*/ bool		bMaximizable; \
/*0x00E8*/ UINT		TransitionStartTick; \
/*0x00EC*/ bool		bAction; \
/*0x00ED*/ bool		bClipToParent; \
/*0x00EE*/ bool		bClientClipRectChanged; \
/*0x00F0*/ int		ParentAndContextMenuArrayIndex; \
/*0x00F4*/ bool		bKeepOnScreen; \
/*0x00F5*/ BYTE		TargetAlpha; \
/*0x00F8*/ UINT		TransitionDuration; \
/*0x00FC*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x00FD*/ bool		bMaximized; \
/*0x0100*/ int		VScrollPos; \
/*0x0104*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x0108*/ RECT		TransitionRect; \
/*0x0118*/ bool		bIsParentOrContextMenuWindow; \
/*0x0119*/ bool		bBottomAnchoredToTop; \
/*0x011C*/ DWORD	XMLIndex; \
/*0x0120*/ UINT		BlinkFadeFreq; \
/*0x0124*/ int		BlinkDuration; \
/*0x0128*/ int		HScrollMax; \
/*0x012C*/ UINT		FadeDuration; \
/*0x0130*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x1c */ \
/*0x014C*/ void* pTipTextObject; \
/*0x0150*/ bool		bLeftAnchoredToLeft; \
/*0x0151*/ BYTE     bResizableMask; \
/*0x0154*/ DWORD  BackgroundDrawType; \
/*0x0158*/ bool		bIsTransitioning; \
/*0x015C*/ void	*IconTextureAnim; \
/*0x0160*/ int	Transition; \
/*0x0164*/ int		LeftOffset; \
/*0x0168*/ RECT		OldLocation; \
/*0x0178*/ bool		Fades; \
/*0x0179*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x017A*/ bool		Faded; \
/*0x017C*/ RECT		ClipRectClient; \
/*0x018C*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x0190*/ UINT		BlinkFadeStartTime; \
/*0x0194*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0198*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x019C*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x01A0*/ bool		bEscapableLocked; \
/*0x01A4*/ void*	pTextObject; \
/*0x01A8*/ void *pController; \
/*0x01AC*/ int		VScrollMax; \
/*0x01B0*/ BYTE		Alpha; \
/*0x01B1*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x01B4*/ DWORD	LastTimeMouseOver; \
/*0x01B8*/ bool		bClientRectChanged; \
/*0x01B9*/ BYTE		FadeAlpha; \
/*0x01BA*/ bool		bCaptureTitle; \
/*0x01BB*/ bool		bRightAnchoredToLeft; \
/*0x01BC*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x01C0*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x01C4*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x01C5*/ bool		dShow; \
/*0x01C6*/ bool		bUseInLayoutVertical; \
/*0x01C8*/ int		BlinkState; \
/*0x01CC*/ bool		bUseInLayoutHorizontal; \
/*0x01CD*/ bool		Minimized; \
/*0x01D0*/ tagSIZE	MaxClientSize; \
/*0x01D8*/
...
// CBazaarSearchWnd_size: 0x92c0 (see 4CCEFA) in Nov 26 2017 Beta - eqmule
...
// CPlayerWindow_size: 0x2d8 (see 4CC73D) in Nov 26 2017 Beta - eqmule
...
// CTargetWindow_size: 0x8b8 (see 4CC5D4) in Nov 26 2017 Beta - eqmule
...
// CBuffWindow_size: 0x708 (see 4CC468) in Nov 26 2017 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x308 (see 7A3938) in Nov 26 2017 Beta - eqmule
...
// CCastSpellWnd_size: 0x2c0 (see 4CC84E) in Nov 26 2017 Beta - eqmule
...
// CInvSlotWnd_size: 0x2c0 (see 7A3A49) in Nov 26 2017 Beta - eqmule
...
// CItemDisplayWindow_size: 0x600 (see 6EE0FF) in Nov 26 2017 Beta - eqmule
...
// CLootWnd_size: 0x388 (see 4CCC10) in Nov 26 2017 Beta - eqmule
...
// CMapViewWnd_size: 0x628 (see 4CC2C9) in Nov 26 2017 Beta - eqmule
...
// CMerchantWnd_size: 0x428 (see 4CCD8E) in Nov 26 2017 Beta - eqmule
...
// CPetInfoWindow_size: 0x8b8 (see 4CBD00) in Nov 26 2017 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x398 (see 4CBFF3) in Nov 26 2017 Beta - eqmule
...
// CTradeWnd__size: 0x2e0 (see 4CCE44) in Nov 26 2017 Beta - eqmule
