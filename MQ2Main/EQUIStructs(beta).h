...
/*0x003C*/ bool		bIsParentOrContextMenuWindow; \
/*0x003D*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x003E*/ BYTE		StartAlpha; \
...
/*0x00B4*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x00B8*/ int		TopOffset; \
/*0x00BC*/ bool		bLeftAnchoredToLeft; \
/*0x00C0*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x00C4*/ bool		bCaptureTitle; \
...
/*0x00D9*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x00DA*/ bool		bAction; \
/*0x00DB*/ bool		bBringToTopWhenClicked; \
/*0x00E0*/ __int64		Data; \
/*0x00E8*/ BYTE		TargetAlpha; \
/*0x00EC*/ int		ParentAndContextMenuArrayIndex; \
/*0x00F0*/ bool		bTiled; \
/*0x00F1*/ bool		Fades; \
...
/*0x012A*/ bool		bTopAnchoredToTop; \
/*0x012C*/ struct _CXSTR*	DataStr; \
/*0x0130*/ BYTE		FadeAlpha; \
/*0x0134*/ void   *TitlePiece; \
/*0x0138*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x013C*/ struct _CSIDLWND* pWndFocusOther; \
/*0x0140*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x0141*/ bool		dShow; \
...
/*0x0188*/ BYTE     bResizableMask; \
/*0x018C*/ int		BlinkState; \
/*0x0190*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x0194*/ void	    *pFont; \
/*0x0198*/ bool		bUseInLayoutVertical; \
/*0x0199*/ bool		bScreenClipRectChanged; \
/*0x019C*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x1c */ \
/*0x01B8*/ bool		bUseInLayoutHorizontal; \
...
/*0x01D5*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x01D6*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x01D7*/ bool		bBorder; \
/*0x01D8*/ BYTE		Alpha; \
/*0x01D9*/ bool		bActive; \
/*0x01DC*/ RECT		TransitionRect; \
/*0x01EC*/ bool		bClientRectChanged; \
/*0x01ED*/ bool		bMaximized; \
...
// CBazaarSearchWnd_size: 0x92d8 (see 538BCD) in Nov  7 2018 Beta - eqmule
...
// CPlayerWindow_size: 0x2f0 (see 5384C0) in Nov  7 2018 Beta - eqmule
...
// CTargetWindow_size: 0x8d0 (see 53835B) in Nov  7 2018 Beta - eqmule
...
// CBuffWindow_size: 0x720 (see 5381FF) in Nov  7 2018 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x328 (see 7E886B) in Nov  7 2018 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d8 (see 5385B9) in Nov  7 2018 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d8 (see 7E897C) in Nov  7 2018 Beta - eqmule
...
// CItemDisplayWindow_size: 0x630 (see 7489E2) in Nov  7 2018 Beta - eqmule
...
// CLootWnd_size: 0x3a0 (see 538925) in Nov  7 2018 Beta - eqmule
...
// CMapViewWnd_size: 0x658 (see 538060) in Nov  7 2018 Beta - eqmule
...
// CMerchantWnd_size: 0x450 (see 538A81) in Nov  7 2018 Beta - eqmule
...
// CPetInfoWindow_size: 0x8d0 (see 537A9A) in Nov  7 2018 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3b0 (see 537D8B) in Nov  7 2018 Beta - eqmule
...
// CTradeWnd__size: 0x2f8 (see 538B27) in Nov  7 2018 Beta - eqmule
