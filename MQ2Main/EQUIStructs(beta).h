...
private: \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ UINT		TransitionDuration; \
/*0x0020*/ bool		dShow; \
/*0x0021*/ bool		bTiled; \
...
/*0x0041*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0044*/ void	*IconTextureAnim; \
/*0x0048*/ bool		bHCenterTooltip; \
/*0x0049*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
...
/*0x00A1*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x00A4*/ RECT		ClipRectClient; \
/*0x00B4*/ bool		bBorder2; \
...
/*0x00D2*/ bool		bFullyScreenClipped; \
/*0x00D4*/ void*	pTextObject; \
/*0x00D8*/ UINT		FadeDuration; \
/*0x00DC*/ bool		bTopAnchoredToTop; \
/*0x00DD*/ bool		bActive; \
/*0x00DE*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x00DF*/ bool		bIsTransitioning; \
/*0x00E0*/ int		RightOffset; \
/*0x00E4*/ int		HScrollPos; \
/*0x00E8*/ int	Transition; \
/*0x00EC*/ bool		bMaximized; \
/*0x00ED*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
...
/*0x0115*/ bool		bUseInLayoutHorizontal; \
/*0x0116*/ BYTE		TargetAlpha; \
/*0x0117*/ bool		bRightAnchoredToLeft; \
...
/*0x012C*/ bool		bMaximizable; \
/*0x012D*/ BYTE     bResizableMask; \
...
/*0x013D*/ bool		bScreenClipRectChanged; \
...
// CBazaarSearchWnd_size: 0x92c8 (see 55B8CE) in Dec  2 2020 Beta - eqmule
...
// CPlayerWindow_size: 0x2e0 (see 55B1BE) in Dec  2 2020 Beta - eqmule
...
// CTargetWindow_size: 0x8c0 (see 55B055) in Dec  2 2020 Beta - eqmule
...
// CBuffWindow_size: 0x710 (see 55AEF9) in Dec  2 2020 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x318 (see 7FCFFB) in Dec  2 2020 Beta - eqmule
...
// CCastSpellWnd_size: 0x2c8 (see 55B2B7) in Dec  2 2020 Beta - eqmule
...
// CInvSlotWnd_size: 0x2c8 (see 7FD10C) in Dec  2 2020 Beta - eqmule
...
// CItemDisplayWindow_size: 0x620 (see 760092) in Dec  2 2020 Beta - eqmule
...
// CLootWnd_size: 0x390 (see 55B626) in Dec  2 2020 Beta - eqmule
...
// CMapViewWnd_size: 0x638 (see 55AD5A) in Dec  2 2020 Beta - eqmule
...
// CMerchantWnd_size: 0x440 (see 55B782) in Dec  2 2020 Beta - eqmule
...
// CPetInfoWindow_size: 0x8c0 (see 55A7B1) in Dec  2 2020 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x398 (see 55AAA2) in Dec  2 2020 Beta - eqmule
...
// CTradeWnd__size: 0x2e8 (see 55B828) in Dec  2 2020 Beta - eqmule
...
// CFactionWnd__size: 0x270 (see 55B974) in Dec  2 2020 Beta - eqmule
