...
// actual size 0x1F0 in Dec  4 2018 Beta (see 0x92FACD) - eqmule
// actual size 0x1E8 in Dec  5 2018 Beta (see 0x92E6CD) - eqmule
// actual size 0x1F8 in Dec  6 2018 Beta (see 0x92FDDD) - eqmule
#define CXW_NO_VTABLE \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x001D*/ bool		bTopAnchoredToTop; \
/*0x001E*/ bool		Faded; \
/*0x001F*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0020*/ bool		bRightAnchoredToLeft; \
/*0x0024*/ int		VScrollMax; \
/*0x0028*/ bool		bIsTransitioning; \
/*0x002C*/ DWORD  BackgroundDrawType; \
/*0x0030*/ bool		Fades; \
/*0x0031*/ bool		bBorder; \
/*0x0034*/ void	*IconTextureAnim; \
/*0x0038*/ BYTE		Alpha; \
/*0x003C*/ struct _CXSTR*	DataStr; \
/*0x0040*/ void   *TitlePiece2; \
/*0x0044*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x0048*/ int		RightOffset; \
/*0x004C*/ bool		bEscapableLocked; \
/*0x0050*/ int		VScrollPos; \
/*0x0054*/ bool		bClipToParent; \
/*0x0058*/ LONG		BlinkStartTimer; \
/*0x005C*/ RECT		IconRect; \
/*0x006C*/ DWORD	XMLIndex; \
/*0x0070*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x0074*/ tagSIZE	MinClientSize; \
/*0x007C*/ BYTE		StartAlpha; \
/*0x0080*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x0084*/ int		TopOffset; \
/*0x0088*/ BYTE		TargetAlpha; \
/*0x008C*/ void* pTipTextObject; \
/*0x0090*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x0091*/ bool		bMaximized; \
/*0x0092*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0094*/ int		HScrollMax; \
/*0x0098*/ void	    *pFont; \
/*0x009C*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x009D*/ bool		bLeftAnchoredToLeft; \
/*0x00A0*/ DWORD	FadeDelay; \
/*0x00A4*/ RECT		ClipRectScreen; \
/*0x00B4*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x00B8*/ void*	pTextObject; \
/*0x00BC*/ COLORREF DisabledBackground; \
/*0x00C0*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x00C4*/ bool		bBringToTopWhenClicked; \
/*0x00C5*/ bool		bIsParentOrContextMenuWindow; \
/*0x00C8*/ int		BlinkDuration; \
/*0x00CC*/ bool		bCaptureTitle; \
/*0x00D0*/ void		*pLayoutStrategy; \
/*0x00D4*/ bool		bClientRectChanged; \
/*0x00D5*/ bool		bUseInLayoutHorizontal; \
/*0x00D6*/ bool		bFullyScreenClipped; \
/*0x00D7*/ bool		bMarkedForDelete; \
/*0x00D8*/ int		HScrollPos; \
/*0x00DC*/ RECT		OldLocation; \
/*0x00EC*/ UINT		TransitionDuration; \
/*0x00F0*/ UINT		TransitionStartTick; \
/*0x00F4*/ tagSIZE	MaxClientSize; \
/*0x00FC*/ int		DeleteCount; \
/*0x0100*/ int		LeftOffset; \
/*0x0104*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x0105*/ bool		Minimized; \
...
/*0x011C*/ int		ParentAndContextMenuArrayIndex; \
/*0x0120*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x0124*/ bool		bClientClipRectChanged; \
/*0x0128*/ int		managerArrayIndex; \
/*0x012C*/ RECT		TransitionRect; \
/*0x013C*/ bool		bBottomAnchoredToTop; \
/*0x0140*/ UINT		BlinkFadeStartTime; \
/*0x0144*/ struct _CSIDLWND* pWndFocusOther; \
/*0x0148*/ void	*DrawTemplate; \
/*0x014C*/ bool		bUseInLayoutVertical; \
...
/*0x0184*/ bool		bActive; \
/*0x0188*/ RECT		Location; \
/*0x0198*/ __int64		Data; \
/*0x01A0*/ int		BlinkState; \
/*0x01A4*/ UINT		LastBlinkFadeRefreshTime; \
/*0x01A8*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x01AC*/ UINT		BlinkFadeDuration; \
/*0x01B0*/ bool		bMaximizable; \
/*0x01B4*/ RECT		ClientRect; \
/*0x01C4*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x01C5*/ bool		dShow; \
/*0x01C8*/ void   *TitlePiece; \
/*0x01CC*/ bool		Enabled; \
...
/*0x01DC*/ int		BottomOffset; \
/*0x01E0*/ BYTE     bResizableMask; \
/*0x01E4*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x01E8*/ UINT		FadeDuration; \
/*0x01EC*/ bool		bKeepOnScreen; \
/*0x01ED*/ BYTE		FadeAlpha; \
/*0x01EE*/ bool		bScreenClipRectChanged; \
/*0x01EF*/ bool		bHCenterTooltip; \
/*0x01F0*/ bool		bTiled; \
/*0x01F1*/ bool		bAction; \
/*0x01F2*/ BYTE Filler0x01F2[0x6];
/*0x01F8*/
...
// CBazaarSearchWnd_size: 0x92e0 (see 54086D) in Dec  6 2018 Beta - eqmule
...
// CPlayerWindow_size: 0x2f8 (see 540160) in Dec  6 2018 Beta - eqmule
...
// CTargetWindow_size: 0x8d8 (see 53FFFB) in Dec  6 2018 Beta - eqmule
...
// CBuffWindow_size: 0x728 (see 53FE9F) in Dec  6 2018 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x330 (see 7F183B) in Dec  6 2018 Beta - eqmule
...
// CCastSpellWnd_size: 0x2e0 (see 540259) in Dec  6 2018 Beta - eqmule
...
// CInvSlotWnd_size: 0x2e0 (see 7F194C) in Dec  6 2018 Beta - eqmule
...
// CItemDisplayWindow_size: 0x638 (see 751842) in Dec  6 2018 Beta - eqmule
...
// CLootWnd_size: 0x3a8 (see 5405C5) in Dec  6 2018 Beta - eqmule
...
// CMapViewWnd_size: 0x668 (see 53FD00) in Dec  6 2018 Beta - eqmule
...
// CMerchantWnd_size: 0x458 (see 540721) in Dec  6 2018 Beta - eqmule
...
// CPetInfoWindow_size: 0x8d8 (see 53F73A) in Dec  6 2018 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3b8 (see 53FA2B) in Dec  6 2018 Beta - eqmule
...
// CTradeWnd__size: 0x300 (see 5407C7) in Dec  6 2018 Beta - eqmule
...
// CFactionWnd__size: 0x288 (see 540913) in Dec  6 2018 Beta - eqmule
