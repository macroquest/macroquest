...
/*0x0030*/ BYTE		Alpha; \
/*0x0031*/ bool		dShow; \
/*0x0032*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
...
/*0x009C*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
...
/*0x00F0*/ bool		bBorder2; \
/*0x00F4*/ RECT		IconRect; \
/*0x0104*/ UINT		FadeDuration; \
/*0x0108*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x010C*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
...
/*0x014B*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x014C*/ int		VScrollMax; \
/*0x0150*/ bool		bMaximizable; \
...
/*0x017C*/ bool		bScreenClipRectChanged; \
/*0x0180*/ UINT		BlinkFadeDuration; \
/*0x0184*/ bool		bClipToParent; \
/*0x0185*/ bool		bLeftAnchoredToLeft; \
...
/*0x01AD*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
...
/*0x01CE*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x01D0*/ RECT		OldLocation; \
/*0x01E0*/ UINT		BlinkFadeFreq; \
/*0x01E4*/ BYTE		FadeAlpha; \
/*0x01E8*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
...
// CBazaarSearchWnd_size: 0x92d8 (see 5587CE) in Oct 19 2020 Beta - eqmule
...
//aAPwcsincombat
// CPlayerWindow_size: 0x2f0 (see 5580BE) in Oct 19 2020 Beta - eqmule
...
// CTargetWindow_size: 0x8d0 (see 557F55) in Oct 19 2020 Beta - eqmule
...
// CBuffWindow_size: 0x720 (see 557DF9) in Oct 19 2020 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x328 (see 7F91CB) in Oct 19 2020 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d8 (see 5581B7) in Oct 19 2020 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d8 (see 7F92DC) in Oct 19 2020 Beta - eqmule
...
// CItemDisplayWindow_size: 0x630 (see 75BFE2) in Oct 19 2020 Beta - eqmule
...
// CLootWnd_size: 0x3a0 (see 558526) in Oct 19 2020 Beta - eqmule
...
// CMapViewWnd_size: 0x658 (see 557C5A) in Oct 19 2020 Beta - eqmule
...
// CMerchantWnd_size: 0x450 (see 558682) in Oct 19 2020 Beta - eqmule
...
// CPetInfoWindow_size: 0x8d0 (see 5576B1) in Oct 19 2020 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a8 (see 5579A2) in Oct 19 2020 Beta - eqmule
...
// CTradeWnd__size: 0x2f8 (see 558728) in Oct 19 2020 Beta - eqmule
...
// CFactionWnd__size: 0x280 (see 558874) in Oct 19 2020 Beta - eqmule
