...
private: \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ bool		bUseInLayoutVertical; \
...
/*0x002C*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x002D*/ BYTE		Alpha; \
/*0x002E*/ bool		bLeftAnchoredToLeft; \
/*0x002F*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x0030*/ bool		bIsTransitioning; \
/*0x0031*/ bool		bBorder; \
/*0x0034*/ int		BlinkState; \
/*0x0038*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0039*/ bool		Faded; \
/*0x003A*/ bool		bClientClipRectChanged; \
...
/*0x00D5*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x00D6*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x00D8*/ RECT		ClientRect; \
/*0x00E8*/ int		managerArrayIndex; \
/*0x00EC*/ RECT		Location; \
/*0x00FC*/ bool		bUseInLayoutHorizontal; \
/*0x00FD*/ BYTE		StartAlpha; \
/*0x00FE*/ bool		bHCenterTooltip; \
/*0x0100*/ struct _CXSTR*	DataStr; \
/*0x0104*/ BYTE     bResizableMask; \
/*0x0108*/ int		BlinkDuration; \
/*0x010C*/ tagSIZE	MaxClientSize; \
/*0x0114*/ void*	pTextObject; \
/*0x0118*/ bool		bBringToTopWhenClicked; \
/*0x0119*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
...
/*0x0161*/ bool		dShow; \
/*0x0164*/ void   *TitlePiece; \
/*0x0168*/ bool		bRightAnchoredToLeft; \
/*0x016C*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
...
/*0x01CD*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x01D0*/ COLORREF DisabledBackground; \
/*0x01D4*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
...
// CBazaarSearchWnd_size: 0x92d8 (see 55148E) in Dec 13 2019 Beta - eqmule
...
// CPlayerWindow_size: 0x2f0 (see 550D7E) in Dec 13 2019 Beta - eqmule
...
// CTargetWindow_size: 0x8d0 (see 550C15) in Dec 13 2019 Beta - eqmule
...
// CBuffWindow_size: 0x720 (see 550AB9) in Dec 13 2019 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x328 (see 8082CB) in Dec 13 2019 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d8 (see 550E77) in Dec 13 2019 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d8 (see 8083DC) in Dec 13 2019 Beta - eqmule
...
// CItemDisplayWindow_size: 0x630 (see 76B422) in Dec 13 2019 Beta - eqmule
...
// CLootWnd_size: 0x3a0 (see 5511E6) in Dec 13 2019 Beta - eqmule
...
// CMapViewWnd_size: 0x658 (see 55091A) in Dec 13 2019 Beta - eqmule
...
// CMerchantWnd_size: 0x450 (see 551342) in Dec 13 2019 Beta - eqmule
...
// CPetInfoWindow_size: 0x8d0 (see 550371) in Dec 13 2019 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3b0 (see 550662) in Dec 13 2019 Beta - eqmule
...
// CTradeWnd__size: 0x2f8 (see 5513E8) in Dec 13 2019 Beta - eqmule
...
// CFactionWnd__size: 0x280 (see 551534) in Dec 13 2019 Beta - eqmule
