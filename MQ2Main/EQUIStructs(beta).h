...
// actual size 0x1F0 in Jun 18 2018 Live (see 0x91D94D) - eqmule
// actual size 0x1F8 in Oct 25 2018 Beta (see 0x9247DD) - eqmule
// actual size 0x1D8 in Oct 26 2018 Beta (see 0x92545D) - eqmule
// actual size 0x1F0 in Oct 30 2018 Beta (see 0x9256ED) - eqmule
// actual size 0x1E0 in Nov  2 2018 Beta (see 0x92604D) - eqmule
// actual size 0x1E8 in Nov  3 2018 Beta (see 0x92631D) - eqmule
// actual size 0x200 in Nov  4 2018 Beta (see 0x925E2D) - eqmule
#define CXW_NO_VTABLE \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x001D*/ bool		bMaximizable; \
/*0x0020*/ UINT		TransitionDuration; \
/*0x0024*/ bool		Minimized; \
/*0x0028*/ COLORREF DisabledBackground; \
/*0x002C*/ DWORD	FadeDelay; \
/*0x0030*/ void   *TitlePiece; \
/*0x0034*/ BYTE		TargetAlpha; \
/*0x0038*/ int		RightOffset; \
/*0x003C*/ void* pTipTextObject; \
/*0x0040*/ int		BlinkDuration; \
/*0x0044*/ int		LeftOffset; \
/*0x0048*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x004C*/ RECT		OldLocation; \
/*0x005C*/ BYTE		Alpha; \
/*0x0060*/ int		HScrollMax; \
/*0x0064*/ bool		bBorder2; \
/*0x0068*/ struct _CSIDLWND* pWndFocusOther; \
/*0x006C*/ LONG		BlinkStartTimer; \
/*0x0070*/ BYTE		FadeAlpha; \
/*0x0071*/ bool		bClientRectChanged; \
/*0x0074*/ void		*pLayoutStrategy; \
/*0x0078*/ bool		bHCenterTooltip; \
/*0x0079*/ bool		bFullyScreenClipped; \
/*0x007A*/ bool		bIsTransitioning; \
/*0x007C*/ int		BlinkState; \
/*0x0080*/ bool		bIsParentOrContextMenuWindow; \
/*0x0084*/ int		BottomOffset; \
/*0x0088*/ bool		bLeftAnchoredToLeft; \
/*0x008C*/ void	*IconTextureAnim; \
/*0x0090*/ UINT		BlinkFadeStartTime; \
/*0x0094*/ int		TopOffset; \
/*0x0098*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x009C*/ int		managerArrayIndex; \
/*0x00A0*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x00A4*/ void	*DrawTemplate; \
/*0x00A8*/ void *pController; \
/*0x00AC*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x00AD*/ bool		Faded; \
/*0x00AE*/ bool		bRightAnchoredToLeft; \
...
/*0x00BC*/ int		ParentAndContextMenuArrayIndex; \
/*0x00C0*/ bool		bActive; \
/*0x00C4*/ DWORD	XMLIndex; \
/*0x00C8*/ int		DeleteCount; \
/*0x00CC*/ bool		bAction; \
/*0x00D0*/ UINT		FadeDuration; \
/*0x00D4*/ RECT		IconRect; \
/*0x00E4*/ bool		bUseInLayoutVertical; \
/*0x00E5*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
...
/*0x00FC*/ bool		bClipToParent; \
/*0x00FD*/ bool		bKeepOnScreen; \
/*0x00FE*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0100*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x1c */ \
/*0x011C*/ int		HScrollPos; \
/*0x0120*/ bool		Enabled; \
/*0x0121*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x0122*/ bool		bEscapableLocked; \
/*0x0123*/ bool		bScreenClipRectChanged; \
/*0x0124*/ BYTE     bResizableMask; \
/*0x0128*/ RECT		ClientRect; \
/*0x0138*/ bool		bUseInLayoutHorizontal; \
/*0x013C*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x0140*/ BYTE		StartAlpha; \
/*0x0144*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x0148*/ bool		bMarkedForDelete; \
/*0x0149*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x014A*/ bool		bClientClipRectChanged; \
/*0x014C*/ int	Transition; \
/*0x0150*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x0154*/ int		VScrollPos; \
/*0x0158*/ UINT		BlinkFadeDuration; \
/*0x015C*/ bool		Fades; \
/*0x0160*/ RECT		Location; \
/*0x0170*/ bool		bCaptureTitle; \
/*0x0174*/ DWORD	LastTimeMouseOver; \
/*0x0178*/ bool		bBringToTopWhenClicked; \
/*0x017C*/ void	    *pFont; \
/*0x0180*/ bool		bTopAnchoredToTop; \
/*0x0184*/ RECT		TransitionRect; \
/*0x0194*/ bool		bBottomAnchoredToTop; \
/*0x0198*/ RECT		ClipRectScreen; \
/*0x01A8*/ bool		bMaximized; \
/*0x01A9*/ bool		bBorder; \
/*0x01AC*/ void*	pTextObject; \
/*0x01B0*/ bool		bTiled; \
/*0x01B4*/ UINT		TransitionStartTick; \
/*0x01B8*/ int		VScrollMax; \
/*0x01BC*/ UINT		LastBlinkFadeRefreshTime; \
/*0x01C0*/ struct _CXSTR*	DataStr; \
/*0x01C4*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x01C8*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x01CC*/ void   *TitlePiece2; \
/*0x01D0*/ bool		dShow; \
/*0x01D4*/ DWORD  BackgroundDrawType; \
/*0x01D8*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x01E0*/ __int64		Data; \
/*0x01E8*/ UINT		BlinkFadeFreq; \
/*0x01EC*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x01F0*/ tagSIZE	MinClientSize; \
/*0x01F8*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x01FC*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
/*0x0200*/
...
//size is 0x228 see 7E7C8C in Nov 04 2018 Beta -eqmule
...
//size is 0x298 see 91E61A in eqgame.exe dated 04 Nov 2018 beta - eqmule
...
/*0x0258*/ PCXSTR Name;
/*0x025c*/ void   *Normal;//CTextureAnimation
/*0x0260*/ void   *taPressed;
/*0x0264*/ void   *Flyby;
/*0x0268*/ void   *taDisabled;
/*0x026c*/ void   *PressedFlyby;
/*0x0270*/ void   *PressedDisabled;
/*0x0274*/ void   *NormalDecal;
/*0x0278*/ void   *PressedDecal;
/*0x027c*/ void   *FlybyDecal;
/*0x0280*/ void   *DisabledDecal;
/*0x0284*/ void   *PressedFlybyDecal;
/*0x0288*/ void   *PressedDisabledDecal;
/*0x028c*/ bool		bAllowButtonClickThrough;
/*0x028d*/ bool		bCoolDownDoDelayedStart;
/*0x028e*/ bool		bIsCheckbox;
/*0x028f*/ bool		bIsDrawLasso;
/*0x0290*/ UINT		ButtonStyle;
/*0x0294*/ PCLABEL	pButtonLabel;
/*0x0298*/
...
// CBazaarSearchWnd_size: 0x92e8 (see 538B2D) in Nov  4 2018 Beta - eqmule
...
// CPlayerWindow_size: 0x300 (see 538420) in Nov  4 2018 Beta - eqmule
...
// CTargetWindow_size: 0x8e0 (see 5382BB) in Nov  4 2018 Beta - eqmule
...
/*0x086c*/ BYTE         Unknown0x086c[0x24];
...
// CBuffWindow_size: 0x730 (see 53815F) in Nov  4 2018 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x338 (see 7E7EEB) in Nov  4 2018 Beta - eqmule
...
/*0x0310*/ DWORD        spellstate;		//1 = cast in progress or refreshtime not met 2 means we ducked or aborted cast, 0 means its ok to cast, should really rename this to tintstage
...
// CCastSpellWnd_size: 0x2e8 (see 538519) in Nov  4 2018 Beta - eqmule
...
/*0x028c*/ BYTE         Unknown0x028c[0x5c];
/*0x02e8*/
} EQCASTSPELLWINDOW, *PEQCASTSPELLWINDOW;

//make sure InvSlot is a short
// CInvSlotWnd_size: 0x2e8 (see 7E7FFC) in Nov  4 2018 Beta - eqmule
typedef struct _EQINVSLOTWND {
/*0x0000*/ struct _CXWND        Wnd;      //----/ actually CButtonWnd
/*0x0200*/ BYTE         Unknown0x0200[0x8c];
/*0x028c*/ BYTE         Unknown0x028c[0x10];
/*0x029c*/ LONG         WindowType;
											// 00 for inventory
											// 01 for bank
											// 02 for shared bank
											...
											// 11 for loot window
/*0x02a0*/ short         InvSlot;
/*0x02a2*/ short         BagSlot;
/*0x02a4*/ short         GlobalSlot;
/*0x02a6*/ short         RandomNum;              //no idea what this is, it changes upon login but we need it for moveitem... -eqmule
/*0x02a8*/ BYTE         Unknown0x02a8[0x20];
/*0x02c8*/ struct _EQINVSLOT *  pInvSlot;
/*0x02cc*/ BYTE         Unknown0x02cc[0x8];
/*0x02d4*/ BOOL         ProcessClick;
/*0x02d8*/ BYTE         Unknown0x02d8[0x10];
/*0x02e8*/
} EQINVSLOTWND, *PEQINVSLOTWND;

// CItemDisplayWindow__CItemDisplayWindow aItemdisplaywin
// CItemDisplayWindow_size: 0x640 (see 748052) in Nov  4 2018 Beta - eqmule
...
/*0x0324*/ int			Unknown0x0304;
/*0x0328*/ int			Unknown0x0308;
...
// CLootWnd_size: 0x3b0 (see 538885) in Nov  4 2018 Beta - eqmule
...
// CMapViewWnd_size: 0x678 (see 537FC0) in Nov  4 2018 Beta - eqmule
typedef struct _EQMAPWINDOW {
/*0x0000*/ struct _CSIDLWND     Wnd;
/*0x0248*/ BYTE         Unknown0x0248[0x40];
/*0x0288*/ CHAR         shortzonename[0x80];
/*0x02a8*/ BYTE         Unknown0x02a8[0x3c];
...
/*0x0658*/ PMAPLINE     pLines;     //0x278
/*0x065c*/ PMAPLABEL    pLabels;    //0x27c
/*0x0660*/ BYTE         Unknown0x0660[0x18];
/*0x0678*/
...
// CMerchantWnd_size: 0x460 (see 5389E1) in Nov  4 2018 Beta - eqmule
...
// CPetInfoWindow_size: 0x8e0 (see 5379FA) in Nov  4 2018 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3c0 (see 537CEB) in Nov  4 2018 Beta - eqmule
...
// CTradeWnd__size: 0x308 (see 538A87) in Nov  4 2018 Beta - eqmule
