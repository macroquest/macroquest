...
/*0x0024*/ void   *TitlePiece2; \
/*0x0028*/ UINT		BlinkFadeDuration; \
/*0x002C*/ bool		bClipToParent; \
/*0x0030*/ void* pTipTextObject; \
/*0x0034*/ LONG		BlinkStartTimer; \
/*0x0038*/ bool		bBorder; \
/*0x0039*/ bool		bTiled; \
/*0x003A*/ bool		bUseInLayoutHorizontal; \
/*0x003B*/ bool		bClientRectChanged; \
...
/*0x0046*/ bool		bLeftAnchoredToLeft; \
/*0x0048*/ tagSIZE	MaxClientSize; \
/*0x0050*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0054*/ COLORREF DisabledBackground; \
/*0x0058*/ bool		bHCenterTooltip; \
/*0x0059*/ BYTE		Alpha; \
/*0x005C*/ void*	pTextObject; \
/*0x0060*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x0064*/ int		DeleteCount; \
/*0x0068*/ void *pController; \
/*0x006C*/ int		HScrollMax; \
/*0x0070*/ int		managerArrayIndex; \
/*0x0074*/ bool		bKeepOnScreen; \
/*0x0075*/ bool		bFullyScreenClipped; \
/*0x0078*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x007C*/ int		RightOffset; \
/*0x0080*/ int		TopOffset; \
/*0x0084*/ RECT		ClientRect; \
/*0x0094*/ bool		dShow; \
/*0x0095*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x0096*/ bool		bTopAnchoredToTop; \
/*0x0097*/ BYTE		TargetAlpha; \
/*0x0098*/ bool		bMaximizable; \
/*0x0099*/ bool		bBottomAnchoredToTop; \
/*0x009C*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x1c */ \
/*0x00B8*/ UINT		LastBlinkFadeRefreshTime; \
/*0x00BC*/ bool		bScreenClipRectChanged; \
/*0x00C0*/ DWORD	FadeDelay; \
/*0x00C4*/ int	Transition; \
/*0x00C8*/ int		VScrollMax; \
/*0x00CC*/ BYTE		FadeAlpha; \
/*0x00D0*/ int		VScrollPos; \
/*0x00D4*/ struct _CSIDLWND* pWndFocusOther; \
/*0x00D8*/ bool		bEscapableLocked; \
/*0x00DC*/ UINT		BlinkFadeFreq; \
/*0x00E0*/ int		ParentAndContextMenuArrayIndex; \
...
/*0x00FD*/ bool		Enabled; \
/*0x0100*/ int		BlinkDuration; \
/*0x0104*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
/*0x0108*/ bool		bBringToTopWhenClicked; \
/*0x010C*/ DWORD	XMLIndex; \
/*0x0110*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0114*/ int		HScrollPos; \
/*0x0118*/ struct _CXSTR*	DataStr; \
/*0x011C*/ bool		bIsTransitioning; \
/*0x011D*/ bool		bActive; \
/*0x011E*/ bool		bAction; \
...
/*0x0140*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0141*/ bool		Minimized; \
/*0x0142*/ bool		bRightAnchoredToLeft; \
...
/*0x0164*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x0168*/ UINT		FadeDuration; \
/*0x016C*/ bool		bMaximized; \
/*0x0170*/ UINT		BlinkFadeStartTime; \
...
/*0x0184*/ void	    *pFont; \
/*0x0188*/ bool		Faded; \
/*0x0189*/ bool		bBorder2; \
/*0x018A*/ bool		bMarkedForDelete; \
...
/*0x01A0*/ void	*DrawTemplate; \
/*0x01A4*/ int		BlinkState; \
/*0x01A8*/ tagSIZE	MinClientSize; \
/*0x01B0*/ DWORD  BackgroundDrawType; \
/*0x01B4*/ RECT		TransitionRect; \
/*0x01C4*/ void   *TitlePiece; \
/*0x01C8*/ int		LeftOffset; \
/*0x01CC*/ void	*IconTextureAnim; \
/*0x01D0*/ bool		Fades; \
/*0x01D1*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x01D2*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x01D3*/ bool		bUseInLayoutVertical; \
/*0x01D4*/ RECT		ClipRectClient; \
...
// CBazaarSearchWnd_size: 0x92d0 (see 538FED) in Oct 31 2018 Beta - eqmule
...
// CPlayerWindow_size: 0x2e8 (see 5388E0) in Oct 31 2018 Beta - eqmule
...
// CTargetWindow_size: 0x8c8 (see 53877B) in Oct 31 2018 Beta - eqmule
...
// CBuffWindow_size: 0x718 (see 53861F) in Oct 31 2018 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x320 (see 7E79EB) in Oct 31 2018 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d0 (see 5389D9) in Oct 31 2018 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d0 (see 7E7AFC) in Oct 31 2018 Beta - eqmule
...
// CItemDisplayWindow_size: 0x628 (see 747D12) in Oct 31 2018 Beta - eqmule
...
// CLootWnd_size: 0x398 (see 538D45) in Oct 31 2018 Beta - eqmule
...
// CMapViewWnd_size: 0x648 (see 538480) in Oct 31 2018 Beta - eqmule
...
// CMerchantWnd_size: 0x448 (see 538EA1) in Oct 31 2018 Beta - eqmule
...
// CPetInfoWindow_size: 0x8c8 (see 537EBA) in Oct 31 2018 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a8 (see 5381AB) in Oct 31 2018 Beta - eqmule
...
// CTradeWnd__size: 0x2f0 (see 538F47) in Oct 31 2018 Beta - eqmule
