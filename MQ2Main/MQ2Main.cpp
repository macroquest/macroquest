...
DWORD WINAPI MQ2Start(LPVOID lpParameter)
{
	...
	szEQMappableCommands[0xA9]="CHAT_SEMICOLON";
	szEQMappableCommands[0xAA]="CHAT_SLASH";
	szEQMappableCommands[0xAB]="UNKNOWN0xAB";
	szEQMappableCommands[0xAC]="UNKNOWN0xAC";
	szEQMappableCommands[0xAD]="INSTANT_CAMP";
	szEQMappableCommands[0xAE]="UNKNOWN0xAE";
	szEQMappableCommands[0xAF]="UNKNOWN0xAF";
	szEQMappableCommands[0xB0]="CHAT_EMPTY";
	szEQMappableCommands[0xB1]="TOGGLE_WINDOWMODE";
	szEQMappableCommands[0xB2]="UNKNOWN0xB2";
	szEQMappableCommands[0xB3]="UNKNOWN0xB3";
	szEQMappableCommands[0xB4]="CHANGEFACE";// maybe? something that requires models.
