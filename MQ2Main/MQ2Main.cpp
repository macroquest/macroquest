...
bool __cdecl MQ2Initialize()
{
    ...
    szEQMappableCommands[0xf9]="CHAT_SEMICOLON";
    szEQMappableCommands[0xfa]="CHAT_SLASH";
    szEQMappableCommands[0xfb]="UNKNOWN0xFB";
    szEQMappableCommands[0xfc]="UNKNOWN0xFC";
    szEQMappableCommands[0xfd]="INSTANT_CAMP";
    szEQMappableCommands[0xfe]="UNKNOWN0xFE";
    szEQMappableCommands[0xff]="UNKNOWN0xFF";
    szEQMappableCommands[0x100]="CHAT_EMPTY";
    szEQMappableCommands[0x101]="TOGGLE_WINDOWMODE";
    szEQMappableCommands[0x102]="UNKNOWN0x102";
    szEQMappableCommands[0x103]="UNKNOWN0x103";
    szEQMappableCommands[0x104]="CHANGEFACE";// maybe? something that requires models.
