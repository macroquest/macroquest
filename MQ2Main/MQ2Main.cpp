...
bool __cdecl MQ2Initialize()
{
    ...
    szEQMappableCommands[0xf8]="UNKNOWN0xF8";
    szEQMappableCommands[0xf9]="UNKNOWN0xF9";
    szEQMappableCommands[0xfa]="UNKNOWN0xFA";
    szEQMappableCommands[0xfb]="CHAT_SEMICOLON";
    szEQMappableCommands[0xfc]="CHAT_SLASH";
    szEQMappableCommands[0xfd]="UNKNOWN0xFD";
    szEQMappableCommands[0xfe]="UNKNOWN0xFE";
    szEQMappableCommands[0xff]="INSTANT_CAMP";
    szEQMappableCommands[0x100]="UNKNOWN0x100";
    szEQMappableCommands[0x101]="UNKNOWN0x101";
    szEQMappableCommands[0x102]="CHAT_EMPTY";
    szEQMappableCommands[0x103]="TOGGLE_WINDOWMODE";
    szEQMappableCommands[0x104]="UNKNOWN0x104";
    szEQMappableCommands[0x105]="UNKNOWN0x105";
    szEQMappableCommands[0x106]="CHANGEFACE";// maybe? something that requires models.
