...
bool __cdecl MQ2Initialize()
{
    ...
    szEQMappableCommands[0xff]="CHAT_SEMICOLON";
    szEQMappableCommands[0x100]="CHAT_SLASH";
    szEQMappableCommands[0x101]="UNKNOWN0x101";
    szEQMappableCommands[0x102]="UNKNOWN0x102";
    szEQMappableCommands[0x103]="INSTANT_CAMP";
    szEQMappableCommands[0x104]="UNKNOWN0x104";
    szEQMappableCommands[0x105]="UNKNOWN0x105";
    szEQMappableCommands[0x106]="CHAT_EMPTY";
    szEQMappableCommands[0x107]="TOGGLE_WINDOWMODE";
    szEQMappableCommands[0x108]="UNKNOWN0x108";
    szEQMappableCommands[0x109]="UNKNOWN0x109";
    szEQMappableCommands[0x10a]="CHANGEFACE";// maybe? something that requires models.
