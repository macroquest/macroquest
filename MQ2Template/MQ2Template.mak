# Microsoft Developer Studio Generated NMAKE File, Based on MQ2Template.dsp
!IF "$(CFG)" == ""
CFG=MQ2Template - Win32 Release
!MESSAGE No configuration specified. Defaulting to MQ2Template - Win32 Release.
!ENDIF 
...
!MESSAGE 
!MESSAGE NMAKE /f "MQ2Template.mak" CFG="MQ2Template - Win32 Release"
!MESSAGE 
...
ALL : "MQ2Main - Win32 Release" "macroquest - Win32 Release" "$(OUTDIR)\MQ2Template.dll"
...
CPP=cl.exe
CPP_PROJ=/nologo /Zp1 /MT /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "CINTERFACE" /Fp"$(INTDIR)\MQ2Template.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
RSC=rc.exe
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\MQ2Template.bsc" 
BSC32_SBRS= \
	
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib ..\Detours\lib60\detours.lib ..\Release\MQ2Main.lib /nologo /dll /incremental:no /pdb:"$(OUTDIR)\MQ2Template.pdb" /machine:I386 /out:"$(OUTDIR)\MQ2Template.dll" /implib:"$(OUTDIR)\MQ2Template.lib" /OPT:ICF 
LINK32_OBJS= \
