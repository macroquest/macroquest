...
namespace ImGui
{
    ...
    IMGUI_API void          SetNextWindowSizeConstraints(const ImVec2& size_min, const ImVec2& size_max, ImGuiSizeCallback custom_callback = NULL); // set next window size limits. use 0.0f or FLT_MAX if you don't want limits. Use -1 for both min and max of same axis to preserve current size (which itself is a constraint). Use callback to apply non-trivial programmatic constraints.
...
enum ImGuiWindowFlags_
{
    ...
    ImGuiWindowFlags_NavFlattened DEPRECATE("ImGuiWindowFlags_NavFlattened is obsolete. Pass ImGuiChildFlags_NavFlattened to child flags instead") = 1 << 29,  // Obsoleted in 1.90.9: moved to ImGuiChildFlags. BeginChild(name, size, 0, ImGuiWindowFlags_NavFlattened)           --> BeginChild(name, size, ImGuiChildFlags_NavFlattened, 0)
    ImGuiWindowFlags_AlwaysUseWindowPadding DEPRECATE("ImGuiWindowFlags_AlwaysUseWindowPadding is obsolete. Pass ImGuiChildFlags_AlwaysUseWindowPadding to child flags instead")  = 1 << 30,  // Obsoleted in 1.90.0: moved to ImGuiChildFlags. BeginChild(name, size, 0, ImGuiWindowFlags_AlwaysUseWindowPadding) --> BeginChild(name, size, ImGuiChildFlags_AlwaysUseWindowPadding, 0)
#endif
};
...
enum ImGuiChildFlags_
{
    ...
    // Obsolete names
#ifndef IMGUI_DISABLE_OBSOLETE_FUNCTIONS
    ImGuiChildFlags_Border DEPRECATE("ImGuiChildFlags_Border is obsolete. Use ImGuiChildFlags_Borders") = ImGuiChildFlags_Borders,  // Renamed in 1.91.1 (August 2024) for consistency.
#endif
};
...
enum ImGuiInputTextFlags_
{
    ...
    // Obsolete names
    ImGuiInputTextFlags_AlwaysInsertMode DEPRECATE("Use ImGuiInputTextFlags_AlwaysOverwrite instead of ImGuiInputTextFlags_AlwaysInsertMode") = ImGuiInputTextFlags_AlwaysOverwrite   // [renamed in 1.82] name was not matching behavior
};
...
#ifndef IMGUI_DISABLE_OBSOLETE_FUNCTIONS
    ImGuiTreeNodeFlags_NavLeftJumpsBackHere DEPRECATE("ImGuiTreeNodeFlags_NavLeftJumpsBackHere is obsolete. Use ImGuiTreeNodeFlags_NavLeftJumpsToParent instead.") = ImGuiTreeNodeFlags_NavLeftJumpsToParent,  // Renamed in 1.92.0
    ImGuiTreeNodeFlags_SpanTextWidth DEPRECATE("ImGuiTreeNodeFlags_SpanTextWidth is obsolete. Use ImGuiTreeNodeFlags_SpanLabelWidth instead.") = ImGuiTreeNodeFlags_SpanLabelWidth,            // Renamed in 1.90.7
    ImGuiTreeNodeFlags_AllowItemOverlap DEPRECATE("ImGuiTreeNodeFlags_AllowItemOverlap is obsolete. Use ImGuiTreeNodeFlags_AllowOverlap instead.") = ImGuiTreeNodeFlags_AllowOverlap,          // Renamed in 1.89.7
#endif
};
...
#ifndef IMGUI_DISABLE_OBSOLETE_FUNCTIONS
    ImGuiSelectableFlags_DontClosePopups DEPRECATE("ImGuiSelectableFlags_DontClosePopups is obsolete. Use ImGuiSelectableFlags_NoAutoClosePopups instead") = ImGuiSelectableFlags_NoAutoClosePopups,   // Renamed in 1.91.0
    ImGuiSelectableFlags_AllowItemOverlap DEPRECATE("ImGuiSelectableFlags_AllowItemOverlap is obsolete. Use ImGuiSelectableFlags_AllowOverlap instead") = ImGuiSelectableFlags_AllowOverlap,        // Renamed in 1.89.7
#endif
};
...
#ifndef IMGUI_DISABLE_OBSOLETE_FUNCTIONS
    ImGuiTabBarFlags_FittingPolicyResizeDown DEPRECATE("ImGuiTabBarFlags_FittingPolicyResizeDown is obsolete. Use ImGuiTabBarFlags_FittingPolicyShrink instead") = ImGuiTabBarFlags_FittingPolicyShrink, // Renamed in 1.92.2
#endif
};
...
#ifndef IMGUI_DISABLE_OBSOLETE_FUNCTIONS
    ImGuiDockNodeFlags_NoSplit DEPRECATE("ImGuiDockNodeFlags_NoSplit is obsolete. Use ImGuiDockNodeFlags_NoDockingSplit instead.") = ImGuiDockNodeFlags_NoDockingSplit, // Renamed in 1.90
    ImGuiDockNodeFlags_NoDockingInCentralNode DEPRECATE("ImGuiDockNodeFlags_NoDockingInCentralNode is obsolete. Use ImGuiDockNodeFlags_NoDockingOverCentralNode instead.") = ImGuiDockNodeFlags_NoDockingOverCentralNode, // Renamed in 1.90
#endif
};
...
#ifndef IMGUI_DISABLE_OBSOLETE_FUNCTIONS
    ImGuiDragDropFlags_SourceAutoExpirePayload DEPRECATE("ImGuiDragDropFlags_SourceAutoExpirePayload is obsolete. Use ImGuiDragDropFlags_PayloadAutoExpire instead") = ImGuiDragDropFlags_PayloadAutoExpire, // Renamed in 1.90.9
#endif
};
...
#ifndef IMGUI_DISABLE_OBSOLETE_FUNCTIONS
    ImGuiKey_COUNT DEPRECATE("ImGuiKey_COUNT is obsolete. Use ImGuiKey_NamedKey_END instead") = ImGuiKey_NamedKey_END,    // Obsoleted in 1.91.5 because it was misleading (since named keys don't start at 0 anymore)
    ImGuiMod_Shortcut DEPRECATE("ImGuiMod_Shortcut is obsolete. Use ImGuiMod_Ctrl instead") = ImGuiMod_Ctrl,            // Removed in 1.90.7, you can now simply use ImGuiMod_Ctrl
    ImGuiKey_ModCtrl DEPRECATE("ImGuiKey_ModCtrl is obsolete. Use ImGuiMod_Ctrl instead") = ImGuiMod_Ctrl, // Renamed in 1.89
    ImGuiKey_ModShift DEPRECATE("ImGuiKey_ModShift is obsolete. Use ImGuiMod_Shift instead") = ImGuiMod_Shift, // Renamed in 1.89
    ImGuiKey_ModAlt DEPRECATE("ImGuiKey_ModAlt is obsolete. Use ImGuiMod_Alt instead") = ImGuiMod_Alt, // Renamed in 1.89
    ImGuiKey_ModSuper DEPRECATE("ImGuiKey_ModSuper is obsolete. Use ImGuiMod_Super instead") = ImGuiMod_Super, // Renamed in 1.89
    ImGuiKey_KeyPadEnter DEPRECATE("ImGuiKey_KeyPadEnter is obsolete. Use ImGuiKey_KeypadEnter instead") = ImGuiKey_KeypadEnter, // Renamed in 1.87
#endif
};
...
#ifndef IMGUI_DISABLE_OBSOLETE_FUNCTIONS
    ImGuiConfigFlags_NavEnableSetMousePos DEPRECATE("ImGuiConfigFlags_NavEnableSetMousePos is obsolete. Use io.ConfigNavMoveSetMousePos instead") = 1 << 2, // [moved/renamed in 1.91.4] -> use bool io.ConfigNavMoveSetMousePos
    ImGuiConfigFlags_NavNoCaptureKeyboard DEPRECATE("ImGuiConfigFlags_NavNoCaptureKeyboard is obsolete. Use io.ConfigNavCaptureKeyboard instead") = 1 << 3, // [moved/renamed in 1.91.4] -> use bool io.ConfigNavCaptureKeyboard
    ImGuiConfigFlags_DpiEnableScaleFonts DEPRECATE("ImGuiConfigFlags_DpiEnableScaleFonts is obsolete. Use io.ConfigDpiScaleFonts instead") = 1 << 14, // [moved/renamed in 1.92.0] -> use bool io.ConfigDpiScaleFonts
    ImGuiConfigFlags_DpiEnableScaleViewports DEPRECATE("ImGuiConfigFlags_DpiEnableScaleViewports is obsolete. Use io.ConfigDpiScaleViewports instead") = 1 << 15, // [moved/renamed in 1.92.0] -> use bool io.ConfigDpiScaleViewports
#endif
};
...
#ifndef IMGUI_DISABLE_OBSOLETE_FUNCTIONS
    ImGuiCol_TabActive  DEPRECATE("ImGuiCol_TabActive is obsolete. Use ImGuiCol_TabSelected instead") = ImGuiCol_TabSelected, // [renamed in 1.90.9]
    ImGuiCol_TabUnfocused  DEPRECATE("ImGuiCol_TabUnfocused is obsolete. Use ImGuiCol_TabDimmed instead") = ImGuiCol_TabDimmed, // [renamed in 1.90.9]
    ImGuiCol_TabUnfocusedActive  DEPRECATE("ImGuiCol_TabUnfocusedActive is obsolete. Use ImGuiCol_TabDimmedSelected instead") = ImGuiCol_TabDimmedSelected, // [renamed in 1.90.9]
    ImGuiCol_NavHighlight DEPRECATE("ImGuiCol_NavHighlight is obsolete. Use ImGuiCol_NavCursor instead") = ImGuiCol_NavCursor, // [renamed in 1.91.4]
#endif
};
...
enum ImGuiColorEditFlags_
{
    ...
    // Obsolete names
#ifndef IMGUI_DISABLE_OBSOLETE_FUNCTIONS
    ImGuiColorEditFlags_RGB DEPRECATE("Use ImGuiColorEditFlags_DisplayRGB instead of ImGuiColorEditFlags_RGB") = ImGuiColorEditFlags_DisplayRGB,
    ImGuiColorEditFlags_HSV DEPRECATE("Use ImGuiColorEditFlags_DisplayHSV instead of ImGuiColorEditFlags_HSV") = ImGuiColorEditFlags_DisplayHSV,
    ImGuiColorEditFlags_HEX DEPRECATE("Use ImGuiColorEditFlags_DisplayHex instead of ImGuiColorEditFlags_HEX") = ImGuiColorEditFlags_DisplayHex,  // [renamed in 1.69]
    ImGuiColorEditFlags_AlphaPreview DEPRECATE("ImGuiColorEditFlags_AlphaPreview is the default and can be removed now") = 0, // Removed in 1.91.8. This is the default now. Will display a checkerboard unless ImGuiColorEditFlags_AlphaNoBg is set.
#endif
...
namespace ImGui
{
    ...
    //DEPRECATE("PushFont with no size parameter is obsolete. Use ImGui::SetFont(font, fontSize) instead")
    inline void         PushFont(ImFont* font)                                  { PushFont(font, font ? font->LegacySize : 0.0f); }
    DEPRECATE("SetWindowFontScale is obsolete. Use ImGui::SetFont(font, fontSize) instead")
    ...
    DEPRECATE("SetItemAllowOverlap is obsolete. Use SetNextItemAllowOverlap()_before item.")
    static inline void  SetItemAllowOverlap() {}                                                      // Use SetNextItemAllowOverlap() _before_ item.
    //-- OBSOLETED in 1.89.4 (from March 2023)
    DEPRECATE("PushAllowKeyboardFocus(bool tab_stop) is obsolete. Use ImGui::PushItemFlag(ImGuiItemFlags_NoTabStop, !tab_stop)")
    static inline void  PushAllowKeyboardFocus(bool tab_stop)                                         { PushItemFlag(ImGuiItemFlags_NoTabStop, !tab_stop); }
    DEPRECATE("PopAllowKeyboardFocus() is obsolete. Use ImGui::PopItemFlag()")
    ...
    DEPRECATE("GetWindowContentRegionWidth is obsolete. See implementation for replacement.")
    static inline float GetWindowContentRegionWidth()                                               { return GetWindowContentRegionMax().x - GetWindowContentRegionMin().x; }
    //-- OBSOLETED in 1.81 (from February 2021)
    DEPRECATE("Use BeginListBox instead of ListBoxHeader")
    static inline bool  ListBoxHeader(const char* label, const ImVec2& size = ImVec2(0, 0))         { return BeginListBox(label, size); }
    DEPRECATE("Use BeginListBox instead of ListBoxHeader")
    static inline bool  ListBoxHeader(const char* label, int items_count, int height_in_items = -1) { float height = GetTextLineHeightWithSpacing() * ((height_in_items < 0 ? (items_count < 7 ? items_count : 7) : height_in_items) + 0.25f) + GetStyle().FramePadding.y * 2.0f; return BeginListBox(label, ImVec2(0.0f, height)); } // Helper to calculate size from items_count and height_in_items
    DEPRECATE("Use EndListBox instead of ListBoxFooter")
    ...
    DEPRECATE("This form of DragFloat is deprecated")
    static inline bool  DragFloat(const char* label, float* v, float v_speed, float v_min, float v_max, const char* format, float power)    { return DragScalar(label, ImGuiDataType_Float, v, v_speed, &v_min, &v_max, format, power != 1.0f ? ImGuiSliderFlags_Logarithmic : ImGuiSliderFlags_None); }     // OBSOLETED in 1.78 (from June 2020)
    DEPRECATE("This form of DragFloat2 is deprecated")
    static inline bool  DragFloat2(const char* label, float v[2], float v_speed, float v_min, float v_max, const char* format, float power) { return DragScalarN(label, ImGuiDataType_Float, v, 2, v_speed, &v_min, &v_max, format, power != 1.0f ? ImGuiSliderFlags_Logarithmic : ImGuiSliderFlags_None); } // OBSOLETED in 1.78 (from June 2020)
    DEPRECATE("This form of DragFloat3 is deprecated")
    static inline bool  DragFloat3(const char* label, float v[3], float v_speed, float v_min, float v_max, const char* format, float power) { return DragScalarN(label, ImGuiDataType_Float, v, 3, v_speed, &v_min, &v_max, format, power != 1.0f ? ImGuiSliderFlags_Logarithmic : ImGuiSliderFlags_None); } // OBSOLETED in 1.78 (from June 2020)
    DEPRECATE("This form of DragFloat4 is deprecated")
    static inline bool  DragFloat4(const char* label, float v[4], float v_speed, float v_min, float v_max, const char* format, float power) { return DragScalarN(label, ImGuiDataType_Float, v, 4, v_speed, &v_min, &v_max, format, power != 1.0f ? ImGuiSliderFlags_Logarithmic : ImGuiSliderFlags_None); } // OBSOLETED in 1.78 (from June 2020)
    DEPRECATE("This form of SliderFloat is deprecated")
    static inline bool  SliderFloat(const char* label, float* v, float v_min, float v_max, const char* format, float power)                 { return SliderScalar(label, ImGuiDataType_Float, v, &v_min, &v_max, format, power != 1.0f ? ImGuiSliderFlags_Logarithmic : ImGuiSliderFlags_None); }            // OBSOLETED in 1.78 (from June 2020)
    DEPRECATE("This form of SliderFloat2 is deprecated")
    static inline bool  SliderFloat2(const char* label, float v[2], float v_min, float v_max, const char* format, float power)              { return SliderScalarN(label, ImGuiDataType_Float, v, 2, &v_min, &v_max, format, power != 1.0f ? ImGuiSliderFlags_Logarithmic : ImGuiSliderFlags_None); }        // OBSOLETED in 1.78 (from June 2020)
    DEPRECATE("This form of SliderFloat3 is deprecated")
    static inline bool  SliderFloat3(const char* label, float v[3], float v_min, float v_max, const char* format, float power)              { return SliderScalarN(label, ImGuiDataType_Float, v, 3, &v_min, &v_max, format, power != 1.0f ? ImGuiSliderFlags_Logarithmic : ImGuiSliderFlags_None); }        // OBSOLETED in 1.78 (from June 2020)
    DEPRECATE("This form of SliderFloat4 is deprecated")
    static inline bool  SliderFloat4(const char* label, float v[4], float v_min, float v_max, const char* format, float power)              { return SliderScalarN(label, ImGuiDataType_Float, v, 4, &v_min, &v_max, format, power != 1.0f ? ImGuiSliderFlags_Logarithmic : ImGuiSliderFlags_None); }        // OBSOLETED in 1.78 (from June 2020)
    ...
    DEPRECATE("TreeAdvanceToLabelPos is obsolete")
    static inline void  TreeAdvanceToLabelPos()               { SetCursorPosX(GetCursorPosX() + GetTreeNodeToLabelSpacing()); }   // OBSOLETED in 1.72 (from July 2019)
    //static inline void  SetNextTreGetWindowContentRegionMineNodeOpen(bool open, ImGuiCond cond = 0) { SetNextItemOpen(open, cond); }                       // OBSOLETED in 1.71 (from June 2019)
    DEPRECATE("Use GetContentRegionAvail().x instead of GetContentRegionAvailWidth()")
