...
static void ShowExampleAppConstrainedResize(bool* p_open)
{
    struct CustomConstraints
    {
        ...
        static void AspectRatio(ImGuiSizeCallbackData* data, float aspect_ratio)
        {
        ...
        static void Step(ImGuiSizeCallbackData* data, float step)
        {
    ...
    if (type == 6) ImGui::SetNextWindowSizeConstraints(ImVec2(0, 0),     ImVec2(FLT_MAX, FLT_MAX), [&](ImGuiSizeCallbackData* data) { CustomConstraints::AspectRatio(data, aspect_ratio); });   // Aspect ratio
    if (type == 7) ImGui::SetNextWindowSizeConstraints(ImVec2(0, 0),     ImVec2(FLT_MAX, FLT_MAX), CustomConstraints::Square);                                                                  // Always Square
    if (type == 8) ImGui::SetNextWindowSizeConstraints(ImVec2(0, 0),     ImVec2(FLT_MAX, FLT_MAX), [&](ImGuiSizeCallbackData* data) { CustomConstraints::Step(data, fixed_step); });            // Fixed Step
